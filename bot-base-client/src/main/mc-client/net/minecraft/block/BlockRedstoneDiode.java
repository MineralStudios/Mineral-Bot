...
public abstract class BlockRedstoneDiode extends BlockDirectional {
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
        return !World.doesBlockHaveSolidTopSurface(p_149742_1_, p_149742_2_, p_149742_3_ - 1, p_149742_4_) ? false
    ...
    public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_) {
        return !World.doesBlockHaveSolidTopSurface(p_149718_1_, p_149718_2_, p_149718_3_ - 1, p_149718_4_) ? false
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (!this.func_149910_g(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, var6)) {
            ...
            if (this.field_149914_a && !var7) {
                ...
                if (!var7) {
                    p_149674_1_.func_147454_a(p_149674_2_, p_149674_3_, p_149674_4_, this.func_149906_e(),
                            this.func_149899_k(var6), -1);
                }
            }
        }
    }
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        return p_149691_1_ == 0
                ? (this.field_149914_a ? Blocks.redstone_torch.getBlockTextureFromSide(p_149691_1_)
                        : Blocks.unlit_redstone_torch.getBlockTextureFromSide(p_149691_1_))
                : (p_149691_1_ == 1 ? this.blockIcon : Blocks.double_stone_slab.getBlockTextureFromSide(1));
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_,
        ...
        if (!this.func_149905_c(var6)) {
            ...
            return var7 == 0 && p_149709_5_ == 3
                    ? this.func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, var6)
                    : (var7 == 1 && p_149709_5_ == 4
                            ? this.func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, var6)
                            : (var7 == 2 && p_149709_5_ == 2
                                    ? this.func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, var6)
                                    : (var7 == 3 && p_149709_5_ == 5
                                            ? this.func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_,
                                                    var6)
                                            : 0)));
        }
    }
    ...
    protected void func_149897_b(World p_149897_1_, int p_149897_2_, int p_149897_3_, int p_149897_4_,
        ...
        if (!this.func_149910_g(p_149897_1_, p_149897_2_, p_149897_3_, p_149897_4_, var6)) {
            ...
            if ((this.field_149914_a && !var7 || !this.field_149914_a && var7)
                    && !p_149897_1_.func_147477_a(p_149897_2_, p_149897_3_, p_149897_4_, this)) {
                byte var8 = -1;
    ...
    protected boolean func_149900_a(World p_149900_1_, int p_149900_2_, int p_149900_3_, int p_149900_4_,
            int p_149900_5_) {
    ...
    protected int func_149903_h(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_) {
        ...
        return var9 >= 15 ? var9
                : Math.max(var9,
                        p_149903_1_.getBlock(var7, p_149903_3_, var8) == Blocks.redstone_wire
                                ? p_149903_1_.getBlockMetadata(var7, p_149903_3_, var8)
                                : 0);
    }
    ...
    protected int func_149913_i(IBlockAccess p_149913_1_, int p_149913_2_, int p_149913_3_, int p_149913_4_,
        ...
        return this.func_149908_a(var6)
                ? (var6 == Blocks.redstone_wire ? p_149913_1_.getBlockMetadata(p_149913_2_, p_149913_3_, p_149913_4_)
    ...
    public boolean func_149912_i(World p_149912_1_, int p_149912_2_, int p_149912_3_, int p_149912_4_,
        ...
        if (func_149909_d(p_149912_1_.getBlock(p_149912_2_ - Direction.offsetX[var6], p_149912_3_,
                p_149912_4_ - Direction.offsetZ[var6]))) {
            int var7 = p_149912_1_.getBlockMetadata(p_149912_2_ - Direction.offsetX[var6], p_149912_3_,
                    p_149912_4_ - Direction.offsetZ[var6]);
