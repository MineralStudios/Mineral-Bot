...
public class BlockDoor extends Block {
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        if (this.blockMaterial == Material.iron) {
            ...
            if ((var10 & 8) == 0) {
                ...
                p_149727_1_.markBlockRangeForRenderUpdate(p_149727_2_, p_149727_3_, p_149727_4_, p_149727_2_,
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
        ...
        if ((var6 & 8) == 0) {
            ...
            if (var7) {
                ...
                boolean var8 = p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_, p_149695_4_)
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return (p_149650_1_ & 8) != 0 ? null
                : (this.blockMaterial == Material.iron ? Items.iron_door : Items.wooden_door);
    }
