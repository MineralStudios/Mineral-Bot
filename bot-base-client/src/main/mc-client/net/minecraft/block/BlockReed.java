...
public class BlockReed extends Block {
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
        ...
        return var5 == this ? true
                : (var5 != Blocks.grass && var5 != Blocks.dirt && var5 != Blocks.sand ? false
                        : (p_149742_1_.getBlock(p_149742_2_ - 1, p_149742_3_ - 1, p_149742_4_)
                                .getMaterial() == Material.water
                                        ...
                                        : (p_149742_1_.getBlock(p_149742_2_ + 1, p_149742_3_ - 1, p_149742_4_)
                                                .getMaterial() == Material.water
                                                        ? true
                                                        : (p_149742_1_
                                                                .getBlock(p_149742_2_, p_149742_3_ - 1, p_149742_4_ - 1)
                                                                .getMaterial() == Material.water
                                                                        ? true
                                                                        : p_149742_1_
                                                                                .getBlock(p_149742_2_, p_149742_3_ - 1,
                                                                                        p_149742_4_ + 1)
                                                                                .getMaterial() == Material.water))));
    }
