...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_,
        ...
        for (int var8 = 0; var8 < var6.size(); ++var8) {
            ...
            if (var9.field_150847_a == p_150111_2_ && var9.field_150845_b == p_150111_3_
                    && var9.field_150846_c == p_150111_4_) {
                ++var7;
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_,
        ...
        if (!this.field_150113_a) {
            ...
            return var6 == 5 && p_149709_5_ == 1 ? 0
                    : (var6 == 3 && p_149709_5_ == 3 ? 0
                            : (var6 == 4 && p_149709_5_ == 2 ? 0
                                    : (var6 == 1 && p_149709_5_ == 5 ? 0 : (var6 == 2 && p_149709_5_ == 4 ? 0 : 15))));
        }
    }
    ...
    private boolean func_150110_m(World p_150110_1_, int p_150110_2_, int p_150110_3_, int p_150110_4_) {
        ...
        return var5 == 5 && p_150110_1_.getIndirectPowerOutput(p_150110_2_, p_150110_3_ - 1, p_150110_4_, 0) ? true
                : (var5 == 3 && p_150110_1_.getIndirectPowerOutput(p_150110_2_, p_150110_3_, p_150110_4_ - 1, 2) ? true
                        : (var5 == 4 && p_150110_1_.getIndirectPowerOutput(p_150110_2_, p_150110_3_, p_150110_4_ + 1, 3)
                                ? true
                                : (var5 == 1 && p_150110_1_.getIndirectPowerOutput(p_150110_2_ - 1, p_150110_3_,
                                        p_150110_4_, 4) ? true
                                                : var5 == 2 && p_150110_1_.getIndirectPowerOutput(p_150110_2_ + 1,
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (this.field_150113_a) {
            if (var6) {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Blocks.unlit_redstone_torch,
                ...
                if (this.func_150111_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, true)) {
                    p_149674_1_.playSoundEffect((double) ((float) p_149674_2_ + 0.5F),
                            (double) ((float) p_149674_3_ + 0.5F), (double) ((float) p_149674_4_ + 0.5F), "random.fizz",
                            0.5F, 2.6F + (p_149674_1_.rand.nextFloat() - p_149674_1_.rand.nextFloat()) * 0.8F);
            ...
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, Blocks.redstone_torch,
                    p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_), 3);
        }
    }
