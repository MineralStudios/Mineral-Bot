...
public class BlockBrewingStand extends BlockContainer {
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        if (p_149727_1_.isClient) {
            ...
            TileEntityBrewingStand var10 = (TileEntityBrewingStand) p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_,
                    p_149727_4_);
            ...
            for (int var9 = 0; var9 < var8.getSizeInventory(); ++var9) {
                ...
                if (var10 != null) {
                    ...
                    while (var10.stackSize > 0) {
                        ...
                        EntityItem var15 = new EntityItem(p_149749_1_, (double) ((float) p_149749_2_ + var11),
                                (double) ((float) p_149749_3_ + var12), (double) ((float) p_149749_4_ + var13),
                                new ItemStack(var10.getItem(), var14, var10.getItemDamage()));
                        float var16 = 0.05F;
