...
public class BlockBed extends BlockDirectional {
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        if (p_149727_1_.isClient) {
            ...
            if (p_149727_1_.provider.canRespawnHere()
                ...
                p_149727_1_.newExplosion((Entity) null, (double) ((float) p_149727_2_ + 0.5F),
                        (double) ((float) p_149727_3_ + 0.5F), (double) ((float) p_149727_4_ + 0.5F), 5.0F, true, true);
                return true;
            }
        }
    }
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        if (p_149691_1_ == 0) {
            ...
            return (var5 != 1 || var4 != 2) && (var5 != 0 || var4 != 3)
                    ? (var4 != 5 && var4 != 4 ? this.field_149983_N[var5] : this.field_149982_M[var5])
                    : this.field_149980_b[var5];
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
        ...
        if (func_149975_b(var6)) {
            if (p_149695_1_.getBlock(p_149695_2_ - field_149981_a[var7][0], p_149695_3_,
                    p_149695_4_ - field_149981_a[var7][1]) != this) {
                p_149695_1_.setBlockToAir(p_149695_2_, p_149695_3_, p_149695_4_);
            }
        } else if (p_149695_1_.getBlock(p_149695_2_ + field_149981_a[var7][0], p_149695_3_,
                p_149695_4_ + field_149981_a[var7][1]) != this) {
            p_149695_1_.setBlockToAir(p_149695_2_, p_149695_3_, p_149695_4_);
        ...
        for (int var7 = 0; var7 <= 1; ++var7) {
            ...
            for (int var12 = var8; var12 <= var10; ++var12) {
                for (int var13 = var9; var13 <= var11; ++var13) {
                    if (World.doesBlockHaveSolidTopSurface(p_149977_0_, var12, p_149977_2_ - 1, var13)
                            && !p_149977_0_.getBlock(var12, p_149977_2_, var13).getMaterial().isOpaque()
                            && !p_149977_0_.getBlock(var12, p_149977_2_ + 1, var13).getMaterial().isOpaque()) {
                        if (p_149977_4_ <= 0) {
