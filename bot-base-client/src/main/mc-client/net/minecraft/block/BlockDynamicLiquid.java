...
public class BlockDynamicLiquid extends BlockLiquid {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (var6 > 0) {
            ...
            if (this.field_149815_a >= 2 && this.blockMaterial == Material.water) {
                if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_).getMaterial().isSolid()) {
                    var11 = 0;
                } else if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_)
                        .getMaterial() == this.blockMaterial
                        && p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == 0) {
                    var11 = 0;
                }
            }

            if (this.blockMaterial == Material.lava && var6 < 8 && var11 < 8 && var11 > var6
        ...
        if (this.func_149809_q(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_)) {
            if (this.blockMaterial == Material.lava && p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_)
            ...
            if (var6 >= 8) {
                ...
                && (var6 == 0 || this.func_149807_p(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_))) {
    ...
    private void func_149813_h(World p_149813_1_, int p_149813_2_, int p_149813_3_, int p_149813_4_, int p_149813_5_) {
        if (this.func_149809_q(p_149813_1_, p_149813_2_, p_149813_3_, p_149813_4_)) {
            ...
            if (this.blockMaterial == Material.lava) {
                ...
                var6.dropBlockAsItem(p_149813_1_, p_149813_2_, p_149813_3_, p_149813_4_,
    ...
    private int func_149812_c(World p_149812_1_, int p_149812_2_, int p_149812_3_, int p_149812_4_, int p_149812_5_,
        ...
        for (int var8 = 0; var8 < 4; ++var8) {
            if ((var8 != 0 || p_149812_6_ != 1) && (var8 != 1 || p_149812_6_ != 0) && (var8 != 2 || p_149812_6_ != 3)
                ...
                if (!this.func_149807_p(p_149812_1_, var9, p_149812_3_, var11)
                        && (p_149812_1_.getBlock(var9, p_149812_3_, var11).getMaterial() != this.blockMaterial
                                || p_149812_1_.getBlockMetadata(var9, p_149812_3_, var11) != 0)) {
    ...
    private boolean[] func_149808_o(World p_149808_1_, int p_149808_2_, int p_149808_3_, int p_149808_4_) {
        ...
        for (var5 = 0; var5 < 4; ++var5) {
            ...
            if (!this.func_149807_p(p_149808_1_, var6, p_149808_3_, var8)
                    && (p_149808_1_.getBlock(var6, p_149808_3_, var8).getMaterial() != this.blockMaterial
                            || p_149808_1_.getBlockMetadata(var6, p_149808_3_, var8) != 0)) {
    ...
    private boolean func_149807_p(World p_149807_1_, int p_149807_2_, int p_149807_3_, int p_149807_4_) {
        ...
        return var5 != Blocks.wooden_door && var5 != Blocks.iron_door && var5 != Blocks.standing_sign
                && var5 != Blocks.ladder && var5 != Blocks.reeds
                        ? (var5.blockMaterial == Material.Portal ? true : var5.blockMaterial.blocksMovement())
                        : true;
    }
