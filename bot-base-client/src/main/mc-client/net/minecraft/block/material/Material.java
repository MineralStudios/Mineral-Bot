...
public class Material {
    ...
    public static final Material anvil = (new Material(MapColor.field_151668_h)).setRequiresTool()
    ...
    public static final Material leaves = (new Material(MapColor.field_151669_i)).setBurning().setTranslucent()
            .setNoPushMobility();
    ...
    public static final Material glass = (new Material(MapColor.field_151660_b)).setTranslucent()
    ...
    public static final Material ice = (new Material(MapColor.field_151657_g)).setTranslucent()
            .setAdventureModeExempt();
    public static final Material field_151598_x = (new Material(MapColor.field_151657_g)).setAdventureModeExempt();
    public static final Material field_151597_y = (new MaterialLogic(MapColor.field_151666_j)).setReplaceable()
            .setTranslucent().setRequiresTool().setNoPushMobility();

    /** The material for crafted snow. */
    public static final Material craftedSnow = (new Material(MapColor.field_151666_j)).setRequiresTool();
    public static final Material field_151570_A = (new Material(MapColor.field_151669_i)).setTranslucent()
            .setNoPushMobility();
    ...
    /**
     * Returns true if blocks with this material can always be mined in adventure
     * mode.
     */
