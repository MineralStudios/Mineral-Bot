...
public class BlockCactus extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_,
            int p_149668_4_) {
        float var5 = 0.0625F;
        return AxisAlignedBB.getBoundingBox((double) ((float) p_149668_2_ + var5), (double) p_149668_3_,
                (double) ((float) p_149668_4_ + var5), (double) ((float) (p_149668_2_ + 1) - var5),
                (double) ((float) (p_149668_3_ + 1) - var5), (double) ((float) (p_149668_4_ + 1) - var5));
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_, int p_149633_2_, int p_149633_3_,
            int p_149633_4_) {
        float var5 = 0.0625F;
        return AxisAlignedBB.getBoundingBox((double) ((float) p_149633_2_ + var5), (double) p_149633_3_,
                (double) ((float) p_149633_4_ + var5), (double) ((float) (p_149633_2_ + 1) - var5),
                (double) (p_149633_3_ + 1), (double) ((float) (p_149633_4_ + 1) - var5));
    }
