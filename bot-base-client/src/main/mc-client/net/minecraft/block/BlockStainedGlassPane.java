...
public class BlockStainedGlassPane extends BlockPane {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        for (int var2 = 0; var2 < field_150106_a.length; ++var2) {
            field_150106_a[var2] = p_149651_1_
                    .registerIcon(this.getTextureName() + "_" + ItemDye.field_150921_b[func_150103_c(var2)]);
            field_150105_b[var2] = p_149651_1_
                    .registerIcon(this.getTextureName() + "_pane_top_" + ItemDye.field_150921_b[func_150103_c(var2)]);
        }
    }
}
