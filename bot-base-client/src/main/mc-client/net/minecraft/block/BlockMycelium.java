...
public class BlockMycelium extends Block {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        return p_149691_1_ == 1 ? this.field_150200_a
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_,
        ...
        if (p_149734_5_.nextInt(10) == 0) {
            p_149734_1_.spawnParticle("townaura", (double) ((float) p_149734_2_ + p_149734_5_.nextFloat()),
                    (double) ((float) p_149734_3_ + 1.1F), (double) ((float) p_149734_4_ + p_149734_5_.nextFloat()),
                    0.0D, 0.0D, 0.0D);
        }
    }
