...
public class BlockCauldron extends Block {
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_,
        ...
        if (!p_149670_1_.isClient && p_149670_5_.isBurning() && var6 > 0
                && p_149670_5_.boundingBox.minY <= (double) var7) {
        ...
        if (p_149727_1_.isClient) {
            ...
            if (var10 == null) {
                ...
                if (var10.getItem() == Items.water_bucket) {
                        ...
                        if (var12 > 0) {
                            if (!p_149727_5_.capabilities.isCreativeMode) {
                                ...
                                if (!p_149727_5_.inventory.addItemStackToInventory(var13)) {
                                    p_149727_1_
                                            .spawnEntityInWorld(new EntityItem(p_149727_1_, (double) p_149727_2_ + 0.5D,
                                                    (double) p_149727_3_ + 1.5D, (double) p_149727_4_ + 0.5D, var13));
                    ...
                    } else if (var12 > 0 && var10.getItem() instanceof ItemArmor
