...
public class BlockDragonEgg extends Block {
    ...
    private void func_150018_e(World p_150018_1_, int p_150018_2_, int p_150018_3_, int p_150018_4_) {
        if (BlockFalling.func_149831_e(p_150018_1_, p_150018_2_, p_150018_3_ - 1, p_150018_4_) && p_150018_3_ >= 0) {
            ...
            if (!BlockFalling.field_149832_M && p_150018_1_.checkChunksExist(p_150018_2_ - var5, p_150018_3_ - var5,
                    p_150018_4_ - var5, p_150018_2_ + var5, p_150018_3_ + var5, p_150018_4_ + var5)) {
                EntityFallingBlock var6 = new EntityFallingBlock(p_150018_1_, (double) ((float) p_150018_2_ + 0.5F),
                        (double) ((float) p_150018_3_ + 0.5F), (double) ((float) p_150018_4_ + 0.5F), this);
            ...
            for (int var5 = 0; var5 < 1000; ++var5) {
                ...
                if (p_150019_1_.getBlock(var6, var7, var8).blockMaterial == Material.air) {
                    if (!p_150019_1_.isClient) {
                        p_150019_1_.setBlock(var6, var7, var8, this,
                                p_150019_1_.getBlockMetadata(p_150019_2_, p_150019_3_, p_150019_4_), 2);
                        ...
                        for (int var10 = 0; var10 < var9; ++var10) {
                            ...
                            double var16 = (double) var6 + (double) (p_150019_2_ - var6) * var11
                                    + (p_150019_1_.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
                            double var18 = (double) var7 + (double) (p_150019_3_ - var7) * var11
                                    + p_150019_1_.rand.nextDouble() * 1.0D - 0.5D;
                            double var20 = (double) var8 + (double) (p_150019_4_ - var8) * var11
                                    + (p_150019_1_.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
                            p_150019_1_.spawnParticle("portal", var16, var18, var20, (double) var13, (double) var14,
                                    (double) var15);
                        }
                    }
