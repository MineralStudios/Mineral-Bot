...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        ...
        return p_149691_1_ == 0
                ? (var3 ? Blocks.redstone_torch.getBlockTextureFromSide(p_149691_1_)
                        : Blocks.unlit_redstone_torch.getBlockTextureFromSide(p_149691_1_))
                : (p_149691_1_ == 1 ? (var3 ? Blocks.powered_comparator.blockIcon : this.blockIcon)
    ...
    private int func_149970_j(World p_149970_1_, int p_149970_2_, int p_149970_3_, int p_149970_4_, int p_149970_5_) {
        return !this.func_149969_d(p_149970_5_)
                ? this.func_149903_h(p_149970_1_, p_149970_2_, p_149970_3_, p_149970_4_, p_149970_5_)
                : Math.max(
                        this.func_149903_h(p_149970_1_, p_149970_2_, p_149970_3_, p_149970_4_, p_149970_5_)
    ...
    protected int func_149903_h(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_) {
        ...
        if (var10.hasComparatorInputOverride()) {
            var6 = var10.getComparatorInputOverride(p_149903_1_, var8, p_149903_3_, var9,
    ...
    public TileEntityComparator func_149971_e(IBlockAccess p_149971_1_, int p_149971_2_, int p_149971_3_,
            int p_149971_4_) {
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        p_149727_1_.playSoundEffect((double) p_149727_2_ + 0.5D, (double) p_149727_3_ + 0.5D,
                (double) p_149727_4_ + 0.5D, "random.click", 0.3F, var12 ? 0.55F : 0.5F);
    ...
    protected void func_149897_b(World p_149897_1_, int p_149897_2_, int p_149897_3_, int p_149897_4_,
        ...
        if (!p_149897_1_.func_147477_a(p_149897_2_, p_149897_3_, p_149897_4_, this)) {
            ...
            if (var7 != var8 || this.func_149905_c(var6) != this.func_149900_a(p_149897_1_, p_149897_2_, p_149897_3_,
                    p_149897_4_, var6)) {
