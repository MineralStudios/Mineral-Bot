...
public class BlockCake extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_,
        ...
        float var7 = (float) (1 + var5 * 2) / 16.0F;
        float var8 = 0.5F;
        return AxisAlignedBB.getBoundingBox((double) ((float) p_149668_2_ + var7), (double) p_149668_3_,
                (double) ((float) p_149668_4_ + var6), (double) ((float) (p_149668_2_ + 1) - var6),
                (double) ((float) p_149668_3_ + var8 - var6), (double) ((float) (p_149668_4_ + 1) - var6));
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_, int p_149633_2_, int p_149633_3_,
        ...
        float var7 = (float) (1 + var5 * 2) / 16.0F;
        float var8 = 0.5F;
        return AxisAlignedBB.getBoundingBox((double) ((float) p_149633_2_ + var7), (double) p_149633_3_,
                (double) ((float) p_149633_4_ + var6), (double) ((float) (p_149633_2_ + 1) - var6),
                (double) ((float) p_149633_3_ + var8), (double) ((float) (p_149633_4_ + 1) - var6));
    }
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        return p_149691_1_ == 1 ? this.field_150038_a
                : (p_149691_1_ == 0 ? this.field_150037_b
                        : (p_149691_2_ > 0 && p_149691_1_ == 4 ? this.field_150039_M : this.blockIcon));
    }
