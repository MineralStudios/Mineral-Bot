...
public class BlockPistonBase extends Block {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        ...
        return var3 > 5 ? this.field_150084_N
                : (p_149691_1_ == var3
                        ? (!func_150075_c(p_149691_2_) && this.field_149759_B <= 0.0D && this.field_149760_C <= 0.0D
                                && this.field_149754_D <= 0.0D && this.field_149755_E >= 1.0D
                                && this.field_149756_F >= 1.0D && this.field_149757_G >= 1.0D ? this.field_150084_N
                                        : this.field_150081_b)
                        : (p_149691_1_ == Facing.oppositeSide[var3] ? this.field_150083_M : this.blockIcon));
    }

    public static IIcon func_150074_e(String p_150074_0_) {
        return p_150074_0_ == "piston_side" ? Blocks.piston.blockIcon
                : (p_150074_0_ == "piston_top_normal" ? Blocks.piston.field_150084_N
                        : (p_150074_0_ == "piston_top_sticky" ? Blocks.sticky_piston.field_150084_N
                                : (p_150074_0_ == "piston_inner" ? Blocks.piston.field_150081_b : null)));
    }
    ...
    private boolean func_150072_a(World p_150072_1_, int p_150072_2_, int p_150072_3_, int p_150072_4_,
            int p_150072_5_) {
    ...
    public boolean onBlockEventReceived(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_,
        ...
        if (p_149696_5_ == 0) {
            ...
            p_149696_1_.setBlockMetadataWithNotify(p_149696_2_, p_149696_3_, p_149696_4_, p_149696_6_ | 8, 2);
            p_149696_1_.playSoundEffect((double) p_149696_2_ + 0.5D, (double) p_149696_3_ + 0.5D,
                    (double) p_149696_4_ + 0.5D, "tile.piston.out", 0.5F, p_149696_1_.rand.nextFloat() * 0.25F + 0.6F);
        } else if (p_149696_5_ == 1) {
            TileEntity var16 = p_149696_1_.getTileEntity(p_149696_2_ + Facing.offsetsXForSide[p_149696_6_],
            ...
            p_149696_1_.setTileEntity(p_149696_2_, p_149696_3_, p_149696_4_,
                    BlockPistonMoving.func_149962_a(this, p_149696_6_, p_149696_6_, false, true));
            ...
            if (this.field_150082_a) {
                ...
                if (!var13 && var11.getMaterial() != Material.air
                        && func_150080_a(var11, p_149696_1_, var8, var9, var10, false)
                        && (var11.getMobilityFlag() == 0 || var11 == Blocks.piston || var11 == Blocks.sticky_piston)) {
                    ...
                    p_149696_1_.setTileEntity(p_149696_2_, p_149696_3_, p_149696_4_,
                            BlockPistonMoving.func_149962_a(var11, var12, p_149696_6_, false, false));
            ...
            p_149696_1_.playSoundEffect((double) p_149696_2_ + 0.5D, (double) p_149696_3_ + 0.5D,
                    (double) p_149696_4_ + 0.5D, "tile.piston.in", 0.5F, p_149696_1_.rand.nextFloat() * 0.15F + 0.6F);
        }
    ...
    public static int func_150071_a(World p_150071_0_, int p_150071_1_, int p_150071_2_, int p_150071_3_,
    ...
    private static boolean func_150080_a(Block p_150080_0_, World p_150080_1_, int p_150080_2_, int p_150080_3_,
    ...
    private static boolean func_150077_h(World p_150077_0_, int p_150077_1_, int p_150077_2_, int p_150077_3_,
            int p_150077_4_) {
    ...
    private boolean func_150079_i(World p_150079_1_, int p_150079_2_, int p_150079_3_, int p_150079_4_,
            int p_150079_5_) {
        ...
        while (true) {
            if (var9 < 13) {
                ...
                if (var10.getMaterial() != Material.air) {
                    ...
                    var10.dropBlockAsItem(p_150079_1_, var6, var7, var8, p_150079_1_.getBlockMetadata(var6, var7, var8),
                            0);
            ...
            for (var13 = new Block[13]; var6 != p_150079_2_ || var7 != p_150079_3_
                    || var8 != p_150079_4_; var8 = var16) {
                ...
                if (var17 == this && var14 == p_150079_2_ && var15 == p_150079_3_ && var16 == p_150079_4_) {
                    p_150079_1_.setBlock(var6, var7, var8, Blocks.piston_extension,
                            p_150079_5_ | (this.field_150082_a ? 8 : 0), 4);
                    p_150079_1_.setTileEntity(var6, var7, var8, BlockPistonMoving.func_149962_a(Blocks.piston_head,
                            p_150079_5_ | (this.field_150082_a ? 8 : 0), p_150079_5_, true, false));
                } else {
                    p_150079_1_.setBlock(var6, var7, var8, Blocks.piston_extension, var18, 4);
                    p_150079_1_.setTileEntity(var6, var7, var8,
                            BlockPistonMoving.func_149962_a(var17, var18, p_150079_5_, true, false));
                }
