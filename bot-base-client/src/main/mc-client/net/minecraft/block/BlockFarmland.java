...
public class BlockFarmland extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_,
            int p_149668_4_) {
        return AxisAlignedBB.getBoundingBox((double) (p_149668_2_ + 0), (double) (p_149668_3_ + 0),
                (double) (p_149668_4_ + 0), (double) (p_149668_2_ + 1), (double) (p_149668_3_ + 1),
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        return p_149691_1_ == 1 ? (p_149691_2_ > 0 ? this.field_149824_a : this.field_149823_b)
        ...
        for (int var6 = p_149822_2_ - var5; var6 <= p_149822_2_ + var5; ++var6) {
            for (int var7 = p_149822_4_ - var5; var7 <= p_149822_4_ + var5; ++var7) {
                ...
                if (var8 == Blocks.wheat || var8 == Blocks.melon_stem || var8 == Blocks.pumpkin_stem
                        || var8 == Blocks.potatoes || var8 == Blocks.carrots) {
                    return true;
                }
            }
        }
