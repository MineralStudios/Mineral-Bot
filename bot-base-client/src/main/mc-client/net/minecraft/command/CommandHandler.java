                ...
                if (var6 > -1) {
                    ...
                    for (int var12 = 0; var12 < var11; ++var12) {
                        ...
                        try {
                            ...
                            ChatComponentTranslation var15 = new ChatComponentTranslation(var17.getMessage(),
                                    var17.getErrorOjbects());
        ...
        if (var3.length == 1) {
            ...
            while (var6.hasNext()) {
                ...
                if (CommandBase.doesStringStartWith(var4, (String) var7.getKey())
                        && ((ICommand) var7.getValue()).canCommandSenderUseCommand(p_71558_1_)) {
