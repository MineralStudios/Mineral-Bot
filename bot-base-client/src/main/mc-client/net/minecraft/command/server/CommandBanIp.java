...
public class CommandBanIp extends CommandBase {
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
        if (p_71515_2_.length >= 1 && p_71515_2_[0].length() > 1) {
            ...
            if (var3.matches()) {
                ...
                EntityPlayerMP var5 = MinecraftServer.getServer().getConfigurationManager()
    ...
    protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_) {
        IPBanEntry var4 = new IPBanEntry(p_147210_2_, (Date) null, p_147210_1_.getCommandSenderName(), (Date) null,
                p_147210_3_);
