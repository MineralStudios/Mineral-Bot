...
public class CommandGameMode extends CommandBase {
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
        if (p_71515_2_.length > 0) {
            ...
            EntityPlayerMP var4 = p_71515_2_.length >= 2 ? getPlayer(p_71515_1_, p_71515_2_[1])
            ...
            if (var4 != p_71515_1_) {
                func_152374_a(p_71515_1_, this, 1, "commands.gamemode.success.other",
                        new Object[] { var4.getCommandSenderName(), var5 });
            } else {
                                ...
                                && !p_71539_2_.equalsIgnoreCase("c")
                                        ? (!p_71539_2_.equalsIgnoreCase(WorldSettings.GameType.ADVENTURE.getName())
                                                && !p_71539_2_.equalsIgnoreCase("a")
                                                        ? WorldSettings
                                                                .getGameTypeById(parseIntBounded(p_71539_1_, p_71539_2_,
    ...
    public List addTabCompletionOptions(ICommandSender p_71516_1_, String[] p_71516_2_) {
        return p_71516_2_.length == 1
                ...
                : (p_71516_2_.length == 2
                        ? getListOfStringsMatchingLastWord(p_71516_2_, this.getListOfPlayerUsernames())
                        : null);
    }
