...
public class CommandSetSpawnpoint extends CommandBase {
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
        EntityPlayerMP var3 = p_71515_2_.length == 0 ? getCommandSenderAsPlayer(p_71515_1_)
        ...
        if (p_71515_2_.length == 4) {
            if (var3.worldObj != null) {
                ...
                func_152373_a(p_71515_1_, this, "commands.spawnpoint.success",
                        new Object[] { var3.getCommandSenderName(), Integer.valueOf(var6), Integer.valueOf(var7),
            ...
            func_152373_a(p_71515_1_, this, "commands.spawnpoint.success", new Object[] { var3.getCommandSenderName(),
