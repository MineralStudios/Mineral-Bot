...
public class JsonUtils {
     ...
     * primitive (String, Java primitive, or
     ...
     * to be the name of the element's
     ...
     * the given default value if the field
     * is missing.
     */
    public static String getJsonObjectStringFieldValueOrDefault(JsonObject p_151219_0_, String p_151219_1_,
            String p_151219_2_) {
     ...
     * the given default value if the
     * field is missing.
     */
    public static boolean getJsonObjectBooleanFieldValueOrDefault(JsonObject p_151209_0_, String p_151209_1_,
            boolean p_151209_2_) {
     ...
     * is missing.
     */
    public static float getJsonObjectFloatFieldValueOrDefault(JsonObject p_151221_0_, String p_151221_1_,
            float p_151221_2_) {
     ...
     * field is missing.
     */
    public static int getJsonObjectIntegerFieldValueOrDefault(JsonObject p_151208_0_, String p_151208_1_,
            int p_151208_2_) {
     ...
     * be the name of the element's field
     ...
     * default value if the field is
     * missing.
     */
    public static JsonObject getJsonObjectFieldOrDefault(JsonObject p_151218_0_, String p_151218_1_,
            JsonObject p_151218_2_) {
        return p_151218_0_.has(p_151218_1_) ? getJsonElementAsJsonObject(p_151218_0_.get(p_151218_1_), p_151218_1_)
                : p_151218_2_;
    }

    /**
     * Gets the given JsonElement as a JsonArray. Expects the second parameter to be
     * the name of the element's field if
     ...
     * missing.
     */
    public static JsonArray getJsonObjectJsonArrayFieldOrDefault(JsonObject p_151213_0_, String p_151213_1_,
