...
public class AxisAlignedBB implements gg.mineral.bot.api.math.BoundingBox {
    @Getter
    @Setter
     ...
     * are given it will shrink). Args: x,
     * y, z
     */
    ...
    public AxisAlignedBB getOffsetBoundingBox(double p_72325_1_, double p_72325_3_, double p_72325_5_) {
        return getBoundingBox(this.minX + p_72325_1_, this.minY + p_72325_3_, this.minZ + p_72325_5_,
                this.maxX + p_72325_1_, this.maxY + p_72325_3_, this.maxZ + p_72325_5_);
    }

    /**
     * if instance and the argument bounding boxes overlap in the Y and Z
     * dimensions, calculate the offset between them
     * in the X dimension. return var2 if the bounding boxes do not overlap or if
     * var2 is closer to 0 then the
     ...
     * dimensions, calculate the offset between them
     * in the Y dimension. return var2 if the bounding boxes do not overlap or if
     * var2 is closer to 0 then the
     * calculated offset. Otherwise return the calculated offset.
     */
     ...
     * dimensions, calculate the offset between them
     * in the Z dimension. return var2 if the bounding boxes do not overlap or if
     * var2 is closer to 0 then the
     * calculated offset. Otherwise return the calculated offset.
     */
