...
public class ChatComponentTranslation extends ChatComponentStyle {
    ...
    /**
     * The discrete elements that make up this component. For example, this would be
     * ["Prefix, ", "FirstArg",
     * "SecondArg", " again ", "SecondArg", " and ", "FirstArg", " lastly ",
     * "ThirdArg", " and also ", "FirstArg", "
        ...
        try {
            ...
            for (; var3.find(var5); var5 = var7) {
                ...
                if (var6 > var5) {
                    ChatComponentText var8 = new ChatComponentText(
                            String.format(p_150269_1_.substring(var5, var6), new Object[0]));
            ...
            if (var5 < p_150269_1_.length()) {
                ChatComponentText var13 = new ChatComponentText(
                        String.format(p_150269_1_.substring(var5), new Object[0]));
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            return Arrays.equals(this.formatArgs, var2.formatArgs) && this.key.equals(var2.key)
