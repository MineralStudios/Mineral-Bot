...
public class ScreenShotHelper {
     ...
     * generate a time-stamped name).
     * Args: gameDirectory, fileName, requestedWidthInPixels,
    ...
    public static IChatComponent saveScreenshot(Minecraft mc, File p_148259_0_, String p_148259_1_, int p_148259_2_,
        ...
        try {
            ...
            if (OpenGlHelper.isFramebufferEnabled(mc)) {
            ...
            if (OpenGlHelper.isFramebufferEnabled(mc)) {
                ...
                GL11.glReadPixels(0, 0, p_148259_2_, p_148259_3_, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV,
                        pixelBuffer);
            }
            ...
            if (OpenGlHelper.isFramebufferEnabled(mc)) {
                ...
                for (int var9 = var8; var9 < p_148259_4_.framebufferTextureHeight; ++var9) {
                    for (int var10 = 0; var10 < p_148259_4_.framebufferWidth; ++var10) {
                        var7.setRGB(var10, var9 - var8,
                                pixelValues[var9 * p_148259_4_.framebufferTextureWidth + var10]);
                    }
                }
            } else {
     ...
     * Handles cases where the timestamp alone
     * is not enough to create a uniquely named file, though it still might suffer
     * from an unlikely race condition where
     * the filename was unique when this method was called, but another process or
     * thread created a file at the same
