...
public enum EnumChatFormatting {
     ...
     * following text as bold, recolored,
     * obfuscated, etc.
     */
    ...
    /**
     * Gets all the valid values. Args: @param par0: Whether or not to include color
     * values. @param par1: Whether or not
     * to include fancy-styling values (anything that isn't a color value or the
     * "reset" value).
     */
