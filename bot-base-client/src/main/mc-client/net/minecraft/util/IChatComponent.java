...
public interface IChatComponent extends Iterable {
    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer {
            ...
            if (p_deserialize_1_.isJsonPrimitive()) {
                ...
                if (var4.has("extra")) {
                    ...
                    for (int var15 = 0; var15 < var13.size(); ++var15) {
                        ((IChatComponent) var5)
                                .appendSibling(this.deserialize(var13.get(var15), p_deserialize_2_, p_deserialize_3_));
                    }
                }
        ...
        private void func_150695_a(ChatStyle p_150695_1_, JsonObject p_150695_2_,
                JsonSerializationContext p_150695_3_) {
        ...
        public JsonElement serialize(IChatComponent p_serialize_1_, Type p_serialize_2_,
        ...
        public static String toJson(IChatComponent p_150696_0_) {
            return field_150700_a.toJson(p_150696_0_);
        }

        public static IChatComponent fromJson(String p_150699_0_) {
