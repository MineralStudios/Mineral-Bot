...
public class Vec3 {
     ...
     * only called from the other static
    ...
    public Vec3 subtract(Vec3 p_72444_1_) {
        return createVectorHelper(p_72444_1_.xCoord - this.xCoord, p_72444_1_.yCoord - this.yCoord,
                p_72444_1_.zCoord - this.zCoord);
    }
    ...
    public Vec3 normalize() {
        ...
        return var1 < 1.0E-4D ? createVectorHelper(0.0D, 0.0D, 0.0D)
                : createVectorHelper(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
    }

    public double dotProduct(@NonNull Vec3 p_72430_1_) {
    ...
    public Vec3 crossProduct(Vec3 p_72431_1_) {
        return createVectorHelper(this.yCoord * p_72431_1_.zCoord - this.zCoord * p_72431_1_.yCoord,
     ...
     * resulting vector. Does not change this
     * vector.
     */
     ...
     * line between this vector and the
    ...
    public Vec3 getIntermediateWithXValue(Vec3 p_72429_1_, double p_72429_2_) {
        ...
        if (var4 * var4 < 1.0000000116860974E-7D) {
            ...
            return var10 >= 0.0D && var10 <= 1.0D
                    ? createVectorHelper(this.xCoord + var4 * var10, this.yCoord + var6 * var10,
