                ...
                try {
                    ...
                    if (p_151223_5_ != null) {
                        p_151223_5_.resetProgresAndWorkingMessage(String.format("Downloading file (%.2f MB)...",
                                new Object[] { Float.valueOf(var7 / 1000.0F / 1000.0F) }));
                    }
                    ...
                    if (p_151223_0_.exists()) {
                        ...
                        HttpUtil.logger.warn("Deleting " + p_151223_0_
                                + " as it does not match what we currently have (" + var28 + " vs our " + var29 + ").");
                        p_151223_0_.delete();
                    ...
                    if (p_151223_4_ > 0 && var7 > (float) p_151223_4_) {
                        ...
                        throw new IOException("Filesize is bigger than maximum allowed (file is " + var6 + ", limit is "
                                + p_151223_4_ + ")");
                    }
                    ...
                    while ((var31 = var2.read(var4)) >= 0) {
                        ...
                        if (p_151223_4_ > 0 && var6 > (float) p_151223_4_) {
                            ...
                            throw new IOException("Filesize was bigger than maximum allowed (got >= " + var6
                                    + ", limit was " + p_151223_4_ + ")");
                        }
