...
public class AchievementList {
    ...
    public static Achievement cookFish = (new Achievement("achievement.cookFish", "cookFish", 2, 6, Items.cooked_fished,
    ...
    public static Achievement field_150966_x = (new Achievement("achievement.diamondsToYou", "diamondsToYou", -1, 2,
    ...
    public static Achievement field_150962_H = (new Achievement("achievement.breedCow", "breedCow", 7, -5, Items.wheat,
            killCow)).registerStat();
    public static Achievement field_150963_I = (new Achievement("achievement.spawnWither", "spawnWither", 7, 12,
            new ItemStack(Items.skull, 1, 1), theEnd2)).registerStat();
    public static Achievement field_150964_J = (new Achievement("achievement.killWither", "killWither", 7, 10,
            Items.nether_star, field_150963_I)).registerStat();
    public static Achievement field_150965_K = (new Achievement("achievement.fullBeacon", "fullBeacon", 7, 8,
            Blocks.beacon, field_150964_J)).setSpecial().registerStat();
    public static Achievement field_150961_L = (new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4,
