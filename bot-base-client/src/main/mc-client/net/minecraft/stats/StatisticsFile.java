...
public class StatisticsFile extends StatFileWriter {
            ...
            while (var5.hasNext()) {
                ...
                if (var7 != null) {
                    ...
                    if (((JsonElement) var6.getValue()).isJsonPrimitive()
                        ...
                        if (var9.has("value") && var9.get("value").isJsonPrimitive()
                    ...
                    logger.warn("Invalid statistic in " + this.field_150887_d + ": Don\'t know what "
                            + (String) var6.getKey() + " is");
                }
            }
    ...
    public static String func_150880_a(Map p_150880_0_) {
        ...
        while (var2.hasNext()) {
            ...
            if (((TupleIntJsonSerializable) var3.getValue()).getJsonSerializableValue() != null) {
                ...
                var4.addProperty("value",
                        Integer.valueOf(((TupleIntJsonSerializable) var3.getValue()).getIntegerValue()));

                try {
                    var4.add("progress", ((TupleIntJsonSerializable) var3.getValue()).getJsonSerializableValue()
                ...
                var1.addProperty(((StatBase) var3.getKey()).statId,
                        Integer.valueOf(((TupleIntJsonSerializable) var3.getValue()).getIntegerValue()));
            }
        }
    ...
    public void func_150876_a(EntityPlayerMP p_150876_1_) {
        ...
        Object2IntOpenHashMap<StatBase> var3 = new Object2IntOpenHashMap<>();
    ...
    public void func_150884_b(EntityPlayerMP p_150884_1_) {
        Object2IntOpenHashMap<StatBase> var2 = new Object2IntOpenHashMap<>();
