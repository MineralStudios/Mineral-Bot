...
public class Achievement extends StatBase {
     ...
     * dynamic info - like the key used to open
     * the inventory.
     */
     ...
     * achievements are the hardest ones to
     * achieve.
     */
    private boolean isSpecial;

    public Achievement(String p_i46327_1_, String p_i46327_2_, int p_i46327_3_, int p_i46327_4_, Item p_i46327_5_,
            Achievement p_i46327_6_) {
