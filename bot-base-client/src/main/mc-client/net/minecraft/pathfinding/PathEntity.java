    ...
    public boolean isSamePath(PathEntity p_75876_1_) {
        if (p_75876_1_ == null) {
            ...
            for (int var2 = 0; var2 < this.points.length; ++var2) {
                if (this.points[var2].xCoord != p_75876_1_.points[var2].xCoord
                        || this.points[var2].yCoord != p_75876_1_.points[var2].yCoord
                        || this.points[var2].zCoord != p_75876_1_.points[var2].zCoord) {
                    return false;
                }
            }
