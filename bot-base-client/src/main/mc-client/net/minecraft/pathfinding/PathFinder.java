...
public class PathFinder {
    ...
    public PathEntity createEntityPathTo(Entity p_75859_1_, int p_75859_2_, int p_75859_3_, int p_75859_4_,
            float p_75859_5_) {
        return this.createEntityPathTo(p_75859_1_, (double) ((float) p_75859_2_ + 0.5F),
                (double) ((float) p_75859_3_ + 0.5F), (double) ((float) p_75859_4_ + 0.5F), p_75859_5_);
    }
    ...
    private PathEntity createEntityPathTo(Entity p_75857_1_, double p_75857_2_, double p_75857_4_, double p_75857_6_,
        ...
        if (this.canEntityDrown && p_75857_1_.isInWater()) {
            ...
            for (Block var11 = this.worldMap.getBlock(MathHelper.floor_double(p_75857_1_.posX), var10,
                    MathHelper.floor_double(p_75857_1_.posZ)); var11 == Blocks.flowing_water
                            || var11 == Blocks.water; var11 = this.worldMap.getBlock(
        ...
        PathPoint var15 = this.openPoint(MathHelper.floor_double(p_75857_1_.boundingBox.minX), var10,
                MathHelper.floor_double(p_75857_1_.boundingBox.minZ));
        PathPoint var12 = this.openPoint(MathHelper.floor_double(p_75857_2_ - (double) (p_75857_1_.width / 2.0F)),
                MathHelper.floor_double(p_75857_4_),
                MathHelper.floor_double(p_75857_6_ - (double) (p_75857_1_.width / 2.0F)));
        PathPoint var13 = new PathPoint(MathHelper.floor_float(p_75857_1_.width + 1.0F),
     ...
     * found (args: unused1, currentPoint,
    ...
    private int findPathOptions(Entity p_75860_1_, PathPoint p_75860_2_, PathPoint p_75860_3_, PathPoint p_75860_4_,
        ...
        if (this.getVerticalOffset(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord + 1, p_75860_2_.zCoord,
                p_75860_3_) == 1) {
            var7 = 1;
        }

        PathPoint var8 = this.getSafePoint(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord, p_75860_2_.zCoord + 1,
                p_75860_3_, var7);
        PathPoint var9 = this.getSafePoint(p_75860_1_, p_75860_2_.xCoord - 1, p_75860_2_.yCoord, p_75860_2_.zCoord,
                p_75860_3_, var7);
        PathPoint var10 = this.getSafePoint(p_75860_1_, p_75860_2_.xCoord + 1, p_75860_2_.yCoord, p_75860_2_.zCoord,
                p_75860_3_, var7);
        PathPoint var11 = this.getSafePoint(p_75860_1_, p_75860_2_.xCoord, p_75860_2_.yCoord, p_75860_2_.zCoord - 1,
                p_75860_3_, var7);
    ...
    private PathPoint getSafePoint(Entity p_75858_1_, int p_75858_2_, int p_75858_3_, int p_75858_4_,
        ...
        if (var8 == 2) {
            ...
            if (var7 == null && p_75858_6_ > 0 && var8 != -3 && var8 != -4 && this.getVerticalOffset(p_75858_1_,
     ...
     * for colliding with any solid block,
     * -1 for water(if avoiding water) but otherwise clear, -2 for lava, -3 for
     * fence, -4 for closed trapdoor, 2 if
    ...
    public int getVerticalOffset(Entity p_75855_1_, int p_75855_2_, int p_75855_3_, int p_75855_4_,
        ...
        return func_82565_a(p_75855_1_, p_75855_2_, p_75855_3_, p_75855_4_, p_75855_5_, this.isPathingInWater,
                ...
                for (int var11 = p_82565_3_; var11 < p_82565_3_ + p_82565_4_.zCoord; ++var11) {
                    ...
                    if (var12.getMaterial() != Material.air) {
                        ...
                        if (p_82565_0_.worldObj.getBlock(var9, var10, var11).getRenderType() == 9) {
                            ...
                            if (p_82565_0_.worldObj.getBlock(var17, var15, var16).getRenderType() != 9
                                    && p_82565_0_.worldObj.getBlock(var17, var15 - 1, var16).getRenderType() != 9) {
                                return -3;
                            }
                        } else if (!var12.getBlocksMovement(p_82565_0_.worldObj, var9, var10, var11)
