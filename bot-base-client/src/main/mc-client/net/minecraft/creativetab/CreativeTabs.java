...
public abstract class CreativeTabs {
    ...
    /**
     * Adds the enchantment books from the supplied EnumEnchantmentType to the given
     * list.
     */
    public void addEnchantmentBooksToList(List p_92116_1_, EnumEnchantmentType... p_92116_2_) {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            ...
            if (var6 != null && var6.type != null) {
                ...
                if (var7) {
                    p_92116_1_.add(
                            Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(var6, var6.getMaxLevel())));
                }
            }
        }
    }
