...
public class ContainerRepair extends Container {
    ...
    public ContainerRepair(InventoryPlayer p_i1800_1_, final World p_i1800_2_, final int p_i1800_3_,
            final int p_i1800_4_, final int p_i1800_5_, EntityPlayer p_i1800_6_) {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(EntityPlayer p_82869_1_) {
                return (p_82869_1_.capabilities.isCreativeMode
                        || p_82869_1_.experienceLevel >= ContainerRepair.this.maximumCost)
            ...
            public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
                ...
                if (!p_82870_1_.capabilities.isCreativeMode && !p_i1800_2_.isClient
                        && p_i1800_2_.getBlock(p_i1800_3_, p_i1800_4_, p_i1800_5_) == Blocks.anvil
                        && p_82870_1_.getRNG().nextFloat() < 0.12F) {
    ...
    public boolean canInteractWith(EntityPlayer p_75145_1_) {
        return this.theWorld.getBlock(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Blocks.anvil
                ? false
                : p_75145_1_.getDistanceSq((double) this.field_82861_i + 0.5D, (double) this.field_82858_j + 0.5D,
