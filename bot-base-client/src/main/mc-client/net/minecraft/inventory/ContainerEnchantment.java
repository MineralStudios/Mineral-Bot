...
public class ContainerEnchantment extends Container {
                        ...
                        for (int var5 = -1; var5 <= 1; ++var5) {
                            if ((var4 != 0 || var5 != 0)
                                    ...
                                    && this.worldPointer.isAirBlock(this.posX + var5, this.posY + 1,
                                            this.posZ + var4)) {
                                if (this.worldPointer.getBlock(this.posX + var5 * 2, this.posY,
                                        this.posZ + var4 * 2) == Blocks.bookshelf) {
                                    ++var3;
                                }

                                if (this.worldPointer.getBlock(this.posX + var5 * 2, this.posY + 1,
                                        this.posZ + var4 * 2) == Blocks.bookshelf) {
                                    ++var3;
                                }
                                ...
                                if (var5 != 0 && var4 != 0) {
                                    ...
                                    if (this.worldPointer.getBlock(this.posX + var5, this.posY,
                                            this.posZ + var4 * 2) == Blocks.bookshelf) {
                                        ++var3;
                                    }

                                    if (this.worldPointer.getBlock(this.posX + var5, this.posY + 1,
                                            this.posZ + var4 * 2) == Blocks.bookshelf) {
                                        ++var3;
                                    }
                                }
    ...
    public boolean enchantItem(EntityPlayer p_75140_1_, int p_75140_2_) {
        ...
        if (this.enchantLevels[p_75140_2_] > 0 && var3 != null
                && (p_75140_1_.experienceLevel >= this.enchantLevels[p_75140_2_]
                        || p_75140_1_.capabilities.isCreativeMode)) {
            if (!this.worldPointer.isClient) {
