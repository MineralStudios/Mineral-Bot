...
public class ContainerHorseInventory extends Container {
        ...
        for (var6 = 0; var6 < 3; ++var6) {
            for (var7 = 0; var7 < 9; ++var7) {
                this.addSlotToContainer(
                        new Slot(p_i1817_1_, var7 + var6 * 9 + 9, 8 + var7 * 18, 102 + var6 * 18 + var5));
            }
        }
    ...
    public boolean canInteractWith(EntityPlayer p_75145_1_) {
        return this.field_111243_a.isUseableByPlayer(p_75145_1_) && this.theHorse.isEntityAlive()
                && this.theHorse.getDistanceToEntity(p_75145_1_) < 8.0F;
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            if (p_82846_2_ < this.field_111243_a.getSizeInventory()) {
                if (!this.mergeItemStack(var5, this.field_111243_a.getSizeInventory(), this.inventorySlots.size(),
                        true)) {
                    return null;
                }
                ...
                if (!this.mergeItemStack(var5, 0, 1, false)) {
                    ...
                    || !this.mergeItemStack(var5, 2, this.field_111243_a.getSizeInventory(), false)) {
                return null;
            }
