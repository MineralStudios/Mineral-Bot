...
public class EntityFireworkStarterFX extends EntityFX {
    ...
    public EntityFireworkStarterFX(Minecraft mc, World p_i46355_1_, double p_i46355_2_, double p_i46355_4_,
            double p_i46355_6_, double p_i46355_8_, double p_i46355_10_, double p_i46355_12_,
            EffectRenderer p_i46355_14_, NBTTagCompound p_i46355_15_) {
    ...
    public void onUpdate() {
        ...
        if (this.fireworkAge == 0 && this.fireworkExplosions != null) {
            ...
            this.worldObj.playSound(this.posX, this.posY, this.posZ, var16, 20.0F, 0.95F + this.rand.nextFloat() * 0.1F,
                    true);
        }
        ...
        if (this.fireworkAge > this.particleMaxAge) {
            if (this.twinkle) {
                ...
                this.worldObj.playSound(this.posX, this.posY, this.posZ, var15, 20.0F,
    ...
    private boolean func_92037_i() {
        return this.mc == null || this.mc.renderViewEntity == null
                || this.mc.renderViewEntity.getDistanceSq(this.posX, this.posY, this.posZ) >= 256.0D;
    }

    /**
     * Creates a single particle. Args: x, y, z, x velocity, y velocity, z velocity,
     * colours, fade colours, whether to
     * trail, whether to twinkle
     */
    private void createParticle(double p_92034_1_, double p_92034_3_, double p_92034_5_, double p_92034_7_,
            double p_92034_9_, double p_92034_11_, int[] p_92034_13_, int[] p_92034_14_, boolean p_92034_15_,
            boolean p_92034_16_) {
        EntityFireworkSparkFX var17 = new EntityFireworkSparkFX(this.worldObj, p_92034_1_, p_92034_3_, p_92034_5_,
                p_92034_7_, p_92034_9_, p_92034_11_, this.theEffectRenderer);
     ...
     * size, colours, fade colours, whether to
     * trail, whether to flicker
     */
    private void createBall(double p_92035_1_, int p_92035_3_, int[] p_92035_4_, int[] p_92035_5_, boolean p_92035_6_,
            boolean p_92035_7_) {
            ...
            for (int var15 = -p_92035_3_; var15 <= p_92035_3_; ++var15) {
                for (int var16 = -p_92035_3_; var16 <= p_92035_3_; ++var16) {
                    ...
                    double var23 = (double) MathHelper.sqrt_double(var17 * var17 + var19 * var19 + var21 * var21)
                            / p_92035_1_ + this.rand.nextGaussian() * 0.05D;
                    this.createParticle(var8, var10, var12, var17 / var23, var19 / var23, var21 / var23, p_92035_4_,
     ...
     * shape, colours, fade colours, whether to
     * trail, whether to flicker, unknown
     */
    private void createShaped(double p_92038_1_, double[][] p_92038_3_, int[] p_92038_4_, int[] p_92038_5_,
            boolean p_92038_6_, boolean p_92038_7_, boolean p_92038_8_) {
        double var9 = p_92038_3_[0][0];
        double var11 = p_92038_3_[0][1];
        this.createParticle(this.posX, this.posY, this.posZ, var9 * p_92038_1_, var11 * p_92038_1_, 0.0D, p_92038_4_,
                p_92038_5_, p_92038_6_, p_92038_7_);
            ...
            for (int var23 = 1; var23 < p_92038_3_.length; ++var23) {
                ...
                for (double var28 = 0.25D; var28 <= 1.0D; var28 += 0.25D) {
                    ...
                    for (double var36 = -1.0D; var36 <= 1.0D; var36 += 2.0D) {
                        this.createParticle(this.posX, this.posY, this.posZ, var30 * var36, var32, var34 * var36,
                                p_92038_4_, p_92038_5_, p_92038_6_, p_92038_7_);
                    }
                }
    ...
    private void createBurst(int[] p_92036_1_, int[] p_92036_2_, boolean p_92036_3_, boolean p_92036_4_) {
        ...
        for (int var9 = 0; var9 < 70; ++var9) {
            ...
            this.createParticle(this.posX, this.posY, this.posZ, var10, var14, var12, p_92036_1_, p_92036_2_,
                    p_92036_3_, p_92036_4_);
        }
    }
