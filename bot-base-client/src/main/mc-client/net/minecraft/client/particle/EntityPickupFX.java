...
public class EntityPickupFX extends EntityFX {
    ...
    public EntityPickupFX(Minecraft mc, World p_i1233_1_, Entity p_i1233_2_, Entity p_i1233_3_, float p_i1233_4_) {
    ...
    public void renderParticle(Tessellator p_70539_1_, float p_70539_2_, float p_70539_3_, float p_70539_4_,
        ...
        double var15 = this.entityPickingUp.lastTickPosX
                + (this.entityPickingUp.posX - this.entityPickingUp.lastTickPosX) * (double) p_70539_2_;
        double var17 = this.entityPickingUp.lastTickPosY
                + (this.entityPickingUp.posY - this.entityPickingUp.lastTickPosY) * (double) p_70539_2_
                + (double) this.yOffs;
        double var19 = this.entityPickingUp.lastTickPosZ
                + (this.entityPickingUp.posZ - this.entityPickingUp.lastTickPosZ) * (double) p_70539_2_;
