...
public class EntityCrit2FX extends EntityFX {
    ...
    public EntityCrit2FX(World p_i1200_1_, Entity p_i1200_2_, String p_i1200_3_) {
        super(p_i1200_1_, p_i1200_2_.posX, p_i1200_2_.boundingBox.minY + (double) (p_i1200_2_.height / 2.0F),
                p_i1200_2_.posZ, p_i1200_2_.motionX, p_i1200_2_.motionY, p_i1200_2_.motionZ);
    ...
    public void onUpdate() {
        for (int var1 = 0; var1 < 16; ++var1) {
            ...
            if (var2 * var2 + var4 * var4 + var6 * var6 <= 1.0D) {
                ...
                double var10 = this.theEntity.boundingBox.minY + (double) (this.theEntity.height / 2.0F)
                        + var4 * (double) this.theEntity.height / 4.0D;
