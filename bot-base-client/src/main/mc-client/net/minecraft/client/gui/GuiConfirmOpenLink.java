...
public class GuiConfirmOpenLink extends GuiYesNo {
    ...
    public GuiConfirmOpenLink(Minecraft mc, GuiYesNoCallback p_i1084_1_, String p_i1084_2_, int p_i1084_3_,
            boolean p_i1084_4_) {
        super(mc, p_i1084_1_, I18n.format(p_i1084_4_ ? "chat.link.confirmTrusted" : "chat.link.confirm", new Object[0]),
    ...
    public void initGui() {
        this.buttonList
                .add(new GuiButton(this.mc, 0, this.width / 3 - 83 + 0, this.height / 6 + 96, 100, 20,
                        this.field_146352_g));
        this.buttonList
                .add(new GuiButton(this.mc, 2, this.width / 3 - 83 + 105, this.height / 6 + 96, 100, 20,
                        this.field_146362_s));
        this.buttonList
                .add(new GuiButton(this.mc, 1, this.width / 3 - 83 + 210, this.height / 6 + 96, 100, 20,
                        this.field_146356_h));
    }
