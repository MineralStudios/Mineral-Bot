...
public class ServerSelectionList extends GuiListExtended {
    ...
    private final GuiListExtended.IGuiListEntry field_148196_n;
    private int field_148197_o = -1;

    public ServerSelectionList(GuiMultiplayer p_i45049_1_, Minecraft mc, int p_i45049_3_, int p_i45049_4_,
            int p_i45049_5_, int p_i45049_6_, int p_i45049_7_) {
        super(mc, p_i45049_3_, p_i45049_4_, p_i45049_5_, p_i45049_6_, p_i45049_7_);
        this.field_148200_k = p_i45049_1_;
        this.field_148196_n = new ServerListEntryLanScan(mc);
    }
    ...
    public void func_148195_a(ServerList p_148195_1_) {
        ...
        for (int var2 = 0; var2 < p_148195_1_.countServers(); ++var2) {
            this.field_148198_l
                    .add(new ServerListEntryNormal(this.mc, this.field_148200_k, p_148195_1_.getServerData(var2)));
        }
    }
    ...
    public void func_148194_a(List p_148194_1_) {
        ...
        while (var2.hasNext()) {
            ...
            this.field_148199_m.add(new ServerListEntryLanDetected(this.mc, this.field_148200_k, var3));
        }
    }
