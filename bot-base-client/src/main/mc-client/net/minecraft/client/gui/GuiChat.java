...
public class GuiChat extends GuiScreen implements GuiYesNoCallback {
    ...
    public GuiChat(Minecraft mc, String textInput) {
        this(mc);
    ...
    public void initGui() {
        ...
        this.field_146415_a = new GuiTextField(this.mc, this.fontRendererObj, 4, this.height - 12, this.width - 4, 12);
        this.field_146415_a.func_146203_f(100);
        this.field_146415_a.func_146185_a(false);
        this.field_146415_a.setFocused(true);
        this.field_146415_a.setText(this.textInput);
    ...
    public void func_146403_a(String p_146403_1_) {
        ...
        if (player != null)
            player.sendChatMessage(p_146403_1_);
    }
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
        if (p_73864_3_ == 0 && this.mc.gameSettings.chatLinks) {
            IChatComponent var4 = this.mc.ingameGUI.getChatGUI().func_146236_a(this.mc.getMouse().getX(),
                    this.mc.getMouse().getY());
                            ...
                            try {
                                ...
                                if (this.mc.gameSettings.chatLinksPrompt) {
                                    ...
                                    this.mc.displayGuiScreen(
                                            new GuiConfirmOpenLink(this.mc, this, var5.getValue(), 0, false));
                                } else {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        drawRect(this.mc, 2, this.height - 14, this.width - 2, this.height - 2, Integer.MIN_VALUE);
        ...
        if (var4 != null && var4.getChatStyle().getChatHoverEvent() != null) {
            ...
            if (var5.getAction() == HoverEvent.Action.SHOW_ITEM) {
                ...
                this.func_146283_a(Splitter.on("\n").splitToList(var5.getValue().getFormattedText()), p_73863_1_,
                        p_73863_2_);
                ...
                if (var12 != null) {
                    ...
                    this.func_146279_a(EnumChatFormatting.RED + "Invalid statistic/achievement!", p_73863_1_,
                            p_73863_2_);
                }
            }
    ...
    public void func_146406_a(String[] p_146406_1_) {
        if (this.field_146414_r) {
            ...
            String var6 = this.field_146415_a.getText()
