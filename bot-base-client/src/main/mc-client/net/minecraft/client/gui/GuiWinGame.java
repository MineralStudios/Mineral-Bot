...
public class GuiWinGame extends GuiScreen {
    ...
    public void initGui() {
        if (this.field_146582_i == null) {
            ...
            try {
                String var1 = "";
                String var2 = "" + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + EnumChatFormatting.GREEN
                        + EnumChatFormatting.AQUA;
                short var3 = 274;
                BufferedReader var4 = new BufferedReader(new InputStreamReader(this.mc.getResourceManager()
                ...
                while ((var1 = var4.readLine()) != null) {
                    ...
                    if (fontRenderer != null)
                        this.field_146582_i.addAll(fontRenderer.listFormattedStringToWidth(var1, var3));
                ...
                var4 = new BufferedReader(new InputStreamReader(this.mc.getResourceManager()
    ...
    private void func_146575_b(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
        ...
        var4.addVertexWithUV((double) var5, (double) this.height, (double) this.zLevel, (double) ((float) var5 * var8),
                (double) (var6 * var8));
        var4.addVertexWithUV((double) var5, 0.0D, (double) this.zLevel, (double) ((float) var5 * var8),
                (double) (var7 * var8));
        ...
        for (var10 = 0; var10 < this.field_146582_i.size(); ++var10) {
            ...
            if ((float) var9 + var8 + 12.0F + 8.0F > 0.0F && (float) var9 + var8 < (float) this.height) {
                ...
                if (var12.startsWith("[C]")) {
                    this.fontRendererObj.drawStringWithShadow(var12.substring(3),
                            var6 + (var5 - this.fontRendererObj.getStringWidth(var12.substring(3))) / 2, var9,
                            16777215);
                } else {
                    this.fontRendererObj.fontRandom
                            .setSeed((long) var10 * 4238972211L + (long) (this.field_146581_h / 4));
