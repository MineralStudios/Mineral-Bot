...
public class GuiNewChat extends Gui {
    ...
    private static final Logger logger = LogManager.getLogger(GuiNewChat.class);
            ...
            if (var5 > 0) {
                ...
                if (fontRenderer != null && var3) {
                    ...
                    if (var18 != var11) {
                        ...
                        drawRect(this.mc, 0, -var19, 2, -var19 - var13, var20 + (var14 << 24));
                        drawRect(this.mc, 2, -var19, 1, -var19 - var13, 13421772 + (var14 << 24));
                    }
                }
    ...
    private String func_146235_b(String p_146235_1_) {
        return this.mc.gameSettings.chatColours ? p_146235_1_
    ...
    private void func_146237_a(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
        ...
        for (Iterator var21 = var8.iterator(); var21.hasNext(); this.field_146253_i.add(0,
                new ChatLine(p_146237_3_, var22, p_146237_2_))) {
    ...
    public void func_146239_a(String p_146239_1_) {
        if (this.field_146248_g.isEmpty()
                || !((String) this.field_146248_g.get(this.field_146248_g.size() - 1)).equals(p_146239_1_)) {
    ...
    public int func_146246_g() {
        return func_146243_b(this.func_146241_e() ? this.mc.gameSettings.chatHeightFocused
                : this.mc.gameSettings.chatHeightUnfocused);
    }
