...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        try {
            ...
            this.mc.displayGuiScreen(new GuiErrorScreen(this.mc, "Unable to load worlds", var2.getMessage()));
            return;
        }
    ...
    public void func_146618_g() {
        this.buttonList
                .add(this.field_146641_z = new GuiButton(this.mc, 1, this.width / 2 - 154, this.height - 52, 150, 20,
                        I18n.format("selectWorld.select", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 3, this.width / 2 + 4, this.height - 52, 150, 20,
                I18n.format("selectWorld.create", new Object[0])));
        this.buttonList
                .add(this.field_146630_A = new GuiButton(this.mc, 6, this.width / 2 - 154, this.height - 28, 72, 20,
                        I18n.format("selectWorld.rename", new Object[0])));
        this.buttonList
                .add(this.field_146642_y = new GuiButton(this.mc, 2, this.width / 2 - 76, this.height - 28, 72, 20,
                        I18n.format("selectWorld.delete", new Object[0])));
        this.buttonList
                .add(this.field_146631_B = new GuiButton(this.mc, 7, this.width / 2 + 4, this.height - 28, 72, 20,
                        I18n.format("selectWorld.recreate", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 0, this.width / 2 + 82, this.height - 28, 72, 20,
        ...
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id == 2) {
                ...
                if (var2 != null) {
                    ...
                    GuiYesNo var3 = func_152129_a(this.mc, this, var2, this.field_146640_r);
                    this.mc.displayGuiScreen(var3);
                }
            } else if (p_146284_1_.id == 1) {
                this.func_146615_e(this.field_146640_r);
            } else if (p_146284_1_.id == 3) {
                this.mc.displayGuiScreen(new GuiCreateWorld(this.mc, this));
            } else if (p_146284_1_.id == 6) {
                this.mc.displayGuiScreen(new GuiRenameWorld(this.mc, this, this.func_146621_a(this.field_146640_r)));
            } else if (p_146284_1_.id == 0) {
                this.mc.displayGuiScreen(this.field_146632_a);
            } else if (p_146284_1_.id == 7) {
                GuiCreateWorld var5 = new GuiCreateWorld(this.mc, this);
                ISaveHandler var6 = this.mc.getSaveLoader().getSaveLoader(this.func_146621_a(this.field_146640_r),
                        false);
    ...
    public static GuiYesNo func_152129_a(Minecraft mc, GuiYesNoCallback p_152129_0_, String p_152129_1_,
            int p_152129_2_) {
        ...
        GuiYesNo var7 = new GuiYesNo(mc, p_152129_0_, var3, var4, var5, var6, p_152129_2_);
        return var7;
    }
    ...
    class List extends GuiSlot {
        ...
        protected void elementClicked(int p_148144_1_, boolean p_148144_2_, int p_148144_3_, int p_148144_4_) {
            ...
            boolean var5 = GuiSelectWorld.this.field_146640_r >= 0
        ...
        protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
            ...
            if (var8.requiresConversion()) {
                ...
                if (var8.isHardcoreModeEnabled()) {
                    var11 = EnumChatFormatting.DARK_RED + I18n.format("gameMode.hardcore", new Object[0])
            ...
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var9, p_148126_2_ + 2, p_148126_3_ + 1,
                    16777215);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var10, p_148126_2_ + 2,
                    p_148126_3_ + 12, 8421504);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var11, p_148126_2_ + 2,
                    p_148126_3_ + 12 + 10, 8421504);
        }
    }
}
