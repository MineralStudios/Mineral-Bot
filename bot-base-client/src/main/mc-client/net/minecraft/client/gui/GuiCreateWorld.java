...
public class GuiCreateWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146343_z = new GuiButton(this.mc, 2, this.width / 2 - 75, 115, 150, 20,
                I18n.format("selectWorld.gameMode", new Object[0])));
        this.buttonList.add(this.field_146324_A = new GuiButton(this.mc, 3, this.width / 2 - 75, 187, 150, 20,
                I18n.format("selectWorld.moreWorldOptions", new Object[0])));
        this.buttonList.add(this.field_146325_B = new GuiButton(this.mc, 4, this.width / 2 - 155, 100, 150, 20,
                I18n.format("selectWorld.mapFeatures", new Object[0])));
        this.field_146325_B.field_146125_m = false;
        this.buttonList.add(this.field_146326_C = new GuiButton(this.mc, 7, this.width / 2 + 5, 151, 150, 20,
                I18n.format("selectWorld.bonusItems", new Object[0])));
        this.field_146326_C.field_146125_m = false;
        this.buttonList.add(this.field_146320_D = new GuiButton(this.mc, 5, this.width / 2 + 5, 100, 150, 20,
                I18n.format("selectWorld.mapType", new Object[0])));
        this.field_146320_D.field_146125_m = false;
        this.buttonList.add(this.field_146321_E = new GuiButton(this.mc, 6, this.width / 2 - 155, 151, 150, 20,
                I18n.format("selectWorld.allowCommands", new Object[0])));
        this.field_146321_E.field_146125_m = false;
        this.buttonList.add(this.field_146322_F = new GuiButton(this.mc, 8, this.width / 2 + 5, 120, 150, 20,
                I18n.format("selectWorld.customizeType", new Object[0])));
        this.field_146322_F.field_146125_m = false;
        this.field_146333_g = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
        this.field_146333_g.setFocused(true);
        this.field_146333_g.setText(this.field_146330_J);
        this.field_146335_h = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
    ...
    private void func_146319_h() {
        this.field_146343_z.displayString = I18n.format("selectWorld.gameMode", new Object[0]) + " "
                + I18n.format("selectWorld.gameMode." + this.field_146342_r, new Object[0]);
        ...
        if (this.field_146341_s) {
            this.field_146325_B.displayString = this.field_146325_B.displayString
        ...
        if (this.field_146338_v && !this.field_146337_w) {
            this.field_146326_C.displayString = this.field_146326_C.displayString
                    + I18n.format("options.on", new Object[0]);
        } else {
            this.field_146326_C.displayString = this.field_146326_C.displayString
                    + I18n.format("options.off", new Object[0]);
        ...
        this.field_146320_D.displayString = I18n.format("selectWorld.mapType", new Object[0]) + " "
                + I18n.format(WorldType.worldTypes[this.field_146331_K].getTranslateName(), new Object[0]);
        ...
        if (this.field_146340_t && !this.field_146337_w) {
            this.field_146321_E.displayString = this.field_146321_E.displayString
                    + I18n.format("options.on", new Object[0]);
        } else {
            this.field_146321_E.displayString = this.field_146321_E.displayString
                    + I18n.format("options.off", new Object[0]);
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id == 1) {
                ...
                WorldSettings var6 = new WorldSettings(var2, var8, this.field_146341_s, this.field_146337_w,
                        WorldType.worldTypes[this.field_146331_K]);
                ...
                while (WorldType.worldTypes[this.field_146331_K] == null
                        || !WorldType.worldTypes[this.field_146331_K].getCanBeCreated()) {
                    ++this.field_146331_K;
                ...
                this.mc.displayGuiScreen(new GuiCreateFlatWorld(this.mc, this, this.field_146334_a));
            }
        }
    }
    ...
    private void func_146316_a(boolean p_146316_1_) {
        ...
        this.field_146322_F.field_146125_m = this.field_146344_y
                && WorldType.worldTypes[this.field_146331_K] == WorldType.FLAT;
