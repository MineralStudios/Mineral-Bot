...
public class GuiEditSign extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146852_i = new GuiButton(this.mc, 0, this.width / 2 - 100, this.height / 4 + 120,
    ...
    public void onGuiClosed() {
        ...
        if (var1 != null) {
            var1.addToSendQueue(
                    new C12PacketUpdateSign(this.field_146848_f.field_145851_c, this.field_146848_f.field_145848_d,
                            this.field_146848_f.field_145849_e, this.field_146848_f.field_145915_a));
        }
    ...
    protected void keyTyped(char p_73869_1_, int p_73869_2_) {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter(p_73869_1_)
                && this.field_146848_f.field_145915_a[this.field_146851_h].length() < 15) {
            this.field_146848_f.field_145915_a[this.field_146851_h] = this.field_146848_f.field_145915_a[this.field_146851_h]
                    + p_73869_1_;
        }
