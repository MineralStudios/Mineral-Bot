...
public abstract class GuiListExtended extends GuiSlot {
    ...
    protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_,
        ...
        this.func_148180_b(p_148126_1_).func_148279_a(p_148126_1_, p_148126_2_, p_148126_3_, this.func_148139_c(),
                p_148126_4_, p_148126_5_, p_148126_6_, p_148126_7_,
                this.func_148124_c(p_148126_6_, p_148126_7_) == p_148126_1_);
    }
    ...
    public boolean func_148179_a(int p_148179_1_, int p_148179_2_, int p_148179_3_) {
        if (this.func_148141_e(p_148179_2_)) {
            ...
            if (var4 >= 0) {
                ...
                int var6 = this.field_148153_b + 4 - this.func_148148_g() + var4 * this.field_148149_f
                        + this.field_148160_j;
    ...
    public interface IGuiListEntry {
        ...
        boolean func_148278_a(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_,
                int p_148278_6_);

        void func_148277_b(int p_148277_1_, int p_148277_2_, int p_148277_3_, int p_148277_4_, int p_148277_5_,
                int p_148277_6_);
    }
}
