...
public class GuiTextField extends Gui {
    ...
    public GuiTextField(Minecraft mc, FontRenderer p_i46392_1_, int p_i46392_2_, int p_i46392_3_, int p_i46392_4_,
        ...
        this.field_146210_g = p_i46392_3_;
        this.field_146218_h = p_i46392_4_;
        this.field_146219_i = p_i46392_5_;
    }
        ...
        if (!this.field_146213_o) {
            ...
            switch (p_146201_1_) {
                ...
                default:
                    switch (p_146201_2_) {
                        case 14:
                            if (GuiScreen.isCtrlKeyDown(this.mc)) {
                                if (this.field_146226_p) {
                        ...
                        case 199:
                            if (GuiScreen.isShiftKeyDown(this.mc)) {
                                this.func_146199_i(0);
                            } else {
                                this.func_146196_d();
                            }
                        ...
                        case 203:
                            ...
                            } else if (GuiScreen.isCtrlKeyDown(this.mc)) {
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            if (this.func_146181_i()) {
                drawRect(this.mc, this.field_146209_f - 1, this.field_146210_g - 1,
                        this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1,
                        -6250336);
                drawRect(this.mc, this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h,
            ...
            if (var6) {
                if (var13) {
                    Gui.drawRect(this.mc, var11, var8 - 1, var11 + 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT,
                            -3092272);
                } else {
