...
public class GuiControls extends GuiScreen {
    ...
    public GuiControls(Minecraft mc, GuiScreen p_i1027_1_, GameSettings p_i1027_2_) {
        super(mc);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(this.mc, 200, this.width / 2 - 155, this.height - 29, 150, 20,
                I18n.format("gui.done", new Object[0])));
        this.buttonList.add(
                this.field_146493_s = new GuiButton(this.mc, 201, this.width / 2 - 155 + 160, this.height - 29, 150,
                        20, I18n.format("controls.resetAll", new Object[0])));
        ...
        for (int var4 = 0; var4 < var3; ++var4) {
            ...
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(this.mc, var5.returnEnumOrdinal(),
                        this.width / 2 - 155 + var1 % 2 * 160, 18 + 24 * (var1 >> 1), var5));
            } else {
                this.buttonList.add(
                        new GuiOptionButton(this.mc, var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160,
                                18 + 24 * (var1 >> 1), var5, this.field_146497_i.getKeyBinding(var5)));
            }
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if (p_146284_1_.id == 200) {
            ...
            p_146284_1_.displayString = this.field_146497_i
