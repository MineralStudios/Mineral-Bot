...
public class GuiKeyBindingList extends GuiListExtended {
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry {
        ...
        private KeyEntry(KeyBinding p_i45029_2_) {
            ...
            this.field_148280_d = new GuiButton(GuiKeyBindingList.this.mc, 0, 0, 0, 75, 18,
                    I18n.format(p_i45029_2_.getKeyDescription(), new Object[0]));
            this.field_148281_e = new GuiButton(GuiKeyBindingList.this.mc, 0, 0, 0, 50, 18,
        ...
        public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_,
            ...
            this.field_148280_d.displayString = GameSettings.getKeyDisplayString(GuiKeyBindingList.this.mc,
                    this.field_148282_b.getKeyCode());
            boolean var11 = false;
            ...
            if (var10) {
                this.field_148280_d.displayString = EnumChatFormatting.WHITE + "> " + EnumChatFormatting.YELLOW
                        + this.field_148280_d.displayString + EnumChatFormatting.WHITE + " <";
            } else if (var11) {
        ...
        public boolean func_148278_a(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_,
            ...
            if (this.field_148280_d.mousePressed(GuiKeyBindingList.this.field_148189_l, p_148278_2_, p_148278_3_)) {
                ...
                return true;
            } else if (this.field_148281_e.mousePressed(GuiKeyBindingList.this.field_148189_l, p_148278_2_,
                    p_148278_3_)) {
                GuiKeyBindingList.this.field_148189_l.gameSettings.setKeyCodeSave(this.field_148282_b,
                        this.field_148282_b.getKeyCodeDefault());
                KeyBinding.resetKeyBindingArrayAndHash(GuiKeyBindingList.this.mc);
                return true;
            } else {
                return false;
            }
