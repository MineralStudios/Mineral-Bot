...
public class ScreenChatOptions extends GuiScreen {
    ...
    public ScreenChatOptions(Minecraft mc, GuiScreen p_i1023_1_, GameSettings p_i1023_2_) {
        super(mc);
            ...
            if (var5.getEnumFloat()) {
                this.buttonList.add(
                        new GuiOptionSlider(this.mc, var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160,
                                this.height / 6 + 24 * (var1 >> 1), var5));
            } else {
                this.buttonList.add(
                        new GuiOptionButton(this.mc, var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160,
                                this.height / 6 + 24 * (var1 >> 1), var5, this.field_146400_h.getKeyBinding(var5)));
            }
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id < 100 && p_146284_1_ instanceof GuiOptionButton) {
                ...
                p_146284_1_.displayString = this.field_146400_h
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146398_r, this.width / 2, this.field_146397_s + 7,
                16777215);
