...
public class GuiCreateFlatWorld extends GuiScreen {
    ...
    public GuiCreateFlatWorld(Minecraft mc, GuiCreateWorld p_i1029_1_, String p_i1029_2_) {
        super(mc);
        this.field_146392_a = new RenderItem(mc);
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        ...
        if (p_146284_1_.id == 1) {
            ...
            this.mc.displayGuiScreen(new GuiFlatPresets(this.mc, this));
        } else if (p_146284_1_.id == 4 && this.func_146382_i()) {
            this.field_146387_g.getFlatLayers().remove(var2);
            this.field_146390_s.field_148228_k = Math.min(this.field_146390_s.field_148228_k,
                    this.field_146387_g.getFlatLayers().size() - 1);
        }
    ...
    private boolean func_146382_i() {
        return this.field_146390_s.field_148228_k > -1
                && this.field_146390_s.field_148228_k < this.field_146387_g.getFlatLayers().size();
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.drawString(this.fontRendererObj, this.field_146391_r,
                var4 + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32, 16777215);
    ...
    class Details extends GuiSlot {
        ...
        protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
            ...
            GuiCreateFlatWorld.this.fontRendererObj.drawString(var12,
                    p_148126_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(var12),
                    p_148126_3_ + 3, 16777215);
        }
