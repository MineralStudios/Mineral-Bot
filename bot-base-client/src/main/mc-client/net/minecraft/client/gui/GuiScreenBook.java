...
public class GuiScreenBook extends GuiScreen {
    ...
    public GuiScreenBook(Minecraft mc, EntityPlayer p_i1080_1_, ItemStack p_i1080_2_, boolean p_i1080_3_) {
        super(mc);
    ...
    public void initGui() {
        ...
        if (this.field_146475_i) {
            this.buttonList
                    .add(this.field_146465_D = new GuiButton(this.mc, 3, this.width / 2 - 100, 4 + this.field_146477_v,
                            98, 20, I18n.format("book.signButton", new Object[0])));
            this.buttonList.add(
                    this.field_146472_C = new GuiButton(this.mc, 0, this.width / 2 + 2, 4 + this.field_146477_v, 98,
                            20, I18n.format("gui.done", new Object[0])));
            this.buttonList
                    .add(this.field_146467_E = new GuiButton(this.mc, 5, this.width / 2 - 100, 4 + this.field_146477_v,
                            98, 20, I18n.format("book.finalizeButton", new Object[0])));
            this.buttonList.add(
                    this.field_146469_F = new GuiButton(this.mc, 4, this.width / 2 + 2, 4 + this.field_146477_v, 98,
                            20, I18n.format("gui.cancel", new Object[0])));
        } else {
            this.buttonList
                    .add(this.field_146472_C = new GuiButton(this.mc, 0, this.width / 2 - 100, 4 + this.field_146477_v,
        ...
        byte var2 = 2;
        this.buttonList
                .add(this.field_146470_A = new GuiScreenBook.NextPageButton(this.mc, 1, var1 + 120, var2 + 154, true));
        this.buttonList
                .add(this.field_146471_B = new GuiScreenBook.NextPageButton(this.mc, 2, var1 + 38, var2 + 154, false));
        this.func_146464_h();
    }
    ...
    private void func_146462_a(boolean p_146462_1_) {
        if (this.field_146475_i && this.field_146481_r) {
            if (this.field_146483_y != null) {
                ...
                if (p_146462_1_) {
                    var2 = "MC|BSign";
                    this.field_146474_h.setTagInfo("author",
                            new NBTTagString(this.field_146468_g.getCommandSenderName()));
    ...
    static class NextPageButton extends GuiButton {
        ...
        public NextPageButton(Minecraft mc, int p_i46316_1_, int p_i46316_2_, int p_i46316_3_, boolean p_i46316_4_) {
            super(mc, p_i46316_1_, p_i46316_2_, p_i46316_3_, 23, 13, "");
