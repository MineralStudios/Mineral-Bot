...
public class GuiCommandBlock extends GuiScreen {
    ...
    public GuiCommandBlock(Minecraft mc, CommandBlockLogic p_i45032_1_) {
        super(mc);
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                this.field_146490_i = new GuiButton(this.mc, 0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12,
                        150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(
                this.field_146487_r = new GuiButton(this.mc, 1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150,
                        20, I18n.format("gui.cancel", new Object[0])));
        this.field_146485_f = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 150, 50, 300, 20);
        ...
        this.field_146486_g = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 150, 135, 300, 20);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150,
                var4 + var7++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        ...
        if (this.field_146486_g.getText().length() > 0) {
            ...
            this.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]),
                    this.width / 2 - 150, var6, 10526880);
