...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public GuiScreenAddServer(Minecraft mc, GuiScreen p_i1033_1_, ServerData p_i1033_2_) {
        super(mc);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(this.mc, 0, this.width / 2 - 100, this.height / 4 + 96 + 18,
                I18n.format("addServer.add", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 1, this.width / 2 - 100, this.height / 4 + 120 + 18,
                I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.field_152176_i = new GuiButton(this.mc, 2, this.width / 2 - 100, this.height / 4 + 72,
                I18n.format("addServer.resourcePack", new Object[0]) + ": "
                        + this.field_146311_h.func_152586_b().func_152589_a().getFormattedText()));
        this.field_146309_g = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 100, 66, 200, 20);
        this.field_146309_g.setFocused(true);
        this.field_146309_g.setText(this.field_146311_h.serverName);
        this.field_146308_f = new GuiTextField(this.mc, this.fontRendererObj, this.width / 2 - 100, 106, 200, 20);
        this.field_146308_f.func_146203_f(128);
        this.field_146308_f.setText(this.field_146311_h.serverIP);
        ((GuiButton) this.buttonList.get(0)).enabled = this.field_146308_f.getText().length() > 0
                && this.field_146308_f.getText().split(":").length > 0 && this.field_146309_g.getText().length() > 0;
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if (p_146284_1_.enabled) {
            if (p_146284_1_.id == 2) {
                this.field_146311_h.func_152584_a(
                        ServerData.ServerResourceMode.values()[(this.field_146311_h.func_152586_b().ordinal() + 1)
