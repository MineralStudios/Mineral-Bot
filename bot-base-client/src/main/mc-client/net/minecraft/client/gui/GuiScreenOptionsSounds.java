...
public class GuiScreenOptionsSounds extends GuiScreen {
    ...
    public GuiScreenOptionsSounds(Minecraft mc, GuiScreen p_i45025_1_, GameSettings p_i45025_2_) {
        super(mc);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiScreenOptionsSounds.Button(SoundCategory.MASTER.getCategoryId(),
                this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 12 + 24 * (var1 >> 1), SoundCategory.MASTER,
                true));
        int var6 = var1 + 2;
        ...
        for (int var4 = 0; var4 < var3; ++var4) {
            ...
            if (var5 != SoundCategory.MASTER) {
                this.buttonList.add(new GuiScreenOptionsSounds.Button(var5.getCategoryId(),
                        this.width / 2 - 155 + var6 % 2 * 160, this.height / 6 - 12 + 24 * (var6 >> 1), var5, false));
                ++var6;
            }
        }
    ...
    class Button extends GuiButton {
        ...
        public void mouseReleased(int p_146118_1_, int p_146118_2_) {
            if (this.field_146155_p) {
                ...
                SoundHandler soundHandler = GuiScreenOptionsSounds.this.mc.getSoundHandler();
