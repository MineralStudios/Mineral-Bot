...
public class GuiYesNo extends GuiScreen {
    ...
    public GuiYesNo(Minecraft mc, GuiYesNoCallback p_i1082_1_, String p_i1082_2_, String p_i1082_3_, int p_i1082_4_) {
        super(mc);
    ...
    public GuiYesNo(Minecraft mc, GuiYesNoCallback p_i1083_1_, String p_i1083_2_, String p_i1083_3_, String p_i1083_4_,
    ...
    public void initGui() {
        this.buttonList
                .add(new GuiOptionButton(this.mc, 0, this.width / 2 - 155, this.height / 6 + 96, this.field_146352_g));
        this.buttonList
                .add(new GuiOptionButton(this.mc, 1, this.width / 2 - 155 + 160, this.height / 6 + 96,
                        this.field_146356_h));
    }
