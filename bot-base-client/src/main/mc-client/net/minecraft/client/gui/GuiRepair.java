...
public class GuiRepair extends GuiContainer implements ICrafting {
    ...
    public void initGui() {
        ...
        this.field_147091_w = new GuiTextField(this.mc, this.fontRendererObj, var1 + 62, var2 + 24, 103, 12);
    ...
    protected void func_146979_b(int p_146979_1_, int p_146979_2_) {
        ...
        if (this.field_147092_v.maximumCost > 0) {
            ...
            if (var4) {
                ...
                if (this.fontRendererObj.isUnicodeFlag()) {
                    drawRect(this.mc, var7 - 3, var8 - 2, this.field_146999_f - 7, var8 + 10, -16777216);
                    drawRect(this.mc, var7 - 2, var8 - 1, this.field_146999_f - 8, var8 + 9, -12895429);
                } else {
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if (textureManager != null)
            textureManager.bindTexture(field_147093_u);

        int var4 = (this.width - this.field_146999_f) / 2;
        int var5 = (this.height - this.field_147000_g) / 2;
        this.drawTexturedModalRect(var4, var5, 0, 0, this.field_146999_f, this.field_147000_g);
        this.drawTexturedModalRect(var4 + 59, var5 + 20, 0,
                this.field_147000_g + (this.field_147092_v.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
