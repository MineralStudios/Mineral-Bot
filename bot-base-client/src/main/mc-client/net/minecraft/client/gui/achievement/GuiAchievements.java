...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        if (this.field_146558_F) {
            ...
            if (this.mc.getMouse().isButtonDown(0)) {
                ...
                if ((this.field_146554_D == 0 || this.field_146554_D == 1) && p_73863_1_ >= var6
                        && p_73863_1_ < var6 + 224 && p_73863_2_ >= var7 && p_73863_2_ < var7 + 155) {
            ...
            var4 = this.mc.getMouse().getDWheel();
    ...
    protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        int var4 = MathHelper
                .floor_double(this.field_146569_s + (this.field_146567_u - this.field_146569_s) * (double) p_146552_3_);
        int var5 = MathHelper
                .floor_double(this.field_146568_t + (this.field_146566_v - this.field_146568_t) * (double) p_146552_3_);
        ...
        for (var39 = 0; var39 < AchievementList.achievementList.size(); ++var39) {
            ...
            if (var43 >= -24 && var44 >= -24 && (float) var43 <= 224.0F * this.field_146570_r
                    && (float) var44 <= 155.0F * this.field_146570_r) {
                ...
                if (var37 >= (float) var43 && var37 <= (float) (var43 + 22) && var38 >= (float) var44
                        && var38 <= (float) (var44 + 22)) {
                    var34 = var41;
                }
            }
        }
        ...
        if (var34 != null) {
            ...
            if (!this.field_146556_E.canUnlockAchievement(var34)) {
                ...
                this.drawGradientRect(var43 - 3, var44 - 3, var43 + var31 + 3, var44 + var46 + 3 + 12, -1073741824,
                        -1073741824);
            ...
            if (var40 != null) {
                this.fontRendererObj.drawStringWithShadow(var40, var43, var44,
                        this.field_146556_E.canUnlockAchievement(var34) ? (var34.getSpecial() ? -128 : -1)
