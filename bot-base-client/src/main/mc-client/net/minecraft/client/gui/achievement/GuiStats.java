...
public class GuiStats extends GuiScreen implements IProgressMeter {
    private final RenderItem field_146544_g;
    ...
    public GuiStats(Minecraft mc, GuiScreen p_i1071_1_, StatFileWriter p_i1071_2_) {
        ...
        this.field_146544_g = new RenderItem(mc);
    }
    ...
    public void func_146541_h() {
        this.buttonList.add(new GuiButton(this.mc, 0, this.width / 2 + 4, this.height - 28, 150, 20,
                I18n.format("gui.done")));
        this.buttonList.add(new GuiButton(this.mc, 1, this.width / 2 - 160, this.height - 52, 80, 20,
                I18n.format("stat.generalButton")));
        GuiButton var1;
        GuiButton var2;
        GuiButton var3;
        this.buttonList.add(var1 = new GuiButton(this.mc, 2, this.width / 2 - 80, this.height - 52, 80, 20,
                I18n.format("stat.blocksButton")));
        this.buttonList.add(var2 = new GuiButton(this.mc, 3, this.width / 2, this.height - 52, 80, 20,
                I18n.format("stat.itemsButton")));
        this.buttonList.add(var3 = new GuiButton(this.mc, 4, this.width / 2 + 80, this.height - 52, 80, 20,
    ...
    private void func_146521_a(int p_146521_1_, int p_146521_2_, Item p_146521_3_) {
        ...
        field_146544_g.renderItemIntoGUI(this.fontRendererObj, this.mc.getTextureManager(),
    ...
    private void func_146527_c(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
        ...
        var9.addVertexWithUV(p_146527_1_, p_146527_2_ + 18, this.zLevel,
                (float) (p_146527_3_) * 0.0078125F, (float) (p_146527_4_ + 18) * 0.0078125F);
        var9.addVertexWithUV(p_146527_1_ + 18, p_146527_2_ + 18, this.zLevel,
                (float) (p_146527_3_ + 18) * 0.0078125F, (float) (p_146527_4_ + 18) * 0.0078125F);
        var9.addVertexWithUV(p_146527_1_ + 18, p_146527_2_, this.zLevel,
                (float) (p_146527_3_ + 18) * 0.0078125F, (float) (p_146527_4_) * 0.0078125F);
        var9.addVertexWithUV(p_146527_1_, p_146527_2_, this.zLevel,
                (float) (p_146527_3_) * 0.0078125F, (float) (p_146527_4_) * 0.0078125F);
        var9.draw();
    }
    ...
    abstract class Stats extends GuiSlot {
        ...
        protected void func_148129_a(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
            if (!this.mc.getMouse().isButtonDown(0)) {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            ...
            if (p_148209_1_ != null) {
                ...
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, var5,
            ...
            if (p_148142_2_ >= this.field_148153_b && p_148142_2_ <= this.field_148154_c) {
                ...
                if (var3 >= 0) {
                    ...
                    if (var9.length() > 0) {
                        ...
                        GuiStats.this.drawGradientRect(var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824,
                                -1073741824);
            ...
            while (var2.hasNext()) {
                ...
                if (GuiStats.this.field_146546_t.writeStat(var3) > 0) {
                    var4 = true;
                        ...
                        && GuiStats.this.field_146546_t.writeStat(StatList.objectUseStats[var5]) > 0) {
                    var4 = true;
                } else if (StatList.objectCraftStats[var5] != null
                        && GuiStats.this.field_146546_t.writeStat(StatList.objectCraftStats[var5]) > 0) {
                    var4 = true;
                }
    ...
    class StatsGeneral extends GuiSlot {
        ...
        protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var8.func_150951_e().getUnformattedText(),
                    p_148126_2_ + 2, p_148126_3_ + 1, p_148126_1_ % 2 == 0 ? 16777215 : 9474192);
            String var9 = var8.func_75968_a(GuiStats.this.field_146546_t.writeStat(var8));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var9,
                    p_148126_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(var9), p_148126_3_ + 1,
            ...
            while (var2.hasNext()) {
                ...
                if (GuiStats.this.field_146546_t.writeStat(var3) > 0) {
                    var4 = true;
                        ...
                        && GuiStats.this.field_146546_t.writeStat(StatList.objectBreakStats[var5]) > 0) {
                    var4 = true;
                } else if (StatList.objectCraftStats[var5] != null
                        && GuiStats.this.field_146546_t.writeStat(StatList.objectCraftStats[var5]) > 0) {
                    var4 = true;
    ...
    class StatsMobsList extends GuiSlot {
        ...
        public StatsMobsList() {
            ...
            while (var2.hasNext()) {
                ...
                if (GuiStats.this.field_146546_t.writeStat(var3.field_151512_d) > 0
                        || GuiStats.this.field_146546_t.writeStat(var3.field_151513_e) > 0) {
        ...
        protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var9, p_148126_2_ + 2 - 10, p_148126_3_ + 1,
                    16777215);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var12, p_148126_2_ + 2,
                    p_148126_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, var10 == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var13, p_148126_2_ + 2,
                    p_148126_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, var11 == 0 ? 6316128 : 9474192);
        }
    }
}
