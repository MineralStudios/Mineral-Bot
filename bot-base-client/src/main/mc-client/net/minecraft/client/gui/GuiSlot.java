...
public abstract class GuiSlot {
    ...
    public int func_148124_c(int p_148124_1_, int p_148124_2_) {
        ...
        return p_148124_1_ < this.func_148137_d() && p_148124_1_ >= var3 && p_148124_1_ <= var4 && var6 >= 0
                && var5 >= 0 && var6 < this.getSize() ? var6 : -1;
    }
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
        ...
        if (p_148128_1_ > this.field_148152_e && p_148128_1_ < this.field_148151_d && p_148128_2_ > this.field_148153_b
                && p_148128_2_ < this.field_148154_c) {
            if (this.mc.getMouse().isButtonDown(0) && this.func_148125_i()) {
                if (this.field_148157_o == -1.0F) {
                    ...
                    if (p_148128_2_ >= this.field_148153_b && p_148128_2_ <= this.field_148154_c) {
                        ...
                        if (p_148128_1_ >= var8 && p_148128_1_ <= var9 && var11 >= 0 && var10 >= 0 && var11 < var4) {
                            boolean var12 = var11 == this.field_148168_r
                                    && Minecraft.getSystemTime() - this.field_148167_s < 250L;
                            ...
                            this.func_148132_a(p_148128_1_ - var8,
                                    p_148128_2_ - this.field_148153_b + (int) this.field_148169_q - 4);
                            var15 = false;
                        }
                        ...
                        if (p_148128_1_ >= var5 && p_148128_1_ <= var6) {
                            ...
                            var13 = (int) ((float) ((this.field_148154_c - this.field_148153_b)
                                    * (this.field_148154_c - this.field_148153_b)) / (float) this.func_148138_e());
                            ...
                            this.field_148170_p /= (float) (this.field_148154_c - this.field_148153_b - var13)
                                    / (float) var19;
                        } else {
                            this.field_148170_p = 1.0F;
                        }
        ...
        if (var19 > 0) {
            var13 = (this.field_148154_c - this.field_148153_b) * (this.field_148154_c - this.field_148153_b)
                    / this.func_148138_e();
            ...
            int var14 = (int) this.field_148169_q * (this.field_148154_c - this.field_148153_b - var13) / var19
                    + this.field_148153_b;
    ...
    private void func_148136_c(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_) {
        ...
        var5.addVertexWithUV((double) this.field_148152_e, (double) p_148136_2_, 0.0D, 0.0D,
                (double) ((float) p_148136_2_ / var6));
        var5.addVertexWithUV((double) (this.field_148152_e + this.field_148155_a), (double) p_148136_2_, 0.0D,
                (double) ((float) this.field_148155_a / var6), (double) ((float) p_148136_2_ / var6));
        var5.setColorRGBA_I(4210752, p_148136_3_);
        var5.addVertexWithUV((double) (this.field_148152_e + this.field_148155_a), (double) p_148136_1_, 0.0D,
                (double) ((float) this.field_148155_a / var6), (double) ((float) p_148136_1_ / var6));
        var5.addVertexWithUV((double) this.field_148152_e, (double) p_148136_1_, 0.0D, 0.0D,
                (double) ((float) p_148136_1_ / var6));
        var5.draw();
    }
