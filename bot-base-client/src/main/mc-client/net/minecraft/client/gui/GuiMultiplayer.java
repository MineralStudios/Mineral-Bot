...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public GuiMultiplayer(Minecraft mc, GuiScreen p_i1040_1_) {
        super(mc);
        this.field_146797_f = new OldServerPinger(mc);
    ...
    public void func_146794_g() {
        this.buttonList
                .add(this.field_146810_r = new GuiButton(this.mc, 7, this.width / 2 - 154, this.height - 28, 70, 20,
                        I18n.format("selectServer.edit", new Object[0])));
        this.buttonList
                .add(this.field_146808_t = new GuiButton(this.mc, 2, this.width / 2 - 74, this.height - 28, 70, 20,
                        I18n.format("selectServer.delete", new Object[0])));
        this.buttonList
                .add(this.field_146809_s = new GuiButton(this.mc, 1, this.width / 2 - 154, this.height - 52, 100, 20,
                        I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 4, this.width / 2 - 50, this.height - 52, 100, 20,
                I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 3, this.width / 2 + 4 + 50, this.height - 52, 100, 20,
                I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 8, this.width / 2 + 4, this.height - 28, 70, 20,
                I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new GuiButton(this.mc, 0, this.width / 2 + 4 + 76, this.height - 28, 75, 20,
        ...
        if (p_146284_1_.enabled) {
            ...
            if (p_146284_1_.id == 2 && var2 instanceof ServerListEntryNormal) {
                ...
                if (var9 != null) {
                    ...
                    GuiYesNo var8 = new GuiYesNo(this.mc, this, var4, var5, var6, var7,
                            this.field_146803_h.func_148193_k());
                ...
                this.mc.displayGuiScreen(new GuiScreenServerList(this.mc, this,
                        this.field_146811_z = new ServerData(I18n.format("selectServer.defaultName", new Object[0]),
                                "")));
            } else if (p_146284_1_.id == 3) {
                this.field_146806_v = true;
                this.mc.displayGuiScreen(new GuiScreenAddServer(this.mc, this,
                        this.field_146811_z = new ServerData(I18n.format("selectServer.defaultName", new Object[0]),
                                "")));
    ...
    private void func_146792_q() {
        this.mc.displayGuiScreen(new GuiMultiplayer(this.mc, this.field_146798_g));
    }
                ...
                if (p_73869_2_ == 200) {
                    if (isShiftKeyDown(this.mc)) {
                        ...
                        if (this.field_146803_h
                                .func_148180_b(this.field_146803_h.func_148193_k()) instanceof ServerListEntryLanScan) {
