...
public class TextureAtlasSprite implements IIcon {
    ...
    public void updateAnimation() {
        ...
        if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
            ...
            int var2 = this.animationMetadata.getFrameCount() == 0 ? this.framesTextureData.size()
        ...
        if (p_147964_2_ == null) {
            ...
            if (p_147964_2_.getFrameCount() > 0) {
                ...
                while (var13.hasNext()) {
                    ...
                    this.framesTextureData.set(var11,
                            this.func_147960_a(func_147962_a(var6, var121, var9, var11), var121, var9));
                }
                ...
                for (var11 = 0; var11 < var7; ++var11) {
                    this.framesTextureData
                            .add(this.func_147960_a(func_147962_a(var6, var121, var9, var11), var121, var9));
                    var131.add(new AnimationFrame(var11, -1));
                }

                this.animationMetadata = new AnimationMetadataSection(var131, this.width, this.height,
                        p_147964_2_.getFrameTime());
            }
        }
    }
