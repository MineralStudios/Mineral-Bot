...
public class RenderItemFrame extends Render {
    ...
    public RenderItemFrame(Minecraft mc) {
        super(mc);
        this.field_147916_f = new RenderBlocks(mc);
    }
    ...
    public void doRender(EntityItemFrame p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        GL11.glPopMatrix();
        this.func_147914_a(p_76986_1_,
                p_76986_2_ + (double) ((float) Direction.offsetX[p_76986_1_.hangingDirection] * 0.3F),
                p_76986_4_ - 0.25D,
                p_76986_6_ + (double) ((float) Direction.offsetZ[p_76986_1_.hangingDirection] * 0.3F));
    }
    ...
    private void func_147915_b(EntityItemFrame p_147915_1_) {
        ...
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F - var5 + 0.0625F),
                (double) (0.5F - var5 + 0.0625F), (double) var3, (double) (0.5F + var5 - 0.0625F),
        ...
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F - var5), (double) (0.5F - var5),
                (double) (var3 + 1.0E-4F), (double) (var3 + 0.5F - var5), (double) (0.5F + var5));
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F + var5 - var3), (double) (0.5F - var5),
                (double) (var3 + 1.0E-4F), (double) (0.5F + var5), (double) (0.5F + var5));
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F - var5), (double) (0.5F - var5), (double) var3,
                (double) (0.5F + var5), (double) (var3 + 0.5F - var5));
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F - var5), (double) (0.5F + var5 - var3),
                (double) var3, (double) (0.5F + var5), (double) (0.5F + var5));
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        this.field_147916_f.unlockBlockBounds();
        this.field_147916_f.clearOverrideBlockTexture();
    ...
    private void renderFrameItemAsBlock(EntityItemFrame p_82403_1_) {
        ...
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, (double) (0.5F - var5 + 0.0625F),
                (double) (0.5F - var5 + 0.0625F), (double) (var3 * 0.5F), (double) (0.5F + var5 - 0.0625F),
                (double) (0.5F + var5 - 0.0625F));
        this.field_147916_f.setOverrideBlockTexture(this.field_94147_f);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        this.field_147916_f.clearOverrideBlockTexture();
    ...
    private void func_82402_b(EntityItemFrame p_82402_1_) {
        ...
        if (var2 != null) {
            ...
            GL11.glPushMatrix();
            GL11.glTranslatef(-0.453125F * (float) Direction.offsetX[p_82402_1_.hangingDirection], -0.18F,
                    -0.453125F * (float) Direction.offsetZ[p_82402_1_.hangingDirection]);
            ...
            if (var4 == Items.filled_map) {
                ...
                if (var7 != null) {
                    this.mc.entityRenderer.getMapItemRenderer().func_148250_a(var7, true);
                }
            } else {
                if (var4 == Items.compass) {
                    ...
                    if (var14 instanceof TextureCompass) {
                        ...
                        var15.updateCompass(p_82402_1_.worldObj, p_82402_1_.posX, p_82402_1_.posZ,
                                (double) MathHelper
                                        .wrapAngleTo180_float((float) (180 + p_82402_1_.hangingDirection * 90)),
                                false, true);
