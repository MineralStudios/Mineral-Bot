...
public abstract class RenderLiving extends RendererLivingEntity {
    ...
    protected boolean func_110813_b(EntityLiving p_110813_1_) {
        return super.func_110813_b(p_110813_1_) && (p_110813_1_.getAlwaysRenderNameTagForRender()
                || p_110813_1_.hasCustomNameTag() && p_110813_1_ == this.renderManager.field_147941_i);
    }
    ...
    protected void func_110827_b(EntityLiving p_110827_1_, double p_110827_2_, double p_110827_4_, double p_110827_6_,
        ...
        if (var10 != null) {
            ...
            double var12 = this.func_110828_a((double) var10.prevRotationYaw, (double) var10.rotationYaw,
                    (double) (p_110827_9_ * 0.5F)) * 0.01745329238474369D;
            double var14 = this.func_110828_a((double) var10.prevRotationPitch, (double) var10.rotationPitch,
                    (double) (p_110827_9_ * 0.5F)) * 0.01745329238474369D;
            ...
            double var24 = this.func_110828_a(var10.prevPosX, var10.posX, (double) p_110827_9_) - var16 * 0.7D
                    - var18 * 0.5D * var22;
            double var26 = this.func_110828_a(var10.prevPosY + (double) var10.getEyeHeight() * 0.7D,
                    var10.posY + (double) var10.getEyeHeight() * 0.7D, (double) p_110827_9_) - var20 * 0.5D - 0.25D;
            double var28 = this.func_110828_a(var10.prevPosZ, var10.posZ, (double) p_110827_9_) - var18 * 0.7D
                    + var16 * 0.5D * var22;
            double var30 = this.func_110828_a((double) p_110827_1_.prevRenderYawOffset,
                    (double) p_110827_1_.renderYawOffset, (double) p_110827_9_) * 0.01745329238474369D + (Math.PI / 2D);
            ...
            for (var47 = 0; var47 <= 24; ++var47) {
                ...
                var11.addVertex(p_110827_2_ + var38 * (double) var48 + 0.0D,
                        p_110827_4_ + var40 * (double) (var48 * var48 + var48) * 0.5D
                                + (double) ((24.0F - (float) var47) / 18.0F + 0.125F),
                        p_110827_6_ + var42 * (double) var48);
                var11.addVertex(p_110827_2_ + var38 * (double) var48 + 0.025D,
                        p_110827_4_ + var40 * (double) (var48 * var48 + var48) * 0.5D
                                + (double) ((24.0F - (float) var47) / 18.0F + 0.125F) + 0.025D,
                        p_110827_6_ + var42 * (double) var48);
            }
            ...
            for (var47 = 0; var47 <= 24; ++var47) {
                ...
                var11.addVertex(p_110827_2_ + var38 * (double) var48 + 0.025D,
                        p_110827_4_ + var40 * (double) (var48 * var48 + var48) * 0.5D
                                + (double) ((24.0F - (float) var47) / 18.0F + 0.125F),
                        p_110827_6_ + var42 * (double) var48 + 0.025D);
            }
