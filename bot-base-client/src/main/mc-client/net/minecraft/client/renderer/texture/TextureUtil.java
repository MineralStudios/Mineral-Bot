...
public class TextureUtil {
    public final IntBuffer dataBuffer = GLAllocation.createDirectIntBuffer(4194304);
    public final DynamicTexture missingTexture;
    public final int[] missingTextureData;
    ...
    public TextureUtil(Minecraft mc) {
        missingTexture = new DynamicTexture(mc, dataBuffer, 16, 16);
    ...
    public static int uploadTextureImage(Minecraft mc, int par0, BufferedImage par1BufferedImage) {
        return uploadTextureImageAllocate(mc, par0, par1BufferedImage, false, false);
    }
    ...
    private static void func_147947_a(Minecraft mc, IntBuffer dataBuffer, int p_147947_0_, int[] p_147947_1_,
        ...
        for (int var10 = 0; var10 < p_147947_2_ * p_147947_3_; var10 += p_147947_2_ * var12) {
            ...
            copyToBufferPos(mc, dataBuffer, p_147947_1_, var10, var13);
    ...
    public static void func_147946_a(int p_147946_0_, int p_147946_1_, int p_147946_2_, int p_147946_3_,
        ...
        for (int var5 = 0; var5 <= p_147946_1_; ++var5) {
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, var5, GL11.GL_RGBA, p_147946_2_ >> var5, p_147946_3_ >> var5, 0,
    ...
    private static void copyToBuffer(Minecraft mc, IntBuffer dataBuffer, int[] par0ArrayOfInteger, int par1) {
        copyToBufferPos(mc, dataBuffer, par0ArrayOfInteger, 0, par1);
    }
    ...
    public static int[] readImageData(IResourceManager par0ResourceManager, ResourceLocation par1ResourceLocation)
            throws IOException {
    ...
    public static int[] func_147948_a(int[] p_147948_0_, int p_147948_1_, int p_147948_2_, int p_147948_3_) {
        ...
        for (var5 = p_147948_2_ - 1; var5 >= 0; --var5) {
            ...
            for (var8 = 0; var8 < p_147948_3_; var8 += p_147948_1_) {
                System.arraycopy(p_147948_0_, var6, p_147948_0_, var7 + p_147948_1_ + var8,
        ...
        for (var5 = 0; var5 < p_147948_3_; var5 += p_147948_2_) {
            ...
            System.arraycopy(p_147948_0_, (p_147948_3_ + p_147948_2_ - var6) * var4, p_147948_0_,
                    (p_147948_3_ - var5 - var6) * var4, var4 * var6);
        }

        for (var5 = 0; var5 < p_147948_3_; var5 += p_147948_2_) {
            var6 = Math.min(p_147948_2_, p_147948_3_ - var5);
            System.arraycopy(p_147948_0_, p_147948_3_ * var4, p_147948_0_, (p_147948_2_ + p_147948_3_ + var5) * var4,
                    var4 * var6);
        }
