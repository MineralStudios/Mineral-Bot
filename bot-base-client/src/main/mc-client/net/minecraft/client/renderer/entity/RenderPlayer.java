...
public class RenderPlayer extends RendererLivingEntity {
    ...
    public RenderPlayer(Minecraft mc) {
        super(mc, new ModelBiped(mc, 0.0F), 0.5F);
        this.modelBipedMain = (ModelBiped) this.mainModel;
        this.modelArmorChestplate = new ModelBiped(mc, 1.0F);
        this.modelArmor = new ModelBiped(mc, 0.5F);
    }
    ...
    public void doRender(AbstractClientPlayer p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        this.modelArmorChestplate.isSneak = this.modelArmor.isSneak = this.modelBipedMain.isSneak = p_76986_1_
                .isSneaking();
    ...
    protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_) {
                ...
                if (var3.hasTagCompound()) {
                    ...
                    if (var6.func_150297_b("SkullOwner", 10)) {
                        var5 = NBTUtil.func_152459_a(var6.getCompoundTag("SkullOwner"));
                            ...
                            && !StringUtils.isNullOrEmpty(var6.getString("SkullOwner"))) {
        ...
        if (var21 && !p_77029_1_.isInvisible() && !p_77029_1_.getHideCape()) {
            ...
            double var23 = p_77029_1_.field_71091_bM
                    + (p_77029_1_.field_71094_bP - p_77029_1_.field_71091_bM) * (double) p_77029_2_
                    - (p_77029_1_.prevPosX + (p_77029_1_.posX - p_77029_1_.prevPosX) * (double) p_77029_2_);
            double var27 = p_77029_1_.field_71096_bN
                    + (p_77029_1_.field_71095_bQ - p_77029_1_.field_71096_bN) * (double) p_77029_2_
                    - (p_77029_1_.prevPosY + (p_77029_1_.posY - p_77029_1_.prevPosY) * (double) p_77029_2_);
            double var9 = p_77029_1_.field_71097_bO
                    + (p_77029_1_.field_71085_bR - p_77029_1_.field_71097_bO) * (double) p_77029_2_
                    - (p_77029_1_.prevPosZ + (p_77029_1_.posZ - p_77029_1_.prevPosZ) * (double) p_77029_2_);
            ...
            var16 += MathHelper.sin((p_77029_1_.prevDistanceWalkedModified
                    + (p_77029_1_.distanceWalkedModified - p_77029_1_.prevDistanceWalkedModified) * p_77029_2_) * 6.0F)
                    * 32.0F * var19;
        ...
        if (var24 != null) {
            ...
            if (var24.getItem() instanceof ItemBlock
                    && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var24.getItem()).getRenderType())) {
                var7 = 0.5F;
        ...
        if (p_96449_10_ < 100.0D) {
            ...
            if (var13 != null) {
                ...
                if (p_96449_1_.isPlayerSleeping()) {
                    this.func_147906_a(p_96449_1_, var14.getScorePoints() + " " + var13.getDisplayName(), p_96449_2_,
                ...
                p_96449_4_ += (double) ((float) this.getFontRendererFromRenderManager().FONT_HEIGHT * 1.15F
                        * p_96449_9_);
            }
        }
