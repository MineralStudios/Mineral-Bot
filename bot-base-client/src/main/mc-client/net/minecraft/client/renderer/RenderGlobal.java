...
public class RenderGlobal implements IWorldAccess {
     ...
     * more than 4 units they will be
     * resorted)
     */
    ...
    private static final AxisAlignedBB AABB_INFINITE = AxisAlignedBB.getBoundingBox(Double.NEGATIVE_INFINITY,
    ...
    public void loadRenderers() {
        if (this.theWorld != null) {
            ...
            for (var10 = 0; var10 < this.renderChunksWide; ++var10) {
                for (int var14 = 0; var14 < this.renderChunksTall; ++var14) {
                    for (int cz = 0; cz < this.renderChunksDeep; ++cz) {
                        ...
                        this.worldRenderers[wri] = WrUpdates.makeWorldRenderer(this.mc, this.theWorld,
                                this.tileEntities,
                                var10 * 16, var14 * 16, cz * 16, this.glRenderListBase + var2);
            ...
            if (this.theWorld != null) {
                ...
                if (var13 != null) {
                    this.markRenderersForNewPosition(MathHelper.floor_double(((EntityLivingBase) var13).posX),
                            MathHelper.floor_double(((EntityLivingBase) var13).posY),
                            MathHelper.floor_double(((EntityLivingBase) var13).posZ));
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            for (var25 = 0; var25 < this.theWorld.weatherEffects.size(); ++var25) {
                ...
                if (!hasEntityShouldRenderInPass || Reflector.callBoolean(var19,
                        Reflector.ForgeEntity_shouldRenderInPass, Integer.valueOf(pass))) {
            ...
            for (var25 = 0; var25 < var24.size(); ++var25) {
                ...
                if (!hasEntityShouldRenderInPass || Reflector.callBoolean(var19,
                    ...
                    if (!te && var19 instanceof EntityLiving var28) {
            ...
            for (var25 = 0; var25 < this.tileEntities.size(); ++var25) {
                ...
                if (!hasTileEntityShouldRenderInPass || Reflector.callBoolean(var27,
                        Reflector.ForgeTileEntity_shouldRenderInPass, Integer.valueOf(pass))) {
                    ...
                    if (var29 == AABB_INFINITE || p_147589_2_.isBoundingBoxInFrustum(var29)) {
                        ...
                        if (var30 == TileEntityChest.class) {
                            Block var31 = this.theWorld.getBlock(var27.field_145851_c, var27.field_145848_d,
    ...
    public String getDebugInfoRenders() {
        return "C: " + this.renderersBeingRendered + "/" + this.renderersLoaded + ". F: " + this.renderersBeingClipped
                + ", O: " + this.renderersBeingOccluded + ", E: " + this.renderersSkippingRenderPass;
    }
     ...
     * have their position changed are
        ...
        for (int ix = 0; ix < this.renderChunksWide; ++ix) {
            ...
            for (int iz = 0; iz < this.renderChunksDeep; ++iz) {
                ...
                for (int iy = 0; iy < this.renderChunksTall; ++iy) {
                    ...
                    WorldRenderer worldrenderer = this.worldRenderers[(iz * this.renderChunksTall + iy)
                            * this.renderChunksWide + ix];
    ...
    public int sortAndRender(EntityLivingBase player, int renderPass, double partialTicks) {
        ...
        boolean var33 = this.prevChunkSortX != player.chunkCoordX || this.prevChunkSortY != player.chunkCoordY
        ...
        if (var33) {
            ...
            if (countResort > (double) (num * num) + 16.0D) {
                ...
                this.markRenderersForNewPosition(MathHelper.floor_double(player.posX),
        ...
        if (this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph
                && renderPass == 0) {
            ...
            for (int switchStep = this.renderChunksWide; endIndex < this.countSortedWorldRenderers; num += this
                    .renderSortedRenderers(startIndex, endIndex, renderPass, partialTicks)) {
                    ...
                    if (wr.skipAllRenderPasses()) {
                        ...
                        if (wr.isInFrustum) {
                            if (mc.getConfig().isOcclusionFancy() && !wr.isInFrustrumFully) {
                                ...
                                ARBOcclusionQuery.glBeginQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB,
                                        wr.glOcclusionQuery);
        ...
        for (int k = startIndex; k < endIndex; ++k) {
            ...
            if (wr.isWaitingOnOcclusionQuery) {
                ...
                ARBOcclusionQuery.glGetQueryObjectuARB(wr.glOcclusionQuery,
                        ARBOcclusionQuery.GL_QUERY_RESULT_AVAILABLE_ARB, this.occlusionResult);

                if (this.occlusionResult.get(0) != 0) {
                    wr.isWaitingOnOcclusionQuery = false;
                    this.occlusionResult.clear();
                    ARBOcclusionQuery.glGetQueryObjectuARB(wr.glOcclusionQuery, ARBOcclusionQuery.GL_QUERY_RESULT_ARB,
     ...
     * startRenderer, numRenderers, renderPass,
     * partialTickTime
     */
    private int renderSortedRenderers(int par1, int par2, int par3, double par4) {
        if (mc.getConfig().isFastRender()) {
            ...
            for (int var22 = var7; var22 != var8; var22 += var9) {
                ...
                if (!this.sortedWorldRenderers[var22].skipRenderPass[par3]
                        && this.sortedWorldRenderers[var22].isInFrustum
                        && (!this.occlusionEnabled || this.sortedWorldRenderers[var22].isVisible)) {
            ...
            if (var6 == 0) {
                ...
                for (var18 = 0; var18 < this.glRenderLists.size(); ++var18) {
                    ...
                    for (var21 = 0; var21 < var17; ++var21) {
                        if (this.allRenderLists[var21].rendersChunk(var24.posXMinus, var24.posYMinus,
                                var24.posZMinus)) {
                            var20 = var21;
                        }
                    }
                    ...
                    if (var20 < 0) {
                        var20 = var17++;
                        this.allRenderLists[var20].setupRenderList(var24.posXMinus, var24.posYMinus, var24.posZMinus,
                                var231, var13, var15);
                    }
    ...
    private int renderSortedRenderersFast(int startIndex, int endIndex, int renderPass, double partialTicks) {
        ...
        for (int entityliving = loopStart; entityliving != loopEnd; entityliving += loopInc) {
            ...
            if (partialX.isInFrustum && !partialX.skipRenderPass[renderPass]
                    && (!this.occlusionEnabled || partialX.isVisible)) {
        ...
        if (l == 0) {
            ...
            double var19 = var18.lastTickPosX + (var18.posX - var18.lastTickPosX) * partialTicks
                    - (double) WorldRenderer.globalChunkOffsetX;
            double partialY = var18.lastTickPosY + (var18.posY - var18.lastTickPosY) * partialTicks;
            double partialZ = var18.lastTickPosZ + (var18.posZ - var18.lastTickPosZ) * partialTicks
                    - (double) WorldRenderer.globalChunkOffsetZ;
    ...
    public void renderSky(float par1) {
        if (Reflector.ForgeWorldProvider_getSkyRenderer.exists()) {
            ...
            Object var3 = var2 != null
                    ? Reflector.call(var2, Reflector.ForgeWorldProvider_getSkyRenderer)
                    : null;

            if (var3 != null) {
                Reflector.callVoid(var3, Reflector.IRenderHandler_render,
                        Float.valueOf(par1), this.theWorld, this.mc);
                return;
            }
        }
        ...
        if (this.mc.theWorld != null && this.mc.theWorld.provider.dimensionId == 1) {
            ...
            Tessellator var201 = this.mc.getTessellator();
            ...
            var21 = CustomColorizer.getSkyColor(var21, this.mc.theWorld, this.mc.renderViewEntity.posX,
                    this.mc.renderViewEntity.posY + 1.0D, this.mc.renderViewEntity.posZ);
            ...
            Tessellator var241 = this.mc.getTessellator();
            GL11.glDepthMask(false);
            GL11.glEnable(GL11.GL_FOG);
            GL11.glColor3f(var231, var4, var5);
            ...
            OpenGlHelper.glBlendFunc(770, 771, 1, 0);
            RenderHelper.disableStandardItemLighting();
            float[] var251 = this.theWorld.provider.calcSunriseSunsetColors(this.theWorld.getCelestialAngle(par1),
                    par1);
            float var9;
            float var10;
            float var11;
            ...
            if (var251 != null && mc.getConfig().isSunMoonEnabled()) {
                ...
                GL11.glPushMatrix();
                GL11.glRotatef(90.0F, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(MathHelper.sin(this.theWorld.getCelestialAngleRadians(par1)) < 0.0F ? 180.0F : 0.0F,
                        0.0F, 0.0F, 1.0F);
                GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
                var8 = var251[0];
                var9 = var251[1];
                ...
                for (var30 = 0; var30 <= var25; ++var30) {
                    ...
                    if (var241 != null)
                        var241.addVertex(var16 * 120.0F, var17 * 120.0F,
                                -var17 * 40.0F * var251[3]);
                }
            ...
            if (mc.getConfig().isSunMoonEnabled()) {
                ...
                if (var241 != null) {
                    ...
                    var241.addVertexWithUV(-var12, -100.0D, -var12, var18,
                            var17);
                    var241.draw();
                }
            }
            ...
            if (this.mc.gameSettings.renderDistanceChunks <= 4) {
                GL11.glColor3f(this.mc.entityRenderer.fogColorRed, this.mc.entityRenderer.fogColorGreen,
                        this.mc.entityRenderer.fogColorBlue);
            }
        ...
        if (!mc.getConfig().isCloudsOff()) {
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.provider.isSurfaceWorld()) {
                if (mc.getConfig().isCloudsFancy()) {
                    ...
                    float var21 = (float) (this.mc.renderViewEntity.lastTickPosY
                    ...
                    if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                        ...
                        dc = this.mc.renderViewEntity.prevPosX
                                + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * (double) par1
                                + exactPlayerZ1 * 0.029999999329447746D;
                        double cdx = this.mc.renderViewEntity.prevPosZ
                        ...
                        if (var5 != null) {
                            ...
                            for (int var22 = -var3 * var4; var22 < var3 * var4; var22 += var3) {
                                for (int var23 = -var3 * var4; var23 < var3 * var4; var23 += var3) {
                                    var5.addVertexWithUV(var22, var19, var23 + var3,
                                            (float) (var22) * var10 + var20,
                                            (float) (var23 + var3) * var10 + var211);
                                    var5.addVertexWithUV(var22 + var3, var19,
                                            var23 + var3,
                                            (float) (var22 + var3) * var10 + var20,
                                            (float) (var23 + var3) * var10 + var211);
                                    var5.addVertexWithUV(var22 + var3, var19, var23,
                                            (float) (var22 + var3) * var10 + var20,
                                            (float) (var23) * var10 + var211);
                                    var5.addVertexWithUV(var22, var19, var23,
                                            (float) (var22) * var10 + var20,
                                            (float) (var23) * var10 + var211);
                                }
                            }
                    ...
                    double exactPlayerX1 = entityliving1.prevPosX
                            + (entityliving1.posX - entityliving1.prevPosX) * (double) partialTicks1;
                    double exactPlayerY1 = entityliving1.prevPosY
                            + (entityliving1.posY - entityliving1.prevPosY) * (double) partialTicks1;
                    exactPlayerZ1 = entityliving1.prevPosZ
                            + (entityliving1.posZ - entityliving1.prevPosZ) * (double) partialTicks1;
    ...
    public void renderCloudsFancy(float par1) {
        ...
        par1 = 0.0F;
        GL11.glDisable(GL11.GL_CULL_FACE);
        float var2 = (float) (this.mc.renderViewEntity.lastTickPosY
                + (this.mc.renderViewEntity.posY - this.mc.renderViewEntity.lastTickPosY) * (double) par1);
        Tessellator var3 = this.mc.getTessellator();
        float var4 = 12.0F;
        float var5 = 4.0F;
        double var6 = (float) this.cloudTickCounter + par1;
        double var8 = (this.mc.renderViewEntity.prevPosX
                + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * (double) par1
                + var6 * 0.029999999329447746D) / (double) var4;
        double var10 = (this.mc.renderViewEntity.prevPosZ
                + (this.mc.renderViewEntity.posZ - this.mc.renderViewEntity.prevPosZ) * (double) par1) / (double) var4
                        ...
                        if (var3 != null) {
                            ...
                            if (var12 > -var5 - 1.0F) {
                                ...
                                var3.addVertexWithUV(var32 + 0.0F, var12 + 0.0F,
                                        var33 + (float) cdx, (var30 + 0.0F) * var21 + var19,
                                        (var31 + (float) cdx) * var21 + exactPlayerZ);
                                var3.addVertexWithUV(var32 + (float) cdx, var12 + 0.0F,
                                        var33 + (float) cdx,
                                        (var30 + (float) cdx) * var21 + var19,
                                        (var31 + (float) cdx) * var21 + exactPlayerZ);
                                var3.addVertexWithUV(var32 + (float) cdx, var12 + 0.0F,
                                        var33 + 0.0F, (var30 + (float) cdx) * var21 + var19,
                                        (var31 + 0.0F) * var21 + exactPlayerZ);
                                var3.addVertexWithUV(var32 + 0.0F, var12 + 0.0F,
                                        var33 + 0.0F, (var30 + 0.0F) * var21 + var19,
                                        (var31 + 0.0F) * var21 + exactPlayerZ);
                            }
                            ...
                            if (var12 <= var5 + 1.0F) {
                                ...
                                var3.setNormal(0.0F, 1.0F, 0.0F);
                                var3.addVertexWithUV(var32 + 0.0F, var12 + var5 - cdz,
                                        var33 + (float) cdx, (var30 + 0.0F) * var21 + var19,
                                        (var31 + (float) cdx) * var21 + exactPlayerZ);
                                var3.addVertexWithUV(var32 + (float) cdx, var12 + var5 - cdz,
                                        var33 + (float) cdx,
                                        (var30 + (float) cdx) * var21 + var19,
                                        (var31 + (float) cdx) * var21 + exactPlayerZ);
                                var3.addVertexWithUV(var32 + (float) cdx, var12 + var5 - cdz,
                            ...
                            if (var28 > -1) {
                                ...
                                for (var34 = 0; var34 < cdx; ++var34) {
                                    var3.addVertexWithUV(var32 + (float) var34 + 0.0F,
                                            var12 + 0.0F,
                                            var33 + (float) cdx,
                                            (var30 + (float) var34 + 0.5F) * var21 + var19,
                                            (var31 + (float) cdx) * var21 + exactPlayerZ);
                                    var3.addVertexWithUV(var32 + (float) var34 + 0.0F,
                                            var12 + var5,
                                            var33 + (float) cdx,
                            ...
                            if (var28 <= 1) {
                                ...
                                for (var34 = 0; var34 < cdx; ++var34) {
                                    var3.addVertexWithUV(var32 + (float) var34 + 1.0F - cdz,
                                            var12 + 0.0F, var33 + (float) cdx,
                                            (var30 + (float) var34 + 0.5F) * var21 + var19,
                                            (var31 + (float) cdx) * var21 + exactPlayerZ);
                                    var3.addVertexWithUV(var32 + (float) var34 + 1.0F - cdz,
                                            var12 + var5, var33 + (float) cdx,
                                            (var30 + (float) var34 + 0.5F) * var21 + var19,
                                            (var31 + (float) cdx) * var21 + exactPlayerZ);
                                    var3.addVertexWithUV(var32 + (float) var34 + 1.0F - cdz,
                            ...
                            if (var29 > -1) {
                                ...
                                for (var34 = 0; var34 < cdx; ++var34) {
                                    var3.addVertexWithUV(var32 + 0.0F, var12 + var5,
                                            var33 + (float) var34 + 0.0F,
                                            (var30 + 0.0F) * var21 + var19,
                                            (var31 + (float) var34 + 0.5F) * var21 + exactPlayerZ);
                                    var3.addVertexWithUV(var32 + (float) cdx, var12 + var5,
                                            var33 + (float) var34 + 0.0F,
                                            (var30 + (float) cdx) * var21 + var19,
                                            (var31 + (float) var34 + 0.5F) * var21 + exactPlayerZ);
                                    var3.addVertexWithUV(var32 + (float) cdx, var12 + 0.0F,
    ...
    public void drawBlockDamageTexture(Tessellator par1Tessellator, EntityLivingBase par2EntityPlayer, float par3) {
        double var4 = par2EntityPlayer.lastTickPosX
                + (par2EntityPlayer.posX - par2EntityPlayer.lastTickPosX) * (double) par3;
        double var6 = par2EntityPlayer.lastTickPosY
                + (par2EntityPlayer.posY - par2EntityPlayer.lastTickPosY) * (double) par3;
        double var8 = par2EntityPlayer.lastTickPosZ
                + (par2EntityPlayer.posZ - par2EntityPlayer.lastTickPosZ) * (double) par3;
        ...
        if (!this.damagedBlocks.isEmpty()) {
            ...
            while (var10.hasNext()) {
                ...
                if (var12 * var12 + var14 * var14 + var16 * var16 > 1024.0D) {
                    ...
                    Block var18 = this.theWorld.getBlock(var11.getPartialBlockX(), var11.getPartialBlockY(),
                            var11.getPartialBlockZ());

                    if (var18.getMaterial() != Material.air) {
                        this.renderBlocksRg.renderBlockUsingTexture(var18, var11.getPartialBlockX(),
                                var11.getPartialBlockY(), var11.getPartialBlockZ(),
                                this.destroyBlockIcons[var11.getPartialBlockDamage()]);
                    }
                }
            }
    ...
    public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3,
        ...
        if (par3 == 0 && par2MovingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            GL11.glDepthMask(false);
            float var5 = 0.002F;
            Block var6 = this.theWorld.getBlock(par2MovingObjectPosition.blockX, par2MovingObjectPosition.blockY,
                    par2MovingObjectPosition.blockZ);

            if (var6.getMaterial() != Material.air) {
                var6.setBlockBoundsBasedOnState(this.theWorld, par2MovingObjectPosition.blockX,
     ...
     * client (which will re-render it),
    ...
    public void markBlockForUpdate(int p_147586_1_, int p_147586_2_, int p_147586_3_) {
        this.markBlocksForUpdate(p_147586_1_ - 1, p_147586_2_ - 1, p_147586_3_ - 1, p_147586_1_ + 1, p_147586_2_ + 1,
                p_147586_3_ + 1);
    }
    ...
    public void markBlockForRenderUpdate(int p_147588_1_, int p_147588_2_, int p_147588_3_) {
        this.markBlocksForUpdate(p_147588_1_ - 1, p_147588_2_ - 1, p_147588_3_ - 1, p_147588_1_ + 1, p_147588_2_ + 1,
                p_147588_3_ + 1);
    }

    /**
     * On the client, re-renders all blocks in this range, inclusive. On the server,
     * does nothing. Args: min x, min y,
     ...
     * those that previously were in the
            ...
            if (var21 != null) {
                ...
                if (var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
                    ...
                    if (par1Str.equals("bubble")) {
                        ...
                        var21 = new EntityCritFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                        ((EntityFX) var21).setRBGColorF(((EntityFX) var21).getRedColorF() * 0.3F,
                        ...
                        if (mc.getConfig().isPotionParticles()) {
                            ...
                            ((EntityFX) var21).setRBGColorF(var26, 0.0F * var26, var26);
                        }
                        ...
                        if (par1Str.startsWith("iconcrack_")) {
                            ...
                            if (var27.length > 2) {
                                ...
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12,
                            ...
                            if (par1Str.startsWith("blockcrack_")) {
                                ...
                                var261 = Integer.parseInt(var27[2]);
                                var21 = (new EntityDiggingFX(this.theWorld, par2, par4, par6, par8, par10, par12,
                                        var281, var261)).applyRenderColor(var261);
                            } else if (par1Str.startsWith("blockdust_")) {
                                var27 = par1Str.split("_", 3);
                                var281 = Block.getBlockById(Integer.parseInt(var27[1]));
                                var261 = Integer.parseInt(var27[2]);
                                var21 = (new EntityBlockDustFX(this.theWorld, par2, par4, par6, par8, par10, par12,
                                        var281, var261)).applyRenderColor(var261);
                            }
                        }
                    }
     ...
     * client worlds, releases any downloaded
    ...
    public void playAuxSFX(EntityPlayer par1EntityPlayer, int par2, int par3, int par4, int par5, int par6) {
        ...
        switch (par2) {
            ...
            case 1003:
                if (Math.random() < 0.5D) {
                    this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                            "random.door_open", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                } else {
                    this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                            "random.door_close", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                }

                break;

            case 1004:
                this.theWorld.playSound((float) par3 + 0.5F, (float) par4 + 0.5F,
                        (float) par5 + 0.5F, "random.fizz", 0.5F,
            ...
            case 1007:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.ghast.charge", 10.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1008:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.ghast.fireball", 10.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1009:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.ghast.fireball", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1010:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.zombie.wood", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1011:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.zombie.metal", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1012:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.zombie.woodbreak", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1014:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.wither.shoot", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1015:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.bat.takeoff", 0.05F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1016:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.zombie.infect", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1017:
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "mob.zombie.unfect", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1020:
                this.theWorld.playSound((float) par3 + 0.5F, (float) par4 + 0.5F,
                        (float) par5 + 0.5F, "random.anvil_break", 1.0F,
                        this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1021:
                this.theWorld.playSound((float) par3 + 0.5F, (float) par4 + 0.5F,
                        (float) par5 + 0.5F, "random.anvil_use", 1.0F,
                        this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1022:
                this.theWorld.playSound((float) par3 + 0.5F, (float) par4 + 0.5F,
                        (float) par5 + 0.5F, "random.anvil_land", 0.3F,
                        this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 2002:
                ...
                for (var16 = 0; var16 < 8; ++var16) {
                    this.spawnParticle(var15, var9, var11, var13, var7.nextGaussian() * 0.15D, var7.nextDouble() * 0.2D,
                ...
                for (var40 = 0; var40 < 100; ++var40) {
                    ...
                    EntityFX var46 = this.doSpawnParticle(var20, var9 + var26 * 0.1D, var11 + 0.3D,
                            var13 + var30 * 0.1D, var26, var28, var30);
                ...
                this.theWorld.playSound((double) par3 + 0.5D, (double) par4 + 0.5D, (double) par5 + 0.5D,
                        "game.potion.smash", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 2003:
                ...
                for (var21 = 0.0D; var21 < (Math.PI * 2D); var21 += 0.15707963267948966D) {
                    this.spawnParticle("portal", var9 + Math.cos(var21) * 5.0D, var11 - 0.4D,
                            var13 + Math.sin(var21) * 5.0D, Math.cos(var21) * -5.0D, 0.0D, Math.sin(var21) * -5.0D);
                    this.spawnParticle("portal", var9 + Math.cos(var21) * 5.0D, var11 - 0.4D,
                            var13 + Math.sin(var21) * 5.0D, Math.cos(var21) * -7.0D, 0.0D, Math.sin(var21) * -7.0D);
                }
                ...
                if (var8.getMaterial() != Material.air) {
                    ...
                    for (int var24 = 0; var24 < var23; ++var24) {
                        ...
                        this.theWorld.spawnParticle(
                                "blockdust_" + Block.getIdFromBlock(var8) + "_"
                                        + this.theWorld.getBlockMetadata(par3, par4, par5),
                                (float) par3 + 0.5F, (float) par4 + 1.0F,
                                (float) par5 + 0.5F, var30, var28, var32);
                    }
                }
        }
    }
     ...
     * coordinates for the given partially destroyed
     * value
     */
    public void destroyBlockPartially(int p_147587_1_, int p_147587_2_, int p_147587_3_, int p_147587_4_,
        ...
        if (p_147587_5_ >= 0 && p_147587_5_ < 10) {
            ...
            if (var6 == null || var6.getPartialBlockX() != p_147587_2_ || var6.getPartialBlockY() != p_147587_3_
    ...
    private boolean isMovingNow(EntityLivingBase entityliving) {
        ...
        return entityliving.isSneaking() || ((double) entityliving.prevSwingProgress > maxDiff || (this.mc.mouseHelper.deltaX != 0 || (this.mc.mouseHelper.deltaY != 0 || (Math.abs(entityliving.posX - entityliving.prevPosX) > maxDiff || (Math.abs(entityliving.posY - entityliving.prevPosY) > maxDiff || Math.abs(entityliving.posZ
    ...
    public boolean isActingNow() {
        return this.mc.getMouse().isButtonDown(0) || this.mc.getMouse().isButtonDown(1);
    }
    ...
    public AxisAlignedBB getTileEntityBoundingBox(TileEntity te) {
        if (!te.hasWorldObj()) {
            ...
            if (blockType == Blocks.enchanting_table) {
                return AxisAlignedBB.getBoundingBox(te.field_145851_c, te.field_145848_d,
                        te.field_145849_e, te.field_145851_c + 1, te.field_145848_d + 1,
                        te.field_145849_e + 1);
                ...
                if (Reflector.ForgeTileEntity_getRenderBoundingBox.exists()) {
                    blockAabb = (AxisAlignedBB) Reflector.call(te, Reflector.ForgeTileEntity_getRenderBoundingBox,
                            new Object[0]);
                ...
                if (blockType != null && blockType != Blocks.beacon) {
                    blockAabb = blockType.getCollisionBoundingBoxFromPool(te.getWorldObj(), te.field_145851_c,
                ...
                return AxisAlignedBB.getBoundingBox(te.field_145851_c - 1, te.field_145848_d,
                        te.field_145849_e - 1, te.field_145851_c + 2,
                        te.field_145848_d + 2, te.field_145849_e + 2);
            }
        }
    }
