...
public class RenderItem extends Render {
    ...
    public RenderItem(Minecraft mc) {
        super(mc);
        this.field_147913_i = new RenderBlocks(mc);
    ...
    public void doRender(EntityItem p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        if (var10.getItem() != null) {
            ...
            GL11.glPushMatrix();
            float var11 = MathHelper.sin(((float) p_76986_1_.age + p_76986_9_) / 10.0F + p_76986_1_.hoverStart) * 0.1F
                    + 0.1F;
            float var12 = (((float) p_76986_1_.age + p_76986_9_) / 20.0F + p_76986_1_.hoverStart)
                    * (180F / (float) Math.PI);
            byte var13 = 1;
            ...
            if (var10.getItemSpriteNumber() == 0 && var10.getItem() instanceof ItemBlock
                    && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var10.getItem()).getRenderType())) {
    ...
    private void renderDroppedItem(EntityItem p_77020_1_, IIcon p_77020_2_, int p_77020_3_, float p_77020_4_,
        ...
        if (this.renderManager.options.fancyGraphics) {
            ...
            if (renderInFrame) {
                ...
                GL11.glRotatef((((float) p_77020_1_.age + p_77020_4_) / 20.0F + p_77020_1_.hoverStart)
    ...
    public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_,
        ...
        if (p_77015_3_.getItemSpriteNumber() == 0
                && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(p_77015_3_.getItem()).getRenderType())) {
    ...
    public void renderItemAndEffectIntoGUI(FontRenderer p_82406_1_, TextureManager p_82406_2_,
        ...
        if (p_82406_3_ != null) {
            ...
            if (p_82406_3_.hasEffect()) {
                ...
                this.renderGlint(p_82406_4_ * 431278612 + p_82406_5_ * 32178161, p_82406_4_ - 2, p_82406_5_ - 2, 20,
                        20);
                OpenGlHelper.glBlendFunc(770, 771, 1, 0);
    ...
    private void renderGlint(int p_77018_1_, int p_77018_2_, int p_77018_3_, int p_77018_4_, int p_77018_5_) {
        for (int var6 = 0; var6 < 2; ++var6) {
            ...
            float var9 = (float) (Minecraft.getSystemTime() % (long) (3000 + var6 * 1873))
                    / (3000.0F + (float) (var6 * 1873)) * 256.0F;
            float var10 = 0.0F;
            ...
            var11.addVertexWithUV((double) (p_77018_2_ + 0), (double) (p_77018_3_ + p_77018_5_), (double) this.zLevel,
                    ...
                    (double) ((var10 + (float) p_77018_5_) * var8));
            var11.addVertexWithUV((double) (p_77018_2_ + p_77018_4_), (double) (p_77018_3_ + p_77018_5_),
                    (double) this.zLevel, (double) ((var9 + (float) p_77018_4_ + (float) p_77018_5_ * var12) * var7),
                    (double) ((var10 + (float) p_77018_5_) * var8));
            var11.addVertexWithUV((double) (p_77018_2_ + p_77018_4_), (double) (p_77018_3_ + 0), (double) this.zLevel,
                    (double) ((var9 + (float) p_77018_4_) * var7), (double) ((var10 + 0.0F) * var8));
            var11.addVertexWithUV((double) (p_77018_2_ + 0), (double) (p_77018_3_ + 0), (double) this.zLevel,
                    (double) ((var9 + 0.0F) * var7), (double) ((var10 + 0.0F) * var8));
            var11.draw();
        }
    }
     ...
     * on top of the item's image at the
     * specified position.
     */
    ...
    public void renderItemOverlayIntoGUI(FontRenderer p_94148_1_, TextureManager p_94148_2_, ItemStack p_94148_3_,
        ...
        if (p_94148_3_ != null) {
            if (p_94148_3_.stackSize > 1 || p_94148_6_ != null) {
                ...
                GL11.glDisable(GL11.GL_BLEND);
                p_94148_1_.drawStringWithShadow(var7, p_94148_4_ + 19 - 2 - p_94148_1_.getStringWidth(var7),
                        p_94148_5_ + 6 + 3, 16777215);
                GL11.glEnable(GL11.GL_LIGHTING);
                GL11.glEnable(GL11.GL_DEPTH_TEST);
            }

            if (p_94148_3_.isItemDamaged()) {
                int var12 = (int) Math.round(13.0D
                        - (double) p_94148_3_.getItemDamageForDisplay() * 13.0D / (double) p_94148_3_.getMaxDamage());
                int var8 = (int) Math.round(255.0D
                        - (double) p_94148_3_.getItemDamageForDisplay() * 255.0D / (double) p_94148_3_.getMaxDamage());
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                GL11.glDisable(GL11.GL_ALPHA_TEST);
    ...
    public void renderIcon(int p_94149_1_, int p_94149_2_, IIcon p_94149_3_, int p_94149_4_, int p_94149_5_) {
        ...
        var6.addVertexWithUV((double) (p_94149_1_ + p_94149_4_), (double) (p_94149_2_ + p_94149_5_),
                (double) this.zLevel, (double) p_94149_3_.getMaxU(), (double) p_94149_3_.getMaxV());
        var6.addVertexWithUV((double) (p_94149_1_ + p_94149_4_), (double) (p_94149_2_ + 0), (double) this.zLevel,
                (double) p_94149_3_.getMaxU(), (double) p_94149_3_.getMinV());
        var6.addVertexWithUV((double) (p_94149_1_ + 0), (double) (p_94149_2_ + 0), (double) this.zLevel,
                (double) p_94149_3_.getMinU(), (double) p_94149_3_.getMinV());
        var6.draw();
    }
