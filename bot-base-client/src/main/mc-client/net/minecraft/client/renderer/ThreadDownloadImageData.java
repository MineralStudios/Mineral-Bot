...
public class ThreadDownloadImageData extends SimpleTexture {
    ...
    private void func_147640_e() {
        if (!this.textureUploaded && this.bufferedImage != null) {
            ...
            TextureUtil.uploadTextureImage(this.mc, super.getGlTextureId(), this.bufferedImage);
    ...
    protected void func_152433_a() {
        ThreadManager.INSTANCE.getAsyncExecutor().execute(() -> {
            ...
            if (ThreadDownloadImageData.this.shouldPipeline()) {
                ...
                try {
                    var1 = (HttpURLConnection) (new URL(ThreadDownloadImageData.this.imageUrl))
                            .openConnection(ThreadDownloadImageData.this.mc.getProxy());
                    ...
                    if (var1.getResponseCode() / 100 == 2) {
                        ...
                        if (ThreadDownloadImageData.this.field_152434_e != null) {
                            FileUtils.copyInputStreamToFile(var1.getInputStream(),
                                    ThreadDownloadImageData.this.field_152434_e);
                    ...
                    ThreadDownloadImageData.this.imageFound = Boolean
                            .valueOf(ThreadDownloadImageData.this.bufferedImage != null);
                }
            }
        });
    }
    ...
    private void loadPipelined() {
        try {
            HttpRequest var6 = HttpPipeline.makeRequest(this.imageUrl, this.mc.getProxy());
