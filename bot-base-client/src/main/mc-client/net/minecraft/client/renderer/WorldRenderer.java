...
public class WorldRenderer {
    ...
    public void setPosition(int par1, int par2, int par3) {
        if (par1 != this.posX || par2 != this.posY || par3 != this.posZ) {
            ...
            this.rendererBoundingBox = AxisAlignedBB.getBoundingBox((double) par1, (double) par2, (double) par3,
                    (double) (par1 + 16), (double) (par2 + 16), (double) (par3 + 16));
    ...
    public void updateRenderer(EntityLivingBase p_147892_1_) {
        if (this.worldObj != null) {
            if (this.needsBoxUpdate) {
                ...
                RenderItem.renderAABB(this.mc,
                        AxisAlignedBB.getBoundingBox((double) this.posXClip, (double) this.posYClip,
                                (double) this.posZClip, (double) (this.posXClip + 16), (double) (this.posYClip + 16),
            ...
            if (this.needsUpdate) {
                ...
                byte var14 = 1;
                ChunkCache chunkcache = new ChunkCache(this.worldObj, xMin - var14, yMin - var14, zMain - var14,
                        xMax + var14, yMax + var14, zMax + var14, var14);
     ...
     * the final normalizing square root,
