...
public class TileEntityRendererDispatcher {
    ...
    public TileEntityRendererDispatcher(Minecraft mc) {
        ...
        this.mapSpecialRenderers.put(TileEntityPiston.class, new TileEntityRendererPiston(mc));
        ...
        this.mapSpecialRenderers.put(TileEntityEnchantmentTable.class, new RenderEnchantmentTable(mc));
        this.mapSpecialRenderers.put(TileEntityEndPortal.class, new RenderEndPortal(mc));
    ...
    public void func_147542_a(World p_147542_1_, TextureManager p_147542_2_, FontRenderer p_147542_3_,
        ...
        this.field_147562_h = p_147542_4_.prevRotationYaw
                + (p_147542_4_.rotationYaw - p_147542_4_.prevRotationYaw) * p_147542_5_;
        this.field_147563_i = p_147542_4_.prevRotationPitch
                + (p_147542_4_.rotationPitch - p_147542_4_.prevRotationPitch) * p_147542_5_;
        this.field_147560_j = p_147542_4_.lastTickPosX
                + (p_147542_4_.posX - p_147542_4_.lastTickPosX) * (double) p_147542_5_;
        this.field_147561_k = p_147542_4_.lastTickPosY
                + (p_147542_4_.posY - p_147542_4_.lastTickPosY) * (double) p_147542_5_;
        this.field_147558_l = p_147542_4_.lastTickPosZ
                + (p_147542_4_.posZ - p_147542_4_.lastTickPosZ) * (double) p_147542_5_;
    }

    public void func_147544_a(TileEntity p_147544_1_, float p_147544_2_) {
        if (p_147544_1_.getDistanceFrom(this.field_147560_j, this.field_147561_k, this.field_147558_l) < p_147544_1_
                .getMaxRenderDistanceSquared()) {
            int var3 = this.field_147550_f.getLightBrightnessForSkyBlocks(p_147544_1_.field_145851_c,
                    p_147544_1_.field_145848_d, p_147544_1_.field_145849_e, 0);
            int var4 = var3 % 65536;
            int var5 = var3 / 65536;
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float) var4 / 1.0F,
                    (float) var5 / 1.0F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            this.func_147549_a(p_147544_1_, (double) p_147544_1_.field_145851_c - staticPlayerX,
                    (double) p_147544_1_.field_145848_d - staticPlayerY,
                    (double) p_147544_1_.field_145849_e - staticPlayerZ, p_147544_2_);
        }
    }
