...
public class RenderMinecart extends Render {
    ...
    public RenderMinecart(Minecraft mc) {
        super(mc);
        this.shadowSize = 0.5F;
        this.modelMinecart = new ModelMinecart(mc);
        this.field_94145_f = new RenderBlocks(mc);
    }
     ...
     */
    public void doRender(EntityMinecart p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        float var24 = p_76986_1_.prevRotationPitch
        ...
        if (var31 > 0.0F) {
            GL11.glRotatef(MathHelper.sin(var31) * var31 * var32 / 10.0F * (float) p_76986_1_.getRollingDirection(),
                    1.0F, 0.0F, 0.0F);
        }
