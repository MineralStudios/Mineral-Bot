...
public class RenderBoat extends Render {
    ...
    public RenderBoat(Minecraft mc) {
        super(mc);
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelBoat(mc);
    }
     ...
     */
    public void doRender(EntityBoat p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        if (var10 > 0.0F) {
            GL11.glRotatef(MathHelper.sin(var10) * var10 * var11 / 10.0F * (float) p_76986_1_.getForwardDirection(),
                    1.0F, 0.0F, 0.0F);
        }
