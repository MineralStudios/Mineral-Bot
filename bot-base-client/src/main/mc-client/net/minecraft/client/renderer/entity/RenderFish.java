...
public class RenderFish extends Render {
        ...
        public void doRender(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_,
                ...
                var10.addVertexWithUV((double) (0.0F - var18), (double) (0.0F - var19), 0.0D, (double) var13,
                                (double) var16);
                var10.addVertexWithUV((double) (var17 - var18), (double) (0.0F - var19), 0.0D, (double) var14,
                                (double) var16);
                var10.addVertexWithUV((double) (var17 - var18), (double) (1.0F - var19), 0.0D, (double) var14,
                                (double) var15);
                var10.addVertexWithUV((double) (0.0F - var18), (double) (1.0F - var19), 0.0D, (double) var13,
                                (double) var15);
                var10.draw();
                ...
                if (p_76986_1_.field_146042_b != null) {
                        ...
                        double var46 = p_76986_1_.prevPosX
                                        + (p_76986_1_.posX - p_76986_1_.prevPosX) * (double) p_76986_9_;
                        double var33 = p_76986_1_.prevPosY
                                        + (p_76986_1_.posY - p_76986_1_.prevPosY) * (double) p_76986_9_ + 0.25D;
                        double var35 = p_76986_1_.prevPosZ
                                        + (p_76986_1_.posZ - p_76986_1_.prevPosZ) * (double) p_76986_9_;
                        ...
                        for (int var44 = 0; var44 <= var43; ++var44) {
                                ...
                                var10.addVertex(p_76986_2_ + var37 * (double) var45,
                                                p_76986_4_ + var39 * (double) (var45 * var45 + var45) * 0.5D + 0.25D,
                                                p_76986_6_ + var41 * (double) var45);
                        }
