...
public class RenderBlocks {
    ...
    public RenderBlocks(Minecraft mc, IBlockAccess par1IBlockAccess) {
        this(mc);
    ...
    public boolean renderBlockBed(Block p_147773_1_, int p_147773_2_, int p_147773_3_, int p_147773_4_) {
        ...
        double var27 = var26 != null ? (double) var26.getMinU() : 0;
        double var29 = var26 != null ? (double) var26.getMaxU() : 0;
        double var31 = var26 != null ? (double) var26.getMinV() : 0;
        double var33 = var26 != null ? (double) var26.getMaxV() : 0;
        ...
        if (var5 != null) {
            ...
            var5.setBrightness(
                    p_147773_1_.getBlockBrightness(this.blockAccess, p_147773_2_, p_147773_3_ + 1, p_147773_4_));
        ...
        var27 = var26 != null ? (double) var26.getMinU() : 0;
        var29 = var26 != null ? (double) var26.getMaxU() : 0;
        var31 = var26 != null ? (double) var26.getMinV() : 0;
        var33 = var26 != null ? (double) var26.getMaxV() : 0;
        var35 = var27;
        var37 = var29;
        var39 = var31;
        var41 = var31;
        ...
        if (var61 != 2 && (this.renderAllFaces
                || p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_ - 1, 2))) {
            if (var5 != null) {
                var5.setBrightness(this.renderMinZ > 0.0D ? var25
                        : p_147773_1_.getBlockBrightness(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_ - 1));
                var5.setColorOpaque_F(var11, var11, var11);
            }
            this.flipTexture = var62 == 2;
            this.renderFaceZNeg(p_147773_1_, (double) p_147773_2_, (double) p_147773_3_, (double) p_147773_4_,
                    this.getBlockIcon(p_147773_1_, this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_, 2));
        }

        if (var61 != 3 && (this.renderAllFaces
                || p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_ + 1, 3))) {
            if (var5 != null) {
                var5.setBrightness(this.renderMaxZ < 1.0D ? var25
                        : p_147773_1_.getBlockBrightness(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_ + 1));
                var5.setColorOpaque_F(var11, var11, var11);
            }
            this.flipTexture = var62 == 3;
            this.renderFaceZPos(p_147773_1_, (double) p_147773_2_, (double) p_147773_3_, (double) p_147773_4_,
                    this.getBlockIcon(p_147773_1_, this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_, 3));
        }

        if (var61 != 4 && (this.renderAllFaces
                || p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_ - 1, p_147773_3_, p_147773_4_, 4))) {
            if (var5 != null) {
                var5.setBrightness(this.renderMinZ > 0.0D ? var25
                        : p_147773_1_.getBlockBrightness(this.blockAccess, p_147773_2_ - 1, p_147773_3_, p_147773_4_));
                var5.setColorOpaque_F(var12, var12, var12);
            }
            this.flipTexture = var62 == 4;
            this.renderFaceXNeg(p_147773_1_, (double) p_147773_2_, (double) p_147773_3_, (double) p_147773_4_,
                    this.getBlockIcon(p_147773_1_, this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_, 4));
        }

        if (var61 != 5 && (this.renderAllFaces
                || p_147773_1_.shouldSideBeRendered(this.blockAccess, p_147773_2_ + 1, p_147773_3_, p_147773_4_, 5))) {
            if (var5 != null) {
                var5.setBrightness(this.renderMaxZ < 1.0D ? var25
                        : p_147773_1_.getBlockBrightness(this.blockAccess, p_147773_2_ + 1, p_147773_3_, p_147773_4_));
                var5.setColorOpaque_F(var12, var12, var12);
            ...
            this.renderFaceXPos(p_147773_1_, (double) p_147773_2_, (double) p_147773_3_, (double) p_147773_4_,
                    this.getBlockIcon(p_147773_1_, this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_, 5));
        }
    ...
    public boolean renderBlockBrewingStand(BlockBrewingStand p_147741_1_, int p_147741_2_, int p_147741_3_,
        ...
        if (EntityRenderer.anaglyphEnable) {
            float var31 = (var7 * 30.0F + var8 * 59.0F + var9 * 11.0F) / 100.0F;
            float var32 = (var7 * 30.0F + var8 * 70.0F) / 100.0F;
        ...
        IIcon var311 = this.getBlockIconFromSideAndMetadata(p_147741_1_, 0, 0);
        ...
        double var321 = var311 != null ? (double) var311.getMinV() : 0;
        double var13 = var311 != null ? (double) var311.getMaxV() : 0;
        ...
        for (int var16 = 0; var16 < 3; ++var16) {
            ...
            double var19 = var311 != null ? (double) var311.getInterpolatedU(8.0D) : 0;
            double var21 = var311 != null ? (double) var311.getMaxU() : 0;

            if ((var15 & 1 << var16) != 0)
                var21 = var311 != null ? (double) var311.getMinU() : 0;
            ...
            if (var5 != null) {
                var5.addVertexWithUV(var23, (double) (p_147741_3_ + 1), var27, var19, var321);
                ...
                var5.addVertexWithUV(var25, (double) (p_147741_3_ + 1), var29, var21, var321);
                var5.addVertexWithUV(var25, (double) (p_147741_3_ + 1), var29, var21, var321);
                var5.addVertexWithUV(var25, (double) (p_147741_3_ + 0), var29, var21, var13);
                var5.addVertexWithUV(var23, (double) (p_147741_3_ + 0), var27, var19, var13);
                var5.addVertexWithUV(var23, (double) (p_147741_3_ + 1), var27, var19, var321);
    ...
    public boolean renderBlockCauldron(BlockCauldron p_147785_1_, int p_147785_2_, int p_147785_3_, int p_147785_4_) {
        ...
        var11 = 0.125F;
        this.renderFaceXPos(p_147785_1_, (double) ((float) p_147785_2_ - 1.0F + var11), (double) p_147785_3_,
                (double) p_147785_4_, var151);
        this.renderFaceXNeg(p_147785_1_, (double) ((float) p_147785_2_ + 1.0F - var11), (double) p_147785_3_,
                (double) p_147785_4_, var151);
        this.renderFaceZPos(p_147785_1_, (double) p_147785_2_, (double) p_147785_3_,
                (double) ((float) p_147785_4_ - 1.0F + var11), var151);
        this.renderFaceZNeg(p_147785_1_, (double) p_147785_2_, (double) p_147785_3_,
                (double) ((float) p_147785_4_ + 1.0F - var11), var151);
        IIcon var161 = BlockCauldron.func_150026_e("inner");
        this.renderFaceYPos(p_147785_1_, (double) p_147785_2_, (double) ((float) p_147785_3_ - 1.0F + 0.25F),
                (double) p_147785_4_, var161);
        this.renderFaceYNeg(p_147785_1_, (double) p_147785_2_, (double) ((float) p_147785_3_ + 1.0F - 0.75F),
                (double) p_147785_4_, var161);
        ...
        if (var13 > 0) {
            ...
            this.renderFaceYPos(p_147785_1_, (double) p_147785_2_,
                    (double) ((float) p_147785_3_ - 1.0F + BlockCauldron.func_150025_c(var13)), (double) p_147785_4_,
                    var14);
        }
    ...
    public boolean renderBlockFlowerpot(BlockFlowerPot p_147752_1_, int p_147752_2_, int p_147752_3_, int p_147752_4_) {
        ...
        var11 = 0.1865F;
        this.renderFaceXPos(p_147752_1_, (double) ((float) p_147752_2_ - 0.5F + var11), (double) p_147752_3_,
                (double) p_147752_4_, var7);
        this.renderFaceXNeg(p_147752_1_, (double) ((float) p_147752_2_ + 0.5F - var11), (double) p_147752_3_,
                (double) p_147752_4_, var7);
        this.renderFaceZPos(p_147752_1_, (double) p_147752_2_, (double) p_147752_3_,
        ...
        if (var211 != null && var211 instanceof TileEntityFlowerPot) {
            ...
            if (var221 instanceof ItemBlock) {
                ...
                if (var16 == 1) {
                    this.drawCrossedSquares(this.getBlockIconFromSideAndMetadata(var15, 0, var14), (double) p_147752_2_,
                            (double) p_147752_3_, (double) p_147752_4_, 0.75F);
                } else if (var16 == 13) {
                    this.renderAllFaces = true;
                    float var20 = 0.125F;
                    this.setRenderBounds((double) (0.5F - var20), 0.0D, (double) (0.5F - var20),
                            (double) (0.5F + var20), 0.25D, (double) (0.5F + var20));
                    this.renderStandardBlock(var15, p_147752_2_, p_147752_3_, p_147752_4_);
                    this.setRenderBounds((double) (0.5F - var20), 0.25D, (double) (0.5F - var20),
                            (double) (0.5F + var20), 0.5D, (double) (0.5F + var20));
                    this.renderStandardBlock(var15, p_147752_2_, p_147752_3_, p_147752_4_);
                    this.setRenderBounds((double) (0.5F - var20), 0.5D, (double) (0.5F - var20),
                            (double) (0.5F + var20), 0.75D, (double) (0.5F + var20));
                    this.renderStandardBlock(var15, p_147752_2_, p_147752_3_, p_147752_4_);
                    this.renderAllFaces = false;
    ...
    public boolean renderBlockAnvil(BlockAnvil p_147725_1_, int p_147725_2_, int p_147725_3_, int p_147725_4_) {
        return this.renderBlockAnvilMetadata(p_147725_1_, p_147725_2_, p_147725_3_, p_147725_4_,
                this.blockAccess.getBlockMetadata(p_147725_2_, p_147725_3_, p_147725_4_));
    }
    ...
    public boolean renderBlockAnvilOrient(BlockAnvil p_147728_1_, int p_147728_2_, int p_147728_3_, int p_147728_4_,
        ...
        var9 = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 0, var9, 0.75F, 0.25F,
                0.75F, var8, p_147728_6_, p_147728_5_);
        var9 = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 1, var9, 0.5F, 0.0625F,
                0.625F, var8, p_147728_6_, p_147728_5_);
        var9 = this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 2, var9, 0.25F, 0.3125F,
                0.5F, var8, p_147728_6_, p_147728_5_);
        this.renderBlockAnvilRotate(p_147728_1_, p_147728_2_, p_147728_3_, p_147728_4_, 3, var9, 0.625F, 0.375F, 1.0F,
                var8, p_147728_6_, p_147728_5_);
        this.setRenderBounds(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D);
        this.uvRotateEast = 0;
        this.uvRotateWest = 0;
    ...
    public float renderBlockAnvilRotate(BlockAnvil p_147737_1_, int p_147737_2_, int p_147737_3_, int p_147737_4_,
        ...
        this.setRenderBounds((double) (0.5F - p_147737_7_), (double) p_147737_6_, (double) (0.5F - p_147737_9_),
                (double) (0.5F + p_147737_7_), (double) (p_147737_6_ + p_147737_8_), (double) (0.5F + p_147737_9_));

        if (p_147737_11_) {
            Tessellator var141 = this.mc.getTessellator();
            if (var141 != null) {
                var141.startDrawingQuads();
                var141.setNormal(0.0F, -1.0F, 0.0F);
                this.renderFaceYNeg(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 0, p_147737_12_));
                var141.draw();
                var141.startDrawingQuads();
                var141.setNormal(0.0F, 1.0F, 0.0F);
                this.renderFaceYPos(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 1, p_147737_12_));
                var141.draw();
                var141.startDrawingQuads();
                var141.setNormal(0.0F, 0.0F, -1.0F);
                this.renderFaceZNeg(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 2, p_147737_12_));
                var141.draw();
                var141.startDrawingQuads();
                var141.setNormal(0.0F, 0.0F, 1.0F);
                this.renderFaceZPos(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 3, p_147737_12_));
                var141.draw();
                var141.startDrawingQuads();
                var141.setNormal(-1.0F, 0.0F, 0.0F);
                this.renderFaceXNeg(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 4, p_147737_12_));
                var141.draw();
                var141.startDrawingQuads();
                var141.setNormal(1.0F, 0.0F, 0.0F);
                this.renderFaceXPos(p_147737_1_, 0.0D, 0.0D, 0.0D,
                        this.getBlockIconFromSideAndMetadata(p_147737_1_, 5, p_147737_12_));
                var141.draw();
            }
        } else {
    ...
    public boolean renderBlockTorch(Block p_147791_1_, int p_147791_2_, int p_147791_3_, int p_147791_4_) {
        ...
        if (var5 == 1) {
            this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_ - var9, (double) p_147791_3_ + var11,
                    (double) p_147791_4_, -var7, 0.0D, 0);
        } else if (var5 == 2) {
            this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_ + var9, (double) p_147791_3_ + var11,
                    (double) p_147791_4_, var7, 0.0D, 0);
        } else if (var5 == 3) {
            this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_, (double) p_147791_3_ + var11,
                    (double) p_147791_4_ - var9, 0.0D, -var7, 0);
        } else if (var5 == 4) {
            this.renderTorchAtAngle(p_147791_1_, (double) p_147791_2_, (double) p_147791_3_ + var11,
                    (double) p_147791_4_ + var9, 0.0D, var7, 0);
        } else {
    ...
    public boolean renderBlockRepeater(BlockRedstoneRepeater p_147759_1_, int p_147759_2_, int p_147759_3_,
        ...
        if (!var11) {
            this.renderTorchAtAngle(p_147759_1_, (double) p_147759_2_ + var12, (double) p_147759_3_ + var9,
                    (double) p_147759_4_ + var14, 0.0D, 0.0D, 0);
        } else {
            ...
            switch (var6) {
                ...
                case 2:
                default:
                    this.setRenderBounds((double) (var21 / 16.0F + (float) var12), 0.125D,
                            (double) (var23 / 16.0F + (float) var14), (double) (var22 / 16.0F + (float) var12), 0.25D,
                            (double) (var24 / 16.0F + (float) var14));
                    double var25 = var20 != null ? (double) var20.getInterpolatedU((double) var21) : 0;
                    double var27 = var20 != null ? (double) var20.getInterpolatedV((double) var23) : 0;
                    double var29 = var20 != null ? (double) var20.getInterpolatedU((double) var22) : 0;
                    double var31 = var20 != null ? (double) var20.getInterpolatedV((double) var24) : 0;
                    if (var8 != null) {
                        var8.addVertexWithUV((double) ((float) p_147759_2_ + var21 / 16.0F) + var12,
                                (double) ((float) p_147759_3_ + 0.25F),
                                (double) ((float) p_147759_4_ + var23 / 16.0F) + var14, var25, var27);
                        var8.addVertexWithUV((double) ((float) p_147759_2_ + var21 / 16.0F) + var12,
                                (double) ((float) p_147759_3_ + 0.25F),
                                (double) ((float) p_147759_4_ + var24 / 16.0F) + var14, var25, var31);
                        var8.addVertexWithUV((double) ((float) p_147759_2_ + var22 / 16.0F) + var12,
                                (double) ((float) p_147759_3_ + 0.25F),
                                (double) ((float) p_147759_4_ + var24 / 16.0F) + var14, var29, var31);
                        var8.addVertexWithUV((double) ((float) p_147759_2_ + var22 / 16.0F) + var12,
                                (double) ((float) p_147759_3_ + 0.25F),
                                (double) ((float) p_147759_4_ + var23 / 16.0F) + var14, var29, var27);
                    }
        ...
        this.renderTorchAtAngle(p_147759_1_, (double) p_147759_2_ + var16, (double) p_147759_3_ + var9,
                (double) p_147759_4_ + var18, 0.0D, 0.0D, 0);
    ...
    public boolean renderBlockRedstoneComparator(BlockRedstoneComparator p_147781_1_, int p_147781_2_, int p_147781_3_,
        ...
        this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + 0.25D * var14 + 0.1875D * var16,
                (double) ((float) p_147781_3_ - 0.1875F), (double) p_147781_4_ + 0.25D * var16 + 0.1875D * var14, 0.0D,
                0.0D, var6);
        this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + 0.25D * var14 + -0.1875D * var16,
                (double) ((float) p_147781_3_ - 0.1875F), (double) p_147781_4_ + 0.25D * var16 + -0.1875D * var14, 0.0D,
                0.0D, var6);
        this.setOverrideBlockTexture(var18);
        this.renderTorchAtAngle(p_147781_1_, (double) p_147781_2_ + var8, (double) p_147781_3_ + var10,
                (double) p_147781_4_ + var12, 0.0D, 0.0D, var6);
        this.clearOverrideBlockTexture();
    ...
    public void renderBlockRedstoneDiodeMetadata(BlockRedstoneDiode p_147732_1_, int p_147732_2_, int p_147732_3_,
        ...
        double var9 = var8 != null ? (double) var8.getMinU() : 0;
        double var11 = var8 != null ? (double) var8.getMaxU() : 0;
        double var13 = var8 != null ? (double) var8.getMinV() : 0;
        double var15 = var8 != null ? (double) var8.getMaxV() : 0;
        double var17 = 0.125D;
    ...
    public boolean renderPistonBase(Block p_147731_1_, int p_147731_2_, int p_147731_3_, int p_147731_4_,
        ...
        if (var7) {
            ...
            ((BlockPistonBase) p_147731_1_).func_150070_b((float) this.renderMinX, (float) this.renderMinY,
                    (float) this.renderMinZ, (float) this.renderMaxX, (float) this.renderMaxY, (float) this.renderMaxZ);
    ...
    public boolean renderPistonExtension(Block p_147809_1_, int p_147809_2_, int p_147809_3_, int p_147809_4_,
        ...
        switch (var7) {
            case 0:
                ...
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + var11),
                        (double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.625F), 0.8F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + var11),
                        (double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.375F), 0.8F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + var11),
                        (double) ((float) p_147809_4_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F), 0.6F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.25F), (double) ((float) p_147809_3_ + 0.25F + var11),
                        (double) ((float) p_147809_4_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F), 0.6F, var12);
                break;
            ...
            case 1:
                ...
                this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F), (double) ((float) p_147809_4_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.625F), 0.8F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F), (double) ((float) p_147809_4_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.375F), 0.8F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F), (double) ((float) p_147809_4_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.625F), 0.6F, var12);
                this.renderPistonRodUD((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_3_ - 0.25F + 1.0F), (double) ((float) p_147809_4_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.375F), 0.6F, var12);
                break;
            ...
            case 2:
                ...
                this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + var11), 0.6F,
                        var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + var11), 0.6F,
                        var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + var11), 0.5F,
                        var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.25F), (double) ((float) p_147809_4_ + 0.25F + var11), 1.0F,
                        var12);
                break;
            ...
            case 3:
                ...
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F), 0.6F, var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F), 0.6F, var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.375F), (double) ((float) p_147809_2_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F), 0.5F, var12);
                this.renderPistonRodSN((double) ((float) p_147809_2_ + 0.625F), (double) ((float) p_147809_2_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_4_ - 0.25F + 1.0F), 1.0F, var12);
                break;
            ...
            case 4:
                ...
                this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
                this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F),
                        (double) ((float) p_147809_2_ + 0.25F + var11), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.375F), 0.5F, var12);
                this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F),
                        (double) ((float) p_147809_2_ + 0.25F + var11), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.625F), 1.0F, var12);
                this.renderPistonRodEW((double) ((float) p_147809_2_ + 0.25F),
                        (double) ((float) p_147809_2_ + 0.25F + var11), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.375F), 0.6F, var12);
            ...
            case 5:
                ...
                this.renderStandardBlock(p_147809_1_, p_147809_2_, p_147809_3_, p_147809_4_);
                this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_2_ - 0.25F + 1.0F), (double) ((float) p_147809_3_ + 0.375F),
                        (double) ((float) p_147809_3_ + 0.375F), (double) ((float) p_147809_4_ + 0.625F),
                        (double) ((float) p_147809_4_ + 0.375F), 0.5F, var12);
                this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_2_ - 0.25F + 1.0F), (double) ((float) p_147809_3_ + 0.625F),
                        (double) ((float) p_147809_3_ + 0.625F), (double) ((float) p_147809_4_ + 0.375F),
                        (double) ((float) p_147809_4_ + 0.625F), 1.0F, var12);
                this.renderPistonRodEW((double) ((float) p_147809_2_ - 0.25F + 1.0F - var11),
                        (double) ((float) p_147809_2_ - 0.25F + 1.0F), (double) ((float) p_147809_3_ + 0.375F),
    ...
    public boolean renderBlockLever(Block p_147790_1_, int p_147790_2_, int p_147790_3_, int p_147790_4_) {
        ...
        if (var6 == 5) {
            this.setRenderBounds((double) (0.5F - var11), 0.0D, (double) (0.5F - var10), (double) (0.5F + var11),
                    (double) var12, (double) (0.5F + var10));
        } else if (var6 == 6) {
            this.setRenderBounds((double) (0.5F - var10), 0.0D, (double) (0.5F - var11), (double) (0.5F + var10),
                    (double) var12, (double) (0.5F + var11));
        } else if (var6 == 4) {
            this.setRenderBounds((double) (0.5F - var11), (double) (0.5F - var10), (double) (1.0F - var12),
                    (double) (0.5F + var11), (double) (0.5F + var10), 1.0D);
        } else if (var6 == 3) {
            this.setRenderBounds((double) (0.5F - var11), (double) (0.5F - var10), 0.0D, (double) (0.5F + var11),
                    (double) (0.5F + var10), (double) var12);
        } else if (var6 == 2) {
            this.setRenderBounds((double) (1.0F - var12), (double) (0.5F - var10), (double) (0.5F - var11), 1.0D,
                    (double) (0.5F + var10), (double) (0.5F + var11));
        } else if (var6 == 1) {
            this.setRenderBounds(0.0D, (double) (0.5F - var10), (double) (0.5F - var11), (double) var12,
                    (double) (0.5F + var10), (double) (0.5F + var11));
        } else if (var6 == 0) {
            this.setRenderBounds((double) (0.5F - var10), (double) (1.0F - var12), (double) (0.5F - var11),
                    (double) (0.5F + var10), 1.0D, (double) (0.5F + var11));
        } else if (var6 == 7) {
            this.setRenderBounds((double) (0.5F - var11), (double) (1.0F - var12), (double) (0.5F - var10),
                    (double) (0.5F + var11), 1.0D, (double) (0.5F + var10));
        }
        ...
        double var14 = var13 != null ? (double) var13.getMinU() : 0;
        double var16 = var13 != null ? (double) var13.getMinV() : 0;
        double var18 = var13 != null ? (double) var13.getMaxU() : 0;
        double var20 = var13 != null ? (double) var13.getMaxV() : 0;
        ...
        for (int var30 = 0; var30 < 6; ++var30) {
            if (var30 == 0) {
                var14 = var13 != null ? (double) var13.getInterpolatedU(7.0D) : 0;
                var16 = var13 != null ? (double) var13.getInterpolatedV(6.0D) : 0;
                var18 = var13 != null ? (double) var13.getInterpolatedU(9.0D) : 0;
                var20 = var13 != null ? (double) var13.getInterpolatedV(8.0D) : 0;
            } else if (var30 == 2) {
                var14 = var13 != null ? (double) var13.getInterpolatedU(7.0D) : 0;
                var16 = var13 != null ? (double) var13.getInterpolatedV(6.0D) : 0;
                var18 = var13 != null ? (double) var13.getInterpolatedU(9.0D) : 0;
                var20 = var13 != null ? (double) var13.getMaxV() : 0;
            }
            ...
            if (var8 != null && var311 != null && var27 != null && var28 != null && var29 != null) {
    ...
    public boolean renderBlockTripWireSource(Block p_147723_1_, int p_147723_2_, int p_147723_3_, int p_147723_4_) {
        ...
        boolean var10 = !World.doesBlockHaveSolidTopSurface(this.blockAccess, p_147723_2_, p_147723_3_ - 1,
                p_147723_4_);
        ...
        if (var7 == 2) {
            this.setRenderBounds((double) (0.5F - var13), (double) var15, (double) (1.0F - var14),
                    (double) (0.5F + var13), (double) var16, 1.0D);
        } else if (var7 == 0) {
            this.setRenderBounds((double) (0.5F - var13), (double) var15, 0.0D, (double) (0.5F + var13), (double) var16,
                    (double) var14);
        } else if (var7 == 1) {
            this.setRenderBounds((double) (1.0F - var14), (double) var15, (double) (0.5F - var13), 1.0D, (double) var16,
                    (double) (0.5F + var13));
        } else if (var7 == 3) {
            this.setRenderBounds(0.0D, (double) var15, (double) (0.5F - var13), (double) var14, (double) var16,
                    (double) (0.5F + var13));
        }
        ...
        double var18 = var17 != null ? (double) var17.getMinU() : 0;
        double var20 = var17 != null ? (double) var17.getMinV() : 0;
        double var22 = var17 != null ? (double) var17.getMaxU() : 0;
        double var24 = var17 != null ? (double) var17.getMaxV() : 0;
        ...
        for (int var61 = 0; var61 < 6; ++var61) {
            if (var61 == 0) {
                ...
                var32 = var26[2];
                var33 = var26[3];
                var18 = var17 != null ? (double) var17.getInterpolatedU((double) var34) : 0;
                var20 = var17 != null ? (double) var17.getInterpolatedV((double) var36) : 0;
                var22 = var17 != null ? (double) var17.getInterpolatedU((double) var35) : 0;
                var24 = var17 != null ? (double) var17.getInterpolatedV((double) (var36 + 2)) : 0;
            } else if (var61 == 1) {
                var601 = var26[7];
                var31 = var26[6];
                var32 = var26[5];
                ...
                var20 = var17 != null ? (double) var17.getInterpolatedV((double) var36) : 0;
                var22 = var17 != null ? (double) var17.getInterpolatedU((double) var35) : 0;
                var24 = var17 != null ? (double) var17.getInterpolatedV((double) var37) : 0;
            } else if (var61 == 3) {
                var601 = var26[2];
                var31 = var26[1];
                var32 = var26[5];
            ...
            if (var5 != null && var601 != null && var31 != null && var32 != null && var33 != null) {
        ...
        var26[0] = Vec3.createVectorHelper((double) (-var611), 0.0D, (double) (-var39));
        var26[1] = Vec3.createVectorHelper((double) var611, 0.0D, (double) (-var39));
        var26[2] = Vec3.createVectorHelper((double) var611, 0.0D, (double) var39);
        var26[3] = Vec3.createVectorHelper((double) (-var611), 0.0D, (double) var39);
        var26[4] = Vec3.createVectorHelper((double) (-var611), (double) var40, (double) (-var39));
        var26[5] = Vec3.createVectorHelper((double) var611, (double) var40, (double) (-var39));
        var26[6] = Vec3.createVectorHelper((double) var611, (double) var40, (double) var39);
        var26[7] = Vec3.createVectorHelper((double) (-var611), (double) var40, (double) var39);
        ...
        for (int var63 = 0; var63 < 6; ++var63) {
            if (var63 == 0) {
                ...
                var32 = var26[2];
                var33 = var26[3];
                var18 = var17 != null ? (double) var17.getInterpolatedU((double) var621) : 0;
                var20 = var17 != null ? (double) var17.getInterpolatedV((double) var43) : 0;
                var22 = var17 != null ? (double) var17.getInterpolatedU((double) var42) : 0;
                var24 = var17 != null ? (double) var17.getInterpolatedV((double) var44) : 0;
            } else if (var63 == 1) {
                var601 = var26[7];
                var31 = var26[6];
                var32 = var26[5];
                ...
                var20 = var17 != null ? (double) var17.getInterpolatedV((double) var43) : 0;
                var22 = var17 != null ? (double) var17.getInterpolatedU((double) var42) : 0;
                var24 = var17 != null ? (double) var17.getInterpolatedV((double) (var43 + 2)) : 0;
            } else if (var63 == 3) {
                var601 = var26[2];
                var31 = var26[1];
                var32 = var26[5];
        ...
        if (var8) {
            ...
            double var50 = var17 != null ? (double) var17.getMinU() : 0;
            double var52 = var17 != null ? (double) var17.getInterpolatedV(var8 ? 2.0D : 0.0D) : 0;
            double var54 = var17 != null ? (double) var17.getMaxU() : 0;
            double var56 = var17 != null ? (double) var17.getInterpolatedV(var8 ? 4.0D : 2.0D) : 0;
            double var58 = (double) (var10 ? 3.5F : 1.5F) / 16.0D;
            if (var5 != null) {
                var5.setColorOpaque_F(0.75F, 0.75F, 0.75F);

                if (var7 == 2) {
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.25D, var50, var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.25D, var50, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) p_147723_4_, var54, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) p_147723_4_, var54, var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), var631, (double) p_147723_4_ + 0.5D,
                            var50,
                            var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), var631, (double) p_147723_4_ + 0.5D,
                            var50,
                            var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.25D, var54, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.25D, var54, var52);
                } else if (var7 == 0) {
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.75D, var50, var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.75D, var50, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), var631, (double) p_147723_4_ + 0.5D,
                            var54,
                            var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), var631, (double) p_147723_4_ + 0.5D,
                            ...
                            var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) (p_147723_4_ + 1), var50, var52);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) (p_147723_4_ + 1), var50, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var49), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.75D, var54, var56);
                    var5.addVertexWithUV((double) ((float) p_147723_2_ + var48), (double) p_147723_3_ + var58,
                            (double) p_147723_4_ + 0.75D, var54, var52);
                } else if (var7 == 1) {
                    var5.addVertexWithUV((double) p_147723_2_, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var50, var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var54, var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var48), var54, var52);
                    var5.addVertexWithUV((double) p_147723_2_, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var48), var50, var52);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var50, var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.5D, var631, (double) ((float) p_147723_4_ + var49),
                            var54,
                            var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.5D, var631, (double) ((float) p_147723_4_ + var48),
                            var54,
                            var52);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.25D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var48), var50, var52);
                    ...
                    var5.addVertexWithUV((double) p_147723_2_ + 0.5D, var631, (double) ((float) p_147723_4_ + var49),
                            var50,
                            var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var54, var56);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var48), var54, var52);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.5D, var631, (double) ((float) p_147723_4_ + var48),
                    ...
                    var5.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var50, var56);
                    var5.addVertexWithUV((double) (p_147723_2_ + 1), (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var49), var54, var56);
                    var5.addVertexWithUV((double) (p_147723_2_ + 1), (double) p_147723_3_ + var58,
                            (double) ((float) p_147723_4_ + var48), var54, var52);
                    var5.addVertexWithUV((double) p_147723_2_ + 0.75D, (double) p_147723_3_ + var58,
    ...
    public boolean renderBlockTripWire(Block p_147756_1_, int p_147756_2_, int p_147756_3_, int p_147756_4_) {
        ...
        double var10 = var6 != null ? (double) var6.getMinU() : 0;
        double var12 = var6 != null ? (double) var6.getInterpolatedV(var8 ? 2.0D : 0.0D) : 0;
        double var14 = var6 != null ? (double) var6.getMaxU() : 0;
        double var16 = var6 != null ? (double) var6.getInterpolatedV(var8 ? 4.0D : 2.0D) : 0;
        ...
        if (var22 && var5 != null) {
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.25D, var10, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.25D, var10, var16);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) p_147756_4_, var14, var16);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) p_147756_4_, var14, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) p_147756_4_, var14, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) p_147756_4_, var14, var16);
        ...
        if (var22 || var23 && !var21 && !var20) {
            if (var5 != null) {
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var10, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var10, var16);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.25D, var14, var16);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.25D, var14, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.25D, var14, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.25D, var14, var16);
        ...
        if (var23 || var22 && !var21 && !var20) {
            if (var5 != null) {
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.75D, var10, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.75D, var10, var16);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var14, var16);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var14, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var14, var12);
                var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                        (double) p_147756_4_ + 0.5D, var14, var16);
        ...
        if (var23 && var5 != null) {
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) (p_147756_4_ + 1), var10, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) (p_147756_4_ + 1), var10, var16);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.75D, var14, var16);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.75D, var14, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var25), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.75D, var14, var12);
            var5.addVertexWithUV((double) ((float) p_147756_2_ + var26), (double) p_147756_3_ + var18,
                    (double) p_147756_4_ + 0.75D, var14, var16);
        ...
        if (var20 && var5 != null) {
            var5.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var26), var10, var16);
            var5.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var26), var14, var16);
            var5.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var25), var14, var12);
            var5.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var25), var10, var12);
            var5.addVertexWithUV((double) p_147756_2_, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var25), var10, var12);
            var5.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var25), var14, var12);
        ...
        if (var20 || var21 && !var22 && !var23) {
            if (var5 != null) {
                var5.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var26), var10, var16);
                var5.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var26), var14, var16);
                var5.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var25), var14, var12);
                var5.addVertexWithUV((double) p_147756_2_ + 0.25D, (double) p_147756_3_ + var18,
        ...
        if (var21 || var20 && !var22 && !var23) {
            if (var5 != null) {
                var5.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var26), var10, var16);
                var5.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var26), var14, var16);
                var5.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + var18,
                        (double) ((float) p_147756_4_ + var25), var14, var12);
                var5.addVertexWithUV((double) p_147756_2_ + 0.5D, (double) p_147756_3_ + var18,
        ...
        if (var21 && var5 != null) {
            var5.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var26), var10, var16);
            var5.addVertexWithUV((double) (p_147756_2_ + 1), (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var26), var14, var16);
            var5.addVertexWithUV((double) (p_147756_2_ + 1), (double) p_147756_3_ + var18,
                    (double) ((float) p_147756_4_ + var25), var14, var12);
            var5.addVertexWithUV((double) p_147756_2_ + 0.75D, (double) p_147756_3_ + var18,
    ...
    public boolean renderBlockFire(BlockFire p_147801_1_, int p_147801_2_, int p_147801_3_, int p_147801_4_) {
        ...
        if (!World.doesBlockHaveSolidTopSurface(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_)
                && !Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_)) {
            float var36 = 0.2F;
            float var19 = 0.0625F;
            ...
            if (Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_ - 1, p_147801_3_, p_147801_4_)
                    && var5 != null) {
                var5.addVertexWithUV((double) ((float) p_147801_2_ + var36),
                        (double) ((float) p_147801_3_ + var17 + var19), (double) (p_147801_4_ + 1), var13, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 1), var13, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var9, var15);
                var5.addVertexWithUV((double) ((float) p_147801_2_ + var36),
                        (double) ((float) p_147801_3_ + var17 + var19), (double) (p_147801_4_ + 0), var9, var11);
                var5.addVertexWithUV((double) ((float) p_147801_2_ + var36),
                        (double) ((float) p_147801_3_ + var17 + var19), (double) (p_147801_4_ + 0), var9, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var9, var15);
            ...
            if (Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_ + 1, p_147801_3_, p_147801_4_)
                    && var5 != null) {
                var5.addVertexWithUV((double) ((float) (p_147801_2_ + 1) - var36),
                        (double) ((float) p_147801_3_ + var17 + var19), (double) (p_147801_4_ + 0), var9, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 1 - 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var9, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 1 - 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 1), var13, var15);
                var5.addVertexWithUV((double) ((float) (p_147801_2_ + 1) - var36),
            ...
            if (Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_, p_147801_3_, p_147801_4_ - 1)
                    && var5 != null) {
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) p_147801_4_ + var36), var13, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var13, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var9, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) p_147801_4_ + var36), var9, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) p_147801_4_ + var36), var9, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 0), var9, var15);
            ...
            if (Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_, p_147801_3_, p_147801_4_ + 1)
                    && var5 != null) {
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) (p_147801_4_ + 1) - var36), var9, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 1 - 0), var9, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 1 - 0), var13, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) (p_147801_4_ + 1) - var36), var13, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17 + var19),
                        (double) ((float) (p_147801_4_ + 1) - var36), var13, var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) (p_147801_3_ + 0) + var19),
                        (double) (p_147801_4_ + 1 - 0), var13, var15);
            ...
            if (Blocks.fire.func_149844_e(this.blockAccess, p_147801_2_, p_147801_3_ + 1, p_147801_4_)) {
                ...
                if ((p_147801_2_ + p_147801_3_ + p_147801_4_ & 1) == 0 && var5 != null) {
                    var5.addVertexWithUV(var28, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 0),
                            var13, var11);
                    ...
                    var5.addVertexWithUV(var28, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 1),
                            var9, var11);
                    var9 = (double) var7.getMinU();
                    var11 = (double) var7.getMinV();
                    var13 = (double) var7.getMaxU();
                    var15 = (double) var7.getMaxV();
                    var5.addVertexWithUV(var30, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 1),
                            var13, var11);
                    ...
                    var5.addVertexWithUV(var30, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 0),
                            var9, var11);
                } else if (var5 != null) {
                    var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17), var34,
                            var13, var11);
                    ...
                    var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17), var34,
                            var9, var11);
                    var9 = (double) var7.getMinU();
                    var11 = (double) var7.getMinV();
                    var13 = (double) var7.getMaxU();
                    var15 = (double) var7.getMaxV();
                    var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17), var32,
                            var13, var11);
                    ...
                    var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17), var32,
                            var9, var11);
                }
            }
        } else {
            ...
            if (var5 != null) {
                var5.addVertexWithUV(var26, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 1), var13,
                        var11);
                ...
                var5.addVertexWithUV(var26, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 0), var9,
                        var11);
                var5.addVertexWithUV(var28, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 0), var13,
                        var11);
                var5.addVertexWithUV(var20, (double) (p_147801_3_ + 0), (double) (p_147801_4_ + 0), var13, var15);
                var5.addVertexWithUV(var20, (double) (p_147801_3_ + 0), (double) (p_147801_4_ + 1), var9, var15);
                var5.addVertexWithUV(var28, (double) ((float) p_147801_3_ + var17), (double) (p_147801_4_ + 1), var9,
                        var11);
            }
            var9 = (double) var7.getMinU();
            var11 = (double) var7.getMinV();
            ...
            var15 = (double) var7.getMaxV();
            if (var5 != null) {
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17), var32, var13,
                        var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) (p_147801_3_ + 0), var24, var13, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) (p_147801_3_ + 0), var24, var9, var15);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17), var32, var9,
                        var11);
                var5.addVertexWithUV((double) (p_147801_2_ + 0), (double) ((float) p_147801_3_ + var17), var30, var13,
                        var11);
                ...
                var5.addVertexWithUV((double) (p_147801_2_ + 1), (double) ((float) p_147801_3_ + var17), var30, var9,
                        var11);
            }
    ...
    public boolean renderBlockRedstoneWire(Block p_147788_1_, int p_147788_2_, int p_147788_3_, int p_147788_4_) {
        ...
        if (!var27) {
            ...
            if (var5 != null) {
                var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var26,
                        (double) var7.getInterpolatedU((double) var30), (double) var7.getInterpolatedV((double) var31));
                var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var25,
                        (double) var7.getInterpolatedU((double) var30), (double) var7.getInterpolatedV((double) var29));
                var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var25,
                        (double) var7.getInterpolatedU((double) var33), (double) var7.getInterpolatedV((double) var29));
                var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var26,
                        (double) var7.getInterpolatedU((double) var33), (double) var7.getInterpolatedV((double) var31));
                var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
                var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var26,
                        (double) var9.getInterpolatedU((double) var30), (double) var9.getInterpolatedV((double) var31));
                var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var25,
                        (double) var9.getInterpolatedU((double) var30), (double) var9.getInterpolatedV((double) var29));
                var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var25,
                        (double) var9.getInterpolatedU((double) var33), (double) var9.getInterpolatedV((double) var29));
                var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var26,
                        (double) var9.getInterpolatedU((double) var33), (double) var9.getInterpolatedV((double) var31));

            }
        } else if (var27 && var5 != null) {
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var26,
                    (double) var8.getMaxU(), (double) var8.getMaxV());
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var25,
                    (double) var8.getMaxU(), (double) var8.getMinV());
            var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var25,
                    (double) var8.getMinU(), (double) var8.getMinV());
            var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var26,
                    (double) var8.getMinU(), (double) var8.getMaxV());
            var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var26,
                    (double) var10.getMaxU(), (double) var10.getMaxV());
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var25,
                    (double) var10.getMaxU(), (double) var10.getMinV());
            var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var25,
                    (double) var10.getMinU(), (double) var10.getMinV());
            var5.addVertexWithUV((double) var23, (double) p_147788_3_ + 0.015625D, (double) var26,
                    (double) var10.getMinU(), (double) var10.getMaxV());
        } else if (var5 != null) {
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var26,
                    (double) var8.getMaxU(), (double) var8.getMaxV());
            var5.addVertexWithUV((double) var24, (double) p_147788_3_ + 0.015625D, (double) var25,
        ...
        if (!this.blockAccess.getBlock(p_147788_2_, p_147788_3_ + 1, p_147788_4_).isBlockNormalCube()) {
            ...
            if (this.blockAccess.getBlock(p_147788_2_ - 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
                ...
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1), (double) var8.getMaxU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1), (double) var8.getMinU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 0), (double) var8.getMinU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 0), (double) var8.getMaxU(), (double) var8.getMaxV());
                var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1), (double) var10.getMaxU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1), (double) var10.getMinU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 0), (double) var10.getMinU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) p_147788_2_ + 0.015625D, (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 0), (double) var10.getMaxU(), (double) var10.getMaxV());
            }
            ...
            if (this.blockAccess.getBlock(p_147788_2_ + 1, p_147788_3_, p_147788_4_).isBlockNormalCube()
                ...
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1), (double) var8.getMinU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
                        (double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1),
                        (double) var8.getMaxU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
                        (double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 0),
                        (double) var8.getMaxU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 0), (double) var8.getMinU(), (double) var8.getMinV());
                var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1), (double) var10.getMinU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
                        (double) ((float) (p_147788_3_ + 1) + 0.021875F), (double) (p_147788_4_ + 1),
                        (double) var10.getMaxU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D,
                        ...
                        (double) var10.getMaxU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1) - 0.015625D, (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 0), (double) var10.getMinU(), (double) var10.getMinV());
            }
            ...
            if (this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ - 1).isBlockNormalCube()
                ...
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
                        (double) p_147788_4_ + 0.015625D, (double) var8.getMinU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) p_147788_4_ + 0.015625D, (double) var8.getMaxU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) p_147788_4_ + 0.015625D, (double) var8.getMaxU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
                        (double) p_147788_4_ + 0.015625D, (double) var8.getMinU(), (double) var8.getMinV());
                var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
                        (double) p_147788_4_ + 0.015625D, (double) var10.getMinU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) p_147788_4_ + 0.015625D, (double) var10.getMaxU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) p_147788_4_ + 0.015625D, (double) var10.getMaxU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
                        (double) p_147788_4_ + 0.015625D, (double) var10.getMinU(), (double) var10.getMinV());
            }
            ...
            if (this.blockAccess.getBlock(p_147788_2_, p_147788_3_, p_147788_4_ + 1).isBlockNormalCube()
                ...
                var5.setColorOpaque_F(var12, var13, var14);
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var8.getMaxU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var8.getMinU(), (double) var8.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var8.getMinU(), (double) var8.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var8.getMaxU(), (double) var8.getMaxV());
                var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var10.getMaxU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 1), (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var10.getMinU(), (double) var10.getMinV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) (p_147788_3_ + 0),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var10.getMinU(), (double) var10.getMaxV());
                var5.addVertexWithUV((double) (p_147788_2_ + 0), (double) ((float) (p_147788_3_ + 1) + 0.021875F),
                        (double) (p_147788_4_ + 1) - 0.015625D, (double) var10.getMaxU(), (double) var10.getMaxV());
            }
        }
    ...
    public boolean renderBlockMinecartTrack(BlockRailBase p_147766_1_, int p_147766_2_, int p_147766_3_,
        ...
        double var8 = var7 != null ? (double) var7.getMinU() : 0;
        double var10 = var7 != null ? (double) var7.getMinV() : 0;
        double var12 = var7 != null ? (double) var7.getMaxU() : 0;
        double var14 = var7 != null ? (double) var7.getMaxV() : 0;
    ...
    public boolean renderBlockLadder(Block p_147794_1_, int p_147794_2_, int p_147794_3_, int p_147794_4_) {
        ...
        double var7 = var6 != null ? (double) var6.getMinU() : 0;
        double var9 = var6 != null ? (double) var6.getMinV() : 0;
        double var11 = var6 != null ? (double) var6.getMaxU() : 0;
        double var13 = var6 != null ? (double) var6.getMaxV() : 0;
        double var16 = 0.0D;
        double var18 = 0.05000000074505806D;

        if (var15 == 5 && var5 != null) {
            var5.addVertexWithUV((double) p_147794_2_ + var18, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 1) + var16, var7, var9);
            var5.addVertexWithUV((double) p_147794_2_ + var18, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 1) + var16, var7, var13);
            var5.addVertexWithUV((double) p_147794_2_ + var18, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 0) - var16, var11, var13);
            var5.addVertexWithUV((double) p_147794_2_ + var18, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 0) - var16, var11, var9);
        }

        if (var15 == 4 && var5 != null) {
            var5.addVertexWithUV((double) (p_147794_2_ + 1) - var18, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 1) + var16, var11, var13);
            var5.addVertexWithUV((double) (p_147794_2_ + 1) - var18, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 1) + var16, var11, var9);
            var5.addVertexWithUV((double) (p_147794_2_ + 1) - var18, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 0) - var16, var7, var9);
            var5.addVertexWithUV((double) (p_147794_2_ + 1) - var18, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 0) - var16, var7, var13);
        }

        if (var15 == 3 && var5 != null) {
            var5.addVertexWithUV((double) (p_147794_2_ + 1) + var16, (double) (p_147794_3_ + 0) - var16,
                    (double) p_147794_4_ + var18, var11, var13);
            var5.addVertexWithUV((double) (p_147794_2_ + 1) + var16, (double) (p_147794_3_ + 1) + var16,
                    (double) p_147794_4_ + var18, var11, var9);
            var5.addVertexWithUV((double) (p_147794_2_ + 0) - var16, (double) (p_147794_3_ + 1) + var16,
                    (double) p_147794_4_ + var18, var7, var9);
            var5.addVertexWithUV((double) (p_147794_2_ + 0) - var16, (double) (p_147794_3_ + 0) - var16,
                    (double) p_147794_4_ + var18, var7, var13);
        }

        if (var15 == 2 && var5 != null) {
            var5.addVertexWithUV((double) (p_147794_2_ + 1) + var16, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 1) - var18, var7, var9);
            var5.addVertexWithUV((double) (p_147794_2_ + 1) + var16, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 1) - var18, var7, var13);
            var5.addVertexWithUV((double) (p_147794_2_ + 0) - var16, (double) (p_147794_3_ + 0) - var16,
                    (double) (p_147794_4_ + 1) - var18, var11, var13);
            var5.addVertexWithUV((double) (p_147794_2_ + 0) - var16, (double) (p_147794_3_ + 1) + var16,
                    (double) (p_147794_4_ + 1) - var18, var11, var9);
        }
    ...
    public boolean renderBlockVine(Block p_147726_1_, int p_147726_2_, int p_147726_3_, int p_147726_4_) {
        ...
        if (mc.getConfig().isConnectedTextures() && this.overrideBlockTexture == null) {
            ...
            var6 = ConnectedTextures.getConnectedTexture(this.mc, this.blockAccess, p_147726_1_, p_147726_2_,
                    p_147726_3_,
                    p_147726_4_, var7, var6);
        }
        ...
        if (var5 != null)
            var5.setColorOpaque_F(var8, var9, var10);
        double var18 = var6 != null ? (double) var6.getMinU() : 0;
        double var19 = var6 != null ? (double) var6.getMinV() : 0;
        double var11 = var6 != null ? (double) var6.getMaxU() : 0;
        double var13 = var6 != null ? (double) var6.getMaxV() : 0;
        double var15 = 0.05000000074505806D;

        if ((var17 & 2) != 0 && var5 != null) {
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 1), (double) (p_147726_4_ + 1),
                    var18, var19);
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 0), (double) (p_147726_4_ + 1),
                    var18, var13);
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 0), (double) (p_147726_4_ + 0),
                    var11, var13);
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 1), (double) (p_147726_4_ + 0),
                    var11, var19);
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 1), (double) (p_147726_4_ + 0),
                    var11, var19);
            var5.addVertexWithUV((double) p_147726_2_ + var15, (double) (p_147726_3_ + 0), (double) (p_147726_4_ + 0),
        ...
        if ((var17 & 8) != 0 && var5 != null) {
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 1), var11, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 1), var11, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 0), var18, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 0), var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 0), var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 1) - var15, (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 0), var18, var19);
        ...
        if ((var17 & 4) != 0 && var5 != null) {
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 0), (double) p_147726_4_ + var15,
                    var11, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1), (double) p_147726_4_ + var15,
                    var11, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1), (double) p_147726_4_ + var15,
                    var18, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0), (double) p_147726_4_ + var15,
                    var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0), (double) p_147726_4_ + var15,
                    var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1), (double) p_147726_4_ + var15,
        ...
        if ((var17 & 1) != 0 && var5 != null) {
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 1) - var15, var18, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 1) - var15, var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 1) - var15, var11, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 1) - var15, var11, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1),
                    (double) (p_147726_4_ + 1) - var15, var11, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 0),
                    (double) (p_147726_4_ + 1) - var15, var11, var13);
        ...
        if (this.blockAccess.getBlock(p_147726_2_, p_147726_3_ + 1, p_147726_4_).isBlockNormalCube() && var5 != null) {
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1) - var15,
                    (double) (p_147726_4_ + 0), var18, var19);
            var5.addVertexWithUV((double) (p_147726_2_ + 1), (double) (p_147726_3_ + 1) - var15,
                    (double) (p_147726_4_ + 1), var18, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1) - var15,
                    (double) (p_147726_4_ + 1), var11, var13);
            var5.addVertexWithUV((double) (p_147726_2_ + 0), (double) (p_147726_3_ + 1) - var15,
                    (double) (p_147726_4_ + 0), var11, var19);
        }
    ...
    public boolean renderBlockStainedGlassPane(Block block, int x, int y, int z) {
        ...
        if (this.hasOverrideBlockTexture()) {
            ...
            iconGlassPaneTop1 = isStainedGlass1 ? ((BlockStainedGlassPane) block).func_150104_b(metadata)
        ...
        if (mc.getConfig().isConnectedTextures() && this.overrideBlockTexture == null) {
            ...
            if (gMinU != iconGlass1 || iz != iconGlass1) {
                ...
                drawTop = this.blockAccess.getBlock(x, y + 1, z) != block
                        || this.blockAccess.getBlockMetadata(x, y + 1, z) != metadata;
                drawBottom = this.blockAccess.getBlock(x, y - 1, z) != block
                        || this.blockAccess.getBlockMetadata(x, y - 1, z) != metadata;
            }
        ...
        double gMinU1 = iconGlass1 != null ? (double) iconGlass1.getMinU() : 0;
        double gHalf7U1 = iconGlass1 != null ? (double) iconGlass1.getInterpolatedU(7.0D) : 0;
        double gHalf9U = iconGlass1 != null ? (double) iconGlass1.getInterpolatedU(9.0D) : 0;
        double gMaxU = iconGlass1 != null ? (double) iconGlass1.getMaxU() : 0;
        double gMinV = iconGlass1 != null ? (double) iconGlass1.getMinV() : 0;
        double gMaxV = iconGlass1 != null ? (double) iconGlass1.getMaxV() : 0;
        double gMinUz = iconZ != null ? (double) iconZ.getMinU() : 0;
        double gHalf7Uz = iconZ != null ? (double) iconZ.getInterpolatedU(7.0D) : 0;
        double gHalf9Uz = iconZ != null ? (double) iconZ.getInterpolatedU(9.0D) : 0;
        double gMaxUz = iconZ != null ? (double) iconZ.getMaxU() : 0;
        double gMinVz = iconZ != null ? (double) iconZ.getMinV() : 0;
        double gMaxVz = iconZ != null ? (double) iconZ.getMaxV() : 0;
        ...
        boolean connZNeg = isStainedGlass1
                ? ((BlockStainedGlassPane) block).func_150098_a(this.blockAccess.getBlock(x, y, z - 1))
                : ((BlockPane) block).func_150098_a(this.blockAccess.getBlock(x, y, z - 1));
        boolean connZPos = isStainedGlass1
                ? ((BlockStainedGlassPane) block).func_150098_a(this.blockAccess.getBlock(x, y, z + 1))
                : ((BlockPane) block).func_150098_a(this.blockAccess.getBlock(x, y, z + 1));
        boolean connXNeg = isStainedGlass1
                ? ((BlockStainedGlassPane) block).func_150098_a(this.blockAccess.getBlock(x - 1, y, z))
                : ((BlockPane) block).func_150098_a(this.blockAccess.getBlock(x - 1, y, z));
        boolean connXPos = isStainedGlass1
                ? ((BlockStainedGlassPane) block).func_150098_a(this.blockAccess.getBlock(x + 1, y, z))
                : ((BlockPane) block).func_150098_a(this.blockAccess.getBlock(x + 1, y, z));
        double var58 = 0.001D;
        double var60 = 0.999D;
        ...
        if (!connXNeg && !disconnected) {
            if (!connZNeg && !connZPos && var6 != null) {
            ...
            if (!connZNeg && !disconnected && var6 != null) {
                var6.addVertexWithUV(xHalfMax, yTop, zHalfMin, gHalf9Uz, gMinVz);
                var6.addVertexWithUV(xHalfMax, yBottom, zHalfMin, gHalf9Uz, gMaxVz);
                var6.addVertexWithUV(x0, yBottom, zHalfMin, gMinUz, gMaxVz);
                var6.addVertexWithUV(x0, yTop, zHalfMin, gMinUz, gMinVz);
            ...
            if (!connZPos && !disconnected && var6 != null) {
                var6.addVertexWithUV(x0, yTop, zHalfMax, gMinUz, gMinVz);
                var6.addVertexWithUV(x0, yBottom, zHalfMax, gMinUz, gMaxVz);
                var6.addVertexWithUV(xHalfMax, yBottom, zHalfMax, gHalf9Uz, gMaxVz);
                var6.addVertexWithUV(xHalfMax, yTop, zHalfMax, gHalf9Uz, gMinVz);
        ...
        } else if (!connXPos && !connZNeg && !connZPos && var6 != null) {
        ...
        if (!connZNeg && !disconnected) {
            if (!connXPos && !connXNeg && var6 != null) {
                var6.addVertexWithUV(xHalfMax, yTop, zHalfMin, gHalf9Uz, gMinVz);
                var6.addVertexWithUV(xHalfMax, yBottom, zHalfMin, gHalf9Uz, gMaxVz);
                var6.addVertexWithUV(xHalfMin, yBottom, zHalfMin, gHalf7Uz, gMaxVz);
                var6.addVertexWithUV(xHalfMin, yTop, zHalfMin, gHalf7Uz, gMinVz);
            ...
            if (!connXNeg && !disconnected && var6 != null) {
                var6.addVertexWithUV(xHalfMin, yTop, z0, gMinU1, gMinV);
                var6.addVertexWithUV(xHalfMin, yBottom, z0, gMinU1, gMaxV);
                var6.addVertexWithUV(xHalfMin, yBottom, zHalfMax, gHalf9U, gMaxV);
                var6.addVertexWithUV(xHalfMin, yTop, zHalfMax, gHalf9U, gMinV);
            ...
            if (!connXPos && !disconnected && var6 != null) {
                var6.addVertexWithUV(xHalfMax, yTop, zHalfMax, gHalf9U, gMinV);
                var6.addVertexWithUV(xHalfMax, yBottom, zHalfMax, gHalf9U, gMaxV);
                var6.addVertexWithUV(xHalfMax, yBottom, z0, gMinU1, gMaxV);
                var6.addVertexWithUV(xHalfMax, yTop, z0, gMinU1, gMinV);
        ...
        } else if (!connZPos && !connXPos && !connXNeg && var6 != null) {
            var6.addVertexWithUV(xHalfMin, yTop, zHalfMax, gHalf7Uz, gMinVz);
            var6.addVertexWithUV(xHalfMin, yBottom, zHalfMax, gHalf7Uz, gMaxVz);
            var6.addVertexWithUV(xHalfMax, yBottom, zHalfMax, gHalf9Uz, gMaxVz);
            var6.addVertexWithUV(xHalfMax, yTop, zHalfMax, gHalf9Uz, gMinVz);
    ...
    public boolean renderBlockPane(BlockPane p_147767_1_, int p_147767_2_, int p_147767_3_, int p_147767_4_) {
        ...
        if (EntityRenderer.anaglyphEnable) {
            float var63 = (var8 * 30.0F + var9 * 59.0F + var10 * 11.0F) / 100.0F;
            float var64 = (var8 * 30.0F + var9 * 70.0F) / 100.0F;
        ...
        if (this.hasOverrideBlockTexture()) {
            ...
            int kr1 = this.blockAccess.getBlockMetadata(p_147767_2_, p_147767_3_, p_147767_4_);
            var631 = this.getBlockIconFromSideAndMetadata(p_147767_1_, 0, kr1);
        ...
        if (mc.getConfig().isConnectedTextures() && this.overrideBlockTexture == null) {
            ...
            kr2 = ConnectedTextures.getConnectedTexture(this.mc, this.blockAccess, p_147767_1_, p_147767_2_,
                    p_147767_3_,
                    p_147767_4_, 3, kr2);
            kz = ConnectedTextures.getConnectedTexture(this.mc, this.blockAccess, p_147767_1_, p_147767_2_, p_147767_3_,
                    p_147767_4_, 4, kz);
            kzr = ConnectedTextures.getConnectedTexture(this.mc, this.blockAccess, p_147767_1_, p_147767_2_,
                    p_147767_3_,
                    p_147767_4_, 5, kzr);
        }

        double var65 = var631 != null ? (double) var631.getMinU() : 0;
        double var15 = var631 != null ? (double) var631.getInterpolatedU(8.0D) : 0;
        double var17 = var631 != null ? (double) var631.getMaxU() : 0;
        double var19 = var631 != null ? (double) var631.getMinV() : 0;
        double var21 = var631 != null ? (double) var631.getMaxV() : 0;
        double dr = kr2 != null ? (double) kr2.getMinU() : 0;
        double d1r = kr2 != null ? (double) kr2.getInterpolatedU(8.0D) : 0;
        double d2r = kr2 != null ? (double) kr2.getMaxU() : 0;
        double d3r = kr2 != null ? (double) kr2.getMinV() : 0;
        double d4r = kr2 != null ? (double) kr2.getMaxV() : 0;
        double dz = kz != null ? (double) kz.getMinU() : 0;
        double d1z = kz != null ? (double) kz.getInterpolatedU(8.0D) : 0;
        double d2z = kz != null ? (double) kz.getMaxU() : 0;
        double d3z = kz != null ? (double) kz.getMinV() : 0;
        double d4z = kz != null ? (double) kz.getMaxV() : 0;
        double dzr = kzr != null ? (double) kzr.getMinU() : 0;
        double d1zr = kzr != null ? (double) kzr.getInterpolatedU(8.0D) : 0;
        double d2zr = kzr != null ? (double) kzr.getMaxU() : 0;
        double d3zr = kzr != null ? (double) kzr.getMinV() : 0;
        double d4zr = kzr != null ? (double) kzr.getMaxV() : 0;
        ...
        boolean var57 = p_147767_1_.shouldSideBeRendered(this.blockAccess, p_147767_2_, p_147767_3_ + 1, p_147767_4_,
                1);
        boolean var58 = p_147767_1_.shouldSideBeRendered(this.blockAccess, p_147767_2_, p_147767_3_ - 1, p_147767_4_,
                0);
        double var59 = 0.01D;
        double var61 = 0.005D;

        if ((!var55 || !var56) && (var55 || var56 || var53 || var54)) {
            if (var55 && !var56 && var6 != null) {
                ...
                if (var57 || p_147767_3_ < var5 - 1
                        && this.blockAccess.isAirBlock(p_147767_2_ - 1, p_147767_3_ + 1, p_147767_4_)) {
        ...
        if ((!var53 || !var54) && (var55 || var56 || var53 || var54)) {
            if (var53 && !var54 && var6 != null) {
                ...
                if (var57 || p_147767_3_ < var5 - 1
                        && this.blockAccess.isAirBlock(p_147767_2_, p_147767_3_ + 1, p_147767_4_ - 1)) {
    ...
    public boolean renderBlockDoublePlant(BlockDoublePlant p_147774_1_, int p_147774_2_, int p_147774_3_,
        ...
        if (var20) {
            ...
            var60 = BlockDoublePlant
                    .func_149890_d(this.blockAccess.getBlockMetadata(p_147774_2_, p_147774_3_ - 1, p_147774_4_));
    ...
    public boolean renderBlockStem(Block p_147724_1_, int p_147724_2_, int p_147724_3_, int p_147724_4_) {
        ...
        int var7 = CustomColorizer.getStemColorMultiplier(var5, this.blockAccess, p_147724_2_, p_147724_3_,
                p_147724_4_);
        float var8 = (float) (var7 >> 16 & 255) / 255.0F;
        float var9 = (float) (var7 >> 8 & 255) / 255.0F;
        float var10 = (float) (var7 & 255) / 255.0F;
        ...
        if (var141 < 0) {
            this.renderBlockStemSmall(var5, this.blockAccess.getBlockMetadata(p_147724_2_, p_147724_3_, p_147724_4_),
                    this.renderMaxY, (double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F),
                    (double) p_147724_4_);
        } else {
            this.renderBlockStemSmall(var5, this.blockAccess.getBlockMetadata(p_147724_2_, p_147724_3_, p_147724_4_),
                    0.5D, (double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F), (double) p_147724_4_);
            this.renderBlockStemBig(var5, this.blockAccess.getBlockMetadata(p_147724_2_, p_147724_3_, p_147724_4_),
                    var141, this.renderMaxY, (double) p_147724_2_, (double) ((float) p_147724_3_ - 0.0625F),
                    (double) p_147724_4_);
        }
    ...
    public boolean renderBlockCrops(Block p_147796_1_, int p_147796_2_, int p_147796_3_, int p_147796_4_) {
        ...
        this.renderBlockCropsImpl(p_147796_1_, this.blockAccess.getBlockMetadata(p_147796_2_, p_147796_3_, p_147796_4_),
                (double) p_147796_2_, (double) ((float) p_147796_3_ - 0.0625F), (double) p_147796_4_);
        return true;
    }
    ...
    public void renderTorchAtAngle(Block p_147747_1_, double p_147747_2_, double p_147747_4_, double p_147747_6_,
        ...
        double var15 = var14 != null ? (double) var14.getMinU() : 0;
        double var17 = var14 != null ? (double) var14.getMinV() : 0;
        double var19 = var14 != null ? (double) var14.getMaxU() : 0;
        double var21 = var14 != null ? (double) var14.getMaxV() : 0;
        double var23 = var14 != null ? (double) var14.getInterpolatedU(7.0D) : 0;
        double var25 = var14 != null ? (double) var14.getInterpolatedV(6.0D) : 0;
        double var27 = var14 != null ? (double) var14.getInterpolatedU(9.0D) : 0;
        double var29 = var14 != null ? (double) var14.getInterpolatedV(8.0D) : 0;
        double var31 = var14 != null ? (double) var14.getInterpolatedU(7.0D) : 0;
        double var33 = var14 != null ? (double) var14.getInterpolatedV(13.0D) : 0;
        double var35 = var14 != null ? (double) var14.getInterpolatedU(9.0D) : 0;
        double var37 = var14 != null ? (double) var14.getInterpolatedV(15.0D) : 0;
        p_147747_2_ += 0.5D;
        p_147747_6_ += 0.5D;
        ...
        double var49 = 0.625D;
        if (var13 != null) {
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ * (1.0D - var49) - var47, p_147747_4_ + var49,
                    p_147747_6_ + p_147747_10_ * (1.0D - var49) - var47, var23, var25);
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ * (1.0D - var49) - var47, p_147747_4_ + var49,
                    p_147747_6_ + p_147747_10_ * (1.0D - var49) + var47, var23, var29);
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ * (1.0D - var49) + var47, p_147747_4_ + var49,
                    p_147747_6_ + p_147747_10_ * (1.0D - var49) + var47, var27, var29);
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ * (1.0D - var49) + var47, p_147747_4_ + var49,
                    p_147747_6_ + p_147747_10_ * (1.0D - var49) - var47, var27, var25);
            var13.addVertexWithUV(p_147747_2_ + var47 + p_147747_8_, p_147747_4_, p_147747_6_ - var47 + p_147747_10_,
                    var35,
                    var33);
            var13.addVertexWithUV(p_147747_2_ + var47 + p_147747_8_, p_147747_4_, p_147747_6_ + var47 + p_147747_10_,
                    var35,
            ...
            var13.addVertexWithUV(p_147747_2_ - var47 + p_147747_8_, p_147747_4_ + 0.0D, var43 + p_147747_10_, var15,
                    var21);
            var13.addVertexWithUV(p_147747_2_ - var47 + p_147747_8_, p_147747_4_ + 0.0D, var45 + p_147747_10_, var19,
                    var21);
            ...
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ + var47, p_147747_4_ + 0.0D, var45 + p_147747_10_, var15,
                    var21);
            var13.addVertexWithUV(p_147747_2_ + p_147747_8_ + var47, p_147747_4_ + 0.0D, var43 + p_147747_10_, var19,
                    var21);
            ...
            var13.addVertexWithUV(var39 + p_147747_8_, p_147747_4_ + 0.0D, p_147747_6_ + var47 + p_147747_10_, var15,
                    var21);
            var13.addVertexWithUV(var41 + p_147747_8_, p_147747_4_ + 0.0D, p_147747_6_ + var47 + p_147747_10_, var19,
                    var21);
            ...
            var13.addVertexWithUV(var41 + p_147747_8_, p_147747_4_ + 0.0D, p_147747_6_ - var47 + p_147747_10_, var15,
                    var21);
            var13.addVertexWithUV(var39 + p_147747_8_, p_147747_4_ + 0.0D, p_147747_6_ - var47 + p_147747_10_, var19,
                    var21);
    ...
    public void renderBlockStemSmall(Block p_147730_1_, int p_147730_2_, double p_147730_3_, double p_147730_5_,
        ...
        double var13 = var12 != null ? (double) var12.getMinU() : 0;
        double var15 = var12 != null ? (double) var12.getMinV() : 0;
        double var17 = var12 != null ? (double) var12.getMaxU() : 0;
        double var19 = var12 != null ? (double) var12.getInterpolatedV(p_147730_3_ * 16.0D) : 0;
    ...
    public boolean renderBlockLilyPad(Block p_147783_1_, int p_147783_2_, int p_147783_3_, int p_147783_4_) {
        ...
        double var8 = var6 != null ? (double) var6.getMinU() : 0;
        double var10 = var6 != null ? (double) var6.getMinV() : 0;
        double var12 = var6 != null ? (double) var6.getMaxU() : 0;
        double var14 = var6 != null ? (double) var6.getMaxV() : 0;
        ...
        if (var5 != null) {
            ...
            var5.addVertexWithUV((double) (var19 + var21 - var22), (double) ((float) p_147783_3_ + var7),
                    (double) (var20 + var21 + var22), var8, var10);
            var5.addVertexWithUV((double) (var19 + var21 + var22), (double) ((float) p_147783_3_ + var7),
                    (double) (var20 - var21 + var22), var12, var10);
            var5.addVertexWithUV((double) (var19 - var21 + var22), (double) ((float) p_147783_3_ + var7),
                    (double) (var20 - var21 - var22), var12, var14);
            var5.addVertexWithUV((double) (var19 - var21 - var22), (double) ((float) p_147783_3_ + var7),
                    (double) (var20 + var21 - var22), var8, var14);
    ...
    public void renderBlockCropsImpl(Block p_147795_1_, int p_147795_2_, double p_147795_3_, double p_147795_5_,
        ...
        double var11 = var10 != null ? (double) var10.getMinU() : 0;
        double var13 = var10 != null ? (double) var10.getMinV() : 0;
        double var15 = var10 != null ? (double) var10.getMaxU() : 0;
        double var17 = var10 != null ? (double) var10.getMaxV() : 0;
    ...
    public boolean renderBlockFluids(Block p_147721_1_, int p_147721_2_, int p_147721_3_, int p_147721_4_) {
        ...
        float var8 = (float) (var6 >> 8 & 255) / 255.0F;
        float var9 = (float) (var6 & 255) / 255.0F;
        boolean var10 = p_147721_1_.shouldSideBeRendered(this.blockAccess, p_147721_2_, p_147721_3_ + 1, p_147721_4_,
                1);
        ...
        if (!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
            ...
            if (this.renderAllFaces || var10) {
                ...
                float var58 = (float) BlockLiquid.func_149802_a(this.blockAccess, p_147721_2_, p_147721_3_, p_147721_4_,
                        var22);
                ...
                if (var58 < -999.0F) {
                    var37 = var57 != null ? (double) var57.getInterpolatedU(0.0D) : 0;
                    var45 = var57 != null ? (double) var57.getInterpolatedV(0.0D) : 0;
                    var39 = var37;
                    var47 = var57 != null ? (double) var57.getInterpolatedV(16.0D) : 0;
                    var41 = var57 != null ? (double) var57.getInterpolatedU(16.0D) : 0;
                    var49 = var47;
                    var43 = var41;
                    var51 = var45;
                } else {
                    ...
                    var54 = 8.0F;
                    var37 = var57 != null ? (double) var57.getInterpolatedU((double) (8.0F + (-var53 - var52) * 16.0F))
                            : 0;
                    var45 = var57 != null ? (double) var57.getInterpolatedV((double) (8.0F + (-var53 + var52) * 16.0F))
                            : 0;
                    var39 = var57 != null ? (double) var57.getInterpolatedU((double) (8.0F + (-var53 + var52) * 16.0F))
                            : 0;
                    var47 = var57 != null ? (double) var57.getInterpolatedV((double) (8.0F + (var53 + var52) * 16.0F))
                            : 0;
                    var41 = var57 != null ? (double) var57.getInterpolatedU((double) (8.0F + (var53 + var52) * 16.0F))
                            : 0;
                    var49 = var57 != null ? (double) var57.getInterpolatedV((double) (8.0F + (var53 - var52) * 16.0F))
                            : 0;
                    var43 = var57 != null ? (double) var57.getInterpolatedU((double) (8.0F + (var53 - var52) * 16.0F))
                            : 0;
                    var51 = var57 != null ? (double) var57.getInterpolatedV((double) (8.0F + (-var53 - var52) * 16.0F))
                            : 0;
                }

                if (var5 != null) {
                    var5.setBrightness(
                            p_147721_1_.getBlockBrightness(this.blockAccess, p_147721_2_, p_147721_3_, p_147721_4_));
                    var5.setColorOpaque_F(var15 * var7, var15 * var8, var15 * var9);
                    double var56 = 3.90625E-5D;
                    var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var24,
                            (double) (p_147721_4_ + 0), var37 + var56, var45 + var56);
                    var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var26,
                            (double) (p_147721_4_ + 1), var39 + var56, var47 - var56);
                    var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var28,
                            (double) (p_147721_4_ + 1), var41 - var56, var49 - var56);
                    var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var30,
                            (double) (p_147721_4_ + 0), var43 - var56, var51 + var56);
                    var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var24,
                            (double) (p_147721_4_ + 0), var37 + var56, var45 + var56);
                    var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var30,
                            (double) (p_147721_4_ + 0), var43 - var56, var51 + var56);
            ...
            if (this.renderAllFaces || var11) {
                if (var5 != null) {
                    var5.setBrightness(
                            p_147721_1_.getBlockBrightness(this.blockAccess, p_147721_2_, p_147721_3_ - 1,
                                    p_147721_4_));
                    var5.setColorOpaque_F(var14 * var7, var14 * var8, var14 * var9);
                }
                this.renderFaceYNeg(p_147721_1_, (double) p_147721_2_, (double) p_147721_3_ + var32,
                        (double) p_147721_4_, this.getBlockIconFromSide(p_147721_1_, 0));
                var13 = true;
            }
            ...
            for (int var571 = 0; var571 < 4; ++var571) {
                ...
                if (this.renderAllFaces || var12[var571]) {
                    ...
                    var13 = true;
                    float var60 = var59 != null ? var59.getInterpolatedU(0.0D) : 0;
                    var52 = var59 != null ? var59.getInterpolatedU(8.0D) : 0;
                    var53 = var59 != null ? var59.getInterpolatedV((1.0D - var39) * 16.0D * 0.5D) : 0;
                    var54 = var59 != null ? var59.getInterpolatedV((1.0D - var41) * 16.0D * 0.5D) : 0;
                    float var55 = var59 != null ? var59.getInterpolatedV(8.0D) : 0;
                    if (var5 != null) {
                        var5.setBrightness(
                                p_147721_1_.getBlockBrightness(this.blockAccess, var581, p_147721_3_, var591));
                        float var61 = 1.0F;
                        var61 *= var571 < 2 ? var16 : var17;
                        var5.setColorOpaque_F(var15 * var61 * var7, var15 * var61 * var8, var15 * var61 * var9);
                        var5.addVertexWithUV(var43, (double) p_147721_3_ + var39, var45, (double) var60,
                                (double) var53);
                        var5.addVertexWithUV(var47, (double) p_147721_3_ + var41, var49, (double) var52,
                                (double) var54);
    ...
    public void renderBlockSandFalling(Block p_147749_1_, World p_147749_2_, int p_147749_3_, int p_147749_4_,
        ...
        this.renderFaceYNeg(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 0, p_147749_6_));
        var11.setColorOpaque_F(var8, var8, var8);
        this.renderFaceYPos(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 1, p_147749_6_));
        var11.setColorOpaque_F(var9, var9, var9);
        this.renderFaceZNeg(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 2, p_147749_6_));
        var11.setColorOpaque_F(var9, var9, var9);
        this.renderFaceZPos(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 3, p_147749_6_));
        var11.setColorOpaque_F(var10, var10, var10);
        this.renderFaceXNeg(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 4, p_147749_6_));
        var11.setColorOpaque_F(var10, var10, var10);
        this.renderFaceXPos(p_147749_1_, -0.5D, -0.5D, -0.5D,
                this.getBlockIconFromSideAndMetadata(p_147749_1_, 5, p_147749_6_));
        var11.draw();
    }
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_,
        ...
        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_, 0)) {
            if (this.renderMinY <= 0.0D) {
                --p_147751_3_;
            }

            this.aoBrightnessXYNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessYZNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoBrightnessYZNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoBrightnessXYPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchXYNN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchYZNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoLightValueScratchYZNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoLightValueScratchXYPN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZNNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ - 1);
            }
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZNNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ + 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZPNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ - 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZPNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ + 1);
            }
            ...
            if (this.renderMinY <= 0.0D
                    || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_).isOpaqueCube()) {
            ...
            var9 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN + this.aoLightValueScratchYZNP
                    + var21) / 4.0F;
            var12 = (this.aoLightValueScratchYZNP + var21 + this.aoLightValueScratchXYZPNP
                    + this.aoLightValueScratchXYPN) / 4.0F;
            var11 = (var21 + this.aoLightValueScratchYZNN + this.aoLightValueScratchXYPN
                    + this.aoLightValueScratchXYZPNN) / 4.0F;
            var10 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN + var21
            ...
            this.renderFaceYNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                    this.getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 0));
            var8 = true;
        }

        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_, 1)) {
            if (this.renderMaxY >= 1.0D) {
                ++p_147751_3_;
            }

            this.aoBrightnessXYNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessXYPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessYZPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoBrightnessYZPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoLightValueScratchXYNP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchXYPP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchYZPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoLightValueScratchYZPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            var16 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1).getCanBlockGrass();
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZNPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ - 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZPPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ - 1);
            }
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZNPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                        p_147751_4_ + 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZPPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                        p_147751_4_ + 1);
            }
            ...
            var21 = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1, p_147751_4_);
            var12 = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP + this.aoLightValueScratchYZPP
                    + var21) / 4.0F;
            var9 = (this.aoLightValueScratchYZPP + var21 + this.aoLightValueScratchXYZPPP
                    + this.aoLightValueScratchXYPP) / 4.0F;
            var10 = (var21 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXYPP
                    + this.aoLightValueScratchXYZPPN) / 4.0F;
            var11 = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN + var21
            ...
            this.colorGreenTopRight *= var12;
            this.colorBlueTopRight *= var12;
            this.renderFaceYPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                    this.getBlockIcon(p_147751_1_, this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 1));
            var8 = true;
        }
        ...
        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1, 2)) {
            if (this.renderMinZ <= 0.0D) {
                --p_147751_4_;
            }

            this.aoLightValueScratchXZNN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchYZNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoLightValueScratchYZPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            this.aoLightValueScratchXZPN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessXZNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessYZNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoBrightnessYZPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            this.aoBrightnessXZPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_ - 1,
                        p_147751_4_);
                this.aoBrightnessXYZNNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1,
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_ + 1,
                        p_147751_4_);
                this.aoBrightnessXYZNPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1,
                        p_147751_3_ + 1, p_147751_4_);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_ - 1,
                        p_147751_4_);
                this.aoBrightnessXYZPNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1,
                        p_147751_3_ - 1, p_147751_4_);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_ + 1,
                        p_147751_4_);
                this.aoBrightnessXYZPPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1,
                        p_147751_3_ + 1, p_147751_4_);
            }
            ...
            if (this.renderMinZ <= 0.0D
                    || !this.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1).isOpaqueCube()) {
            ...
            var9 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + var21
                    + this.aoLightValueScratchYZPN) / 4.0F;
            var10 = (var21 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN
                    + this.aoLightValueScratchXYZPPN) / 4.0F;
            var11 = (this.aoLightValueScratchYZNN + var21 + this.aoLightValueScratchXYZPNN
                    + this.aoLightValueScratchXZPN) / 4.0F;
            var12 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN
                    + var21) / 4.0F;
            ...
            if (betterGrass) {
                var22 = this.fixAoSideGrassTexture(var22, p_147751_2_, p_147751_3_, p_147751_4_, 2, p_147751_5_,
                        p_147751_6_, p_147751_7_);
            }

            this.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, var22);

            if (defaultTexture && fancyGrass && var22 == TextureUtils.iconGrassSide
                ...
                this.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1, 3)) {
            if (this.renderMaxZ >= 1.0D) {
                ++p_147751_4_;
            }

            this.aoLightValueScratchXZNP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchXZPP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoLightValueScratchYZNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoLightValueScratchYZPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            this.aoBrightnessXZNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessXZPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1, p_147751_3_,
                    p_147751_4_);
            this.aoBrightnessYZNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoBrightnessYZPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            var16 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ + 1).getCanBlockGrass();
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_ - 1,
                        p_147751_4_);
                this.aoBrightnessXYZNNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1,
                        p_147751_3_ - 1, p_147751_4_);
            }
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147751_2_ - 1, p_147751_3_ + 1,
                        p_147751_4_);
                this.aoBrightnessXYZNPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ - 1,
                        p_147751_3_ + 1, p_147751_4_);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_ - 1,
                        p_147751_4_);
                this.aoBrightnessXYZPNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1,
                        p_147751_3_ - 1, p_147751_4_);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_ + 1,
                        p_147751_4_);
                this.aoBrightnessXYZPPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_ + 1,
                        p_147751_3_ + 1, p_147751_4_);
            }
            ...
            var21 = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_, p_147751_4_ + 1);
            var9 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + var21
                    + this.aoLightValueScratchYZPP) / 4.0F;
            var12 = (var21 + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP
                    + this.aoLightValueScratchXYZPPP) / 4.0F;
            var11 = (this.aoLightValueScratchYZNP + var21 + this.aoLightValueScratchXYZPNP
                    + this.aoLightValueScratchXZPP) / 4.0F;
            var10 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP
                    + var21) / 4.0F;
            ...
            if (betterGrass) {
                var22 = this.fixAoSideGrassTexture(var22, p_147751_2_, p_147751_3_, p_147751_4_, 3, p_147751_5_,
                        p_147751_6_, p_147751_7_);
            }
            ...
            if (defaultTexture && fancyGrass && var22 == TextureUtils.iconGrassSide
                ...
                this.colorBlueBottomRight *= p_147751_7_;
                this.colorBlueTopRight *= p_147751_7_;
                this.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_, 4)) {
            if (this.renderMinX <= 0.0D) {
                --p_147751_2_;
            }

            this.aoLightValueScratchXYNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoLightValueScratchXZNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoLightValueScratchXZNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoLightValueScratchXYNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            this.aoBrightnessXYNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoBrightnessXZNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoBrightnessXZNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoBrightnessXYNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            var16 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_).getCanBlockGrass();
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZNNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ - 1);
            }
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZNNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ + 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZNPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ - 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZNPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ + 1);
            }
            ...
            if (this.renderMinX <= 0.0D
                    || !this.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_).isOpaqueCube()) {
            ...
            if (betterGrass) {
                var22 = this.fixAoSideGrassTexture(var22, p_147751_2_, p_147751_3_, p_147751_4_, 4, p_147751_5_,
                        p_147751_6_, p_147751_7_);
            }
            ...
            if (defaultTexture && fancyGrass && var22 == TextureUtils.iconGrassSide
                ...
                this.colorBlueBottomRight *= p_147751_7_;
                this.colorBlueTopRight *= p_147751_7_;
                this.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_, 5)) {
            if (this.renderMaxX >= 1.0D) {
                ++p_147751_2_;
            }

            this.aoLightValueScratchXYPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoLightValueScratchXZPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoLightValueScratchXZPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoLightValueScratchXYPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            this.aoBrightnessXYPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                    p_147751_4_);
            this.aoBrightnessXZPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ - 1);
            this.aoBrightnessXZPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_,
                    p_147751_4_ + 1);
            this.aoBrightnessXYPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                    p_147751_4_);
            var16 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1).getCanBlockGrass();
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZPNN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ - 1);
            }
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZPNP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ - 1,
                        p_147751_4_ + 1);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ - 1);
                this.aoBrightnessXYZPPN = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ - 1);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ + 1);
                this.aoBrightnessXYZPPP = p_147751_1_.getBlockBrightness(this.blockAccess, p_147751_2_, p_147751_3_ + 1,
                        p_147751_4_ + 1);
            }
            ...
            var21 = this.getAmbientOcclusionLightValue(p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            var9 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + var21
                    + this.aoLightValueScratchXZPP) / 4.0F;
            var10 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN
                    + var21) / 4.0F;
            var11 = (this.aoLightValueScratchXZPN + var21 + this.aoLightValueScratchXYZPPN
                    + this.aoLightValueScratchXYPP) / 4.0F;
            var12 = (var21 + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP
                    + this.aoLightValueScratchXYZPPP) / 4.0F;
            ...
            if (betterGrass) {
                var22 = this.fixAoSideGrassTexture(var22, p_147751_2_, p_147751_3_, p_147751_4_, 5, p_147751_5_,
                        p_147751_6_, p_147751_7_);
            }
            ...
            if (defaultTexture && fancyGrass && var22 == TextureUtils.iconGrassSide
                ...
                this.colorBlueBottomRight *= p_147751_7_;
                this.colorBlueTopRight *= p_147751_7_;
                this.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_,
                        BlockGrass.func_149990_e());
            }
    ...
    public boolean renderStandardBlockWithAmbientOcclusionPartial(Block p_147808_1_, int p_147808_2_, int p_147808_3_,
        ...
        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_, 0)) {
            if (this.renderMinY <= 0.0D) {
                --p_147808_3_;
            }

            this.aoBrightnessXYNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessYZNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoBrightnessYZNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoBrightnessXYPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchXYNN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchYZNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoLightValueScratchYZNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoLightValueScratchXYPN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZNNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ - 1);
            }
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZNNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ + 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZPNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ - 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZPNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ + 1);
            }
            ...
            if (this.renderMinY <= 0.0D
                    || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_).isOpaqueCube()) {
            ...
            this.colorGreenTopRight *= var12;
            this.colorBlueTopRight *= var12;
            this.renderFaceYNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                    this.getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 0));
            var8 = true;
        }

        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_, 1)) {
            if (this.renderMaxY >= 1.0D) {
                ++p_147808_3_;
            }

            this.aoBrightnessXYNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessXYPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessYZPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoBrightnessYZPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoLightValueScratchXYNP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchXYPP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchYZPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoLightValueScratchYZPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            var16 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1).getCanBlockGrass();
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZNPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ - 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZPPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ - 1);
            }
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZNPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                        p_147808_4_ + 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZPPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                        p_147808_4_ + 1);
            }
            ...
            this.colorGreenTopRight *= var12;
            this.colorBlueTopRight *= var12;
            this.renderFaceYPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                    this.getBlockIcon(p_147808_1_, this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 1));
            var8 = true;
        }
        ...
        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1, 2)) {
            if (this.renderMinZ <= 0.0D) {
                --p_147808_4_;
            }

            this.aoLightValueScratchXZNN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchYZNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoLightValueScratchYZPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            this.aoLightValueScratchXZPN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessXZNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessYZNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoBrightnessYZPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            this.aoBrightnessXZPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_ - 1,
                        p_147808_4_);
                this.aoBrightnessXYZNNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1,
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_ + 1,
                        p_147808_4_);
                this.aoBrightnessXYZNPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1,
                        p_147808_3_ + 1, p_147808_4_);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_ - 1,
                        p_147808_4_);
                this.aoBrightnessXYZPNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1,
                        p_147808_3_ - 1, p_147808_4_);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_ + 1,
                        p_147808_4_);
                this.aoBrightnessXYZPPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1,
                        p_147808_3_ + 1, p_147808_4_);
            }
            ...
            if (this.renderMinZ <= 0.0D
                    || !this.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1).isOpaqueCube()) {
            ...
            var22 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + var21
                    + this.aoLightValueScratchYZPN) / 4.0F;
            var23 = (var21 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN
                    + this.aoLightValueScratchXYZPPN) / 4.0F;
            var24 = (this.aoLightValueScratchYZNN + var21 + this.aoLightValueScratchXYZPNN
                    + this.aoLightValueScratchXZPN) / 4.0F;
            var25 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN
                    + var21) / 4.0F;
            var9 = (float) ((double) var22 * this.renderMaxY * (1.0D - this.renderMinX)
                    + (double) var23 * this.renderMaxY * this.renderMinX
                    + (double) var24 * (1.0D - this.renderMaxY) * this.renderMinX
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            var10 = (float) ((double) var22 * this.renderMaxY * (1.0D - this.renderMaxX)
                    + (double) var23 * this.renderMaxY * this.renderMaxX
                    + (double) var24 * (1.0D - this.renderMaxY) * this.renderMaxX
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            var11 = (float) ((double) var22 * this.renderMinY * (1.0D - this.renderMaxX)
                    + (double) var23 * this.renderMinY * this.renderMaxX
                    + (double) var24 * (1.0D - this.renderMinY) * this.renderMaxX
                    + (double) var25 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
            var12 = (float) ((double) var22 * this.renderMinY * (1.0D - this.renderMinX)
                    + (double) var23 * this.renderMinY * this.renderMinX
                    + (double) var24 * (1.0D - this.renderMinY) * this.renderMinX
            ...
            this.brightnessTopLeft = this.mixAoBrightness(var26, var27, var28, var29,
                    this.renderMaxY * (1.0D - this.renderMinX), this.renderMaxY * this.renderMinX,
                    (1.0D - this.renderMaxY) * this.renderMinX, (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            this.brightnessBottomLeft = this.mixAoBrightness(var26, var27, var28, var29,
                    this.renderMaxY * (1.0D - this.renderMaxX), this.renderMaxY * this.renderMaxX,
                    (1.0D - this.renderMaxY) * this.renderMaxX, (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            this.brightnessBottomRight = this.mixAoBrightness(var26, var27, var28, var29,
            ...
            this.brightnessTopRight = this.mixAoBrightness(var26, var27, var28, var29,
                    this.renderMinY * (1.0D - this.renderMinX), this.renderMinY * this.renderMinX,
                    (1.0D - this.renderMinY) * this.renderMinX, (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
            ...
            if (var30 != null && fancyGrass && var30.getIconName().equals("grass_side")
                    && !this.hasOverrideBlockTexture()) {
                ...
                this.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1, 3)) {
            if (this.renderMaxZ >= 1.0D) {
                ++p_147808_4_;
            }

            this.aoLightValueScratchXZNP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchXZPP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoLightValueScratchYZNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoLightValueScratchYZPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            this.aoBrightnessXZNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessXZPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1, p_147808_3_,
                    p_147808_4_);
            this.aoBrightnessYZNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoBrightnessYZPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            var16 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ + 1).getCanBlockGrass();
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_ - 1,
                        p_147808_4_);
                this.aoBrightnessXYZNNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1,
                        p_147808_3_ - 1, p_147808_4_);
            }
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147808_2_ - 1, p_147808_3_ + 1,
                        p_147808_4_);
                this.aoBrightnessXYZNPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ - 1,
                        p_147808_3_ + 1, p_147808_4_);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_ - 1,
                        p_147808_4_);
                this.aoBrightnessXYZPNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1,
                        p_147808_3_ - 1, p_147808_4_);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_ + 1,
                        p_147808_4_);
                this.aoBrightnessXYZPPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_ + 1,
                        p_147808_3_ + 1, p_147808_4_);
            }
            ...
            var21 = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_, p_147808_4_ + 1);
            var22 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + var21
                    + this.aoLightValueScratchYZPP) / 4.0F;
            var23 = (var21 + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP
                    + this.aoLightValueScratchXYZPPP) / 4.0F;
            var24 = (this.aoLightValueScratchYZNP + var21 + this.aoLightValueScratchXYZPNP
                    + this.aoLightValueScratchXZPP) / 4.0F;
            var25 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP
                    + var21) / 4.0F;
            var9 = (float) ((double) var22 * this.renderMaxY * (1.0D - this.renderMinX)
                    + (double) var23 * this.renderMaxY * this.renderMinX
                    + (double) var24 * (1.0D - this.renderMaxY) * this.renderMinX
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinX));
            var10 = (float) ((double) var22 * this.renderMinY * (1.0D - this.renderMinX)
                    + (double) var23 * this.renderMinY * this.renderMinX
                    + (double) var24 * (1.0D - this.renderMinY) * this.renderMinX
                    + (double) var25 * (1.0D - this.renderMinY) * (1.0D - this.renderMinX));
            var11 = (float) ((double) var22 * this.renderMinY * (1.0D - this.renderMaxX)
                    ...
                    + (double) var24 * (1.0D - this.renderMinY) * this.renderMaxX
                    + (double) var25 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxX));
            var12 = (float) ((double) var22 * this.renderMaxY * (1.0D - this.renderMaxX)
                    + (double) var23 * this.renderMaxY * this.renderMaxX
                    + (double) var24 * (1.0D - this.renderMaxY) * this.renderMaxX
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX));
            ...
            this.brightnessTopLeft = this.mixAoBrightness(var26, var29, var28, var27,
                    this.renderMaxY * (1.0D - this.renderMinX), (1.0D - this.renderMaxY) * (1.0D - this.renderMinX),
                    (1.0D - this.renderMaxY) * this.renderMinX, this.renderMaxY * this.renderMinX);
            this.brightnessBottomLeft = this.mixAoBrightness(var26, var29, var28, var27,
                    this.renderMinY * (1.0D - this.renderMinX), (1.0D - this.renderMinY) * (1.0D - this.renderMinX),
                    (1.0D - this.renderMinY) * this.renderMinX, this.renderMinY * this.renderMinX);
            this.brightnessBottomRight = this.mixAoBrightness(var26, var29, var28, var27,
            ...
            this.brightnessTopRight = this.mixAoBrightness(var26, var29, var28, var27,
                    this.renderMaxY * (1.0D - this.renderMaxX), (1.0D - this.renderMaxY) * (1.0D - this.renderMaxX),
                    (1.0D - this.renderMaxY) * this.renderMaxX, this.renderMaxY * this.renderMaxX);
            ...
            if (var30 != null && fancyGrass && var30.getIconName().equals("grass_side")
                ...
                this.colorBlueBottomRight *= p_147808_7_;
                this.colorBlueTopRight *= p_147808_7_;
                this.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_, 4)) {
            if (this.renderMinX <= 0.0D) {
                --p_147808_2_;
            }

            this.aoLightValueScratchXYNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoLightValueScratchXZNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoLightValueScratchXZNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoLightValueScratchXYNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            this.aoBrightnessXYNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoBrightnessXZNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoBrightnessXZNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoBrightnessXYNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            var16 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_).getCanBlockGrass();
            ...
            if (!var18 && !var17) {
                ...
                this.aoLightValueScratchXYZNNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZNNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ - 1);
            }
            ...
            if (!var19 && !var17) {
                ...
                this.aoLightValueScratchXYZNNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZNNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ + 1);
            }
            ...
            if (!var18 && !var16) {
                ...
                this.aoLightValueScratchXYZNPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZNPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ - 1);
            }
            ...
            if (!var19 && !var16) {
                ...
                this.aoLightValueScratchXYZNPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZNPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ + 1);
            }
            ...
            if (this.renderMinX <= 0.0D
                    || !this.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_).isOpaqueCube()) {
            ...
            var22 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + var21
                    + this.aoLightValueScratchXZNP) / 4.0F;
            var23 = (var21 + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP
                    + this.aoLightValueScratchXYZNPP) / 4.0F;
            var24 = (this.aoLightValueScratchXZNN + var21 + this.aoLightValueScratchXYZNPN
                    + this.aoLightValueScratchXYNP) / 4.0F;
            var25 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN + this.aoLightValueScratchXZNN
                    + var21) / 4.0F;
            var9 = (float) ((double) var23 * this.renderMaxY * this.renderMaxZ
                    + (double) var24 * this.renderMaxY * (1.0D - this.renderMaxZ)
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ)
                    + (double) var22 * (1.0D - this.renderMaxY) * this.renderMaxZ);
            var10 = (float) ((double) var23 * this.renderMaxY * this.renderMinZ
                    + (double) var24 * this.renderMaxY * (1.0D - this.renderMinZ)
                    + (double) var25 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ)
                    + (double) var22 * (1.0D - this.renderMaxY) * this.renderMinZ);
            var11 = (float) ((double) var23 * this.renderMinY * this.renderMinZ
                    + (double) var24 * this.renderMinY * (1.0D - this.renderMinZ)
                    + (double) var25 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ)
                    + (double) var22 * (1.0D - this.renderMinY) * this.renderMinZ);
            var12 = (float) ((double) var23 * this.renderMinY * this.renderMaxZ
                    + (double) var24 * this.renderMinY * (1.0D - this.renderMaxZ)
                    + (double) var25 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ)
            ...
            this.brightnessTopLeft = this.mixAoBrightness(var27, var28, var29, var26, this.renderMaxY * this.renderMaxZ,
                    this.renderMaxY * (1.0D - this.renderMaxZ), (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ),
                    (1.0D - this.renderMaxY) * this.renderMaxZ);
            this.brightnessBottomLeft = this.mixAoBrightness(var27, var28, var29, var26,
                    this.renderMaxY * this.renderMinZ, this.renderMaxY * (1.0D - this.renderMinZ),
                    (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ), (1.0D - this.renderMaxY) * this.renderMinZ);
            this.brightnessBottomRight = this.mixAoBrightness(var27, var28, var29, var26,
                    this.renderMinY * this.renderMinZ, this.renderMinY * (1.0D - this.renderMinZ),
                    (1.0D - this.renderMinY) * (1.0D - this.renderMinZ), (1.0D - this.renderMinY) * this.renderMinZ);
            this.brightnessTopRight = this.mixAoBrightness(var27, var28, var29, var26,
                    this.renderMinY * this.renderMaxZ, this.renderMinY * (1.0D - this.renderMaxZ),
                    (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ), (1.0D - this.renderMinY) * this.renderMaxZ);
            ...
            if (var30 != null && fancyGrass && var30.getIconName().equals("grass_side")
                ...
                this.colorBlueBottomRight *= p_147808_7_;
                this.colorBlueTopRight *= p_147808_7_;
                this.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                        BlockGrass.func_149990_e());
            }
        ...
        if (this.renderAllFaces
                || p_147808_1_.shouldSideBeRendered(this.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_, 5)) {
            if (this.renderMaxX >= 1.0D) {
                ++p_147808_2_;
            }

            this.aoLightValueScratchXYPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoLightValueScratchXZPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoLightValueScratchXZPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoLightValueScratchXYPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            this.aoBrightnessXYPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                    p_147808_4_);
            this.aoBrightnessXZPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ - 1);
            this.aoBrightnessXZPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_,
                    p_147808_4_ + 1);
            this.aoBrightnessXYPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                    p_147808_4_);
            var16 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_).getCanBlockGrass();
            var17 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_).getCanBlockGrass();
            var18 = this.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1).getCanBlockGrass();
            ...
            if (!var17 && !var19) {
                ...
                this.aoLightValueScratchXYZPNN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZPNN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ - 1);
            }
            ...
            if (!var17 && !var18) {
                ...
                this.aoLightValueScratchXYZPNP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZPNP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ - 1,
                        p_147808_4_ + 1);
            }
            ...
            if (!var16 && !var19) {
                ...
                this.aoLightValueScratchXYZPPN = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ - 1);
                this.aoBrightnessXYZPPN = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ - 1);
            }
            ...
            if (!var16 && !var18) {
                ...
                this.aoLightValueScratchXYZPPP = this.getAmbientOcclusionLightValue(p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ + 1);
                this.aoBrightnessXYZPPP = p_147808_1_.getBlockBrightness(this.blockAccess, p_147808_2_, p_147808_3_ + 1,
                        p_147808_4_ + 1);
            }
            ...
            var21 = this.getAmbientOcclusionLightValue(p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            var22 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + var21
                    + this.aoLightValueScratchXZPP) / 4.0F;
            var23 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN
                    + var21) / 4.0F;
            var24 = (this.aoLightValueScratchXZPN + var21 + this.aoLightValueScratchXYZPPN
                    + this.aoLightValueScratchXYPP) / 4.0F;
            var25 = (var21 + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP
                    + this.aoLightValueScratchXYZPPP) / 4.0F;
            var9 = (float) ((double) var22 * (1.0D - this.renderMinY) * this.renderMaxZ
                    + (double) var23 * (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ)
                    + (double) var24 * this.renderMinY * (1.0D - this.renderMaxZ)
                    + (double) var25 * this.renderMinY * this.renderMaxZ);
            var10 = (float) ((double) var22 * (1.0D - this.renderMinY) * this.renderMinZ
                    + (double) var23 * (1.0D - this.renderMinY) * (1.0D - this.renderMinZ)
                    + (double) var24 * this.renderMinY * (1.0D - this.renderMinZ)
                    + (double) var25 * this.renderMinY * this.renderMinZ);
            var11 = (float) ((double) var22 * (1.0D - this.renderMaxY) * this.renderMinZ
                    + (double) var23 * (1.0D - this.renderMaxY) * (1.0D - this.renderMinZ)
                    + (double) var24 * this.renderMaxY * (1.0D - this.renderMinZ)
                    + (double) var25 * this.renderMaxY * this.renderMinZ);
            var12 = (float) ((double) var22 * (1.0D - this.renderMaxY) * this.renderMaxZ
                    + (double) var23 * (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ)
                    + (double) var24 * this.renderMaxY * (1.0D - this.renderMaxZ)
            ...
            this.brightnessTopLeft = this.mixAoBrightness(var26, var29, var28, var27,
                    (1.0D - this.renderMinY) * this.renderMaxZ, (1.0D - this.renderMinY) * (1.0D - this.renderMaxZ),
                    this.renderMinY * (1.0D - this.renderMaxZ), this.renderMinY * this.renderMaxZ);
            this.brightnessBottomLeft = this.mixAoBrightness(var26, var29, var28, var27,
                    (1.0D - this.renderMinY) * this.renderMinZ, (1.0D - this.renderMinY) * (1.0D - this.renderMinZ),
                    this.renderMinY * (1.0D - this.renderMinZ), this.renderMinY * this.renderMinZ);
            this.brightnessBottomRight = this.mixAoBrightness(var26, var29, var28, var27,
            ...
            this.brightnessTopRight = this.mixAoBrightness(var26, var29, var28, var27,
                    (1.0D - this.renderMaxY) * this.renderMaxZ, (1.0D - this.renderMaxY) * (1.0D - this.renderMaxZ),
                    this.renderMaxY * (1.0D - this.renderMaxZ), this.renderMaxY * this.renderMaxZ);
            ...
            if (var30 != null && fancyGrass && var30.getIconName().equals("grass_side")
                ...
                this.colorBlueBottomRight *= p_147808_7_;
                this.colorBlueTopRight *= p_147808_7_;
                this.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_,
                        BlockGrass.func_149990_e());
            }
    ...
    public int mixAoBrightness(int p_147727_1_, int p_147727_2_, int p_147727_3_, int p_147727_4_, double p_147727_5_,
        ...
        int var14 = (int) ((double) (p_147727_1_ & 255) * p_147727_5_ + (double) (p_147727_2_ & 255) * p_147727_7_
                + (double) (p_147727_3_ & 255) * p_147727_9_ + (double) (p_147727_4_ & 255) * p_147727_11_) & 255;
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_,
        ...
        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_, 0)) {
            if (var26 < 0) {
            ...
            if (var8 != null) {
                var8.setBrightness(this.renderMinY > 0.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_));
            ...
            this.renderFaceYNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_,
                    this.getBlockIcon(p_147736_1_, this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 0));
            var9 = true;
        }

        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_, p_147736_3_ + 1, p_147736_4_, 1)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
            ...
            var22 = var27 * p_147736_7_;
            if (var8 != null) {
                var8.setBrightness(this.renderMaxY < 1.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_ + 1, p_147736_4_));
                var8.setColorOpaque_F(var13, var19, var22);
            }
            this.renderFaceYPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_,
                    this.getBlockIcon(p_147736_1_, this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 1));
            var9 = true;
        }
        ...
        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1, 2)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
            ...
            if (var8 != null) {
                var8.setBrightness(this.renderMinZ > 0.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1));
            ...
            if (defaultTexture && fancyGrass && var271 == TextureUtils.iconGrassSide
                    && !this.hasOverrideBlockTexture()) {
                if (var8 != null)
                    var8.setColorOpaque_F(var19 * p_147736_5_, var22 * p_147736_6_, var25 * p_147736_7_);
        ...
        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ + 1, 3)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
            ...
            if (var8 != null) {
                var8.setBrightness(this.renderMaxZ < 1.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ + 1));
                var8.setColorOpaque_F(var19, var22, var25);
            }
        ...
        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_, 4)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
            ...
            if (var8 != null) {
                var8.setBrightness(this.renderMinX > 0.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_));
                var8.setColorOpaque_F(var19, var22, var25);
            }
        ...
        if (this.renderAllFaces
                || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_ + 1, p_147736_3_, p_147736_4_, 5)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
            ...
            if (var8 != null) {
                var8.setBrightness(this.renderMaxX < 1.0D ? var26
                        : p_147736_1_.getBlockBrightness(this.blockAccess, p_147736_2_ + 1, p_147736_3_, p_147736_4_));
                var8.setColorOpaque_F(var19, var22, var25);
            }
    ...
    public boolean renderBlockCactusImpl(Block p_147754_1_, int p_147754_2_, int p_147754_3_, int p_147754_4_,
        ...
        if (this.renderAllFaces
                || p_147754_1_.shouldSideBeRendered(this.blockAccess, p_147754_2_, p_147754_3_ - 1, p_147754_4_, 0)) {
            if (var8 != null) {
                var8.setBrightness(this.renderMinY > 0.0D ? var27
                        : p_147754_1_.getBlockBrightness(this.blockAccess, p_147754_2_, p_147754_3_ - 1, p_147754_4_));
                var8.setColorOpaque_F(var14, var18, var22);
            }
            this.renderFaceYNeg(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                    this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 0));
        }

        if (this.renderAllFaces
                || p_147754_1_.shouldSideBeRendered(this.blockAccess, p_147754_2_, p_147754_3_ + 1, p_147754_4_, 1)) {
            if (var8 != null) {
                var8.setBrightness(this.renderMaxY < 1.0D ? var27
                        : p_147754_1_.getBlockBrightness(this.blockAccess, p_147754_2_, p_147754_3_ + 1, p_147754_4_));
                var8.setColorOpaque_F(var15, var19, var23);
            }
            this.renderFaceYPos(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                    this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 1));
        }
        ...
        this.renderFaceZNeg(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 2));
        if (var8 != null) {
            var8.addTranslation(0.0F, 0.0F, -var26);
            var8.addTranslation(0.0F, 0.0F, -var26);
        }
        this.renderFaceZPos(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 3));
        if (var8 != null) {
            var8.addTranslation(0.0F, 0.0F, var26);
            var8.setColorOpaque_F(var17, var21, var25);
            var8.addTranslation(var26, 0.0F, 0.0F);
        }
        this.renderFaceXNeg(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 4));
        if (var8 != null) {
            var8.addTranslation(-var26, 0.0F, 0.0F);
            var8.addTranslation(-var26, 0.0F, 0.0F);
        }
        this.renderFaceXPos(p_147754_1_, (double) p_147754_2_, (double) p_147754_3_, (double) p_147754_4_,
                this.getBlockIcon(p_147754_1_, this.blockAccess, p_147754_2_, p_147754_3_, p_147754_4_, 5));
        if (var8 != null)
            var8.addTranslation(var26, 0.0F, 0.0F);
        return true;
    }
    ...
    public boolean renderBlockFence(BlockFence p_147735_1_, int p_147735_2_, int p_147735_3_, int p_147735_4_) {
        ...
        if (p_147735_1_.func_149826_e(this.blockAccess, p_147735_2_ - 1, p_147735_3_, p_147735_4_)
                || p_147735_1_.func_149826_e(this.blockAccess, p_147735_2_ + 1, p_147735_3_, p_147735_4_)) {
            var8 = true;
        }

        if (p_147735_1_.func_149826_e(this.blockAccess, p_147735_2_, p_147735_3_, p_147735_4_ - 1)
                || p_147735_1_.func_149826_e(this.blockAccess, p_147735_2_, p_147735_3_, p_147735_4_ + 1)) {
            var9 = true;
        }
        ...
        if (var8) {
            this.setRenderBounds((double) var16, (double) var14, (double) var6, (double) var17, (double) var15,
                    (double) var7);
            this.renderStandardBlock(p_147735_1_, p_147735_2_, p_147735_3_, p_147735_4_);
            var5 = true;
        }
        ...
        if (var9) {
            this.setRenderBounds((double) var6, (double) var14, (double) var18, (double) var7, (double) var15,
                    (double) var19);
            this.renderStandardBlock(p_147735_1_, p_147735_2_, p_147735_3_, p_147735_4_);
            var5 = true;
        }
    ...
    public boolean renderBlockDragonEgg(BlockDragonEgg p_147802_1_, int p_147802_2_, int p_147802_3_, int p_147802_4_) {
        ...
        for (int var7 = 0; var7 < 8; ++var7) {
            ...
            var6 += var9;
            this.setRenderBounds((double) (0.5F - var10), (double) var12, (double) (0.5F - var10),
    ...
    public boolean renderBlockFenceGate(BlockFenceGate p_147776_1_, int p_147776_2_, int p_147776_3_, int p_147776_4_) {
        ...
        if (var8 != 3 && var8 != 1) {
            ...
            var17 = 0.4375F;
            var18 = 0.5625F;
            this.setRenderBounds((double) var15, (double) var13, (double) var17, (double) var16, (double) var14,
                    (double) var18);
        ...
        if (var7) {
            ...
            var17 = 0.4375F;
            var18 = 0.5625F;
            this.setRenderBounds((double) var15, (double) var9, (double) var17, (double) var16, (double) var12,
                    (double) var18);
            this.renderStandardBlock(p_147776_1_, p_147776_2_, p_147776_3_, p_147776_4_);
            var15 = 0.5F;
            var16 = 0.625F;
    ...
    public boolean renderBlockHopper(BlockHopper p_147803_1_, int p_147803_2_, int p_147803_3_, int p_147803_4_) {
        ...
        if (var5 != null)
            var5.setColorOpaque_F(var7, var8, var9);
        return this.renderBlockHopperMetadata(p_147803_1_, p_147803_2_, p_147803_3_, p_147803_4_,
                this.blockAccess.getBlockMetadata(p_147803_2_, p_147803_3_, p_147803_4_), false);
    }
    ...
    public boolean renderBlockHopperMetadata(BlockHopper p_147799_1_, int p_147799_2_, int p_147799_3_, int p_147799_4_,
        ...
        if (p_147799_6_ && var7 != null) {
            var7.startDrawingQuads();
            var7.setNormal(0.0F, -1.0F, 0.0F);
            this.renderFaceYNeg(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 0, p_147799_5_));
            var7.draw();
            var7.startDrawingQuads();
            var7.setNormal(0.0F, 1.0F, 0.0F);
            this.renderFaceYPos(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 1, p_147799_5_));
            var7.draw();
            var7.startDrawingQuads();
            var7.setNormal(0.0F, 0.0F, -1.0F);
            this.renderFaceZNeg(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 2, p_147799_5_));
            var7.draw();
            var7.startDrawingQuads();
            var7.setNormal(0.0F, 0.0F, 1.0F);
            this.renderFaceZPos(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 3, p_147799_5_));
            var7.draw();
            var7.startDrawingQuads();
            var7.setNormal(-1.0F, 0.0F, 0.0F);
            this.renderFaceXNeg(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 4, p_147799_5_));
            var7.draw();
            var7.startDrawingQuads();
            var7.setNormal(1.0F, 0.0F, 0.0F);
            this.renderFaceXPos(p_147799_1_, 0.0D, 0.0D, 0.0D,
                    this.getBlockIconFromSideAndMetadata(p_147799_1_, 5, p_147799_5_));
            var7.draw();
        } else {
        ...
        if (!p_147799_6_) {
            if (var7 != null)
                var7.setBrightness(
                        p_147799_1_.getBlockBrightness(this.blockAccess, p_147799_2_, p_147799_3_, p_147799_4_));
        ...
        if (p_147799_6_ && var7 != null) {
            ...
            this.renderFaceXPos(p_147799_1_, (double) ((float) p_147799_2_ - 1.0F + var13), (double) p_147799_3_,
                    (double) p_147799_4_, var241);
            this.renderFaceXNeg(p_147799_1_, (double) ((float) p_147799_2_ + 1.0F - var13), (double) p_147799_3_,
                    (double) p_147799_4_, var241);
            this.renderFaceZPos(p_147799_1_, (double) p_147799_2_, (double) p_147799_3_,
                    (double) ((float) p_147799_4_ - 1.0F + var13), var241);
            this.renderFaceZNeg(p_147799_1_, (double) p_147799_2_, (double) p_147799_3_,
                    (double) ((float) p_147799_4_ + 1.0F - var13), var241);
            this.renderFaceYPos(p_147799_1_, (double) p_147799_2_, (double) ((float) p_147799_3_ - 1.0F) + var9,
                    (double) p_147799_4_, var251);
        }
    ...
    public boolean renderBlockDoor(Block p_147760_1_, int p_147760_2_, int p_147760_3_, int p_147760_4_) {
        ...
        if (var5 != null) {
            var5.setBrightness(this.renderMinY > 0.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_, p_147760_3_ - 1, p_147760_4_));
            var5.setColorOpaque_F(var8, var8, var8);
        }
        this.renderFaceYNeg(p_147760_1_, (double) p_147760_2_, (double) p_147760_3_, (double) p_147760_4_,
                this.getBlockIcon(p_147760_1_, this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_, 0));
        var7 = true;
        if (var5 != null) {
            var5.setBrightness(this.renderMaxY < 1.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_, p_147760_3_ + 1, p_147760_4_));
            var5.setColorOpaque_F(var9, var9, var9);
        }
        this.renderFaceYPos(p_147760_1_, (double) p_147760_2_, (double) p_147760_3_, (double) p_147760_4_,
                this.getBlockIcon(p_147760_1_, this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_, 1));
        var7 = true;
        if (var5 != null) {
            var5.setBrightness(this.renderMinZ > 0.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_ - 1));
            var5.setColorOpaque_F(var10, var10, var10);
        }
        ...
        this.flipTexture = false;
        if (var5 != null) {
            var5.setBrightness(this.renderMaxZ < 1.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_, p_147760_3_, p_147760_4_ + 1));
            var5.setColorOpaque_F(var10, var10, var10);
        }
        ...
        this.flipTexture = false;
        if (var5 != null) {
            var5.setBrightness(this.renderMinX > 0.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_ - 1, p_147760_3_, p_147760_4_));
            var5.setColorOpaque_F(var11, var11, var11);
        }
        ...
        this.flipTexture = false;
        if (var5 != null) {
            var5.setBrightness(this.renderMaxX < 1.0D ? var12
                    : p_147760_1_.getBlockBrightness(this.blockAccess, p_147760_2_ + 1, p_147760_3_, p_147760_4_));
            var5.setColorOpaque_F(var11, var11, var11);
        }
    ...
    public void renderFaceZNeg(Block p_147761_1_, double p_147761_2_, double p_147761_4_, double p_147761_6_,
        ...
        double var101 = (double) p_147761_8_.getInterpolatedU(this.renderMinX * 16.0D);
        double var12 = (double) p_147761_8_.getInterpolatedU(this.renderMaxX * 16.0D);

        if (this.field_152631_f) {
            var12 = (double) p_147761_8_.getInterpolatedU((1.0D - this.renderMinX) * 16.0D);
            var101 = (double) p_147761_8_.getInterpolatedU((1.0D - this.renderMaxX) * 16.0D);
        }
    ...
    public void renderFaceXPos(Block p_147764_1_, double p_147764_2_, double p_147764_4_, double p_147764_6_,
        ...
        double var101 = (double) p_147764_8_.getInterpolatedU(this.renderMinZ * 16.0D);
        double var12 = (double) p_147764_8_.getInterpolatedU(this.renderMaxZ * 16.0D);

        if (this.field_152631_f) {
            var12 = (double) p_147764_8_.getInterpolatedU((1.0D - this.renderMinZ) * 16.0D);
            var101 = (double) p_147764_8_.getInterpolatedU((1.0D - this.renderMaxZ) * 16.0D);
        }
        ...
        if (var6 != 0 && var6 != 31 && var6 != 39 && var6 != 16 && var6 != 26) {
            if (var6 == 1) {
                ...
                for (int var181 = 0; var181 < 8; ++var181) {
                    ...
                    var14 += var18;
                    this.setRenderBounds((double) (0.5F - var11), (double) var13, (double) (0.5F - var11),
                            (double) (0.5F + var11), (double) var12, (double) (0.5F + var11));
                    if (var4 != null)
                        var4.setNormal(0.0F, -1.0F, 0.0F);
                    this.renderFaceYNeg(p_147800_1_, 0.0D, 0.0D, 0.0D, this.getBlockIconFromSide(p_147800_1_, 0));
                    if (var4 != null)
                ...
                for (var14 = 0; var14 < 4; ++var14) {
                    ...
                    if (var14 == 0) {
                        this.setRenderBounds((double) (0.5F - var8), 0.0D, 0.0D, (double) (0.5F + var8), 1.0D,
                                (double) (var8 * 2.0F));
                    }

                    if (var14 == 1) {
                        this.setRenderBounds((double) (0.5F - var8), 0.0D, (double) (1.0F - var8 * 2.0F),
                                (double) (0.5F + var8), 1.0D, 1.0D);
                    }

                    var8 = 0.0625F;

                    if (var14 == 2) {
                        this.setRenderBounds((double) (0.5F - var8), (double) (1.0F - var8 * 3.0F),
                                (double) (-var8 * 2.0F), (double) (0.5F + var8), (double) (1.0F - var8),
                                (double) (1.0F + var8 * 2.0F));
                    }

                    if (var14 == 3) {
                        this.setRenderBounds((double) (0.5F - var8), (double) (0.5F - var8 * 3.0F),
                                (double) (-var8 * 2.0F), (double) (0.5F + var8), (double) (0.5F - var8),
                                (double) (1.0F + var8 * 2.0F));
                    }
                ...
                for (var14 = 0; var14 < 3; ++var14) {
                    ...
                    if (var14 == 0) {
                        this.setRenderBounds((double) (0.5F - var8), 0.30000001192092896D, 0.0D, (double) (0.5F + var8),
                                1.0D, (double) (var8 * 2.0F));
                    }

                    if (var14 == 1) {
                        this.setRenderBounds((double) (0.5F - var8), 0.30000001192092896D,
                                (double) (1.0F - var8 * 2.0F), (double) (0.5F + var8), 1.0D, 1.0D);
                    }

                    var8 = 0.0625F;

                    if (var14 == 2) {
                        this.setRenderBounds((double) (0.5F - var8), 0.5D, 0.0D, (double) (0.5F + var8),
                                (double) (1.0F - var8), 1.0D);
                    }
                ...
                for (var14 = 0; var14 < 2; ++var14) {
                    ...
                    this.renderFaceYNeg(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 0, p_147800_2_));
                    if (var4 != null) {
                        var4.draw();
                        var4.startDrawingQuads();
                        var4.setNormal(0.0F, 1.0F, 0.0F);
                    }
                    this.renderFaceYPos(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 1, p_147800_2_));
                    if (var4 != null) {
                        var4.draw();
                        var4.startDrawingQuads();
                        var4.setNormal(0.0F, 0.0F, -1.0F);
                    }
                    this.renderFaceZNeg(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 2, p_147800_2_));
                    if (var4 != null) {
                        var4.draw();
                        var4.startDrawingQuads();
                        var4.setNormal(0.0F, 0.0F, 1.0F);
                    }
                    this.renderFaceZPos(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 3, p_147800_2_));
                    if (var4 != null) {
                        var4.draw();
                        var4.startDrawingQuads();
                        var4.setNormal(-1.0F, 0.0F, 0.0F);
                    }
                    this.renderFaceXNeg(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 4, p_147800_2_));
                    if (var4 != null) {
                        var4.draw();
                        var4.startDrawingQuads();
                        var4.setNormal(1.0F, 0.0F, 0.0F);
                    }
                    this.renderFaceXPos(p_147800_1_, 0.0D, 0.0D, 0.0D,
                            this.getBlockIconFromSideAndMetadata(p_147800_1_, 5, p_147800_2_));
                    if (var4 != null)
                        var4.draw();
                    GL11.glTranslatef(0.5F, 0.5F, 0.5F);
                }
    ...
    private boolean hasSnowNeighbours(int x, int y, int z) {
        ...
        return this.blockAccess.getBlock(x - 1, y, z) != blockSnow
