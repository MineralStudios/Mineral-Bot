...
public class RenderZombie extends RenderBiped {
    ...
    public RenderZombie(Minecraft mc) {
        super(mc, new ModelZombie(mc), 0.5F, 1.0F);
        this.field_82434_o = this.modelBipedMain;
        this.zombieVillagerModel = new ModelZombieVillager(mc);
    }

    protected void func_82421_b() {
        this.field_82423_g = new ModelZombie(mc, 1.0F, true);
        this.field_82425_h = new ModelZombie(mc, 0.5F, true);
        this.field_82437_k = this.field_82423_g;
        this.field_82435_l = this.field_82425_h;
        this.field_82436_m = new ModelZombieVillager(mc, 1.0F, 0.0F, true);
        this.field_82433_n = new ModelZombieVillager(mc, 0.5F, 0.0F, true);
    }
