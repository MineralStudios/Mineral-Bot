...
public class RenderEnchantmentTable extends TileEntitySpecialRenderer {
    ...
    public RenderEnchantmentTable(Minecraft mc) {
        this.field_147541_c = new ModelBook(mc);
        this.mc = mc;
    }
    ...
    public void renderTileEntityAt(TileEntityEnchantmentTable p_147500_1_, double p_147500_2_,
        ...
        for (var10 = p_147500_1_.field_145928_o
                - p_147500_1_.field_145925_p; var10 >= (float) Math.PI; var10 -= ((float) Math.PI * 2F)) {
            ;
        }
        ...
        float var12 = p_147500_1_.field_145931_j
                + (p_147500_1_.field_145933_i - p_147500_1_.field_145931_j) * p_147500_8_ + 0.25F;
        float var13 = p_147500_1_.field_145931_j
                + (p_147500_1_.field_145933_i - p_147500_1_.field_145931_j) * p_147500_8_ + 0.75F;
        ...
        float var14 = p_147500_1_.field_145927_n
