...
public class RenderWitch extends RenderLiving {
     ...
     */
    public void doRender(EntityWitch p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
    ...
    protected void renderEquippedItems(EntityWitch p_77029_1_, float p_77029_2_) {
        ...
        if (var3 != null) {
            ...
            if (var3.getItem() instanceof ItemBlock
                    && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var3.getItem()).getRenderType())) {
                var4 = 0.5F;
