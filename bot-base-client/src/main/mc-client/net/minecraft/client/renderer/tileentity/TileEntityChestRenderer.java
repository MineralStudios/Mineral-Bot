...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation field_147507_b = new ResourceLocation(
            "textures/entity/chest/trapped_double.png");
    private static final ResourceLocation field_147508_c = new ResourceLocation(
    ...
    public TileEntityChestRenderer(Minecraft mc) {
        ...
        this.field_147511_i = new ModelLargeChest(mc);
    ...
    public void renderTileEntityAt(TileEntityChest p_147500_1_, double p_147500_2_, double p_147500_4_,
        ...
        if (!p_147500_1_.hasWorldObj()) {
            ...
            if (var10 instanceof BlockChest && var9 == 0) {
                ((BlockChest) var10).func_149954_e(p_147500_1_.getWorldObj(), p_147500_1_.field_145851_c,
        ...
        if (p_147500_1_.field_145992_i == null && p_147500_1_.field_145991_k == null) {
            ...
            GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
            float var12 = p_147500_1_.field_145986_n
                    + (p_147500_1_.field_145989_m - p_147500_1_.field_145986_n) * p_147500_8_;
            float var13;
