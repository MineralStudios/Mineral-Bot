...
public class ItemRenderer {
    ...
    public ItemRenderer(Minecraft mc) {
        this.mc = mc;
        renderBlocksIr = new RenderBlocks(mc);
    }
        ...
        if (var8 != null && var8.getItem() == Items.filled_map) {
            ...
            if (var3.getItemInUseCount() > 0) {
                ...
                if (var23 == EnumAction.eat || var23 == EnumAction.drink) {
                    ...
                    var16 = var16 * var16 * var16;
                    var17 = 1.0F - var16;
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(var14 / 4.0F * (float) Math.PI) * 0.1F)
            ...
            if (var3.getItemInUseCount() > 0) {
                ...
                if (var27 == EnumAction.block) {
                    ...
                    var18 = (float) var8.getMaxItemUseDuration()
                            - ((float) var3.getItemInUseCount() - p_78440_1_ + 1.0F);
                    var19 = var18 / 20.0F;
            ...
            var14 = MathHelper.sin(var13 * (float) Math.PI);
            var15 = MathHelper.sin(MathHelper.sqrt_float(var13) * (float) Math.PI);
            GL11.glTranslatef(-var15 * 0.3F,
                    MathHelper.sin(MathHelper.sqrt_float(var13) * (float) Math.PI * 2.0F) * 0.4F, -var14 * 0.4F);
