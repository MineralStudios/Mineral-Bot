...
public class RenderSheep extends RenderLiving {
    ...
    public RenderSheep(Minecraft mc, ModelBase p_i1266_1_, ModelBase p_i1266_2_, float p_i1266_3_) {
        super(mc, p_i1266_1_, p_i1266_3_);
    ...
    protected int shouldRenderPass(EntitySheep p_77032_1_, int p_77032_2_, float p_77032_3_) {
        if (p_77032_2_ == 0 && !p_77032_1_.getSheared()) {
            ...
            if (p_77032_1_.hasCustomNameTag() && "jeb_".equals(p_77032_1_.getCustomNameTag())) {
                ...
                GL11.glColor3f(
                        EntitySheep.fleeceColorTable[var6][0] * (1.0F - var8)
                                + EntitySheep.fleeceColorTable[var7][0] * var8,
                        EntitySheep.fleeceColorTable[var6][1] * (1.0F - var8)
                                + EntitySheep.fleeceColorTable[var7][1] * var8,
                        EntitySheep.fleeceColorTable[var6][2] * (1.0F - var8)
                                + EntitySheep.fleeceColorTable[var7][2] * var8);
            } else {
                int var4 = p_77032_1_.getFleeceColor();
                GL11.glColor3f(EntitySheep.fleeceColorTable[var4][0], EntitySheep.fleeceColorTable[var4][1],
                        EntitySheep.fleeceColorTable[var4][2]);
            }
