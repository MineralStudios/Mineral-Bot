...
public class RenderBiped extends RenderLiving {
    ...
    public RenderBiped(Minecraft mc, ModelBiped p_i1258_1_, float p_i1258_2_, float p_i1258_3_) {
        super(mc, p_i1258_1_, p_i1258_2_);
    ...
    protected void func_82421_b() {
        this.field_82423_g = new ModelBiped(this.mc, 1.0F);
        this.field_82425_h = new ModelBiped(this.mc, 0.5F);
    }
    ...
    protected void func_82420_a(EntityLiving p_82420_1_, ItemStack p_82420_2_) {
        this.field_82423_g.heldItemRight = this.field_82425_h.heldItemRight = this.modelBipedMain.heldItemRight = p_82420_2_ != null
                ? 1
                : 0;
    ...
    protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
                ...
                if (var4.hasTagCompound()) {
                    ...
                    if (var8.func_150297_b("SkullOwner", 10)) {
                        var7 = NBTUtil.func_152459_a(var8.getCompoundTag("SkullOwner"));
                            ...
                            && !StringUtils.isNullOrEmpty(var8.getString("SkullOwner"))) {
        ...
        if (var3 != null && var3.getItem() != null) {
            ...
            if (var5 instanceof ItemBlock
                    && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var5).getRenderType())) {
                var6 = 0.5F;
