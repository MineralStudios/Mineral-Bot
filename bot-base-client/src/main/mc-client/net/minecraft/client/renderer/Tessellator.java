...
public class Tessellator {
     ...
     * from vertexCount because it adds extra
    ...
    public TesselatorVertexState getVertexState(float p_147564_1_, float p_147564_2_, float p_147564_3_) {
        if (this.rawBufferIndex < 1) {
            ...
            PriorityQueue var5 = new PriorityQueue(this.rawBufferIndex,
            ...
            return new TesselatorVertexState(var4, this.rawBufferIndex, this.vertexCount, this.hasTexture,
                    this.hasBrightness, this.hasNormals, this.hasColor);
        }
    }
