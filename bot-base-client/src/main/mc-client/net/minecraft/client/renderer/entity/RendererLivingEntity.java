...
public abstract class RendererLivingEntity extends Render {
     ...
     * is done after the primary model is
     * rendered) Args: model
     */
     ...
     * and par2 are the angles between which
     * to interpolate, par3 is probably a float between 0.0 and 1.0 that tells us
     * where "between" the two angles we are.
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        try {
            float var10 = this.interpolateRotation(p_76986_1_.prevRenderYawOffset, p_76986_1_.renderYawOffset,
                    p_76986_9_);
            float var11 = this.interpolateRotation(p_76986_1_.prevRotationYawHead, p_76986_1_.rotationYawHead,
                    p_76986_9_);
            float var13;
            ...
            float var26 = p_76986_1_.prevRotationPitch
            ...
            float var15 = p_76986_1_.prevLimbSwingAmount
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        ...
        } else if (!p_77036_1_.isInvisibleToPlayer(this.mc.thePlayer)) {
            GL11.glPushMatrix();
    ...
    protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
        ...
        if (p_77043_1_.deathTime > 0) {
            ...
            if ((var6.equals("Dinnerbone") || var6.equals("Grumm"))
        ...
        if (this.func_110813_b(p_77033_1_)) {
            ...
            if (var10 < (double) (var12 * var12)) {
                ...
                if (p_77033_1_.isSneaking()) {
                    ...
                    GL11.glPushMatrix();
                    GL11.glTranslatef((float) p_77033_2_ + 0.0F, (float) p_77033_4_ + p_77033_1_.height + 0.5F,
                            (float) p_77033_6_);
    ...
    protected boolean func_110813_b(EntityLivingBase p_110813_1_) {
        return this.mc.isGuiEnabled() && p_110813_1_ != this.renderManager.livingPlayer
                && !p_110813_1_.isInvisibleToPlayer(this.mc.thePlayer)
