    ...
    public FontMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
        ...
        if (var4.has("characters")) {
            ...
            if (var11.has("default")) {
                ...
                Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var8),
                        "Invalid default width", new Object[0]);
                var9 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "spacing", var9);
                Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var9),
                        "Invalid default spacing", new Object[0]);
                var10 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "left", var9);
                Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var10),
                        "Invalid default left", new Object[0]);
            }
            ...
            for (int var18 = 0; var18 < 256; ++var18) {
                ...
                if (var13 != null) {
                    ...
                    Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var14),
                            "Invalid width", new Object[0]);
                    var15 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "spacing", var9);
                    Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var15),
                            "Invalid spacing", new Object[0]);
                    var16 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "left", var10);
                    Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(var16),
                            "Invalid left", new Object[0]);
                }
