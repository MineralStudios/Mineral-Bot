...
public class LoadingScreenRenderer implements IProgressUpdate {
    ...
    public LoadingScreenRenderer(Minecraft mc) {
        ...
        this.field_146588_g = new Framebuffer(mc, mc.displayWidth, mc.displayHeight, false);
        this.field_146588_g.setFramebufferFilter(9728);
    }

    /**
     * this string, followed by "working..." and then the "% complete" are the 3
     * lines shown. This resets progress to 0,
    ...
    public void func_73722_d(String p_73722_1_) {
        ...
        if (!this.mc.running) {
            ...
            if (OpenGlHelper.isFramebufferEnabled(this.mc)) {
                ...
                GL11.glOrtho(0.0D, (double) (this.field_146587_f.getScaledWidth() * var2),
                        (double) (this.field_146587_f.getScaledHeight() * var2), 0.0D, 100.0D, 300.0D);
            } else {
                ScaledResolution var3 = new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight);
                GL11.glOrtho(0.0D, var3.getScaledWidth_double(), var3.getScaledHeight_double(), 0.0D, 100.0D,
                        300.0D);
            }
