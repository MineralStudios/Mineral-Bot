...
public class SoundListSerializer implements JsonDeserializer {
    ...
    public SoundList deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
        ...
        SoundCategory var6 = SoundCategory.func_147154_a(JsonUtils.getJsonObjectStringFieldValueOrDefault(var4,
        ...
        if (var4.has("sounds")) {
            ...
            for (int var8 = 0; var8 < var7.size(); ++var8) {
                ...
                if (JsonUtils.jsonElementTypeIsString(var9)) {
                    ...
                    if (var11.has("type")) {
                        SoundList.SoundEntry.Type var12 = SoundList.SoundEntry.Type
                                .func_148580_a(JsonUtils.getJsonObjectStringFieldValue(var11, "type"));
