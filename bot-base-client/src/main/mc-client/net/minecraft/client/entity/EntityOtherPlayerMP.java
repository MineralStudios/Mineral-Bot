...
public class EntityOtherPlayerMP extends AbstractClientPlayer {
    ...
    public EntityOtherPlayerMP(Minecraft mc, World p_i45075_1_, GameProfile p_i45075_2_) {
        super(mc, p_i45075_1_, p_i45075_2_);
        this.mc = mc;
        this.yOffset = 0.0F;
    ...
    public void onUpdate() {
        ...
        if (!this.isItemInUse && this.isEating() && this.inventory.mainInventory[this.inventory.currentItem] != null) {
            ...
            this.setItemInUse(this.inventory.mainInventory[this.inventory.currentItem],
                    var6.getItem().getMaxItemUseDuration(var6));
