...
import gg.mineral.bot.lwjgl.opengl.GL13;
...
public class ShaderManager {
        ...
        for (int var1 = 0; var1 < this.field_148010_h.size(); ++var1) {
            if (this.field_147997_f.get(this.field_147998_g.get(var1)) != null) {
                ...
                if (var3 != -1) {
                    ...
                    OpenGlHelper.func_153163_f(OpenGlHelper.func_153194_a(this.field_148006_l,
                            (CharSequence) this.field_147998_g.get(var1)), var1);
                }
            }
        }
    ...
    public ShaderUniform func_147991_a(String p_147991_1_) {
        return this.field_148009_k.containsKey(p_147991_1_) ? (ShaderUniform) this.field_148009_k.get(p_147991_1_)
                : null;
    }

    public ShaderUniform func_147984_b(String p_147984_1_) {
        return (ShaderUniform) (this.field_148009_k.containsKey(p_147984_1_)
                ? (ShaderUniform) this.field_148009_k.get(p_147984_1_)
    ...
    private void func_147990_i() {
        ...
        for (int var2 = 0; var1 < this.field_147998_g.size(); ++var2) {
            ...
            if (var4 == -1) {
                logger.warn("Shader " + this.field_148007_m + "could not find sampler named " + var3
