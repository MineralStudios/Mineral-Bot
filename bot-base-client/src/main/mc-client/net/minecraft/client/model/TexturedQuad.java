...
public class TexturedQuad {
    ...
    public TexturedQuad(PositionTextureVertex[] p_i1153_1_, int p_i1153_2_, int p_i1153_3_, int p_i1153_4_,
        ...
        p_i1153_1_[0] = p_i1153_1_[0].setTexturePosition((float) p_i1153_4_ / p_i1153_6_ - var8,
                (float) p_i1153_3_ / p_i1153_7_ + var9);
        p_i1153_1_[1] = p_i1153_1_[1].setTexturePosition((float) p_i1153_2_ / p_i1153_6_ + var8,
                (float) p_i1153_3_ / p_i1153_7_ + var9);
        p_i1153_1_[2] = p_i1153_1_[2].setTexturePosition((float) p_i1153_2_ / p_i1153_6_ + var8,
                (float) p_i1153_5_ / p_i1153_7_ - var9);
        p_i1153_1_[3] = p_i1153_1_[3].setTexturePosition((float) p_i1153_4_ / p_i1153_6_ - var8,
                (float) p_i1153_5_ / p_i1153_7_ - var9);
    }
    ...
    public void draw(Tessellator p_78236_1_, float p_78236_2_) {
        ...
        for (int var6 = 0; var6 < 4; ++var6) {
            ...
            p_78236_1_.addVertexWithUV((double) ((float) var7.vector3D.xCoord * p_78236_2_),
                    (double) ((float) var7.vector3D.yCoord * p_78236_2_),
                    (double) ((float) var7.vector3D.zCoord * p_78236_2_), (double) var7.texturePositionX,
