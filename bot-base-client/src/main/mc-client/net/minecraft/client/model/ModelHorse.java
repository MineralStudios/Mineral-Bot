...
public class ModelHorse extends ModelBase {
    ...
    public ModelHorse(Minecraft mc) {
        this.textureWidth = 128;
        this.textureHeight = 128;
        this.body = new ModelRenderer(mc, this, 0, 34);
        this.body.addBox(-5.0F, -8.0F, -19.0F, 10, 10, 24);
        this.body.setRotationPoint(0.0F, 11.0F, 9.0F);
        this.tailBase = new ModelRenderer(mc, this, 44, 0);
        ...
        this.tailMiddle = new ModelRenderer(mc, this, 38, 7);
        ...
        this.tailTip = new ModelRenderer(mc, this, 24, 3);
        ...
        this.mouthTop = new ModelRenderer(mc, this, 24, 18);
        ...
        this.mouthBottom = new ModelRenderer(mc, this, 24, 27);
        ...
        this.horseLeftEar = new ModelRenderer(mc, this, 0, 0);
        ...
        this.horseRightEar = new ModelRenderer(mc, this, 0, 0);
        ...
        this.muleLeftEar = new ModelRenderer(mc, this, 0, 12);
        ...
        this.muleRightEar = new ModelRenderer(mc, this, 0, 12);
        ...
        this.neck = new ModelRenderer(mc, this, 0, 12);
        ...
        this.muleLeftChest = new ModelRenderer(mc, this, 0, 34);
        ...
        this.muleRightChest = new ModelRenderer(mc, this, 0, 47);
        ...
        this.horseRightFaceMetal = new ModelRenderer(mc, this, 74, 13);
        ...
        this.horseFaceRopes = new ModelRenderer(mc, this, 80, 12);
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        if (!var11) {
            ...
            if (var10 <= 0.0F) {
                ...
                GL11.glTranslatef(0.0F, 0.9F * (1.0F - var15) * var10 + 1.35F * (1.0F - var15) * (1.0F - var10),
                        0.15F * (1.0F - var15) * var10);
            }
        }
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
        ...
        float var7 = p_78086_1_.prevRotationPitch
        ...
        this.head.rotateAngleX = var12 * (0.2617994F + var9) + var11 * 2.18166F
                + (1.0F - Math.max(var12, var11)) * this.head.rotateAngleX;
        this.head.rotateAngleY = var12 * (var8 / (180F / (float) Math.PI))
                + (1.0F - Math.max(var12, var11)) * this.head.rotateAngleY;
        this.head.rotationPointY = var12 * -6.0F + var11 * 11.0F
                + (1.0F - Math.max(var12, var11)) * this.head.rotationPointY;
        this.head.rotationPointZ = var12 * -1.0F + var11 * -10.0F
                + (1.0F - Math.max(var12, var11)) * this.head.rotationPointZ;
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY
                + MathHelper.sin(((float) Math.PI / 2F) + var24 + var13 * -var19 * 0.5F * p_78086_3_) * 7.0F;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ
                + MathHelper.cos(((float) Math.PI * 3F / 2F) + var24 + var13 * -var19 * 0.5F * p_78086_3_) * 7.0F;
        ...
        this.backLeftShin.rotateAngleX = -0.08726646F * var12
                + (-var19 * 0.5F * p_78086_3_ - Math.max(0.0F, var19 * 0.5F * p_78086_3_)) * var13;
        ...
        this.backRightShin.rotateAngleX = -0.08726646F * var12
                + (var19 * 0.5F * p_78086_3_ - Math.max(0.0F, -var19 * 0.5F * p_78086_3_)) * var13;
        ...
        this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX
                + (float) Math.PI * Math.max(0.0F, 0.2F + var25 * 0.2F)) * var12
                + (var20 + Math.max(0.0F, var19 * 0.5F * p_78086_3_)) * var13;
