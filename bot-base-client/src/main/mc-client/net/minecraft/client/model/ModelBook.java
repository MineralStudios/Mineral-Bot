...
public class ModelBook extends ModelBase {
    ...
    public final ModelRenderer coverRight;

    /** Left cover renderer (when facing the book) */
    public final ModelRenderer coverLeft;

    /** The right pages renderer (when facing the book) */
    public final ModelRenderer pagesRight;

    /** The left pages renderer (when facing the book) */
    public final ModelRenderer pagesLeft;

    /** Right cover renderer (when facing the book) */
    public final ModelRenderer flippingPageRight;

    /** Right cover renderer (when facing the book) */
    public final ModelRenderer flippingPageLeft;
    ...
    public ModelBook(Minecraft mc) {
        ...
        this.coverLeft = (new ModelRenderer(mc, this)).setTextureOffset(16, 0).addBox(0.0F, -5.0F, 0.0F, 6, 10, 0);
        this.pagesRight = (new ModelRenderer(mc, this)).setTextureOffset(0, 10).addBox(0.0F, -4.0F, -0.99F, 5, 8, 1);
        this.pagesLeft = (new ModelRenderer(mc, this)).setTextureOffset(12, 10).addBox(0.0F, -4.0F, -0.01F, 5, 8, 1);
        this.flippingPageRight = (new ModelRenderer(mc, this)).setTextureOffset(24, 10).addBox(0.0F, -4.0F, 0.0F, 5, 8,
                0);
        this.flippingPageLeft = (new ModelRenderer(mc, this)).setTextureOffset(24, 10).addBox(0.0F, -4.0F, 0.0F, 5, 8,
                0);
        this.bookSpine = (new ModelRenderer(mc, this)).setTextureOffset(12, 0).addBox(-1.0F, -5.0F, 0.0F, 2, 10, 0);
