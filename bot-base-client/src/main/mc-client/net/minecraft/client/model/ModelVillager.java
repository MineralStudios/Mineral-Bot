...
public class ModelVillager extends ModelBase {
    ...
    public ModelVillager(Minecraft mc, float p_i1164_1_, float p_i1164_2_, int p_i1164_3_, int p_i1164_4_) {
        this.villagerHead = (new ModelRenderer(mc, this)).setTextureSize(p_i1164_3_, p_i1164_4_);
        ...
        this.villagerNose = (new ModelRenderer(mc, this)).setTextureSize(p_i1164_3_, p_i1164_4_);
        ...
        this.villagerBody = (new ModelRenderer(mc, this)).setTextureSize(p_i1164_3_, p_i1164_4_);
        ...
        this.villagerArms = (new ModelRenderer(mc, this)).setTextureSize(p_i1164_3_, p_i1164_4_);
        ...
        this.rightVillagerLeg = (new ModelRenderer(mc, this, 0, 22)).setTextureSize(p_i1164_3_, p_i1164_4_);
        ...
        this.leftVillagerLeg = (new ModelRenderer(mc, this, 0, 22)).setTextureSize(p_i1164_3_, p_i1164_4_);
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
        ...
        this.leftVillagerLeg.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F + (float) Math.PI) * 1.4F * p_78087_2_
                * 0.5F;
