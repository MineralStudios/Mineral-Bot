...
public class ModelMinecart extends ModelBase {
    ...
    public ModelMinecart(Minecraft mc) {
        ...
        this.sideModels[1] = new ModelRenderer(mc, this, 0, 0);
        this.sideModels[2] = new ModelRenderer(mc, this, 0, 0);
        this.sideModels[3] = new ModelRenderer(mc, this, 0, 0);
        this.sideModels[4] = new ModelRenderer(mc, this, 0, 0);
        this.sideModels[5] = new ModelRenderer(mc, this, 44, 10);
        byte var1 = 20;
        byte var2 = 8;
        byte var3 = 16;
        byte var4 = 4;
