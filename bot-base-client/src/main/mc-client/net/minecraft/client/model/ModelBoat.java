...
public class ModelBoat extends ModelBase {
    ...
    public ModelBoat(Minecraft mc) {
        ...
        this.boatSides[1] = new ModelRenderer(mc, this, 0, 0);
        this.boatSides[2] = new ModelRenderer(mc, this, 0, 0);
        this.boatSides[3] = new ModelRenderer(mc, this, 0, 0);
        this.boatSides[4] = new ModelRenderer(mc, this, 0, 0);
        byte var1 = 24;
        byte var2 = 6;
        byte var3 = 20;
        byte var4 = 4;
