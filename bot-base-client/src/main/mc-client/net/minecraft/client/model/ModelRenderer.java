...
public class ModelRenderer {
    ...
    public ModelRenderer(Minecraft mc, ModelBase par1ModelBase) {
        this(mc, par1ModelBase, (String) null);
    }

    public ModelRenderer(Minecraft mc, ModelBase par1ModelBase, int par2, int par3) {
        this(mc, par1ModelBase);
    ...
    public ModelRenderer addBox(String par1Str, float par2, float par3, float par4, int par5, int par6, int par7) {
        ...
        this.cubeList.add(
                (new ModelBox(this, this.textureOffsetX, this.textureOffsetY, par2, par3, par4, par5, par6, par7, 0.0F))
                        .func_78244_a(par1Str));
        return this;
    }

    public ModelRenderer addBox(float par1, float par2, float par3, int par4, int par5, int par6) {
        this.cubeList.add(
                new ModelBox(this, this.textureOffsetX, this.textureOffsetY, par1, par2, par3, par4, par5, par6, 0.0F));
        return this;
    }
    ...
    private void compileDisplayList(float par1) {
        ...
        for (i = 0; i < this.spriteList.size(); ++i) {
            ...
            sprite.render(this.mc.getTessellator(), par1);
        }
    ...
    public void addSprite(float posX, float posY, float posZ, int sizeX, int sizeY, int sizeZ, float sizeAdd) {
        this.spriteList.add(new ModelSprite(this, this.textureOffsetX, this.textureOffsetY, posX, posY, posZ, sizeX,
                sizeY, sizeZ, sizeAdd));
    }
}
