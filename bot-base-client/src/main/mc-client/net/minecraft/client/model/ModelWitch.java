...
public class ModelWitch extends ModelVillager {
    ...
    public ModelWitch(Minecraft mc, float p_i46361_1_) {
        ...
        this.field_82901_h = (new ModelRenderer(mc, this)).setTextureSize(64, 128);
        ...
        this.witchHat = (new ModelRenderer(mc, this)).setTextureSize(64, 128);
        this.witchHat.setRotationPoint(-5.0F, -10.03125F, -5.0F);
        this.witchHat.setTextureOffset(0, 64).addBox(0.0F, 0.0F, 0.0F, 10, 2, 10);
        this.villagerHead.addChild(this.witchHat);
        ModelRenderer var2 = (new ModelRenderer(mc, this)).setTextureSize(64, 128);
        ...
        ModelRenderer var3 = (new ModelRenderer(mc, this)).setTextureSize(64, 128);
        ...
        var2.addChild(var3);
        ModelRenderer var4 = (new ModelRenderer(mc, this)).setTextureSize(64, 128);
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
        ...
        this.villagerNose.rotateAngleX = MathHelper.sin((float) p_78087_7_.ticksExisted * var8) * 4.5F * (float) Math.PI
                / 180.0F;
        this.villagerNose.rotateAngleY = 0.0F;
        this.villagerNose.rotateAngleZ = MathHelper.cos((float) p_78087_7_.ticksExisted * var8) * 2.5F * (float) Math.PI
                / 180.0F;
