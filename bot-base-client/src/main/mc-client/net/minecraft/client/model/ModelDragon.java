...
public class ModelDragon extends ModelBase {
    ...
    public ModelDragon(Minecraft mc, float p_i46360_1_) {
        ...
        float var2 = -16.0F;
        this.head = new ModelRenderer(mc, this, "head");
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        float var16 = this.updateRotations(
                var8.getMovementOffsets(5, this.partialTicks)[0] - var8.getMovementOffsets(10, this.partialTicks)[0]);
        ...
        for (int var19 = 0; var19 < 5; ++var19) {
            ...
            this.spine.rotateAngleZ = -this.updateRotations(var20[0] - (double) var17) * (float) Math.PI / 180.0F
                    * var14;
        ...
        for (int var25 = 0; var25 < 12; ++var25) {
            ...
            this.spine.rotateAngleY = (this.updateRotations(var22[0] - var15[0]) * var14 + 180.0F) * (float) Math.PI
                    / 180.0F;
            this.spine.rotateAngleX = var24 + (float) (var22[1] - var15[1]) * (float) Math.PI / 180.0F * var14 * 5.0F;
            this.spine.rotateAngleZ = this.updateRotations(var22[0] - (double) var17) * (float) Math.PI / 180.0F
                    * var14;
            this.spine.rotationPointY = var11;
            this.spine.rotationPointZ = var12;
            this.spine.rotationPointX = var13;
     ...
     * degrees or less than -180 degrees. It adds
     * or subtracts 360 degrees, so that the appearance is the same, although the
     * numbers are then simplified to range
     * -180 to 180
     */
