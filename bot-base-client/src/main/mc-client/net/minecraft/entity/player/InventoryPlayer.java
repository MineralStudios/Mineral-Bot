...
public class InventoryPlayer implements IInventory {
     ...
     * have to write your own code to check
    ...
    private int findSlot(Item item) {
        for (int var2 = 0; var2 < this.mainInventory.length; ++var2)
            if (this.mainInventory[var2] != null && this.mainInventory[var2].getItem() == item)
                return var2;

        return -1;
    }

    private int findSlot(Item item, int damage) {
        for (int var3 = 0; var3 < this.mainInventory.length; ++var3)
            if (this.mainInventory[var3] != null && this.mainInventory[var3].getItem() == item
                    && this.mainInventory[var3].getItemDamage() == damage)
                return var3;
    ...
    private int storeItemStack(ItemStack p_70432_1_) {
        for (int var2 = 0; var2 < this.mainInventory.length; ++var2) {
            if (this.mainInventory[var2] != null && this.mainInventory[var2].getItem() == p_70432_1_.getItem()
    ...
    public void func_146030_a(Item p_146030_1_, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_) {
        ...
        if (p_146030_3_) {
            var7 = this.findSlot(p_146030_1_, p_146030_2_);
        } else {
            var7 = this.findSlot(p_146030_1_);
        }
    ...
    public int clearInventory(Item p_146027_1_, int p_146027_2_) {
        ...
        for (var4 = 0; var4 < this.mainInventory.length; ++var4) {
            ...
            if (var5 != null && (p_146027_1_ == null || var5.getItem() == p_146027_1_)
    ...
    public void func_70439_a(Item p_70439_1_, int p_70439_2_) {
        if (p_70439_1_ != null) {
            ...
            int var3 = this.findSlot(p_70439_1_, p_70439_2_);
     ...
     * slot and returns the quantity of
     * left over items.
     */
     ...
     * This is used to handle the animation of
     * receiving a block.
     */
    ...
    public boolean consumeInventoryItem(Item p_146026_1_) {
        int var2 = this.findSlot(p_146026_1_);
    ...
    public boolean hasItem(Item p_146028_1_) {
        int var2 = this.findSlot(p_146028_1_);
        return var2 >= 0;
    }
     ...
     * indices are used (+100 for armor, +80
     * for crafting).
     */
