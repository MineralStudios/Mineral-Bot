...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender, ClientPlayer {
     ...
     * pressed (And they are allowed to fly, as
     * defined in the player's movementInput) it sets this to 7. If it's pressed and
     * it's greater than 0 enable fly.
     */
    ...
    public EntityPlayer(World p_i45324_1_, GameProfile p_i45324_2_) {
        super(p_i45324_1_);
        this.entityUniqueID = getUUIDFromGameProfile(p_i45324_2_);
        ...
        this.setLocationAndAngles((double) var3.posX + 0.5D, (double) (var3.posY + 1), (double) var3.posZ + 0.5D, 0.0F,
                0.0F);
    ...
    protected void updateItemUse(ItemStack p_71010_1_, int p_71010_2_) {
        ...
        if (p_71010_1_.getItemUseAction() == EnumAction.eat) {
            for (int var3 = 0; var3 < p_71010_2_; ++var3) {
                Vec3 var4 = Vec3.createVectorHelper(((double) this.rand.nextFloat() - 0.5D) * 0.1D,
                        Math.random() * 0.1D + 0.1D, 0.0D);
                var4.rotateAroundX(-this.rotationPitch * (float) Math.PI / 180.0F);
                var4.rotateAroundY(-this.rotationYaw * (float) Math.PI / 180.0F);
                Vec3 var5 = Vec3.createVectorHelper(((double) this.rand.nextFloat() - 0.5D) * 0.3D,
                ...
                this.worldObj.spawnParticle(var6, var5.xCoord, var5.yCoord, var5.zCoord, var4.xCoord,
     ...
     * requirements for this entity to be spawned
    ...
    public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_) {
        if (p_146097_1_ == null) {
            ...
            if (p_146097_2_) {
                ...
                var5 = 0.3F;
                var4.motionX = (double) (-MathHelper.sin(this.rotationYaw / 180.0F * (float) Math.PI)
                        * MathHelper.cos(this.rotationPitch / 180.0F * (float) Math.PI) * var5);
                var4.motionZ = (double) (MathHelper.cos(this.rotationYaw / 180.0F * (float) Math.PI)
                        * MathHelper.cos(this.rotationPitch / 180.0F * (float) Math.PI) * var5);
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
        ...
        this.entityUniqueID = getUUIDFromGameProfile(this.field_146106_i);
        ...
        if (p_70037_1_.func_150297_b("SpawnX", 99) && p_70037_1_.func_150297_b("SpawnY", 99)
     ...
     * value of this is the chance of seeing
     * them anyway.
     */
     ...
     * the armor first and then health
     ...
     * The equipped item has hitEntity
    ...
    public EntityPlayer.EnumStatus sleepInBedAt(int p_71018_1_, int p_71018_2_, int p_71018_3_) {
        if (!this.worldObj.isClient) {
            ...
            List var8 = this.worldObj.getEntitiesWithinAABB(EntityMob.class,
                    AxisAlignedBB.getBoundingBox((double) p_71018_1_ - var4, (double) p_71018_2_ - var6,
                            (double) p_71018_3_ - var4, (double) p_71018_1_ + var4, (double) p_71018_2_ + var6,
                            (double) p_71018_3_ + var4));
        ...
        if (this.worldObj.blockExists(p_71018_1_, p_71018_2_, p_71018_3_)) {
            ...
            this.setPosition((double) ((float) p_71018_1_ + var10), (double) ((float) p_71018_2_ + 0.9375F),
                    (double) ((float) p_71018_3_ + var7));
        } else {
    ...
    private boolean isInBed() {
        return this.worldObj.getBlock(this.playerLocation.posX, this.playerLocation.posY,
                this.playerLocation.posZ) == Blocks.bed;
    }

    /**
     * Ensure that a block enabling respawning exists at the specified coordinates
     * and find an empty space nearby to
     * spawn.
     */
    public static ChunkCoordinates verifyRespawnCoordinates(World p_71056_0_, ChunkCoordinates p_71056_1_,
        ...
        if (p_71056_0_.getBlock(p_71056_1_.posX, p_71056_1_.posY, p_71056_1_.posZ) == Blocks.bed) {
            ChunkCoordinates var8 = BlockBed.func_149977_a(p_71056_0_, p_71056_1_.posX, p_71056_1_.posY,
                    p_71056_1_.posZ, 0);
            return var8;
        } else {
    ...
    public float getBedOrientationInDegrees() {
        if (this.playerLocation != null) {
            int var1 = this.worldObj.getBlockMetadata(this.playerLocation.posX, this.playerLocation.posY,
                    this.playerLocation.posZ);
     ...
     * entity is visible or not to a specfic
     * player, if the entity is normally invisible.\nFor EntityLivingBase
     * subclasses, returning false when invisible
    ...
    public static UUID getUUIDFromGameProfile(GameProfile gameProfile) {
        UUID var1 = gameProfile.getId();

        if (var1 == null) {
            var1 = UUID.nameUUIDFromBytes(("OfflinePlayer:" + gameProfile.getName()).getBytes(Charsets.UTF_8));
        }
