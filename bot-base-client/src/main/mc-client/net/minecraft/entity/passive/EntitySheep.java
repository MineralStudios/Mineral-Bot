...
public class EntitySheep extends EntityAnimal {
     ...
     * handleHealthUpdate and counts down with each
     * tick.
     */
            ...
            if (!this.worldObj.isClient) {
                ...
                for (int var4 = 0; var4 < var3; ++var4) {
                    EntityItem var5 = this.entityDropItem(
                            new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, this.getFleeceColor()), 1.0F);
    ...
    public static int getRandomFleeceColor(Random p_70895_0_) {
        ...
        return var1 < 5 ? 15
                : (var1 < 10 ? 7 : (var1 < 15 ? 8 : (var1 < 18 ? 12 : (p_70895_0_.nextInt(500) == 0 ? 6 : 0))));
    }
