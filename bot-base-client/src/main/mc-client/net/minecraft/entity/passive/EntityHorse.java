...
public class EntityHorse extends EntityAnimal implements IInvBasic {
    ...
    private static final IAttribute horseJumpStrength = (new RangedAttribute("horse.jumpStrength", 0.7D, 0.0D, 2.0D))
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
        ...
        return this.riddenByEntity != null && this.riddenByEntity.equals(var3) ? false
    ...
    protected void fall(float p_70069_1_) {
        ...
        if (var2 > 0) {
            ...
            Block var3 = this.worldObj.getBlock(MathHelper.floor_double(this.posX),
                    MathHelper.floor_double(this.posY - 0.2D - (double) this.prevRotationYaw),
                    MathHelper.floor_double(this.posZ));

            if (var3.getMaterial() != Material.air) {
                Block.SoundType var4 = var3.stepSound;
                this.worldObj.playSoundAtEntity(this, var4.func_150498_e(), var4.func_150497_c() * 0.5F,
    ...
    protected EntityHorse getClosestHorse(Entity p_110250_1_, double p_110250_2_) {
        ...
        Entity var6 = null;
        List var7 = this.worldObj.getEntitiesWithinAABBExcludingEntity(p_110250_1_,
    ...
    public void openGUI(EntityPlayer p_110199_1_) {
        if (!this.worldObj.isClient && (this.riddenByEntity == null || this.riddenByEntity == p_110199_1_)
                && this.isTame()) {
            this.horseChest.func_110133_a(this.getCommandSenderName());
    ...
    public boolean interact(EntityPlayer p_70085_1_) {
        ...
        if (var2 != null && var2.getItem() == Items.spawn_egg) {
            ...
            if (var2 != null) {
                ...
                if (!var3 && this.func_110229_cs() && !this.isChested()
                        && var2.getItem() == Item.getItemFromBlock(Blocks.chest)) {
    ...
    public EntityAgeable createChild(EntityAgeable p_90011_1_) {
        ...
        double var14 = this.getEntityAttribute(horseJumpStrength).getBaseValue()
                + p_90011_1_.getEntityAttribute(horseJumpStrength).getBaseValue() + this.func_110245_cM();
    ...
    public void updateRiderPosition() {
        ...
        if (this.prevRearingAmount > 0.0F) {
            ...
            this.riddenByEntity.setPosition(this.posX + (double) (var3 * var1),
                    this.posY + this.getMountedYOffset() + this.riddenByEntity.getYOffset() + (double) var4,
                    this.posZ - (double) (var3 * var2));
