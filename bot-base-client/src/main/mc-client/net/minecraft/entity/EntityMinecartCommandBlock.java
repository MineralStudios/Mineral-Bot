...
public class EntityMinecartCommandBlock extends EntityMinecart {
    private final CommandBlockLogic field_145824_a = new CommandBlockLogic() {
        ...
        public void func_145756_e() {
            ...
            EntityMinecartCommandBlock.this.getDataWatcher().updateObject(24,
                    IChatComponent.Serializer.toJson(this.func_145749_h()));
        }
    ...
    protected void readEntityFromNBT(NBTTagCompound p_70037_1_) {
        ...
        this.getDataWatcher().updateObject(24,
                IChatComponent.Serializer.toJson(this.func_145822_e().func_145749_h()));
    }
    ...
    public void func_145781_i(int p_145781_1_) {
        ...
        if (p_145781_1_ == 24) {
            try {
                this.field_145824_a.func_145750_b(
                        IChatComponent.Serializer.fromJson(this.getDataWatcher().getWatchableObjectString(24)));
