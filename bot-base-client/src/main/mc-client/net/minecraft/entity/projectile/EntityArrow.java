...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_,
            float p_i1755_5_) {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_,
        ...
        this.prevRotationPitch = this.rotationPitch = (float) (Math.atan2(p_70186_3_, (double) var10) * 180.0D
                / Math.PI);
    ...
    public void onUpdate() {
        ...
        if (var16.getMaterial() != Material.air) {
            var16.setBlockBoundsBasedOnState(this.worldObj, this.field_145791_d, this.field_145792_e,
                    this.field_145789_f);
            AxisAlignedBB var2 = var16.getCollisionBoundingBoxFromPool(this.worldObj, this.field_145791_d,
        ...
        if (this.inGround) {
            ...
            var3 = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY,
                    this.posZ + this.motionZ);
            ...
            if (var4 != null && var4.entityHit != null && var4.entityHit instanceof EntityPlayer) {
                ...
                if (var19.capabilities.disableDamage || this.shootingEntity instanceof EntityPlayer
                        && !((EntityPlayer) this.shootingEntity).canAttackPlayer(var19)) {
                    var4 = null;
                }
            }
            ...
            for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) var20) * 180.0D
            ...
            if (this.isInWater()) {
                for (int var25 = 0; var25 < 4; ++var25) {
                    var26 = 0.25F;
                    this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double) var26,
                            this.posY - this.motionY * (double) var26, this.posZ - this.motionZ * (double) var26,
