...
public abstract class EntityFireball extends Entity {
    ...
    public EntityFireball(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_,
    ...
    public EntityFireball(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_,
            double p_i1761_7_) {
        super(p_i1761_1_);
        this.shootingEntity = p_i1761_2_;
        this.setSize(1.0F, 1.0F);
        this.setLocationAndAngles(p_i1761_2_.posX, p_i1761_2_.posY, p_i1761_2_.posZ, p_i1761_2_.rotationYaw,
    ...
    public void onUpdate() {
        if (!this.worldObj.isClient && (this.shootingEntity != null && this.shootingEntity.isDead
            ...
            for (this.rotationPitch = (float) (Math.atan2((double) var15, this.motionY) * 180.0D / Math.PI)
            ...
            if (this.isInWater()) {
                for (int var17 = 0; var17 < 4; ++var17) {
                    float var18 = 0.25F;
                    this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double) var18,
                            this.posY - this.motionY * (double) var18, this.posZ - this.motionZ * (double) var18,
