...
public class EntityFishHook extends Entity {
    ...
    public EntityFishHook(World p_i1766_1_, EntityPlayer p_i1766_2_) {
        ...
        this.setSize(0.25F, 0.25F);
        this.setLocationAndAngles(p_i1766_2_.posX, p_i1766_2_.posY + 1.62D - (double) p_i1766_2_.yOffset,
                p_i1766_2_.posZ, p_i1766_2_.rotationYaw, p_i1766_2_.rotationPitch);
    ...
    public void func_146035_c(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_,
        ...
        this.prevRotationPitch = this.rotationPitch = (float) (Math.atan2(p_146035_3_, (double) var10) * 180.0D
                / Math.PI);
    ...
    public void onUpdate() {
        ...
        if (this.field_146055_aB > 0) {
            ...
            this.rotationPitch = (float) ((double) this.rotationPitch
                    + (this.field_146060_aG - (double) this.rotationPitch) / (double) this.field_146055_aB);
            ...
            if (!this.worldObj.isClient) {
                ...
                if (this.field_146042_b.isDead || !this.field_146042_b.isEntityAlive() || var1 == null
            ...
            Vec3 var2 = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY,
            ...
            var2 = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY,
                    this.posZ + this.motionZ);
            ...
            if (var3 != null) {
                if (var3.entityHit != null) {
                    if (var3.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.field_146042_b),
                            0.0F)) {
            ...
            if (!this.field_146051_au) {
                ...
                for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) var30) * 180.0D
                ...
                for (int var34 = 0; var34 < var32; ++var34) {
                    double var14 = this.boundingBox.minY
                            + (this.boundingBox.maxY - this.boundingBox.minY) * (double) (var34 + 0) / (double) var32
                            - 0.125D + 0.125D;
                    double var16 = this.boundingBox.minY
                            + (this.boundingBox.maxY - this.boundingBox.minY) * (double) (var34 + 1) / (double) var32
                            - 0.125D + 0.125D;
                    AxisAlignedBB var18 = AxisAlignedBB.getBoundingBox(this.boundingBox.minX, var14,
                    ...
                    if (this.field_146045_ax > 0) {
                        ...
                        if (this.field_146038_az > 0) {
                            ...
                            if (this.field_146038_az <= 0) {
                                ...
                                var35.func_147487_a("bubble", this.posX, (double) (var15 + 1.0F), this.posZ,
                                        (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D,
                                        (double) this.width, 0.20000000298023224D);
                                var35.func_147487_a("wake", this.posX, (double) (var15 + 1.0F), this.posZ,
                                        (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D,
                                        (double) this.width, 0.20000000298023224D);
                                this.field_146045_ax = MathHelper.getRandomIntegerInRange(this.rand, 10, 30);
                            } else {
                                this.field_146054_aA = (float) ((double) this.field_146054_aA
                                ...
                                if (this.rand.nextFloat() < 0.15F) {
                                    var35.func_147487_a("bubble", var38, var20 - 0.10000000149011612D, var22, 1,
                                            (double) var37, 0.1D, (double) var17, 0.0D);
                                }

                                float var24 = var37 * 0.04F;
                                float var25 = var17 * 0.04F;
                                var35.func_147487_a("wake", var38, var20, var22, 0, (double) var25, 0.01D,
                                        (double) (-var24), 1.0D);
                                var35.func_147487_a("wake", var38, var20, var22, 0, (double) (-var25), 0.01D,
                                        (double) var24, 1.0D);
                            }
                            ...
                            if (this.rand.nextFloat() < var15) {
                                ...
                                var35.func_147487_a("splash", var38, var20, var22, 2 + this.rand.nextInt(2),
    ...
    public int func_146034_e() {
        if (this.worldObj.isClient) {
            ...
            if (this.field_146043_c != null) {
                ...
                this.field_146042_b.worldObj.spawnEntityInWorld(new EntityXPOrb(this.field_146042_b.worldObj,
                        this.field_146042_b.posX, this.field_146042_b.posY + 0.5D, this.field_146042_b.posZ + 0.5D,
    ...
    private ItemStack func_146033_f() {
        ...
        if (var1 < var4) {
            ...
            return ((WeightedRandomFishable) WeightedRandom.getRandomItem(this.rand, field_146039_d))
            ...
            if (var1 < var5) {
                ...
                return ((WeightedRandomFishable) WeightedRandom.getRandomItem(this.rand, field_146041_e))
                        .func_150708_a(this.rand);
            } else {
                float var10000 = var1 - var5;
                this.field_146042_b.addStat(StatList.fishCaughtStat, 1);
                return ((WeightedRandomFishable) WeightedRandom.getRandomItem(this.rand, field_146036_f))
                        .func_150708_a(this.rand);
            }
        }
    }
