...
public abstract class Entity implements ClientEntity {
     ...
     * spot is clear of entities that can
     * prevent spawning.
     */
     ...
     * it (currently make note the entity
     ...
     */
    public int fireResistance, fire;
    /**
     ...
     * EntityFish for now. Used in RenderGlobal:
    ...
    public void setPosition(double p_70107_1_, double p_70107_3_, double p_70107_5_) {
        ...
        this.boundingBox.setBounds(p_70107_1_ - (double) var7, p_70107_3_ - (double) this.yOffset + (double) this.ySize,
                p_70107_5_ - (double) var7, p_70107_1_ + (double) var7,
                p_70107_3_ - (double) this.yOffset + (double) this.ySize + (double) var8, p_70107_5_ + (double) var7);
    }

    /**
     * Adds par1*0.15 to the entity's yaw, and *subtracts* par2*0.15 from the pitch.
     * Clamps pitch from -90 to 90. Both
            ...
            if (var4.getMaterial() != Material.air) {
                this.worldObj.spawnParticle(
                        "blockcrack_" + Block.getIdFromBlock(var4) + "_"
                                + this.worldObj.getBlockMetadata(var5, var2, var6),
    ...
    public void moveEntity(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
        if (this.noClip) {
            ...
            List var36 = this.worldObj.getCollidingBoundingBoxes(this,
            ...
            if (this.stepHeight > 0.0F && var37 && (var20 || this.ySize < 0.05F)
                ...
                var36 = this.worldObj.getCollidingBoundingBoxes(this,
                        this.boundingBox.addCoord(var13, p_70091_3_, var17));
            ...
            if (this.canTriggerWalking() && !var20 && this.ridingEntity == null) {
                ...
                this.distanceWalkedModified = (float) ((double) this.distanceWalkedModified
                        + (double) MathHelper.sqrt_double(var38 * var38 + var27 * var27) * 0.6D);
                this.distanceWalkedOnStepModified = (float) ((double) this.distanceWalkedOnStepModified
                        + (double) MathHelper.sqrt_double(var38 * var38 + var25 * var25 + var27 * var27) * 0.6D);
                ...
                if (this.distanceWalkedOnStepModified > (float) this.nextStepDistance
                    ...
                    if (this.isInWater()) {
                        float var34 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224D
                        ...
                        this.playSound(this.getSwimSound(), var34,
                ...
                for (int var8 = var2; var8 <= var5; ++var8) {
                    for (int var9 = var3; var9 <= var6; ++var9) {
                        ...
                        try {
                            ...
                            CrashReportCategory.func_147153_a(var13, var7, var8, var9, var10,
                                    this.worldObj.getBlockMetadata(var7, var8, var9));
    ...
    public void setBoundingBox(BoundingBox boundingBox) {
        this.boundingBox = (AxisAlignedBB) boundingBox;
    }
    ...
    public boolean handleWaterMovement() {
        if (this.worldObj.handleMaterialAcceleration(
            ...
            if (!this.inWater && !this.firstUpdate) {
                ...
                this.playSound(this.getSplashSound(), var1,
                        1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
    ...
    public void setPositionAndRotation(double p_70080_1_, double p_70080_3_, double p_70080_5_, float p_70080_7_,
        ...
        this.ySize = 0.0F;
        double var9 = this.prevRotationYaw - p_70080_7_;
     ...
     * saving ridden entities with their
     * riders.
     */
     ...
     * false without doing anything. If this
     * returns false the entity is not saved on disk. Ridden entities return false
     * here as they are saved with their
     * rider.
     */
    ...
    public EntityItem entityDropItem(ItemStack p_70099_1_, float p_70099_2_) {
        if (p_70099_1_.stackSize != 0 && p_70099_1_.getItem() != null) {
            EntityItem var3 = new EntityItem(this.worldObj, this.posX, this.posY + (double) p_70099_2_, this.posZ,
                    p_70099_1_);
     ...
     * the legs to be in 'sit' position
     * for players.
     */
     ...
     * burning; 1) is sneaking; 2) is riding
    ...
    public String toString() {
        return String.format("%s['%s'/%d, l='%s', x=%.2f, y=%.2f, z=%.2f]",
                this.getClass().getSimpleName(), this.getCommandSenderName(),
     ...
     * teleporting entities between worlds, as this
     * actually deletes the teleporting entity and re-creates it on the other side.
     * Params: Entity to copy from, unused
     * (always true)
     */
