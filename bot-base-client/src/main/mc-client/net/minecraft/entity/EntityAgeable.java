...
public abstract class EntityAgeable extends EntityCreature {
     ...
     * incremented on each tick, if it's
     * positive, it get's decremented each tick. Don't confuse this with
     * EntityLiving.getAge. With a negative value the
     ...
     * entity is an adult (if the entity's
     ...
     * The age value may be negative or positive or zero. If it's negative, it get's
     * incremented on each tick, if it's
     * positive, it get's decremented each tick. With a negative value the Entity is
     * considered a child.
     */
