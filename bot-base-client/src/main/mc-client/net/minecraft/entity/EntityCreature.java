...
public abstract class EntityCreature extends EntityLiving {
    ...
    protected void updateEntityActionState() {
        ...
        if (this.entityToAttack == null) {
            ...
            if (this.entityToAttack != null) {
                this.pathToEntity = this.worldObj.getPathEntityToEntity(this, this.entityToAttack, var21, true, false,
                        false, true);
            }
        ...
        if (this.entityToAttack instanceof EntityPlayerMP
                && ((EntityPlayerMP) this.entityToAttack).theItemInWorldManager.isCreative()) {
            this.entityToAttack = null;
        }
        ...
        if (this.pathToEntity != null && this.rand.nextInt(100) != 0) {
            ...
            if (var5 != null) {
                ...
                this.moveForward = (float) this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
                        .getAttributeValue();
    ...
    public boolean isWithinHomeDistance(int p_110176_1_, int p_110176_2_, int p_110176_3_) {
        return this.maximumHomeDistance == -1.0F ? true
                : this.homePosition.getDistanceSquared(p_110176_1_, p_110176_2_, p_110176_3_) < this.maximumHomeDistance
