...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
     ...
     * tail/neck positions. [0] = yaw
     * offset, [1] = y offset, [2] = unused, always 0. Parameters: buffer index
    ...
    public double[] getMovementOffsets(int p_70974_1_, float p_70974_2_) {
        ...
        var5[2] = this.ringBuffer[var3][2]
                + (this.ringBuffer[var4][2] - this.ringBuffer[var3][2]) * (double) p_70974_2_;
        return var5;
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            if (this.worldObj.isClient) {
                ...
                Vec3 var15 = Vec3.createVectorHelper(this.targetX - this.posX, this.targetY - this.posY,
                        this.targetZ - this.posZ).normalize();
                Vec3 var39 = Vec3
                        .createVectorHelper((double) MathHelper.sin(this.rotationYaw * (float) Math.PI / 180.0F),
            ...
            for (int var30 = 0; var30 < 3; ++var30) {
                ...
                if (var32 != null) {
                    var32.onUpdate();
                    var32.setLocationAndAngles(this.posX - (double) ((var28 * var38 + var36 * var40) * var3),
                            this.posY + (var34[1] - var29[1]) * 1.0D - (double) ((var40 + var38) * var27) + 1.5D,
                            this.posZ + (double) ((var7 * var38 + var37 * var40) * var3), 0.0F, 0.0F);
                }
            }
            ...
            for (int var11 = var3; var11 <= var6; ++var11) {
                for (int var12 = var4; var12 <= var7; ++var12) {
                    ...
                    if (var13.getMaterial() != Material.air) {
                        if (var13 != Blocks.obsidian && var13 != Blocks.end_stone && var13 != Blocks.bedrock
