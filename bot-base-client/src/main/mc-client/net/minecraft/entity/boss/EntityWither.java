...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
            ...
            for (var1 = 1; var1 < 3; ++var1) {
                if (this.ticksExisted >= this.field_82223_h[var1 - 1]) {
                    ...
                    if (var12 > 0) {
                        ...
                        List var13 = this.worldObj.selectEntitiesWithinAABB(EntityLivingBase.class,
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
        if (this.isEntityInvulnerable()) {
            ...
            if (var3 != null && !(var3 instanceof EntityPlayer) && var3 instanceof EntityLivingBase
                    && ((EntityLivingBase) var3).getCreatureAttribute() == this.getCreatureAttribute()) {
                return false;
            } else {
                if (this.field_82222_j <= 0) {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        ...
        if (!this.worldObj.isClient) {
            Iterator var3 = this.worldObj
                    .getEntitiesWithinAABB(EntityPlayer.class, this.boundingBox.expand(50.0D, 100.0D, 50.0D))
                    .iterator();
     ...
     * whether its health is below half of
     * its maximum.
     */
