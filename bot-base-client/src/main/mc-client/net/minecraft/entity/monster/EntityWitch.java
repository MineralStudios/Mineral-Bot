...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
     ...
     * aggressive and when reaches zero the witch
    ...
    public void handleHealthUpdate(byte p_70103_1_) {
        if (p_70103_1_ == 15) {
            for (int var2 = 0; var2 < this.rand.nextInt(35) + 10; ++var2) {
                this.worldObj.spawnParticle("witchMagic", this.posX + this.rand.nextGaussian() * 0.12999999523162842D,
                        this.boundingBox.maxY + 0.5D + this.rand.nextGaussian() * 0.12999999523162842D,
