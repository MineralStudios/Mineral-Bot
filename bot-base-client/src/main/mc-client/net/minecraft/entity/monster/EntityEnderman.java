...
public class EntityEnderman extends EntityMob {
    ...
    /**
     * A player must stare at an enderman for 5 ticks before it becomes aggressive.
     * This field counts those ticks.
     */
    ...
    private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
            ...
            Vec3 var4 = Vec3
                    .createVectorHelper(this.posX - p_70821_1_.posX,
                            this.boundingBox.minY + (double) (this.height / 2.0F)
                                    - (p_70821_1_.posY + (double) p_70821_1_.getEyeHeight()),
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isClient && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
            ...
            if (this.func_146080_bZ().getMaterial() == Material.air) {
                ...
                if (var4.getMaterial() == Material.air && var5.getMaterial() != Material.air
        ...
        if (this.worldObj.isDaytime() && !this.worldObj.isClient) {
            ...
            if (var7 > 0.5F
                    ...
                    && this.rand.nextFloat() * 30.0F < (var7 - 0.4F) * 2.0F) {
    ...
    protected boolean teleportToEntity(Entity p_70816_1_) {
        Vec3 var2 = Vec3.createVectorHelper(this.posX - p_70816_1_.posX, this.boundingBox.minY
