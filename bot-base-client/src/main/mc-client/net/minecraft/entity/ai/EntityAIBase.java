...
public abstract class EntityAIBase {
     ...
     * simple bitwise AND - if it yields
     * zero, the two tasks may run concurrently, if not - they must run exclusively
     * from each other.
     */
     ...
     * a simple bitwise AND - if it yields
     * zero, the two tasks may run concurrently, if not - they must run exclusively
     * from each other.
     */
