...
public class EntityAIOpenDoor extends EntityAIDoorInteract {
    ...
    public void startExecuting() {
        ...
        this.field_151504_e.func_150014_a(this.theEntity.worldObj, this.entityPosX, this.entityPosY, this.entityPosZ,
                true);
    }
    ...
    public void resetTask() {
        if (this.field_75361_i) {
            this.field_151504_e.func_150014_a(this.theEntity.worldObj, this.entityPosX, this.entityPosY,
