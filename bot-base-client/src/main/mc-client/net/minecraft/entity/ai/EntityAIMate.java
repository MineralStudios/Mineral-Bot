...
public class EntityAIMate extends EntityAIBase {
     ...
     * can be mated with. Returns the first
     * valid mate found.
     */
        ...
        if (var1 != null) {
            ...
            for (int var4 = 0; var4 < 7; ++var4) {
                ...
                this.theWorld.spawnParticle("heart",
                        this.theAnimal.posX + (double) (var3.nextFloat() * this.theAnimal.width * 2.0F)
                                - (double) this.theAnimal.width,
                        this.theAnimal.posY + 0.5D + (double) (var3.nextFloat() * this.theAnimal.height),
                        this.theAnimal.posZ + (double) (var3.nextFloat() * this.theAnimal.width * 2.0F)
                                - (double) this.theAnimal.width,
                        var5, var7, var9);
            }
