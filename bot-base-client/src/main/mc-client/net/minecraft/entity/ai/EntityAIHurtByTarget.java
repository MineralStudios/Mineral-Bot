...
public class EntityAIHurtByTarget extends EntityAITarget {
    ...
    public void startExecuting() {
        ...
        if (this.entityCallsForHelp) {
            ...
            List var3 = this.taskOwner.worldObj.getEntitiesWithinAABB(this.taskOwner.getClass(),
                    AxisAlignedBB
                            .getBoundingBox(this.taskOwner.posX, this.taskOwner.posY, this.taskOwner.posZ,
