...
public class EntityItem extends Entity {
    ...
    public void onUpdate() {
        if (this.getEntityItem() == null) {
            ...
            if (this.onGround) {
                var2 = this.worldObj.getBlock(MathHelper.floor_double(this.posX),
     ...
     * if successful. Either this item or
     ...
     * dropped (instead of five). Used when
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_) {
        if (!this.worldObj.isClient) {
            ...
            if (this.delayBeforeCanPickup == 0
                    && (this.field_145802_g == null || 6000 - this.age <= 200
                            || this.field_145802_g.equals(p_70100_1_.getCommandSenderName()))
                ...
                this.worldObj.playSoundAtEntity(p_70100_1_, "random.pop", 0.2F,
     ...
     * will log an error but still return an
