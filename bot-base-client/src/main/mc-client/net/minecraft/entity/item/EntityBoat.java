...
public class EntityBoat extends Entity {
    ...
    public void onUpdate() {
        ...
        for (int var4 = 0; var4 < var1; ++var4) {
            ...
            AxisAlignedBB var9 = AxisAlignedBB.getBoundingBox(this.boundingBox.minX, var5, this.boundingBox.minZ,
        ...
        if (this.worldObj.isClient && this.isBoatEmpty) {
            if (this.boatPosRotationIncrements > 0) {
                ...
                this.rotationYaw = (float) ((double) this.rotationYaw
                        + var26 / (double) this.boatPosRotationIncrements);
            ...
            if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase) {
                ...
                this.motionX += -Math.sin((double) (var21 * (float) Math.PI / 180.0F)) * this.speedMultiplier
                        * (double) var20.moveForward * 0.05000000074505806D;
                this.motionZ += Math.cos((double) (var21 * (float) Math.PI / 180.0F)) * this.speedMultiplier
                        * (double) var20.moveForward * 0.05000000074505806D;
            }
