...
public class VillageCollection extends WorldSavedData {
     ...
     * interface, but you can't query that
     ...
     * bounding box plus the given the
     * distance.
     */
    ...
    private void addDoorToNewListIfAppropriate(int p_75542_1_, int p_75542_2_, int p_75542_3_) {
        ...
        if (var4 != 0 && var4 != 2) {
            ...
            if (var5 != 0) {
                this.newDoors.add(new VillageDoorInfo(p_75542_1_, p_75542_2_, p_75542_3_, 0, var5 > 0 ? -2 : 2,
                        this.tickCounter));
            }
        } else {
            var5 = 0;
            ...
            if (var5 != 0) {
                this.newDoors.add(new VillageDoorInfo(p_75542_1_, p_75542_2_, p_75542_3_, var5 > 0 ? -2 : 2, 0,
                        this.tickCounter));
            }
        }
    }
