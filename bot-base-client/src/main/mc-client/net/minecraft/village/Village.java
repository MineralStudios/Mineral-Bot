...
public class Village {
     ...
     * village center by dividing by the number
     * of doors.
     */
    ...
    private Vec3 tryGetIronGolemSpawningLocation(int p_75559_1_, int p_75559_2_, int p_75559_3_, int p_75559_4_,
        ...
        for (int var7 = 0; var7 < 10; ++var7) {
            ...
            if (this.isInRange(var8, var9, var10)
                    && this.isValidIronGolemSpawningLocation(var8, var9, var10, p_75559_4_, p_75559_5_, p_75559_6_)) {
    ...
    private void updateNumIronGolems() {
        List var1 = this.worldObj.getEntitiesWithinAABB(EntityIronGolem.class,
                AxisAlignedBB.getBoundingBox((double) (this.center.posX - this.villageRadius),
    ...
    public boolean isInRange(int p_75570_1_, int p_75570_2_, int p_75570_3_) {
        return this.center.getDistanceSquared(p_75570_1_, p_75570_2_,
                p_75570_3_) < (float) (this.villageRadius * this.villageRadius);
    }
     ...
     * blocks, then the least restricted
     * one (i.e. the one protecting the lowest number of villagers) of them is
     * chosen, else the nearest one regardless
     * of restriction.
     */
    ...
    public VillageDoorInfo getVillageDoorAt(int p_75578_1_, int p_75578_2_, int p_75578_3_) {
        if (this.center.getDistanceSquared(p_75578_1_, p_75578_2_,
                p_75578_3_) > (float) (this.villageRadius * this.villageRadius)) {
            return null;
        } else {
