...
public abstract class Packet {
    ...
    /**
     * Will write a byte array to supplied ByteBuf as a separately defined structure
     * by prefixing the byte array with
     * its length
     */
    ...
    /**
     * Will read a byte array from the supplied ByteBuf, the first short encountered
     * will be interpreted as the size of
     ...
     */
    public abstract void readPacketData(PacketBuffer p_148837_1_, Minecraft mc) throws IOException;
