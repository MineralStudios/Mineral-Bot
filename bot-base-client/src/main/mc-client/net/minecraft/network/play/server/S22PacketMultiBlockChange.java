...
public class S22PacketMultiBlockChange extends Packet {
    ...
    public S22PacketMultiBlockChange(int p_i45181_1_, short[] p_i45181_2_, Chunk p_i45181_3_) {
        ...
        try {
            ...
            for (int var7 = 0; var7 < p_i45181_1_; ++var7) {
                ...
                var6.writeShort(
                        (short) ((Block.getIdFromBlock(p_i45181_3_.getBlockAt(var8, var10, var9)) & 4095) << 4
                                | p_i45181_3_.getBlockMetadata(var8, var10, var9) & 15));
            }
            ...
            if (this.field_148926_c.length != var4) {
                throw new RuntimeException(
                        "Expected length " + var4 + " doesn\'t match received length " + this.field_148926_c.length);
            }
    ...
    public String serialize() {
        return String.format("xc=%d, zc=%d, count=%d", new Object[] { Integer.valueOf(this.field_148925_b.chunkXPos),
                Integer.valueOf(this.field_148925_b.chunkZPos), Integer.valueOf(this.field_148924_d) });
    }
