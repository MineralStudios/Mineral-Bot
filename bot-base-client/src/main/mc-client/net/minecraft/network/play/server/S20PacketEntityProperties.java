    ...
    public S20PacketEntityProperties(int p_i45236_1_, Collection<IAttributeInstance> p_i45236_2_) {
        ...
        while (var3.hasNext()) {
            ...
            this.field_149444_b.add(new S20PacketEntityProperties.Snapshot(
                    var4.getAttribute().getAttributeUnlocalizedName(), var4.getBaseValue(), var4.func_111122_c()));
        }
    }
    ...
    public void readPacketData(PacketBuffer p_148837_1_, Minecraft mc) throws IOException {
        ...
        for (int var3 = 0; var3 < var2; ++var3) {
            ...
            for (int var9 = 0; var9 < var8; ++var9) {
                ...
                var7.add(new AttributeModifier(var10, "Unknown synced attribute modifier", p_148837_1_.readDouble(),
