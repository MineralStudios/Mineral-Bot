...
public class NetworkStatistics {
    ...
    static class PacketStatData {
        ...
        public NetworkStatistics.PacketStatData func_152494_a(long p_152494_1_) {
            return new NetworkStatistics.PacketStatData(p_152494_1_ + this.field_152496_a, this.field_152497_b + 1,
                    (double) ((p_152494_1_ + this.field_152496_a) / (long) (this.field_152497_b + 1)));
        }
        ...
        public String toString() {
            return "{totalBytes=" + this.field_152496_a + ", count=" + this.field_152497_b + ", averageBytes="
                    + this.field_152498_c + '}';
        }
    ...
    static class Tracker {
        ...
        public Tracker() {
            for (int var1 = 0; var1 < 100; ++var1) {
                this.field_152490_a[var1] = new AtomicReference(
                        new NetworkStatistics.PacketStatData(0L, 0, 0.0D, null));
            }
        }
        ...
        public void func_152488_a(int p_152488_1_, long p_152488_2_) {
            try {
                ...
                if (NetworkStatistics.field_152478_a.isDebugEnabled()) {
                    NetworkStatistics.field_152478_a.debug(NetworkStatistics.field_152479_b,
                            "NetStat failed with packetId: " + p_152488_1_, var6);
                }
            }
        }
        ...
        public NetworkStatistics.PacketStat func_152484_c() {
            ...
            for (int var3 = 0; var3 < 100; ++var3) {
                NetworkStatistics.PacketStatData var4 = (NetworkStatistics.PacketStatData) this.field_152490_a[var3]
                        .get();
        ...
        public NetworkStatistics.PacketStat func_152487_a(int p_152487_1_) {
            return p_152487_1_ >= 0 && p_152487_1_ < 100
                    ? new NetworkStatistics.PacketStat(p_152487_1_,
                            (NetworkStatistics.PacketStatData) this.field_152490_a[p_152487_1_].get())
                    : null;
        }
    }
}
