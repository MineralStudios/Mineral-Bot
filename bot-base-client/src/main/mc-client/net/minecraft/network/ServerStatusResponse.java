...
public class ServerStatusResponse {
    ...
    public static class MinecraftProtocolVersionIdentifier {
        ...
        public static class Serializer implements JsonDeserializer, JsonSerializer {
            ...
            public ServerStatusResponse.MinecraftProtocolVersionIdentifier deserialize(JsonElement p_deserialize_1_,
                    Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            ...
            public JsonElement serialize(ServerStatusResponse.MinecraftProtocolVersionIdentifier p_serialize_1_,
    ...
    public static class PlayerCountData {
        ...
        public static class Serializer implements JsonDeserializer, JsonSerializer {
            ...
            public ServerStatusResponse.PlayerCountData deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
                ...
                if (JsonUtils.jsonObjectFieldTypeIsArray(var4, "sample")) {
                    ...
                    if (var6.size() > 0) {
                        ...
                        for (int var8 = 0; var8 < var7.length; ++var8) {
                            JsonObject var9 = JsonUtils.getJsonElementAsJsonObject(var6.get(var8),
                                    "player[" + var8 + "]");
    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer {
        ...
        public ServerStatusResponse deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
            ...
            if (var4.has("players")) {
                var5.func_151319_a((ServerStatusResponse.PlayerCountData) p_deserialize_3_
