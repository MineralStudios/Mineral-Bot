...
public class TileEntityBrewingStand extends TileEntity implements ISidedInventory {
    ...
    public void updateEntity() {
        ...
        if (var1 != this.field_145943_l) {
            ...
            this.worldObj.setBlockMetadataWithNotify(this.field_145851_c, this.field_145848_d, this.field_145849_e,
                    var1, 2);
        }
    ...
    public boolean isItemValidForSlot(int p_94041_1_, ItemStack p_94041_2_) {
        return p_94041_1_ == 3 ? p_94041_2_.getItem().isPotionIngredient(p_94041_2_)
                : p_94041_2_.getItem() == Items.potionitem || p_94041_2_.getItem() == Items.glass_bottle;
    }
