...
public class TileEntityEnderChest extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if (++this.field_145974_k % 20 * 4 == 0) {
            this.worldObj.func_147452_c(this.field_145851_c, this.field_145848_d, this.field_145849_e,
                    Blocks.ender_chest, 1, this.field_145973_j);
        }
        ...
        if (this.field_145973_j > 0 && this.field_145972_a == 0.0F) {
            ...
            this.worldObj.playSoundEffect(var2, (double) this.field_145848_d + 0.5D, var4, "random.chestopen", 0.5F,
                    this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }

        if (this.field_145973_j == 0 && this.field_145972_a > 0.0F
                || this.field_145973_j > 0 && this.field_145972_a < 1.0F) {
            ...
            if (this.field_145972_a < var3 && var8 >= var3) {
                ...
                this.worldObj.playSoundEffect(var4, (double) this.field_145848_d + 0.5D, var6, "random.chestclosed",
    ...
    public void func_145969_a() {
        ++this.field_145973_j;
        this.worldObj.func_147452_c(this.field_145851_c, this.field_145848_d, this.field_145849_e, Blocks.ender_chest,
                1, this.field_145973_j);
    }
    ...
    public boolean func_145971_a(EntityPlayer p_145971_1_) {
        return this.worldObj.getTileEntity(this.field_145851_c, this.field_145848_d, this.field_145849_e) != this
                ? false
                : p_145971_1_.getDistanceSq((double) this.field_145851_c + 0.5D, (double) this.field_145848_d + 0.5D,
