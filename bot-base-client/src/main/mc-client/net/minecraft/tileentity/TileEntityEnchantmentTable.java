...
public class TileEntityEnchantmentTable extends TileEntity {
    ...
    public void updateEntity() {
        ...
        EntityPlayer var1 = this.worldObj.getClosestPlayer((double) ((float) this.field_145851_c + 0.5F),
                (double) ((float) this.field_145848_d + 0.5F), (double) ((float) this.field_145849_e + 0.5F), 3.0D);
