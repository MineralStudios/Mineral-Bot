...
public class TileEntity {
    ...
    public int getBlockMetadata() {
        if (this.blockMetadata == -1) {
            this.blockMetadata = this.worldObj.getBlockMetadata(this.field_145851_c, this.field_145848_d,
                    this.field_145849_e);
        }
    ...
    public void onInventoryChanged() {
        if (this.worldObj != null) {
            ...
            if (this.getBlockType() != Blocks.air) {
                this.worldObj.func_147453_f(this.field_145851_c, this.field_145848_d, this.field_145849_e,
                        this.getBlockType());
            }
        }
    }
    ...
    public void func_145828_a(CrashReportCategory p_145828_1_) {
        p_145828_1_.addCrashSectionCallable("Name",
                () -> (String) TileEntity.classToNameMap.get(TileEntity.this.getClass()) + " // "
                        + TileEntity.this.getClass().getCanonicalName());
        CrashReportCategory.func_147153_a(p_145828_1_, this.field_145851_c, this.field_145848_d, this.field_145849_e,
                this.getBlockType(), this.getBlockMetadata());
        p_145828_1_.addCrashSectionCallable("Actual block type", () -> {
            int var1 = Block.getIdFromBlock(TileEntity.this.worldObj.getBlock(TileEntity.this.field_145851_c,
                    TileEntity.this.field_145848_d, TileEntity.this.field_145849_e));
        ...
        p_145828_1_.addCrashSectionCallable("Actual block data value", () -> {
            int var1 = TileEntity.this.worldObj.getBlockMetadata(TileEntity.this.field_145851_c,
                    TileEntity.this.field_145848_d, TileEntity.this.field_145849_e);
