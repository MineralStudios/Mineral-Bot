...
public class TileEntityPiston extends TileEntity {
    ...
    public float func_145865_b(float p_145865_1_) {
        return this.field_145875_k
                ? (this.func_145860_a(p_145865_1_) - 1.0F) * (float) Facing.offsetsXForSide[this.field_145874_j]
                : (1.0F - this.func_145860_a(p_145865_1_)) * (float) Facing.offsetsXForSide[this.field_145874_j];
    }

    public float func_145862_c(float p_145862_1_) {
        return this.field_145875_k
                ? (this.func_145860_a(p_145862_1_) - 1.0F) * (float) Facing.offsetsYForSide[this.field_145874_j]
                : (1.0F - this.func_145860_a(p_145862_1_)) * (float) Facing.offsetsYForSide[this.field_145874_j];
    }

    public float func_145859_d(float p_145859_1_) {
        return this.field_145875_k
                ? (this.func_145860_a(p_145859_1_) - 1.0F) * (float) Facing.offsetsZForSide[this.field_145874_j]
                : (1.0F - this.func_145860_a(p_145859_1_)) * (float) Facing.offsetsZForSide[this.field_145874_j];
    }
    ...
    private void func_145863_a(float p_145863_1_, float p_145863_2_) {
        ...
        AxisAlignedBB var3 = Blocks.piston_extension.func_149964_a(this.worldObj, this.field_145851_c,
                this.field_145848_d, this.field_145849_e, this.field_145869_a, p_145863_1_, this.field_145874_j);
        ...
        if (var3 != null) {
            ...
            if (!var4.isEmpty()) {
                ...
                while (var5.hasNext()) {
                    ...
                    var6.moveEntity((double) (p_145863_2_ * (float) Facing.offsetsXForSide[this.field_145874_j]),
                            (double) (p_145863_2_ * (float) Facing.offsetsYForSide[this.field_145874_j]),
                            (double) (p_145863_2_ * (float) Facing.offsetsZForSide[this.field_145874_j]));
                }
    ...
    public void func_145866_f() {
        if (this.field_145870_n < 1.0F && this.worldObj != null) {
            ...
            if (this.worldObj.getBlock(this.field_145851_c, this.field_145848_d,
                    this.field_145849_e) == Blocks.piston_extension) {
                this.worldObj.setBlock(this.field_145851_c, this.field_145848_d, this.field_145849_e,
                        this.field_145869_a, this.field_145876_i, 3);
                this.worldObj.func_147460_e(this.field_145851_c, this.field_145848_d, this.field_145849_e,
                        this.field_145869_a);
            }
        }
    }
