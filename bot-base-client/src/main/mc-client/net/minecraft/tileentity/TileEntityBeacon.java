...
public class TileEntityBeacon extends TileEntity implements IInventory {
        ...
        if (this.field_146015_k && this.field_146012_l > 0 && !this.worldObj.isClient && this.field_146013_m > 0) {
            ...
            AxisAlignedBB var4 = AxisAlignedBB
                    .getBoundingBox((double) this.field_145851_c, (double) this.field_145848_d,
                            (double) this.field_145849_e, (double) (this.field_145851_c + 1),
                            (double) (this.field_145848_d + 1), (double) (this.field_145849_e + 1))
            ...
            for (int var2 = 1; var2 <= 4; this.field_146012_l = var2++) {
                ...
                for (int var5 = this.field_145851_c - var2; var5 <= this.field_145851_c + var2 && var4; ++var5) {
                    for (int var6 = this.field_145849_e - var2; var6 <= this.field_145849_e + var2; ++var6) {
                        ...
                        if (var7 != Blocks.emerald_block && var7 != Blocks.gold_block && var7 != Blocks.diamond_block
    ...
    public boolean isItemValidForSlot(int p_94041_1_, ItemStack p_94041_2_) {
        return p_94041_2_.getItem() == Items.emerald || p_94041_2_.getItem() == Items.diamond
                || p_94041_2_.getItem() == Items.gold_ingot || p_94041_2_.getItem() == Items.iron_ingot;
    }
