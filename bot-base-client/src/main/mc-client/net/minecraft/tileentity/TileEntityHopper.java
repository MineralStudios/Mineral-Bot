...
public class TileEntityHopper extends TileEntity implements IHopper {
    ...
    public static boolean func_145891_a(IHopper p_145891_0_) {
        ...
        if (var1 != null) {
            ...
            EntityItem var6 = func_145897_a(p_145891_0_.getWorldObj(), p_145891_0_.getXPos(),
    ...
    private IInventory func_145895_l() {
        ...
        return func_145893_b(this.getWorldObj(), (double) (this.field_145851_c + Facing.offsetsXForSide[var1]),
                (double) (this.field_145848_d + Facing.offsetsYForSide[var1]),
                (double) (this.field_145849_e + Facing.offsetsZForSide[var1]));
    }
