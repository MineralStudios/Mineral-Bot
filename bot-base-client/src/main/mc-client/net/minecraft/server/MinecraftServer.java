...
public abstract class MinecraftServer implements ICommandSender, Runnable {
    ...
    public MinecraftServer(Minecraft mc, File p_i46400_1_, Proxy p_i46400_2_) {
        ...
        this.field_147144_o = new NetworkSystem(mc, this);
    ...
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_,
        ...
        for (int var10 = 0; var10 < this.worldServers.length; ++var10) {
            ...
            if (var10 == 0) {
                if (this.isDemo())
                    this.worldServers[var10] = new DemoWorldServer(mc, this, var7, p_71247_2_, var11, this.theProfiler);
                else
                    this.worldServers[var10] = new WorldServer(mc, this, var7, p_71247_2_, var11, var8,
                            this.theProfiler);

            } else {
                this.worldServers[var10] = new WorldServerMulti(mc, this, var7, p_71247_2_, var11, var8,
    ...
    public void run() {
        try {
            ...
            if (var2.saveToFile(this.mc, var3))
    ...
    public void tick() {
        ...
        if (var1 - this.field_147142_T >= 5000000000L) {
            ...
            int var4 = MathHelper.getRandomIntegerInRange(this.field_147146_q, 0,
                    this.getCurrentPlayerCount() - var3.length);

            for (int var5 = 0; var5 < var3.length; ++var5) {
                var3[var5] = ((EntityPlayerMP) this.serverConfigManager.playerEntityList.get(var4 + var5))
                        .getGameProfile();
            }
        ...
        for (var1 = 0; var1 < this.worldServers.length; ++var1) {
            ...
            if (var1 == 0 || this.getAllowNether()) {
                ...
                if (this.tickCounter % 20 == 0) {
                    ...
                    this.serverConfigManager.func_148537_a(
    ...
    public WorldServer worldServerForDimension(int p_71218_1_) {
        return p_71218_1_ == -1 ? this.worldServers[1]
                : (p_71218_1_ == 1 ? this.worldServers[2] : this.worldServers[0]);
    }
    ...
    /**
     * Returns true if a player does not have permission to edit the block at the
     * given coordinates.
     */
    ...
    /**
     * returns the difference, measured in milliseconds, between the current system
