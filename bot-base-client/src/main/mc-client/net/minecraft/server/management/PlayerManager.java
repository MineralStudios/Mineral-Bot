...
public class PlayerManager {
    ...
    /**
     * contains a PlayerInstance for every chunk they can see. the "player instance"
     * cotains a list of all players who
     * can also that chunk
     */
    ...
    public PlayerManager(Minecraft mc, WorldServer par1Minecraft) {
        this.mc = mc;
        ...
        if (this.chunkCoordsNotLoaded.size() > 0) {
            for (int var22 = 0; var22 < this.players.size(); ++var22) {
                ...
                for (int chunk = 0; chunk < this.chunkCoordsNotLoaded.size(); ++chunk) {
                    ...
                    if (coords != null) {
                        PlayerManager.PlayerInstance cw = this.getOrCreateChunkWatcher(coords.chunkXPos,
    ...
    public void addPlayer(EntityPlayerMP par1EntityPlayerMP) {
        ...
        par1EntityPlayerMP.playerNetServerHandler.sendPacket(new S26PacketMapChunkBulk(mc, spawnList));
     ...
     * provided radius. Arguments: x1, z1, x2,
     * z2, radius.
     */
                ...
                for (int var15 = var2 - var12; var15 <= var2 + var12; ++var15) {
                    for (int var16 = var3 - var12; var16 <= var3 + var12; ++var16) {
                        ...
                        if (!this.overlaps(var15 - var13, var16 - var14, var2, var3, var12)) {
                            PlayerManager.PlayerInstance var17 = this.getOrCreateChunkWatcher(var15 - var13,
                                    var16 - var14, false);
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP par1EntityPlayerMP, int par2, int par3) {
        ...
        return var4 != null && var4.playersWatchingChunk.contains(par1EntityPlayerMP)
                && !par1EntityPlayerMP.loadedChunks.contains(var4.chunkLocation);
    }
                ...
                if (var2 > 0) {
                    for (var7 = var5 - p_152622_1_; var7 <= var5 + p_152622_1_; ++var7) {
                        for (var8 = var6 - p_152622_1_; var8 <= var6 + p_152622_1_; ++var8) {
                            PlayerManager.PlayerInstance var9 = this.getOrCreateChunkWatcher(var7, var8, true, true);
    ...
    public class PlayerInstance {
        ...
        public void removePlayer(EntityPlayerMP par1EntityPlayerMP, boolean sendData) {
            if (this.playersWatchingChunk.contains(par1EntityPlayerMP)) {
                Chunk var2 = PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.chunkLocation.chunkXPos,
                        this.chunkLocation.chunkZPos);

                if (sendData && var2.func_150802_k()) {
                    par1EntityPlayerMP.playerNetServerHandler.sendPacket(new S21PacketChunkData(mc, var2, true, 0));
                }
                ...
                if (this.playersWatchingChunk.isEmpty()) {
                    long var3 = (long) this.chunkLocation.chunkXPos + 2147483647L
                    ...
                    if (this.chunkLoaded) {
                        PlayerManager.this.getWorldServer().theChunkProviderServer
                    ...
                    if (this.numberOfTilesToUpdate == 64) {
                        ...
                        for (var3 = 0; var3 < 16; ++var3) {
                            if ((this.flagsYAreasToUpdate & 1 << var3) != 0) {
                                var4 = var3 << 4;
                                List var5 = PlayerManager.this.theWorldServer.func_147486_a(var1, var4, var2, var1 + 16,
                                        var4 + 16, var2 + 16);
                        ...
                        for (var1 = 0; var1 < this.numberOfTilesToUpdate; ++var1) {
                            ...
                            if (ReflectorForge.blockHasTileEntity(PlayerManager.this.theWorldServer, var2, var3,
                                    var4)) {
        ...
        public void sendThisChunkToAllPlayers() {
            for (int i = 0; i < this.playersWatchingChunk.size(); ++i) {
                ...
                Chunk chunk = PlayerManager.this.getWorldServer().getChunkFromChunkCoords(this.chunkLocation.chunkXPos,
                        this.chunkLocation.chunkZPos);
                ArrayList list = new ArrayList(1);
                list.add(chunk);
                player.playerNetServerHandler.sendPacket(new S26PacketMapChunkBulk(mc, list));
            }
        }
    }
}
