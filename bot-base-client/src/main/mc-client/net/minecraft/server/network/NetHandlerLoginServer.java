...
public class NetHandlerLoginServer implements INetHandlerLoginServer {
    ...
    public void func_147322_a(String p_147322_1_) {
        try {
            ...
            this.field_147333_a.scheduleOutboundPacket(new S00PacketDisconnect(var2));
    ...
    public void func_147326_c() {
        ...
        String var1 = this.field_147327_f.getConfigurationManager()
                .func_148542_a(this.field_147333_a.getSocketAddress(), this.field_147337_i);
        ...
        if (var1 != null) {
            ...
            this.field_147327_f.getConfigurationManager().initializeConnectionToPlayer(this.field_147333_a,
                    this.field_147327_f.getConfigurationManager().func_148545_a(this.field_147337_i));
        }
    }
    ...
    public void onDisconnect(IChatComponent p_147231_1_) {
        logger.info("{} lost connection: {}", this.func_147317_d(), p_147231_1_.getUnformattedText());
    }

    public String func_147317_d() {
        return this.field_147337_i != null
                ? this.field_147337_i + " (" + this.field_147333_a.getSocketAddress() + ")"
                : String.valueOf(this.field_147333_a.getSocketAddress());
    }
    ...
    public void processLoginStart(C00PacketLoginStart p_147316_1_) {
        ...
        this.field_147337_i = p_147316_1_.getGameProfile();
        ...
        if (this.field_147327_f.isServerInOnlineMode() && !this.field_147333_a.isLocalChannel()) {
            ...
            this.field_147333_a.scheduleOutboundPacket(new S01PacketEncryptionRequest(this.field_147334_j,
                    this.field_147327_f.getKeyPair().getPublic(), this.field_147330_e));
        } else {
                ...
                public void run() {
                    ...
                    try {
                        String var2 = (new BigInteger(
                                CryptManager.getServerIdHash(NetHandlerLoginServer.this.field_147334_j,
                                        NetHandlerLoginServer.this.field_147327_f.getKeyPair().getPublic(),
                                        NetHandlerLoginServer.this.field_147335_k))).toString(16);
                        NetHandlerLoginServer.this.field_147337_i = NetHandlerLoginServer.this.field_147327_f
                                .func_147130_as().hasJoinedServer(new GameProfile(null, var1.getName()), var2, null);
                        ...
                        if (NetHandlerLoginServer.this.field_147337_i != null) {
                            ...
                            NetHandlerLoginServer.logger
                                    .error("Username '{}' tried to join with an invalid session", NetHandlerLoginServer.this.field_147337_i.getName());
                        }
