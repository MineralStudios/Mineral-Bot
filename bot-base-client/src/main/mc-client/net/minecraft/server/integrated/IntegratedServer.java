...
public class IntegratedServer extends MinecraftServer {
    private static final Logger logger = LogManager.getLogger(IntegratedServer.class);
    ...
    protected void loadAllWorlds(String par1Str, String par2Str, long par3, WorldType par5WorldType, String par6Str) {
        ...
        if (Reflector.DimensionManager.exists()) {
            Object var8 = this.isDemo() ? new DemoWorldServer(mc, this, var7, par2Str, 0, this.theProfiler)
                    : new WorldServerOF(mc, this, var7, par2Str, 0, this.theWorldSettings, this.theProfiler);
            Integer[] var9 = (Integer[]) ((Integer[]) Reflector.call(Reflector.DimensionManager_getStaticDimensionIDs,
                    new Object[0]));
            Integer[] arr$ = var9;
            int len$ = var9.length;
            ...
            for (int i$ = 0; i$ < len$; ++i$) {
                ...
                Object world = dim == 0 ? var8
                        : new WorldServerMultiOF(mc, this, var7, par2Str, dim, this.theWorldSettings,
                                (WorldServer) var8,
                                this.theProfiler);
            ...
            for (int var15 = 0; var15 < this.worldServers.length; ++var15) {
                ...
                if (var15 == 0) {
                    if (this.isDemo()) {
                        this.worldServers[var15] = new DemoWorldServer(mc, this, var7, par2Str, var16,
                                this.theProfiler);
                    } else {
                        this.worldServers[var15] = new WorldServerOF(mc, this, var7, par2Str, var16,
                                this.theWorldSettings,
                                this.theProfiler);
                    }
                } else {
                    this.worldServers[var15] = new WorldServerMultiOF(mc, this, var7, par2Str, var16,
                            this.theWorldSettings,
    ...
    protected boolean startServer() throws IOException {
        ...
        this.loadAllWorlds(this.getFolderName(), this.getWorldName(), this.theWorldSettings.getSeed(),
                this.theWorldSettings.getTerrainType(), this.theWorldSettings.func_82749_j());
    ...
    public void tick() {
        ...
        this.isGamePaused = this.mc.getNetHandler() != null
                && this.mc.func_147113_T();
