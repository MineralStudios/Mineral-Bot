...
public class CrashReportCategory {
    ...
    private final List<CrashReportCategory.Entry> field_85077_c = new ArrayList<>();
    ...
    public static String getLocationInfo(int p_85071_0_, int p_85071_1_, int p_85071_2_) {
        ...
        try {
            var3.append(String.format("World: (%d,%d,%d)", new Object[] { Integer.valueOf(p_85071_0_),
        ...
        try {
            ...
            var11 = (var4 + 1 << 4) - 1;
            var12 = (var5 + 1 << 4) - 1;
            var3.append(String.format("Chunk: (at %d,%d,%d in %d,%d; contains blocks %d,0,%d to %d,255,%d)",
                    new Object[] { Integer.valueOf(var6), Integer.valueOf(var7), Integer.valueOf(var8),
                            Integer.valueOf(var4), Integer.valueOf(var5), Integer.valueOf(var9), Integer.valueOf(var10),
                            Integer.valueOf(var11), Integer.valueOf(var12) }));
        ...
        try {
            ...
            var3.append(String.format("Region: (%d,%d; contains chunks %d,%d to %d,%d, blocks %d,0,%d to %d,255,%d)",
                    new Object[] { Integer.valueOf(var4), Integer.valueOf(var5), Integer.valueOf(var6),
                            Integer.valueOf(var7), Integer.valueOf(var8), Integer.valueOf(var9), Integer.valueOf(var10),
                            Integer.valueOf(var11), Integer.valueOf(var12), Integer.valueOf(var13) }));
    ...
    public void addCrashSectionCallable(String name, Callable<?> callable) {
        try {
            this.addCrashSection(name, callable.call());
        } catch (Throwable var4) {
            this.addCrashSectionThrowable(name, var4);
        }
    }
     ...
     * entries. The parameter indicates
     * how many additional deepest entries to prune. Returns the number of entries
     * in the resulting pruned stack trace.
     */
    ...
    public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement p_85069_1_, StackTraceElement p_85069_2_) {
        if (this.stackTrace.length != 0 && p_85069_1_ != null) {
            ...
            if (var3.isNativeMethod() == p_85069_1_.isNativeMethod()
                    && var3.getClassName().equals(p_85069_1_.getClassName())
                    && var3.getFileName().equals(p_85069_1_.getFileName())
                    && var3.getMethodName().equals(p_85069_1_.getMethodName())) {
    ...
    public static void func_147153_a(CrashReportCategory p_147153_0_, final int p_147153_1_, final int p_147153_2_,
            final int p_147153_3_, final Block p_147153_4_, final int p_147153_5_) {
        final int var6 = Block.getIdFromBlock(p_147153_4_);
        p_147153_0_.addCrashSectionCallable("Block type", () -> {
            try {
                return String.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(var6),
                        p_147153_4_.getUnlocalizedName(), p_147153_4_.getClass().getCanonicalName() });
            } catch (Throwable var2) {
                return "ID #" + var6;
            }
        });
        p_147153_0_.addCrashSectionCallable("Block data value", () -> {
            if (p_147153_5_ < 0)
                return "Unknown? (Got " + p_147153_5_ + ")";

            String var1 = String.format("%4s", new Object[] { Integer.toBinaryString(p_147153_5_) })
                    .replace(" ", "0");
            return String.format("%1$d / 0x%1$X / 0b%2$s", new Object[] { Integer.valueOf(p_147153_5_), var1 });
        });
        p_147153_0_.addCrashSectionCallable("Block location",
                () -> CrashReportCategory.getLocationInfo(p_147153_1_, p_147153_2_, p_147153_3_));
    }

    static class Entry {
        private final String field_85092_a, field_85091_b;
