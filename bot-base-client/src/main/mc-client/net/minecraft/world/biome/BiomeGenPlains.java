...
public class BiomeGenPlains extends BiomeGenBase {
    ...
    public String func_150572_a(Random p_150572_1_, int p_150572_2_, int p_150572_3_, int p_150572_4_) {
        ...
        if (var5 < -0.8D) {
            ...
            return var7 == 0 ? BlockFlower.field_149859_a[0]
                    : (var7 == 1 ? BlockFlower.field_149859_a[3] : BlockFlower.field_149859_a[8]);
        } else {
    ...
    public void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_, int p_76728_4_) {
        double var5 = field_150606_ad.func_151601_a((double) (p_76728_3_ + 8) / 200.0D,
                (double) (p_76728_4_ + 8) / 200.0D);
        int var7;
        int var8;
        int var9;
        int var10;
