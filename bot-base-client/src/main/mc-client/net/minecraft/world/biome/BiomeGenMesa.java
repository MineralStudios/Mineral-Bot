...
public class BiomeGenMesa extends BiomeGenBase {
    ...
    public void func_150573_a(World p_150573_1_, Random p_150573_2_, Block[] p_150573_3_, byte[] p_150573_4_,
        ...
        if (this.field_150626_aH) {
            ...
            double var13 = Math.min(Math.abs(p_150573_7_),
                    this.field_150623_aE.func_151601_a((double) var11 * 0.25D, (double) var12 * 0.25D));

            if (var13 > 0.0D) {
                double var15 = 0.001953125D;
                double var17 = Math
                        .abs(this.field_150624_aF.func_151601_a((double) var11 * var15, (double) var12 * var15));
    ...
    private byte func_150618_d(int p_150618_1_, int p_150618_2_, int p_150618_3_) {
        int var4 = (int) Math.round(this.field_150625_aG.func_151601_a((double) p_150618_1_ * 1.0D / 512.0D,
