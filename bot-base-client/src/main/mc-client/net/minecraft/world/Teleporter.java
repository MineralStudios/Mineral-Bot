...
public class Teleporter {
     ...
     * the X & Z of the players initial
     * location.
     */
    ...
    public void placeInPortal(Entity p_77185_1_, double p_77185_2_, double p_77185_4_, double p_77185_6_,
        ...
        if (this.worldServerInstance.provider.dimensionId != 1) {
            ...
            p_77185_1_.setLocationAndAngles((double) var9, (double) var10, (double) var11, p_77185_1_.rotationYaw,
                    0.0F);
            ...
            for (var20 = 0; var20 < 4; ++var20) {
                for (var21 = -1; var21 < 4; ++var21) {
                    ...
                    this.worldServerInstance.setBlock(var22, var23, var24,
                            (Block) (var33 ? Blocks.obsidian : Blocks.portal), 0, 2);
                }
            }
            ...
            for (var20 = 0; var20 < 4; ++var20) {
                for (var21 = -1; var21 < 4; ++var21) {
                    ...
                    this.worldServerInstance.notifyBlocksOfNeighborChange(var22, var23, var24,
                            this.worldServerInstance.getBlock(var22, var23, var24));
                }
            }
        }
