...
public final class SpawnerAnimals {
    ...
    protected static ChunkPosition func_151350_a(World p_151350_0_, int p_151350_1_, int p_151350_2_) {
        ...
        int var6 = p_151350_0_.rand
                .nextInt(var3 == null ? p_151350_0_.getActualHeight() : var3.getTopFilledSegment() + 16 - 1);
        return new ChunkPosition(var4, var6, var5);
    }

    /**
     * adds all chunks within the spawn radius of the players to
     * eligibleChunksForSpawning. pars: the world,
    ...
    public int findChunksForSpawning(WorldServer par1WorldServer, boolean par2, boolean par3, boolean par4) {
        if (!par2 && !par3) {
            ...
            if (player == null || player.chunkCoordX != this.lastPlayerChunkX
                    || player.chunkCoordZ != this.lastPlayerChunkZ || this.eligibleChunksForSpawning.size() <= 0) {
                ...
                for (var5 = 0; var5 < par1WorldServer.playerEntities.size(); ++var5) {
                    ...
                    for (int var37 = -var36; var37 <= var36; ++var37) {
                        for (countEntities = -var36; countEntities <= var36; ++countEntities) {
                            boolean var38 = var37 == -var36 || var37 == var36 || countEntities == -var36
                                    || countEntities == var36;
            ...
            for (int var43 = 0; var43 < var8; ++var43) {
                ...
                if (Reflector.ForgeWorld_countEntities.exists()) {
                    countEntities = Reflector.callInt(par1WorldServer, Reflector.ForgeWorld_countEntities,
                            new Object[] { var44, Boolean.valueOf(true) });
                } else {
                    countEntities = par1WorldServer.countEntities(var44.getCreatureClass());
                }

                if ((!var44.getPeacefulCreature() || par3) && (var44.getPeacefulCreature() || par2)
                        && (!var44.getAnimal() || par4) && countEntities <= var44.getMaxNumberOfCreature()
                                * this.eligibleChunksForSpawning.size() / 256) {
                    ...
                    while (var46.hasNext()) {
                        ...
                        if (!((Boolean) this.eligibleChunksForSpawning.get(var39)).booleanValue()) {
                            ...
                            int var15 = par1WorldServer.rand.nextInt(chunk == null ? par1WorldServer.getActualHeight()
                                    : chunk.getTopFilledSegment() + 16 - 1);

                            if (!par1WorldServer.getBlock(var14, var15, var16).isNormalCube() && par1WorldServer
                                    .getBlock(var14, var15, var16).getMaterial() == var44.getCreatureMaterial()) {
                                int var17 = 0;
                                int var18 = 0;
                                ...
                                while (var18 < 3) {
                                    ...
                                    while (true) {
                                        if (var25 < 4) {
                                            label136: {
                                                var19 += par1WorldServer.rand.nextInt(var22)
                                                        - par1WorldServer.rand.nextInt(var22);
                                                var20 += par1WorldServer.rand.nextInt(1)
                                                        - par1WorldServer.rand.nextInt(1);
                                                var21 += par1WorldServer.rand.nextInt(var22)
                                                        - par1WorldServer.rand.nextInt(var22);

                                                if (canCreatureTypeSpawnAtLocation(var44, par1WorldServer, var19, var20,
                                                        var21)) {
                                                    float var26 = (float) var19 + 0.5F;
                                                    float var27 = (float) var20;
                                                    float var28 = (float) var21 + 0.5F;

                                                    if (par1WorldServer.getClosestPlayer((double) var26, (double) var27,
                                                        ...
                                                        if (var32 >= 576.0F) {
                                                            if (var23 == null) {
                                                                var23 = par1WorldServer.spawnRandomCreature(var44,
                                                                        var19, var20, var21);
                                                            ...
                                                            try {
                                                                var41 = (EntityLiving) this.mapSampleEntitiesByClass
                                                                ...
                                                                if (var41 == null) {
                                                                    ...
                                                                    this.mapSampleEntitiesByClass.put(var23.entityClass,
                                                                            var41);
                                                                }
                                                            ...
                                                            if (Reflector.ForgeEventFactory_canEntitySpawn.exists()) {
                                                                Object result = Reflector.call(
                                                                        Reflector.ForgeEventFactory_canEntitySpawn,
                                                                        new Object[] { var41, par1WorldServer,
                                                                                Float.valueOf(var26),
                                                                                Float.valueOf(var27),
                                                                                Float.valueOf(var28) });
                                                                Object result_ALLOW = Reflector
                                                                        .getFieldValue(Reflector.Event_Result_ALLOW);
                                                                Object result_DEFAULT = Reflector
                                                                        .getFieldValue(Reflector.Event_Result_DEFAULT);
                                                                canSpawn = result == result_ALLOW
                                                                        || result == result_DEFAULT
                                                                                && var41.getCanSpawnHere();
                                                            } else {
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType par0EnumCreatureType, World par1World,
        ...
        if (par0EnumCreatureType.getCreatureMaterial() == Material.water) {
            ...
            return Reflector.ForgeBlock_canCreatureSpawn.exists()
                    && !Reflector.callBoolean(var5, Reflector.ForgeBlock_canCreatureSpawn,
                            new Object[] { par0EnumCreatureType, par1World, Integer.valueOf(par2),
    ...
    public static void performWorldGenSpawning(World par0World, BiomeGenBase par1BiomeGenBase, int par2, int par3,
        ...
        if (!var7.isEmpty()) {
            while (par6Random.nextFloat() < par1BiomeGenBase.getSpawningChance()) {
                BiomeGenBase.SpawnListEntry var8 = (BiomeGenBase.SpawnListEntry) WeightedRandom
                ...
                for (int var15 = 0; var15 < var10; ++var15) {
                    ...
                    for (int var17 = 0; !var16 && var17 < 4; ++var17) {
                        ...
                        for (var12 += par6Random.nextInt(5) - par6Random.nextInt(5); var11 < par2
                                || var11 >= par2 + par4 || var12 < par3 || var12 >= par3 + par4; var12 = var14
