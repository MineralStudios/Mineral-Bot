...
public class AnvilSaveConverter extends SaveFormatOld {
            ...
            for (int var5 = 0; var5 < var4; ++var5) {
                ...
                if (var6.isDirectory()) {
                    ...
                    if (var8 != null && (var8.getSaveVersion() == 19132 || var8.getSaveVersion() == 19133)) {
                        ...
                        long var11 = 0L;
                        var1.add(new SaveFormatComparator(var7, var10, var8.getLastTimePlayed(), var11,
                                var8.getGameType(), var9, var8.isHardcoreModeEnabled(), var8.areCommandsAllowed()));
                    }
                }
            }
    ...
    public boolean convertMapFormat(String p_75805_1_, IProgressUpdate p_75805_2_) {
        ...
        this.convertFile(new File(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F),
                var3.size(), var9, p_75805_2_);
        this.convertFile(new File(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F),
                var3.size() + var4.size(), var9, p_75805_2_);
    ...
    private void convertChunks(File p_75811_1_, File p_75811_2_, WorldChunkManager p_75811_3_, int p_75811_4_,
            int p_75811_5_, IProgressUpdate p_75811_6_) {
        try {
            String var7 = p_75811_2_.getName();
            RegionFile var8 = new RegionFile(p_75811_2_);
            RegionFile var9 = new RegionFile(
                    new File(p_75811_1_, var7.substring(0, var7.length() - ".mcr".length()) + ".mca"));
            ...
            for (int var10 = 0; var10 < 32; ++var10) {
                ...
                int var20 = (int) Math
                        .round(100.0D * (double) ((var10 + 1) * 32 + p_75811_4_ * 1024) / (double) (p_75811_5_ * 1024));
