...
public class Chunk {
     ...
     * metadata. Each entry corresponds to a
     ...
     * field is set to true the first time the
    ...
    public Chunk(World p_i1995_1_, int p_i1995_2_, int p_i1995_3_) {
        ...
        this.chunkTileEntityMap = new Object2ObjectOpenHashMap<>();
            ...
            for (int var8 = 0; var8 < 16; ++var8) {
                for (int var9 = 0; var9 < var5; ++var9) {
                    ...
                    if (var10 != null && var10.getMaterial() != Material.air) {
                        ...
                        this.storageArrays[var11].setBlock(var7, var9 & 15, var8, var10);
                    }
                }
            }
        }
            ...
            for (int var9 = 0; var9 < 16; ++var9) {
                for (int var10 = 0; var10 < var6; ++var10) {
                    ...
                    if (var12 != null && var12 != Blocks.air) {
                        ...
                        this.storageArrays[var13].setBlock(var8, var10 & 15, var9, var12);
    ...
    public void generateSkylightMap() {
        ...
        for (int var2 = 0; var2 < 16; ++var2) {
            ...
            while (var3 < 16) {
                ...
                while (true) {
                    if (var4 > 0) {
                        if (this.getLightOpacityAt(var2, var4 - 1, var3) == 0) {
                            --var4;
                            continue;
                        }
                    ...
                    if (!this.worldObj.provider.hasNoSky) {
                        ...
                        do {
                            int var6 = this.getLightOpacityAt(var2, var5, var3);
                            ...
                            if (var4 > 0) {
                                ...
                                if (var7 != null) {
                                    ...
                                    this.worldObj.func_147479_m((this.xPosition << 4) + var2, var5,
                ...
                if (var5 < var4) {
                    for (var8 = var5; var8 < var4; ++var8) {
                        ...
                        if (var9 != null) {
                            ...
                            this.worldObj.func_147479_m((this.xPosition << 4) + p_76615_1_, var8,
    ...
    public int getLightOpacityAt(int p_150808_1_, int p_150808_2_, int p_150808_3_) {
        return this.getBlockAt(p_150808_1_, p_150808_2_, p_150808_3_).getLightOpacity();
    }

    public Block getBlockAt(final int p_150810_1_, final int p_150810_2_, final int p_150810_3_) {
        ...
        if (p_150810_2_ >> 4 < this.storageArrays.length) {
            ...
            if (var5 != null) {
                try {
                    var4 = var5.getBlockAt(p_150810_1_, p_150810_2_ & 15, p_150810_3_);
    ...
    public boolean setBlockMetadata(int p_76589_1_, int p_76589_2_, int p_76589_3_, int p_76589_4_) {
        ...
        if (var5 == null) {
            ...
            if (var6 == p_76589_4_) {
                ...
                if (var5.getBlockAt(p_76589_1_, p_76589_2_ & 15, p_76589_3_) instanceof ITileEntityProvider) {
     ...
     * it in the skylightmap and if its a
    ...
    public void setLightValue(EnumSkyBlock p_76633_1_, int p_76633_2_, int p_76633_3_, int p_76633_4_, int p_76633_5_) {
        ...
        if (var6 == null) {
            var6 = this.storageArrays[p_76633_3_ >> 4] = new ExtendedBlockStorage(p_76633_3_ >> 4 << 4,
                    !this.worldObj.provider.hasNoSky);
            this.generateSkylightMap();
        }
    ...
    public int getBlockLightValue(int p_76629_1_, int p_76629_2_, int p_76629_3_, int p_76629_4_) {
        ...
        if (var5 == null) {
            ...
            int var6 = this.worldObj.provider.hasNoSky ? 0
                    : var5.getExtSkylightValue(p_76629_1_, p_76629_2_ & 15, p_76629_3_);
    ...
    public void addEntity(Entity p_76612_1_) {
        ...
        if (var2 != this.xPosition || var3 != this.zPosition) {
            logger.warn("Wrong location! " + p_76612_1_ + " (at " + var2 + ", " + var3 + " instead of " + this.xPosition
                    + ", " + this.zPosition + ")");
            Thread.dumpStack();
        }
    ...
    public TileEntity func_150806_e(int p_150806_1_, int p_150806_2_, int p_150806_3_) {
        ...
        if (var5 == null) {
            Block var6 = this.getBlockAt(p_150806_1_, p_150806_2_, p_150806_3_);

            if (!var6.hasTileEntity()) {
                return null;
            }

            var5 = ((ITileEntityProvider) var6).createNewTileEntity(this.worldObj,
                    this.getBlockMetadata(p_150806_1_, p_150806_2_, p_150806_3_));
            this.worldObj.setTileEntity(this.xPosition * 16 + p_150806_1_, p_150806_2_,
                    this.zPosition * 16 + p_150806_3_, var5);
        }
    ...
    public void func_150812_a(int p_150812_1_, int p_150812_2_, int p_150812_3_, TileEntity p_150812_4_) {
        ...
        if (this.getBlockAt(p_150812_1_, p_150812_2_, p_150812_3_) instanceof ITileEntityProvider) {
    ...
    public void getEntitiesWithinAABBForEntity(Entity p_76588_1_, AxisAlignedBB p_76588_2_, List p_76588_3_,
        ...
        for (int var7 = var5; var7 <= var6; ++var7) {
            ...
            for (int var9 = 0; var9 < var8.size(); ++var9) {
                ...
                if (var10 != p_76588_1_ && var10.boundingBox.intersectsWith(p_76588_2_)
                        && (p_76588_4_ == null || p_76588_4_.isEntityApplicable(var10))) {
    ...
    public void getEntitiesOfTypeWithinAAAB(Class p_76618_1_, AxisAlignedBB p_76618_2_, List p_76618_3_,
        ...
        for (int var7 = var5; var7 <= var6; ++var7) {
            ...
            for (int var9 = 0; var9 < var8.size(); ++var9) {
                ...
                if (p_76618_1_.isAssignableFrom(var10.getClass()) && var10.boundingBox.intersectsWith(p_76618_2_)
                        && (p_76618_4_ == null || p_76618_4_.isEntityApplicable(var10))) {
    ...
    public int getPrecipitationHeight(int p_76626_1_, int p_76626_2_) {
        ...
        if (var4 == -999) {
            ...
            while (var5 > 0 && var4 == -1) {
                Block var6 = this.getBlockAt(p_76626_1_, var5, p_76626_2_);
     ...
     * arg 1 to arg 2 are fully empty
     * (true) or not (false).
     */
     ...
     */
    public void fillChunk(byte[] data, int primaryBitMask, int addBitMap, boolean groundUpContinuous) {
        int var5 = 0;
        boolean var6 = !this.worldObj.provider.hasNoSky;
        int var7;

        for (var7 = 0; var7 < this.storageArrays.length; ++var7) {
            if ((primaryBitMask & 1 << var7) != 0) {
                ...
                System.arraycopy(data, var5, var8, 0, var8.length);
                var5 += var8.length;
            } else if (groundUpContinuous && this.storageArrays[var7] != null) {
        ...
        for (var7 = 0; var7 < this.storageArrays.length; ++var7) {
            if ((primaryBitMask & 1 << var7) != 0 && this.storageArrays[var7] != null) {
                var10 = this.storageArrays[var7].getMetadataArray();
                System.arraycopy(data, var5, var10.data, 0, var10.data.length);
        ...
        for (var7 = 0; var7 < this.storageArrays.length; ++var7) {
            if ((addBitMap & 1 << var7) != 0) {
                if (this.storageArrays[var7] == null) {
                    ...
                    && this.storageArrays[var7].getBlockMSBArray() != null) {
                this.storageArrays[var7].clearMSBArray();
            }
        }

        if (groundUpContinuous) {
            System.arraycopy(data, var5, this.blockBiomeArray, 0, this.blockBiomeArray.length);
            int var10000 = var5 + this.blockBiomeArray.length;
        }

        for (var7 = 0; var7 < this.storageArrays.length; ++var7) {
            if (this.storageArrays[var7] != null && (primaryBitMask & 1 << var7) != 0) {
    ...
    public BiomeGenBase getBiomeGenForWorldCoords(int p_76591_1_, int p_76591_2_, WorldChunkManager p_76591_3_) {
        ...
        if (var4 == 255) {
            BiomeGenBase var5 = p_76591_3_.getBiomeGenAt((this.xPosition << 4) + p_76591_1_,
     ...
     * block positions in this Chunk to
     * biome IDs.
     */
     ...
     * index per-storage-block by up to 8
     * blocks at a time. In a worst-case scenario, can potentially take up to 1.6
     * seconds, calculated via
     * (4096/(8*16))/20, to re-check all blocks in a chunk, which could explain both
     * lagging light updates in certain
    ...
    public void func_150809_p() {
        ...
        if (!this.worldObj.provider.hasNoSky) {
            if (this.worldObj.checkChunksExist(this.xPosition * 16 - 1, 0, this.zPosition * 16 - 1,
                    this.xPosition * 16 + 1, 63, this.zPosition * 16 + 1)) {
    ...
    private boolean func_150811_f(int p_150811_1_, int p_150811_2_) {
        ...
        for (var6 = var3 + 16 - 1; var6 > 63 || var6 > 0 && !var5; --var6) {
            int var7 = this.getLightOpacityAt(p_150811_1_, var6, p_150811_2_);
            ...
            if (!var4 && var7 > 0) {
                var4 = true;
            } else if (var4 && var7 == 0 && !this.worldObj.func_147451_t(this.xPosition * 16 + p_150811_1_, var6,
                    this.zPosition * 16 + p_150811_2_)) {
                return false;
            }
        }

        for (; var6 > 0; --var6) {
            if (this.getBlockAt(p_150811_1_, var6, p_150811_2_).getLightValue() > 0) {
