...
public class ChunkLoader {
    ...
    public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_,
            WorldChunkManager p_76690_2_) {
                    ...
                    for (int var12 = 0; var12 < 16; ++var12) {
                        for (int var13 = 0; var13 < 16; ++var13) {
                            ...
                            var22.set(var23, var12, var13,
                                    p_76690_0_.blockLight.get(var23, var12 + (var5 << 4), var13));
                        }
                    }
                }
        ...
        for (int var18 = 0; var18 < 16; ++var18) {
            for (var7 = 0; var7 < 16; ++var7) {
                var17[var7 << 4 | var18] = (byte) (p_76690_2_.getBiomeGenAt(p_76690_0_.x << 4 | var18,
                        p_76690_0_.z << 4 | var7).biomeID & 255);
            }
        }
