...
public abstract class WorldProvider {
    ...
    public static WorldProvider getProviderForDimension(int p_76570_0_) {
        return (WorldProvider) (p_76570_0_ == -1 ? new WorldProviderHell()
                : (p_76570_0_ == 0 ? new WorldProviderSurface() : (p_76570_0_ == 1 ? new WorldProviderEnd() : null)));
    }
     ...
     * map at which void fog is at its
     * maximum. The default factor of 0.03125 relative to 256, for example, means
     * the void fog will be at its maximum at
     * (256*0.03125), or 8.
     */
