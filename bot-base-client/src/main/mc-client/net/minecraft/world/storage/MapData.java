...
public class MapData extends WorldSavedData {
    ...
    public void updateVisiblePlayers(EntityPlayer p_76191_1_, ItemStack p_76191_2_) {
        ...
        if (p_76191_2_.isOnItemFrame()) {
            this.func_82567_a(1, p_76191_1_.worldObj, "frame-" + p_76191_2_.getItemFrame().getEntityId(),
                    (double) p_76191_2_.getItemFrame().field_146063_b,
                    (double) p_76191_2_.getItemFrame().field_146062_d,
                    (double) (p_76191_2_.getItemFrame().hangingDirection * 90));
        }
    }
