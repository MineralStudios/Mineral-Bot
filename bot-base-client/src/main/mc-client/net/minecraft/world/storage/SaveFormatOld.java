...
public class SaveFormatOld implements ISaveFormat {
    ...
    /**
     * @args: Takes two arguments - first the name of the directory containing the
     *        world and second the new name for
     *        that world. @desc: Renames the world by storing the new name in
     *        level.dat. It does *not* rename the directory
     ...
     *        delete. @desc: Delete the world by deleting
     ...
     *        delete. @desc: Deletes the files and directory
