...
public class WorldGeneratorBonusChest extends WorldGenerator {
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        ...
        while (((var6 = p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_)).getMaterial() == Material.air
                || var6.getMaterial() == Material.leaves) && p_76484_4_ > 1) {
            --p_76484_4_;
        }
        ...
        if (p_76484_4_ < 1) {
            ...
            for (int var7 = 0; var7 < 4; ++var7) {
                ...
                if (p_76484_1_.isAirBlock(var8, var9, var10)
                        && World.doesBlockHaveSolidTopSurface(p_76484_1_, var8, var9 - 1, var10)) {
                    ...
                    if (var11 != null && var11 != null) {
                        WeightedRandomChestContent.generateChestContents(p_76484_2_, this.theBonusChestGenerator, var11,
                                this.itemsToGenerateInBonusChest);
                    }

                    if (p_76484_1_.isAirBlock(var8 - 1, var9, var10)
                            && World.doesBlockHaveSolidTopSurface(p_76484_1_, var8 - 1, var9 - 1, var10)) {
                    ...
                    if (p_76484_1_.isAirBlock(var8, var9, var10 - 1)
                            && World.doesBlockHaveSolidTopSurface(p_76484_1_, var8 - 1, var9 - 1, var10)) {
