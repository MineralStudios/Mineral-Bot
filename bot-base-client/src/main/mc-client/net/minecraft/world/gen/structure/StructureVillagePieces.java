...
public class StructureVillagePieces {
    ...
    private static StructureVillagePieces.Village func_75083_a(StructureVillagePieces.Start p_75083_0_,
        ...
        if (var9 == StructureVillagePieces.House4Garden.class) {
            var10 = StructureVillagePieces.House4Garden.func_74912_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.Church.class) {
            var10 = StructureVillagePieces.Church.func_74919_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.House1.class) {
            var10 = StructureVillagePieces.House1.func_74898_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.WoodHut.class) {
            var10 = StructureVillagePieces.WoodHut.func_74908_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.Hall.class) {
            var10 = StructureVillagePieces.Hall.func_74906_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_, p_75083_5_,
                    p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.Field1.class) {
            var10 = StructureVillagePieces.Field1.func_74900_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.Field2.class) {
            var10 = StructureVillagePieces.Field2.func_74902_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.House2.class) {
            var10 = StructureVillagePieces.House2.func_74915_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        } else if (var9 == StructureVillagePieces.House3.class) {
            var10 = StructureVillagePieces.House3.func_74921_a(p_75083_0_, p_75083_2_, p_75083_3_, p_75083_4_,
                    p_75083_5_, p_75083_6_, p_75083_7_, p_75083_8_);
        }
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        if (!var12.canSpawnMoreVillagePiecesOfType(p_75081_7_)
                                || var12 == p_75081_0_.structVillagePieceWeight
                                        && p_75081_0_.structureVillageWeightedPieceList.size() > 1) {
                            break;
                        }

                        StructureVillagePieces.Village var13 = func_75083_a(p_75081_0_, var12, p_75081_1_, p_75081_2_,
                                p_75081_3_, p_75081_4_, p_75081_5_, p_75081_6_, p_75081_7_);
            ...
            StructureBoundingBox var14 = StructureVillagePieces.Torch.func_74904_a(p_75081_0_, p_75081_1_, p_75081_2_,
                    p_75081_3_, p_75081_4_, p_75081_5_, p_75081_6_);
    ...
    private static StructureComponent getNextVillageStructureComponent(StructureVillagePieces.Start p_75077_0_,
        ...
        if (p_75077_7_ > 50) {
            return null;
        } else if (Math.abs(p_75077_3_ - p_75077_0_.getBoundingBox().minX) <= 112
                && Math.abs(p_75077_5_ - p_75077_0_.getBoundingBox().minZ) <= 112) {
            StructureVillagePieces.Village var8 = getNextVillageComponent(p_75077_0_, p_75077_1_, p_75077_2_,
                    p_75077_3_, p_75077_4_, p_75077_5_, p_75077_6_, p_75077_7_ + 1);
            ...
            if (var8 != null) {
                ...
                if (p_75077_0_.getWorldChunkManager().areBiomesViable(var9, var10, var13 / 2 + 4,
    ...
    private static StructureComponent getNextComponentVillagePath(StructureVillagePieces.Start p_75080_0_,
        ...
        if (p_75080_7_ > 3 + p_75080_0_.terrainType) {
            return null;
        } else if (Math.abs(p_75080_3_ - p_75080_0_.getBoundingBox().minX) <= 112
                && Math.abs(p_75080_5_ - p_75080_0_.getBoundingBox().minZ) <= 112) {
            StructureBoundingBox var8 = StructureVillagePieces.Path.func_74933_a(p_75080_0_, p_75080_1_, p_75080_2_,
                    p_75080_3_, p_75080_4_, p_75080_5_, p_75080_6_);

            if (var8 != null && var8.minY > 10) {
                StructureVillagePieces.Path var9 = new StructureVillagePieces.Path(p_75080_0_, p_75080_7_, p_75080_2_,
                        var8, p_75080_6_);
                ...
                if (p_75080_0_.getWorldChunkManager().areBiomesViable(var10, var11, var14 / 2 + 4,
                        MapGenVillage.villageSpawnBiomes)) {
                    p_75080_1_.add(var9);
    ...
    public static class Church extends StructureVillagePieces.Village {
        ...
        public Church(StructureVillagePieces.Start p_i2102_1_, int p_i2102_2_, Random p_i2102_3_,
                StructureBoundingBox p_i2102_4_, int p_i2102_5_) {
        ...
        public static StructureVillagePieces.Church func_74919_a(StructureVillagePieces.Start p_74919_0_,
                ...
                int p_74919_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74919_3_, p_74919_4_,
                    p_74919_5_, 0, 0, 0, 5, 12, 9, p_74919_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74919_1_, var8) == null
                    ? new StructureVillagePieces.Church(p_74919_0_, p_74919_7_, p_74919_2_, var8, p_74919_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 1, 0, 3, 10, 0, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 0, 1, 1, 0, 10, 3, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 4, 1, 1, 4, 10, 3, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 5, 4, 3, 10, 4, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            ...
            this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3), 1, 1, 5,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3), 2, 1, 6,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3), 3, 1, 5,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 1), 1, 2, 7,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 0), 3, 2, 7,
                    p_74875_3_);
            ...
            this.placeDoorAtCurrentPosition(p_74875_1_, p_74875_3_, p_74875_2_, 2, 1, 0,
                    this.func_151555_a(Blocks.wooden_door, 1));

            if (this.func_151548_a(p_74875_1_, 2, 0, -1, p_74875_3_).getMaterial() == Material.air
                    && this.func_151548_a(p_74875_1_, 2, -1, -1, p_74875_3_).getMaterial() != Material.air) {
                this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3), 2, 0,
                        -1, p_74875_3_);
            }
    ...
    public static class Field1 extends StructureVillagePieces.Village {
        ...
        public Field1(StructureVillagePieces.Start p_i2095_1_, int p_i2095_2_, Random p_i2095_3_,
                StructureBoundingBox p_i2095_4_, int p_i2095_5_) {
        ...
        public static StructureVillagePieces.Field1 func_74900_a(StructureVillagePieces.Start p_74900_0_,
                ...
                int p_74900_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74900_3_, p_74900_4_,
                    p_74900_5_, 0, 0, 0, 13, 4, 9, p_74900_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74900_1_, var8) == null
                    ? new StructureVillagePieces.Field1(p_74900_0_, p_74900_7_, p_74900_2_, var8, p_74900_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            for (var4 = 1; var4 <= 7; ++var4) {
                this.func_151550_a(p_74875_1_, this.cropTypeA, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 1,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeA, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 2,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeB, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 4,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeB, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 5,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeC, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 7,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeC, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 8,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeD, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 10,
                        1, var4, p_74875_3_);
                this.func_151550_a(p_74875_1_, this.cropTypeD, MathHelper.getRandomIntegerInRange(p_74875_2_, 2, 7), 11,
                        1, var4, p_74875_3_);
            }
    ...
    public static class Field2 extends StructureVillagePieces.Village {
        ...
        public Field2(StructureVillagePieces.Start p_i2096_1_, int p_i2096_2_, Random p_i2096_3_,
                StructureBoundingBox p_i2096_4_, int p_i2096_5_) {
        ...
        public static StructureVillagePieces.Field2 func_74902_a(StructureVillagePieces.Start p_74902_0_,
                ...
                int p_74902_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74902_3_, p_74902_4_,
                    p_74902_5_, 0, 0, 0, 7, 4, 9, p_74902_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74902_1_, var8) == null
                    ? new StructureVillagePieces.Field2(p_74902_0_, p_74902_7_, p_74902_2_, var8, p_74902_6_)
                    : null;
        }
    ...
    public static class Hall extends StructureVillagePieces.Village {
        ...
        public Hall(StructureVillagePieces.Start p_i2099_1_, int p_i2099_2_, Random p_i2099_3_,
                StructureBoundingBox p_i2099_4_, int p_i2099_5_) {
        ...
        public static StructureVillagePieces.Hall func_74906_a(StructureVillagePieces.Start p_74906_0_, List p_74906_1_,
            ...
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74906_3_, p_74906_4_,
                    p_74906_5_, 0, 0, 0, 9, 7, 11, p_74906_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74906_1_, var8) == null
                    ? new StructureVillagePieces.Hall(p_74906_0_, p_74906_7_, p_74906_2_, var8, p_74906_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151550_a(p_74875_1_, Blocks.oak_stairs, this.func_151555_a(Blocks.oak_stairs, 3), 2, 1, 4,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.oak_stairs, this.func_151555_a(Blocks.oak_stairs, 1), 1, 1, 3,
                    p_74875_3_);
            this.func_151549_a(p_74875_1_, p_74875_3_, 5, 0, 1, 7, 0, 3, Blocks.double_stone_slab,
            ...
            this.placeDoorAtCurrentPosition(p_74875_1_, p_74875_3_, p_74875_2_, 6, 1, 5,
                    this.func_151555_a(Blocks.wooden_door, 1));
    ...
    public static class House1 extends StructureVillagePieces.Village {
        ...
        public House1(StructureVillagePieces.Start p_i2094_1_, int p_i2094_2_, Random p_i2094_3_,
                StructureBoundingBox p_i2094_4_, int p_i2094_5_) {
        ...
        public static StructureVillagePieces.House1 func_74898_a(StructureVillagePieces.Start p_74898_0_,
                ...
                int p_74898_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74898_3_, p_74898_4_,
                    p_74898_5_, 0, 0, 0, 9, 9, 6, p_74898_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74898_1_, var8) == null
                    ? new StructureVillagePieces.House1(p_74898_0_, p_74898_7_, p_74898_2_, var8, p_74898_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151550_a(p_74875_1_, Blocks.oak_stairs, this.func_151555_a(Blocks.oak_stairs, 0), 7, 1, 3,
                    p_74875_3_);
            ...
            this.placeDoorAtCurrentPosition(p_74875_1_, p_74875_3_, p_74875_2_, 1, 1, 0,
                    this.func_151555_a(Blocks.wooden_door, 1));

            if (this.func_151548_a(p_74875_1_, 1, 0, -1, p_74875_3_).getMaterial() == Material.air
                    && this.func_151548_a(p_74875_1_, 1, -1, -1, p_74875_3_).getMaterial() != Material.air) {
                this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3), 1, 0,
                        -1, p_74875_3_);
            }
    ...
    public static class House2 extends StructureVillagePieces.Village {
        ...
        public House2(StructureVillagePieces.Start p_i2103_1_, int p_i2103_2_, Random p_i2103_3_,
                StructureBoundingBox p_i2103_4_, int p_i2103_5_) {
        ...
        public static StructureVillagePieces.House2 func_74915_a(StructureVillagePieces.Start p_74915_0_,
                ...
                int p_74915_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74915_3_, p_74915_4_,
                    p_74915_5_, 0, 0, 0, 10, 6, 7, p_74915_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74915_1_, var8) == null
                    ? new StructureVillagePieces.House2(p_74915_0_, p_74915_7_, p_74915_2_, var8, p_74915_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151550_a(p_74875_1_, Blocks.oak_stairs, this.func_151555_a(Blocks.oak_stairs, 3), 2, 1, 5,
                    p_74875_3_);
            this.func_151550_a(p_74875_1_, Blocks.oak_stairs, this.func_151555_a(Blocks.oak_stairs, 1), 1, 1, 4,
                    p_74875_3_);
            int var4;
            int var5;
            ...
            if (!this.hasMadeChest) {
                ...
                if (p_74875_3_.isVecInside(var5, var4, var6)) {
                    ...
                    this.generateStructureChestContents(p_74875_1_, p_74875_3_, p_74875_2_, 5, 1, 5,
                            villageBlacksmithChestContents, 3 + p_74875_2_.nextInt(6));
                }
            }

            for (var4 = 6; var4 <= 8; ++var4) {
                if (this.func_151548_a(p_74875_1_, var4, 0, -1, p_74875_3_).getMaterial() == Material.air
                        && this.func_151548_a(p_74875_1_, var4, -1, -1, p_74875_3_).getMaterial() != Material.air) {
                    this.func_151550_a(p_74875_1_, Blocks.stone_stairs, this.func_151555_a(Blocks.stone_stairs, 3),
                            var4, 0, -1, p_74875_3_);
                }
            }
    ...
    public static class House3 extends StructureVillagePieces.Village {
        ...
        public House3(StructureVillagePieces.Start p_i2106_1_, int p_i2106_2_, Random p_i2106_3_,
                StructureBoundingBox p_i2106_4_, int p_i2106_5_) {
        ...
        public static StructureVillagePieces.House3 func_74921_a(StructureVillagePieces.Start p_74921_0_,
                ...
                int p_74921_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74921_3_, p_74921_4_,
                    p_74921_5_, 0, 0, 0, 9, 7, 12, p_74921_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74921_1_, var8) == null
                    ? new StructureVillagePieces.House3(p_74921_0_, p_74921_7_, p_74921_2_, var8, p_74921_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 0, 1, 7, 0, 4, Blocks.planks, Blocks.planks, false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 0, 0, 0, 0, 3, 5, Blocks.cobblestone, Blocks.cobblestone, false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 8, 0, 0, 8, 3, 10, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 2, 0, 6, 2, 3, 10, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 3, 0, 10, 7, 3, 10, Blocks.cobblestone, Blocks.cobblestone,
                    false);
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 2, 0, 7, 3, 0, Blocks.planks, Blocks.planks, false);
    ...
    public static class House4Garden extends StructureVillagePieces.Village {
        ...
        public House4Garden(StructureVillagePieces.Start p_i2100_1_, int p_i2100_2_, Random p_i2100_3_,
                StructureBoundingBox p_i2100_4_, int p_i2100_5_) {
        ...
        public static StructureVillagePieces.House4Garden func_74912_a(StructureVillagePieces.Start p_74912_0_,
                ...
                int p_74912_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74912_3_, p_74912_4_,
                    p_74912_5_, 0, 0, 0, 5, 6, 5, p_74912_6_);
            return StructureComponent.findIntersecting(p_74912_1_, var8) != null ? null
                    : new StructureVillagePieces.House4Garden(p_74912_0_, p_74912_7_, p_74912_2_, var8, p_74912_6_);
        }
    ...
    public static class Path extends StructureVillagePieces.Road {
        ...
        public Path(StructureVillagePieces.Start p_i2105_1_, int p_i2105_2_, Random p_i2105_3_,
                StructureBoundingBox p_i2105_4_, int p_i2105_5_) {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            ...
            for (var5 = p_74861_3_.nextInt(5); var5 < this.averageGroundLevel - 8; var5 += 2 + p_74861_3_.nextInt(5)) {
                var6 = this.getNextComponentNN((StructureVillagePieces.Start) p_74861_1_, p_74861_2_, p_74861_3_, 0,
                        var5);
            ...
            for (var5 = p_74861_3_.nextInt(5); var5 < this.averageGroundLevel - 8; var5 += 2 + p_74861_3_.nextInt(5)) {
                var6 = this.getNextComponentPP((StructureVillagePieces.Start) p_74861_1_, p_74861_2_, p_74861_3_, 0,
                        var5);
            ...
            if (var4 && p_74861_3_.nextInt(3) > 0) {
                switch (this.coordBaseMode) {
                    case 0:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY,
                                this.boundingBox.maxZ - 2, 1, this.getComponentType());
                        break;

                    case 1:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY,
                    ...
                    case 2:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY,
                                this.boundingBox.minZ, 1, this.getComponentType());
                        break;

                    case 3:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.maxX - 2, this.boundingBox.minY,
                                this.boundingBox.minZ - 1, 2, this.getComponentType());
                }
            }
            ...
            if (var4 && p_74861_3_.nextInt(3) > 0) {
                switch (this.coordBaseMode) {
                    case 0:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY,
                                this.boundingBox.maxZ - 2, 3, this.getComponentType());
                        break;
                    ...
                    case 2:
                        StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_,
                                p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY,
                                this.boundingBox.minZ, 3, this.getComponentType());
                        break;
        ...
        public static StructureBoundingBox func_74933_a(StructureVillagePieces.Start p_74933_0_, List p_74933_1_,
            ...
            for (int var7 = 7 * MathHelper.getRandomIntegerInRange(p_74933_2_, 3, 5); var7 >= 7; var7 -= 7) {
                StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74933_3_, p_74933_4_,
                        p_74933_5_, 0, 0, 0, 3, 3, var7, p_74933_6_);
    ...
    public static class Torch extends StructureVillagePieces.Village {
        ...
        public Torch(StructureVillagePieces.Start p_i2097_1_, int p_i2097_2_, Random p_i2097_3_,
                StructureBoundingBox p_i2097_4_, int p_i2097_5_) {
        ...
        public static StructureBoundingBox func_74904_a(StructureVillagePieces.Start p_74904_0_, List p_74904_1_,
            ...
            StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(p_74904_3_, p_74904_4_,
                    p_74904_5_, 0, 0, 0, 3, 4, 2, p_74904_6_);
    ...
    abstract static class Village extends StructureComponent {
        ...
        protected StructureComponent getNextComponentNN(StructureVillagePieces.Start p_74891_1_, List p_74891_2_,
            ...
            switch (this.coordBaseMode) {
                case 0:
                    return StructureVillagePieces.getNextVillageStructureComponent(p_74891_1_, p_74891_2_, p_74891_3_,
                            this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_,
                            this.boundingBox.minZ + p_74891_5_, 1, this.getComponentType());
        ...
        protected StructureComponent getNextComponentPP(StructureVillagePieces.Start p_74894_1_, List p_74894_2_,
            ...
            switch (this.coordBaseMode) {
                case 0:
                    return StructureVillagePieces.getNextVillageStructureComponent(p_74894_1_, p_74894_2_, p_74894_3_,
                            this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_,
                            this.boundingBox.minZ + p_74894_5_, 3, this.getComponentType());
            ...
            for (int var5 = this.boundingBox.minZ; var5 <= this.boundingBox.maxZ; ++var5) {
                for (int var6 = this.boundingBox.minX; var6 <= this.boundingBox.maxX; ++var6) {
                    if (p_74889_2_.isVecInside(var6, 64, var5)) {
                        var3 += Math.max(p_74889_1_.getTopSolidOrLiquidBlock(var6, var5),
                                p_74889_1_.provider.getAverageGroundLevel());
                        ++var4;
                    }
                }
            }
        ...
        protected void spawnVillagers(World p_74893_1_, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_,
        ...
        protected void func_151550_a(World p_151550_1_, Block p_151550_2_, int p_151550_3_, int p_151550_4_,
                int p_151550_5_, int p_151550_6_, StructureBoundingBox p_151550_7_) {
        ...
        protected void func_151549_a(World p_151549_1_, StructureBoundingBox p_151549_2_, int p_151549_3_,
                int p_151549_4_, int p_151549_5_, int p_151549_6_, int p_151549_7_, int p_151549_8_, Block p_151549_9_,
                Block p_151549_10_, boolean p_151549_11_) {
            ...
            super.func_151556_a(p_151549_1_, p_151549_2_, p_151549_3_, p_151549_4_, p_151549_5_, p_151549_6_,
                    p_151549_7_, p_151549_8_, var12, var13, var14, var15, p_151549_11_);
        }

        protected void func_151554_b(World p_151554_1_, Block p_151554_2_, int p_151554_3_, int p_151554_4_,
                int p_151554_5_, int p_151554_6_, StructureBoundingBox p_151554_7_) {
    ...
    public static class Well extends StructureVillagePieces.Village {
        ...
        public Well(StructureVillagePieces.Start p_i2109_1_, int p_i2109_2_, Random p_i2109_3_, int p_i2109_4_,
                int p_i2109_5_) {
            ...
            switch (this.coordBaseMode) {
                case 0:
                case 2:
                    this.boundingBox = new StructureBoundingBox(p_i2109_4_, 64, p_i2109_5_, p_i2109_4_ + 6 - 1, 78,
                            p_i2109_5_ + 6 - 1);
                    break;
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_, p_74861_2_,
                    p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1,
                    this.getComponentType());
            StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_, p_74861_2_,
                    p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3,
                    this.getComponentType());
            StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_, p_74861_2_,
                    p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2,
                    this.getComponentType());
            StructureVillagePieces.getNextComponentVillagePath((StructureVillagePieces.Start) p_74861_1_, p_74861_2_,
                    p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0,
                    this.getComponentType());
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 0, 1, 4, 12, 4, Blocks.cobblestone, Blocks.flowing_water,
                    false);
            ...
            this.func_151549_a(p_74875_1_, p_74875_3_, 1, 15, 1, 4, 15, 4, Blocks.cobblestone, Blocks.cobblestone,
                    false);
    ...
    public static class WoodHut extends StructureVillagePieces.Village {
        ...
        public WoodHut(StructureVillagePieces.Start p_i2101_1_, int p_i2101_2_, Random p_i2101_3_,
                StructureBoundingBox p_i2101_4_, int p_i2101_5_) {
        ...
        public static StructureVillagePieces.WoodHut func_74908_a(StructureVillagePieces.Start p_74908_0_,
                ...
                int p_74908_7_) {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_74908_3_, p_74908_4_,
                    p_74908_5_, 0, 0, 0, 4, 6, 5, p_74908_6_);
            return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(p_74908_1_, var8) == null
                    ? new StructureVillagePieces.WoodHut(p_74908_0_, p_74908_7_, p_74908_2_, var8, p_74908_6_)
                    : null;
        }
