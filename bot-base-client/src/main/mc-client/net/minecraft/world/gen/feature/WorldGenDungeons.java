        ...
        for (var10 = p_76484_3_ - var7 - 1; var10 <= p_76484_3_ + var7 + 1; ++var10) {
            for (var11 = p_76484_4_ - 1; var11 <= p_76484_4_ + var6 + 1; ++var11) {
                for (var12 = p_76484_5_ - var8 - 1; var12 <= p_76484_5_ + var8 + 1; ++var12) {
                    ...
                    if ((var10 == p_76484_3_ - var7 - 1 || var10 == p_76484_3_ + var7 + 1
                            || var12 == p_76484_5_ - var8 - 1 || var12 == p_76484_5_ + var8 + 1) && var11 == p_76484_4_
                            && p_76484_1_.isAirBlock(var10, var11, var12)
                            && p_76484_1_.isAirBlock(var10, var11 + 1, var12)) {
                        ++var9;
                    }
                }
            }
        ...
        if (var9 >= 1 && var9 <= 5) {
            for (var10 = p_76484_3_ - var7 - 1; var10 <= p_76484_3_ + var7 + 1; ++var10) {
                for (var11 = p_76484_4_ + var6; var11 >= p_76484_4_ - 1; --var11) {
                    for (var12 = p_76484_5_ - var8 - 1; var12 <= p_76484_5_ + var8 + 1; ++var12) {
                        if (var10 != p_76484_3_ - var7 - 1 && var11 != p_76484_4_ - 1 && var12 != p_76484_5_ - var8 - 1
                                && var10 != p_76484_3_ + var7 + 1 && var11 != p_76484_4_ + var6 + 1
                                && var12 != p_76484_5_ + var8 + 1) {
                            p_76484_1_.setBlockToAir(var10, var11, var12);
                        } else if (var11 >= 0
                                && !p_76484_1_.getBlock(var10, var11 - 1, var12).getMaterial().isSolid()) {
                            p_76484_1_.setBlockToAir(var10, var11, var12);
                                ...
                                if (var15 == 1) {
                                    ...
                                    WeightedRandomChestContent[] var16 = WeightedRandomChestContent
                                            .func_92080_a(field_111189_a, new WeightedRandomChestContent[] {
                                                    Items.enchanted_book.func_92114_b(p_76484_2_) });
                                    TileEntityChest var17 = (TileEntityChest) p_76484_1_.getTileEntity(var12,
                                            p_76484_4_, var14);
            ...
            TileEntityMobSpawner var18 = (TileEntityMobSpawner) p_76484_1_.getTileEntity(p_76484_3_, p_76484_4_,
                    p_76484_5_);

            if (var18 != null) {
                var18.func_145881_a().setMobID(this.pickMobSpawner(p_76484_2_));
            } else {
                System.err.println("Failed to fetch mob spawner entity at (" + p_76484_3_ + ", " + p_76484_4_ + ", "
                        + p_76484_5_ + ")");
            }
