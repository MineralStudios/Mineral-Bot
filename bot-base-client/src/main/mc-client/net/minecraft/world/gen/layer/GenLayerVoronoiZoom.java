...
public class GenLayerVoronoiZoom extends GenLayer {
    ...
    public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
            ...
            for (int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14) {
                ...
                for (int var37 = 0; var37 < 4; ++var37) {
                    ...
                    for (int var39 = 0; var39 < 4; ++var39) {
                        double var40 = ((double) var37 - var21) * ((double) var37 - var21)
                                + ((double) var39 - var19) * ((double) var39 - var19);
                        double var42 = ((double) var37 - var25) * ((double) var37 - var25)
                                + ((double) var39 - var23) * ((double) var39 - var23);
                        double var44 = ((double) var37 - var29) * ((double) var37 - var29)
                                + ((double) var39 - var27) * ((double) var39 - var27);
                        double var46 = ((double) var37 - var33) * ((double) var37 - var33)
                                + ((double) var39 - var31) * ((double) var39 - var31);
        ...
        int[] var48 = IntCache.getIntCache(p_75904_3_ * p_75904_4_);

        for (var14 = 0; var14 < p_75904_4_; ++var14) {
            System.arraycopy(var12, (var14 + (p_75904_2_ & 3)) * var10 + (p_75904_1_ & 3), var48, var14 * p_75904_3_,
                    p_75904_3_);
        }
