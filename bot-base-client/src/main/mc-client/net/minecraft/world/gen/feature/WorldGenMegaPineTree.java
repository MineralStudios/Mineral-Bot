...
public class WorldGenMegaPineTree extends WorldGenHugeTrees {
        ...
        if (!this.func_150537_a(p_76484_1_, p_76484_2_, p_76484_3_, p_76484_4_, p_76484_5_, var6)) {
            ...
            for (int var7 = 0; var7 < var6; ++var7) {
                ...
                if (var8.getMaterial() == Material.air || var8.getMaterial() == Material.leaves) {
                    this.func_150516_a(p_76484_1_, p_76484_3_, p_76484_4_ + var7, p_76484_5_, Blocks.log,
                            this.woodMetadata);
                }
                ...
                if (var7 < var6 - 1) {
                    ...
                    if (var8.getMaterial() == Material.air || var8.getMaterial() == Material.leaves) {
                        this.func_150516_a(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + var7, p_76484_5_, Blocks.log,
                                this.woodMetadata);
                    }
                    ...
                    if (var8.getMaterial() == Material.air || var8.getMaterial() == Material.leaves) {
                        this.func_150516_a(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + var7, p_76484_5_ + 1, Blocks.log,
                                this.woodMetadata);
                    }
                    ...
                    if (var8.getMaterial() == Material.air || var8.getMaterial() == Material.leaves) {
                        this.func_150516_a(p_76484_1_, p_76484_3_, p_76484_4_ + var7, p_76484_5_ + 1, Blocks.log,
                                this.woodMetadata);
                    }
                }
            }
    ...
    private void func_150541_c(World p_150541_1_, int p_150541_2_, int p_150541_3_, int p_150541_4_, int p_150541_5_,
        ...
        for (int var9 = p_150541_4_ - var7; var9 <= p_150541_4_; ++var9) {
            ...
            this.func_150535_a(p_150541_1_, p_150541_2_, var9, p_150541_3_,
                    var11 + (var10 > 0 && var11 == var8 && (var9 & 1) == 0 ? 1 : 0), p_150541_6_);
            var8 = var11;
        }
    }
    ...
    public void func_150524_b(World p_150524_1_, Random p_150524_2_, int p_150524_3_, int p_150524_4_,
        ...
        for (int var6 = 0; var6 < 5; ++var6) {
            ...
            if (var8 == 0 || var8 == 7 || var9 == 0 || var9 == 7) {
                this.func_150539_c(p_150524_1_, p_150524_2_, p_150524_3_ - 3 + var8, p_150524_4_,
                        p_150524_5_ - 3 + var9);
            }
        }
    }
