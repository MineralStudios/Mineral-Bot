...
public class GenLayerShore extends GenLayer {
        ...
        for (int var7 = 0; var7 < p_75904_4_; ++var7) {
            for (int var8 = 0; var8 < p_75904_3_; ++var8) {
                ...
                if (var9 == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    if (var11 != BiomeGenBase.ocean.biomeID && var12 != BiomeGenBase.ocean.biomeID
                            && var13 != BiomeGenBase.ocean.biomeID && var14 != BiomeGenBase.ocean.biomeID) {
                    ...
                    if (this.func_151631_c(var11) && this.func_151631_c(var12) && this.func_151631_c(var13)
                            && this.func_151631_c(var14)) {
                        if (!func_151618_b(var11) && !func_151618_b(var12) && !func_151618_b(var13)
                                && !func_151618_b(var14)) {
                            var6[var8 + var7 * p_75904_3_] = var9;
                        } else {
                ...
                } else if (var9 != BiomeGenBase.extremeHills.biomeID && var9 != BiomeGenBase.field_150580_W.biomeID
                        && var9 != BiomeGenBase.extremeHillsEdge.biomeID) {
                    if (var10 != null && var10.func_150559_j()) {
                        this.func_151632_a(var5, var6, var8, var7, p_75904_3_, var9,
                        ...
                        if (var9 != BiomeGenBase.ocean.biomeID && var9 != BiomeGenBase.field_150575_M.biomeID
                                && var9 != BiomeGenBase.river.biomeID && var9 != BiomeGenBase.swampland.biomeID) {
                            var11 = var5[var8 + 1 + (var7 + 1 - 1) * (p_75904_3_ + 2)];
                            var12 = var5[var8 + 1 + 1 + (var7 + 1) * (p_75904_3_ + 2)];
                            var13 = var5[var8 + 1 - 1 + (var7 + 1) * (p_75904_3_ + 2)];
                            var14 = var5[var8 + 1 + (var7 + 1 + 1) * (p_75904_3_ + 2)];
                        ...
                        if (!func_151618_b(var11) && !func_151618_b(var12) && !func_151618_b(var13)
                                && !func_151618_b(var14)) {
                            if (this.func_151633_d(var11) && this.func_151633_d(var12) && this.func_151633_d(var13)
    ...
    private boolean func_151631_c(int p_151631_1_) {
        return BiomeGenBase.func_150568_d(p_151631_1_) != null
                && BiomeGenBase.func_150568_d(p_151631_1_).func_150562_l() == BiomeGenJungle.class
                        ? true
                        : p_151631_1_ == BiomeGenBase.field_150574_L.biomeID
                                ...
                                || p_151631_1_ == BiomeGenBase.taiga.biomeID || func_151618_b(p_151631_1_);
    }
