...
public class MapGenCaves extends MapGenBase {
    ...
    protected void func_151542_a(long p_151542_1_, int p_151542_3_, int p_151542_4_, Block[] p_151542_5_,
            double p_151542_6_, double p_151542_8_, double p_151542_10_) {
        this.func_151541_a(p_151542_1_, p_151542_3_, p_151542_4_, p_151542_5_, p_151542_6_, p_151542_8_, p_151542_10_,
                1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_,
            double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_,
            float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
        ...
        for (boolean var28 = var25.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
            double var29 = 1.5D
                    + (double) (MathHelper.sin((float) p_151541_15_ * (float) Math.PI / (float) p_151541_16_)
                            * p_151541_12_ * 1.0F);
            ...
            if (!var54 && p_151541_15_ == var27 && p_151541_12_ > 1.0F && p_151541_16_ > 0) {
                this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_,
                        p_151541_10_, var25.nextFloat() * 0.5F + 0.5F, p_151541_13_ - ((float) Math.PI / 2F),
                        p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
                this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_,
                        p_151541_10_, var25.nextFloat() * 0.5F + 0.5F, p_151541_13_ + ((float) Math.PI / 2F),
                        p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
                return;
            ...
            if (var54 || var25.nextInt(4) != 0) {
                ...
                if (p_151541_6_ >= var19 - 16.0D - var29 * 2.0D && p_151541_10_ >= var21 - 16.0D - var29 * 2.0D
                        && p_151541_6_ <= var19 + 16.0D + var29 * 2.0D
                        && p_151541_10_ <= var21 + 16.0D + var29 * 2.0D) {
                                ...
                                if (var59 * var59 + var60 * var60 < 1.0D) {
                                    for (int var50 = var38 - 1; var50 >= var56; --var50) {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var60 * var60 < 1.0D) {
                                            ...
                                            if (var53 == Blocks.stone || var53 == Blocks.dirt
                                                    || var53 == Blocks.grass) {
                                                if (var50 < 10) {
                                                    ...
                                                    if (var49 && p_151541_5_[var48 - 1] == Blocks.dirt) {
                                                        p_151541_5_[var48 - 1] = this.worldObj.getBiomeGenForCoords(
                                                                var42 + p_151541_3_ * 16,
                                                                var45 + p_151541_4_ * 16).topBlock;
                                                    }
                                                }
                                            }
                                        }
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_,
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.func_151541_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13,
