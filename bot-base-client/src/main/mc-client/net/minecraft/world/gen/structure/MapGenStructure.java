...
public abstract class MapGenStructure extends MapGenBase {
     ...
     * Used so that during recursive
     * generation, the structure generator can avoid generating structures that
     * intersect ones that have already been
     * placed.
     */
        ...
        if (!this.structureMap.containsKey(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(p_151538_2_, p_151538_3_)))) {
            ...
            try {
                ...
                var9.addCrashSectionCallable("Structure type",
                        () -> MapGenStructure.this.getClass().getCanonicalName());
    ...
    protected StructureStart func_143028_c(int p_143028_1_, int p_143028_2_, int p_143028_3_) {
        ...
        while (var4.hasNext()) {
            ...
            if (var5.isSizeableStructure()
                    && var5.getBoundingBox().intersectsWith(p_143028_1_, p_143028_3_, p_143028_1_, p_143028_3_)) {
    ...
    public ChunkPosition func_151545_a(World p_151545_1_, int p_151545_2_, int p_151545_3_, int p_151545_4_) {
        ...
        while (var16.hasNext()) {
            ...
            if (var17.isSizeableStructure()) {
                ...
                var20 = var19.x - p_151545_2_;
                var21 = var19.y - p_151545_3_;
                var22 = var19.z - p_151545_4_;
     ...
     * run, or null if not relevant to this
     * structure generator.
     */
    ...
    private void func_143027_a(World p_143027_1_) {
        if (this.field_143029_e == null) {
            this.field_143029_e = (MapGenStructureData) p_143027_1_.loadItemData(MapGenStructureData.class,
                    this.func_143025_a());
    ...
    private void func_143026_a(int p_143026_1_, int p_143026_2_, StructureStart p_143026_3_) {
        this.field_143029_e.func_143043_a(p_143026_3_.func_143021_a(p_143026_1_, p_143026_2_), p_143026_1_,
                p_143026_2_);
