...
public class GenLayerBiomeEdge extends GenLayer {
    ...
    public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
        ...
        for (int var7 = 0; var7 < p_75904_4_; ++var7) {
            for (int var8 = 0; var8 < p_75904_3_; ++var8) {
                ...
                if (!this.func_151636_a(var5, var6, var8, var7, p_75904_3_, var9, BiomeGenBase.extremeHills.biomeID,
                        BiomeGenBase.extremeHillsEdge.biomeID)
                        && !this.func_151635_b(var5, var6, var8, var7, p_75904_3_, var9,
                                BiomeGenBase.field_150607_aa.biomeID, BiomeGenBase.field_150589_Z.biomeID)
                        && !this.func_151635_b(var5, var6, var8, var7, p_75904_3_, var9,
                                BiomeGenBase.field_150608_ab.biomeID, BiomeGenBase.field_150589_Z.biomeID)
                        && !this.func_151635_b(var5, var6, var8, var7, p_75904_3_, var9,
                                BiomeGenBase.field_150578_U.biomeID, BiomeGenBase.taiga.biomeID)) {
                    int var10;
                    int var11;
                    int var12;
                    int var13;
                    ...
                    if (var9 == BiomeGenBase.desert.biomeID) {
                        ...
                        if (var10 != BiomeGenBase.desert.biomeID && var11 != BiomeGenBase.desert.biomeID
                                ...
                                && var10 != BiomeGenBase.field_150584_S.biomeID
                                && var11 != BiomeGenBase.field_150584_S.biomeID
                                && var12 != BiomeGenBase.field_150584_S.biomeID
                                && var13 != BiomeGenBase.field_150584_S.biomeID
    ...
    private boolean func_151636_a(int[] p_151636_1_, int[] p_151636_2_, int p_151636_3_, int p_151636_4_,
            int p_151636_5_, int p_151636_6_, int p_151636_7_, int p_151636_8_) {
        if (!func_151616_a(p_151636_6_, p_151636_7_)) {
            ...
            if (this.func_151634_b(var9, p_151636_7_) && this.func_151634_b(var10, p_151636_7_)
                    && this.func_151634_b(var11, p_151636_7_) && this.func_151634_b(var12, p_151636_7_)) {
    ...
    private boolean func_151635_b(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_,
            int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_) {
        if (p_151635_6_ != p_151635_7_) {
            ...
            if (func_151616_a(var9, p_151635_7_) && func_151616_a(var10, p_151635_7_)
                    && func_151616_a(var11, p_151635_7_) && func_151616_a(var12, p_151635_7_)) {
