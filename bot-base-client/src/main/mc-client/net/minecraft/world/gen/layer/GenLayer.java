...
public abstract class GenLayer {
     ...
     * function, the third is the same as the
     * first.
     */
    ...
    protected static boolean func_151616_a(final int p_151616_0_, final int p_151616_1_) {
        if (p_151616_0_ == p_151616_1_) {
            ...
            try {
                ...
                var4.addCrashSectionCallable("Biome A", () -> String.valueOf(BiomeGenBase.func_150568_d(p_151616_0_)));
                var4.addCrashSectionCallable("Biome B", () -> String.valueOf(BiomeGenBase.func_150568_d(p_151616_1_)));
    ...
    protected static boolean func_151618_b(int p_151618_0_) {
        return p_151618_0_ == BiomeGenBase.ocean.biomeID || p_151618_0_ == BiomeGenBase.field_150575_M.biomeID
