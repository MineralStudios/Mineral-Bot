...
public class GenLayerBiome extends GenLayer {
    ...
    public GenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_) {
        ...
        this.field_151623_c = new BiomeGenBase[] { BiomeGenBase.desert, BiomeGenBase.desert, BiomeGenBase.desert,
                BiomeGenBase.field_150588_X, BiomeGenBase.field_150588_X, BiomeGenBase.plains };
        this.field_151621_d = new BiomeGenBase[] { BiomeGenBase.forest, BiomeGenBase.field_150585_R,
                BiomeGenBase.extremeHills, BiomeGenBase.plains, BiomeGenBase.field_150583_P, BiomeGenBase.swampland };
        ...
        this.field_151620_f = new BiomeGenBase[] { BiomeGenBase.icePlains, BiomeGenBase.icePlains,
                BiomeGenBase.icePlains, BiomeGenBase.field_150584_S };
            ...
            for (int var8 = 0; var8 < p_75904_3_; ++var8) {
                ...
                if (func_151618_b(var9)) {
                    ...
                    if (var10 > 0) {
                        ...
                        var6[var8 + var7 * p_75904_3_] = this.field_151623_c[this
                    ...
                    if (var10 > 0) {
                        ...
                        var6[var8 + var7 * p_75904_3_] = this.field_151621_d[this
                    ...
                    if (var10 > 0) {
                        ...
                        var6[var8 + var7 * p_75904_3_] = this.field_151622_e[this
                                .nextInt(this.field_151622_e.length)].biomeID;
                    }
                } else if (var9 == 4) {
                    var6[var8 + var7 * p_75904_3_] = this.field_151620_f[this
