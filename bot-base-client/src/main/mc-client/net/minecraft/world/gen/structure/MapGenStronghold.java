...
public class MapGenStronghold extends MapGenStructure {
    ...
    public MapGenStronghold(Map p_i2068_1_) {
        ...
        while (var2.hasNext()) {
            ...
            if (((String) var3.getKey()).equals("distance")) {
                this.field_82671_h = MathHelper.parseDoubleWithDefaultAndMax((String) var3.getValue(),
    ...
    protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_) {
        if (!this.ranBiomeCheck) {
            ...
            for (int var7 = 0; var7 < this.structureCoords.length; ++var7) {
                ...
                ChunkPosition var12 = this.worldObj.getWorldChunkManager().func_150795_a((var10 << 4) + 8,
    ...
    protected StructureStart getStructureStart(int p_75049_1_, int p_75049_2_) {
        ...
        for (var3 = new MapGenStronghold.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_); var3.getComponents()
                .isEmpty()
                || ((StructureStrongholdPieces.Stairs2) var3.getComponents()
                        .get(0)).strongholdPortalRoom == null; var3 = new MapGenStronghold.Start(this.worldObj,
                                this.rand, p_75049_1_, p_75049_2_)) {
            ;
        }
    ...
    public static class Start extends StructureStart {
        ...
        public Start(World p_i2067_1_, Random p_i2067_2_, int p_i2067_3_, int p_i2067_4_) {
            ...
            StructureStrongholdPieces.Stairs2 var5 = new StructureStrongholdPieces.Stairs2(0, p_i2067_2_,
