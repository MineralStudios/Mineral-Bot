            ...
            for (var8 = 0; var8 < 16; ++var8) {
                for (var32 = 0; var32 < 16; ++var32) {
                    for (var10 = 0; var10 < 8; ++var10) {
                        var34 = !var6[(var8 * 16 + var32) * 8 + var10]
                        ...
                        if (var34) {
                            Material var12 = p_76484_1_
                                    .getBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32).getMaterial();

                            if (var10 >= 4 && var12.isLiquid()) {
                                return false;
                            }

                            if (var10 < 4 && !var12.isSolid() && p_76484_1_.getBlock(p_76484_3_ + var8,
                                    p_76484_4_ + var10, p_76484_5_ + var32) != this.field_150556_a) {
                                return false;
                            }
                        }
                    }
                ...
                for (var32 = 0; var32 < 16; ++var32) {
                    for (var10 = 0; var10 < 8; ++var10) {
                        if (var6[(var8 * 16 + var32) * 8 + var10]) {
                            p_76484_1_.setBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32,
                                    var10 >= 4 ? Blocks.air : this.field_150556_a, 0, 2);
                        }
                    }
                }
            }
            ...
            for (var8 = 0; var8 < 16; ++var8) {
                for (var32 = 0; var32 < 16; ++var32) {
                    for (var10 = 4; var10 < 8; ++var10) {
                        if (var6[(var8 * 16 + var32) * 8 + var10]
                                && p_76484_1_.getBlock(p_76484_3_ + var8, p_76484_4_ + var10 - 1,
                                        p_76484_5_ + var32) == Blocks.dirt
                                && p_76484_1_.getSavedLightValue(EnumSkyBlock.Sky, p_76484_3_ + var8,
                                        p_76484_4_ + var10, p_76484_5_ + var32) > 0) {
                            BiomeGenBase var35 = p_76484_1_.getBiomeGenForCoords(p_76484_3_ + var8, p_76484_5_ + var32);

                            if (var35.topBlock == Blocks.mycelium) {
                                p_76484_1_.setBlock(p_76484_3_ + var8, p_76484_4_ + var10 - 1, p_76484_5_ + var32,
                                        Blocks.mycelium, 0, 2);
                            } else {
                                p_76484_1_.setBlock(p_76484_3_ + var8, p_76484_4_ + var10 - 1, p_76484_5_ + var32,
                                        Blocks.grass, 0, 2);
                ...
                for (var8 = 0; var8 < 16; ++var8) {
                    for (var32 = 0; var32 < 16; ++var32) {
                        for (var10 = 0; var10 < 8; ++var10) {
                            ...
                            if (var34 && (var10 < 4 || p_76484_2_.nextInt(2) != 0)
                                    && p_76484_1_.getBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32)
                                            .getMaterial().isSolid()) {
                                p_76484_1_.setBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32,
                                        Blocks.stone, 0, 2);
                            }
                ...
                for (var8 = 0; var8 < 16; ++var8) {
                    for (var32 = 0; var32 < 16; ++var32) {
                        ...
                        if (p_76484_1_.isBlockFreezable(p_76484_3_ + var8, p_76484_4_ + var33, p_76484_5_ + var32)) {
                            p_76484_1_.setBlock(p_76484_3_ + var8, p_76484_4_ + var33, p_76484_5_ + var32, Blocks.ice,
                                    0, 2);
                        }
                    }
                }
