...
public class MapGenCavesHell extends MapGenBase {
    ...
    protected void func_151544_a(long p_151544_1_, int p_151544_3_, int p_151544_4_, Block[] p_151544_5_,
            double p_151544_6_, double p_151544_8_, double p_151544_10_) {
        this.func_151543_a(p_151544_1_, p_151544_3_, p_151544_4_, p_151544_5_, p_151544_6_, p_151544_8_, p_151544_10_,
                1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void func_151543_a(long p_151543_1_, int p_151543_3_, int p_151543_4_, Block[] p_151543_5_,
            double p_151543_6_, double p_151543_8_, double p_151543_10_, float p_151543_12_, float p_151543_13_,
            float p_151543_14_, int p_151543_15_, int p_151543_16_, double p_151543_17_) {
        ...
        for (boolean var28 = var25.nextInt(6) == 0; p_151543_15_ < p_151543_16_; ++p_151543_15_) {
            double var29 = 1.5D
                    + (double) (MathHelper.sin((float) p_151543_15_ * (float) Math.PI / (float) p_151543_16_)
                            * p_151543_12_ * 1.0F);
            ...
            if (!var53 && p_151543_15_ == var27 && p_151543_12_ > 1.0F) {
                this.func_151543_a(var25.nextLong(), p_151543_3_, p_151543_4_, p_151543_5_, p_151543_6_, p_151543_8_,
                        p_151543_10_, var25.nextFloat() * 0.5F + 0.5F, p_151543_13_ - ((float) Math.PI / 2F),
                        p_151543_14_ / 3.0F, p_151543_15_, p_151543_16_, 1.0D);
                this.func_151543_a(var25.nextLong(), p_151543_3_, p_151543_4_, p_151543_5_, p_151543_6_, p_151543_8_,
                        p_151543_10_, var25.nextFloat() * 0.5F + 0.5F, p_151543_13_ + ((float) Math.PI / 2F),
                        p_151543_14_ / 3.0F, p_151543_15_, p_151543_16_, 1.0D);
                return;
            ...
            if (var53 || var25.nextInt(4) != 0) {
                ...
                if (p_151543_6_ >= var19 - 16.0D - var29 * 2.0D && p_151543_10_ >= var21 - 16.0D - var29 * 2.0D
                            ...
                            for (var45 = var56; var45 < var40; ++var45) {
                                ...
                                for (int var49 = var38 - 1; var49 >= var55; --var49) {
                                    ...
                                    if (var50 > -0.7D && var58 * var58 + var50 * var50 + var59 * var59 < 1.0D) {
                                        ...
                                        if (var52 == Blocks.netherrack || var52 == Blocks.dirt
                                                || var52 == Blocks.grass) {
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_,
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.func_151543_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13,
