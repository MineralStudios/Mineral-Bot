                ...
                if ((var19 == Blocks.grass || var19 == Blocks.dirt || var19 == Blocks.farmland)
                    ...
                    for (var11 = 0; var11 < var6; ++var11) {
                        ...
                        if (var12.getMaterial() == Material.air || var12.getMaterial() == Material.leaves) {
                            this.func_150516_a(p_76484_1_, p_76484_3_, p_76484_4_ + var11, p_76484_5_, Blocks.log,
                                    this.metaWood);

                            if (this.vinesGrow && var11 > 0) {
                                if (p_76484_2_.nextInt(3) > 0
                                        && p_76484_1_.isAirBlock(p_76484_3_ - 1, p_76484_4_ + var11, p_76484_5_)) {
                                    this.func_150516_a(p_76484_1_, p_76484_3_ - 1, p_76484_4_ + var11, p_76484_5_,
                                            Blocks.vine, 8);
                                }
                                ...
                                if (p_76484_2_.nextInt(3) > 0
                                        && p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_ + var11, p_76484_5_ - 1)) {
                                    this.func_150516_a(p_76484_1_, p_76484_3_, p_76484_4_ + var11, p_76484_5_ - 1,
                                            Blocks.vine, 1);
                                }
                            ...
                            for (var14 = p_76484_3_ - var13; var14 <= p_76484_3_ + var13; ++var14) {
                                for (var15 = p_76484_5_ - var13; var15 <= p_76484_5_ + var13; ++var15) {
                                    if (p_76484_1_.getBlock(var14, var11, var15).getMaterial() == Material.leaves) {
                                        if (p_76484_2_.nextInt(4) == 0 && p_76484_1_.getBlock(var14 - 1, var11, var15)
                                        ...
                                        if (p_76484_2_.nextInt(4) == 0 && p_76484_1_.getBlock(var14, var11, var15 - 1)
                                                .getMaterial() == Material.air) {
                            ...
                            for (var11 = 0; var11 < 2; ++var11) {
                                for (var21 = 0; var21 < 4; ++var21) {
                                    if (p_76484_2_.nextInt(4 - var11) == 0) {
                                        ...
                                        this.func_150516_a(p_76484_1_,
                                                p_76484_3_ + Direction.offsetX[Direction.rotateOpposite[var21]],
                                                p_76484_4_ + var6 - 5 + var11,
                                                p_76484_5_ + Direction.offsetZ[Direction.rotateOpposite[var21]],
                                                Blocks.cocoa, var13 << 2 | var21);
                                    }
                                }
                            }
                        }
