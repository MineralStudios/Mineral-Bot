...
public abstract class World implements IBlockAccess {
     ...
     * Used with an A value of 3 and a C
     * value of 0x3c6ef35f, producing a highly planar series of values ill-suited
     * for choosing random blocks in a
     * 16x128x16 field.
     */
     ...
     * updateWeather(). Value appears to be
     * unused.
     */
     ...
     * levels. Holds up to 32x32x32 blocks (the
     * maximum influence of a light source.) Every element is a packed bit value:
     * 0000000000LLLLzzzzzzyyyyyyxxxxxx. The
     * 4-bit L is a light level used when darkening blocks. 6-bit numbers x, y and z
     * represent the block's offset from
    ...
    public Block getBlock(int p_147439_1_, int p_147439_2_, int p_147439_3_) {
        if (p_147439_1_ >= -30000000 && p_147439_3_ >= -30000000 && p_147439_1_ < 30000000 && p_147439_3_ < 30000000
                && p_147439_2_ >= 0 && p_147439_2_ < 256) {
            Chunk var4 = null;

            try {
                var4 = this.getChunkFromChunkCoords(p_147439_1_ >> 4, p_147439_3_ >> 4);
                return var4.getBlockAt(p_147439_1_ & 15, p_147439_2_, p_147439_3_ & 15);
    ...
    public boolean doChunksNearChunkExist(int p_72873_1_, int p_72873_2_, int p_72873_3_, int p_72873_4_) {
        return this.checkChunksExist(p_72873_1_ - p_72873_4_, p_72873_2_ - p_72873_4_, p_72873_3_ - p_72873_4_,
     ...
     * ID, new metadata, flags. Flag 1 will
     * cause a block update. Flag 2 will send the change to clients (you almost
    ...
    public boolean setBlock(int p_147465_1_, int p_147465_2_, int p_147465_3_, Block p_147465_4_, int p_147465_5_,
        ...
        if (p_147465_1_ >= -30000000 && p_147465_3_ >= -30000000 && p_147465_1_ < 30000000 && p_147465_3_ < 30000000) {
            if (p_147465_2_ < 0) {
                ...
                if ((p_147465_6_ & 1) != 0) {
                    var8 = var7.getBlockAt(p_147465_1_ & 15, p_147465_2_, p_147465_3_ & 15);
                }

                boolean var9 = var7.func_150807_a(p_147465_1_ & 15, p_147465_2_, p_147465_3_ & 15, p_147465_4_,
                        p_147465_5_);
     ...
     * changed, depending on the flag. Args:
    ...
    public boolean setBlockMetadataWithNotify(int p_72921_1_, int p_72921_2_, int p_72921_3_, int p_72921_4_,
        ...
        if (p_72921_1_ >= -30000000 && p_72921_3_ >= -30000000 && p_72921_1_ < 30000000 && p_72921_3_ < 30000000) {
            if (p_72921_2_ < 0) {
                ...
                if (var9) {
                    Block var10 = var6.getBlockAt(var7, p_72921_2_, var8);
    ...
    public boolean canBlockSeeTheSky(int p_72937_1_, int p_72937_2_, int p_72937_3_) {
        return this.getChunkFromChunkCoords(p_72937_1_ >> 4, p_72937_3_ >> 4).canBlockSeeTheSky(p_72937_1_ & 15,
                p_72937_2_, p_72937_3_ & 15);
    }
    ...
    public int getFullBlockLightValue(int p_72883_1_, int p_72883_2_, int p_72883_3_) {
        if (p_72883_2_ < 0) {
            ...
            return this.getChunkFromChunkCoords(p_72883_1_ >> 4, p_72883_3_ >> 4).getBlockLightValue(p_72883_1_ & 15,
     ...
     * gets the value and has a bool flag
     * that indicates if its a half step block to get the maximum light value of a
     * direct neighboring block (left,
     ...
     * loaded. Coords are in blocks. Args:
     * X, Z
     */
    ...
    public int getSkyBlockTypeBrightness(EnumSkyBlock p_72925_1_, int p_72925_2_, int p_72925_3_, int p_72925_4_) {
        if (this.provider.hasNoSky && p_72925_1_ == EnumSkyBlock.Sky) {
            ...
            } else if (p_72925_2_ >= -30000000 && p_72925_4_ >= -30000000 && p_72925_2_ < 30000000
                    && p_72925_4_ < 30000000) {
     ...
     * enumSkyBlock is set to sky or block.
            ...
            if (p_72915_3_ >= 0) {
                if (p_72915_3_ < 256) {
                    if (this.chunkExists(p_72915_2_ >> 4, p_72915_4_ >> 4)) {
                        ...
                        for (int var7 = 0; var7 < this.worldAccesses.size(); ++var7) {
                            ((IWorldAccess) this.worldAccesses.get(var7)).markBlockForRenderUpdate(p_72915_2_,
                                    p_72915_3_, p_72915_4_);
                        }
                    }
                }
            }
    ...
    public void func_147479_m(int p_147479_1_, int p_147479_2_, int p_147479_3_) {
        for (int var4 = 0; var4 < this.worldAccesses.size(); ++var4) {
            ((IWorldAccess) this.worldAccesses.get(var4)).markBlockForRenderUpdate(p_147479_1_, p_147479_2_,
                    p_147479_3_);
        }
    }
     ...
     * looked up in a lookup table (light
    ...
    public MovingObjectPosition func_147447_a(Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_,
        ...
        if (!Double.isNaN(p_147447_1_.xCoord) && !Double.isNaN(p_147447_1_.yCoord)
            ...
            if (!Double.isNaN(p_147447_2_.xCoord) && !Double.isNaN(p_147447_2_.yCoord)
                ...
                if ((!p_147447_4_ || var12.getCollisionBoundingBoxFromPool(this, var9, var10, var11) != null)
                        && var12.canCollideCheck(var13, p_147447_3_)) {
                    MovingObjectPosition var14 = var12.collisionRayTrace(this, var9, var10, var11, p_147447_1_,
                            p_147447_2_);
                ...
                while (var13-- >= 0) {
                    ...
                    if (!p_147447_4_ || var37.getCollisionBoundingBoxFromPool(this, var9, var10, var11) != null) {
                        if (var37.canCollideCheck(var38, p_147447_3_)) {
                            MovingObjectPosition var39 = var37.collisionRayTrace(this, var9, var10, var11, p_147447_1_,
                                    p_147447_2_);
    ...
    public void playSoundAtEntity(Entity p_72956_1_, String p_72956_2_, float p_72956_3_, float p_72956_4_) {
        for (int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
            ((IWorldAccess) this.worldAccesses.get(var5)).playSound(p_72956_2_, p_72956_1_.posX,
                    p_72956_1_.posY - (double) p_72956_1_.yOffset, p_72956_1_.posZ, p_72956_3_, p_72956_4_);
        }
    }
    ...
    public void playSoundToNearExcept(EntityPlayer p_85173_1_, String p_85173_2_, float p_85173_3_, float p_85173_4_) {
        for (int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
            ((IWorldAccess) this.worldAccesses.get(var5)).playSoundToNearExcept(p_85173_1_, p_85173_2_, p_85173_1_.posX,
                    p_85173_1_.posY - (double) p_85173_1_.yOffset, p_85173_1_.posZ, p_85173_3_, p_85173_4_);
        }
    }

    /**
     * Play a sound effect. Many many parameters for this function. Not sure what
     * they do, but a classic call is :
     * (double)i + 0.5D, (double)j + 0.5D, (double)k + 0.5D, 'random.door_open',
            ...
            for (int var10 = var7; var10 < var8; ++var10) {
                if (this.blockExists(var9, 64, var10)) {
                    for (int var11 = var5 - 1; var11 < var6; ++var11) {
                        ...
                        var12.addCollisionBoxesToList(this, var9, var11, var10, p_72945_2_, this.collidingBoundingBoxes,
                                p_72945_1_);
                    }
                }
            }
    ...
    public int getPrecipitationHeight(int p_72874_1_, int p_72874_2_) {
        return this.getChunkFromBlockCoords(p_72874_1_, p_72874_2_).getPrecipitationHeight(p_72874_1_ & 15,
                p_72874_2_ & 15);
    }
    ...
    public int getTopSolidOrLiquidBlock(int p_72825_1_, int p_72825_2_) {
        ...
        for (p_72825_2_ &= 15; var4 > 0; --var4) {
            Block var5 = var3.getBlockAt(p_72825_1_, var4, p_72825_2_);
    ...
    public void updateEntities() {
        ...
        while (var9.hasNext()) {
            ...
            if (!var10.isInvalid() && var10.hasWorldObj()
                    && this.blockExists(var10.field_145851_c, var10.field_145848_d, var10.field_145849_e)) {
                try {
                    var10.updateEntity();
            ...
            if (var10.isInvalid()) {
                ...
                if (this.chunkExists(var10.field_145851_c >> 4, var10.field_145849_e >> 4)) {
                    ...
                    if (var12 != null) {
                        var12.removeTileEntity(var10.field_145851_c & 15, var10.field_145848_d,
                                var10.field_145849_e & 15);
                    }
                }
            }
        }
            ...
            for (int var11 = 0; var11 < this.field_147484_a.size(); ++var11) {
                ...
                if (!var13.isInvalid()) {
                    ...
                    if (this.chunkExists(var13.field_145851_c >> 4, var13.field_145849_e >> 4)) {
                        Chunk var15 = this.getChunkFromChunkCoords(var13.field_145851_c >> 4,
                                var13.field_145849_e >> 4);

                        if (var15 != null) {
                            var15.func_150812_a(var13.field_145851_c & 15, var13.field_145848_d,
                                    var13.field_145849_e & 15, var13);
                        }
                    }
                    ...
                    for (int var14 = var8; var14 < var9; ++var14) {
                        ...
                        if (var15.getMaterial() == p_72918_2_) {
                            double var16 = (double) ((float) (var13 + 1)
                                    - BlockLiquid.func_149801_b(this.getBlockMetadata(var12, var13, var14)));
     ...
     * extinguish it. Args: Player, X,Y,Z,
     * blockDirection
     */
        ...
        if (p_147438_2_ >= 0 && p_147438_2_ < 256) {
            ...
            if (this.field_147481_N) {
                for (var5 = 0; var5 < this.field_147484_a.size(); ++var5) {
                    ...
                    if (!var6.isInvalid() && var6.field_145851_c == p_147438_1_ && var6.field_145848_d == p_147438_2_
                            && var6.field_145849_e == p_147438_3_) {
                        var4 = var6;
                        break;
                    }
                }
        ...
        if (p_147455_4_ != null && !p_147455_4_.isInvalid()) {
            if (this.field_147481_N) {
                ...
                while (var5.hasNext()) {
                    ...
                    if (var6.field_145851_c == p_147455_1_ && var6.field_145848_d == p_147455_2_
                            && var6.field_145849_e == p_147455_3_) {
                        var6.invalidate();
                        var5.remove();
                    }
                }
    ...
    public boolean func_147469_q(int p_147469_1_, int p_147469_2_, int p_147469_3_) {
        AxisAlignedBB var4 = this.getBlock(p_147469_1_, p_147469_2_, p_147469_3_).getCollisionBoundingBoxFromPool(this,
                p_147469_1_, p_147469_2_, p_147469_3_);
    ...
    protected void func_147467_a(int p_147467_1_, int p_147467_2_, Chunk p_147467_3_) {
        ...
        if (this.ambientTickCountdown == 0 && !this.isClient) {
            ...
            Block var8 = p_147467_3_.getBlockAt(var5, var7, var6);
            var5 += p_147467_1_;
            var6 += p_147467_2_;
     ...
     * the par4 boolean is set, this will
     * only return true if there is a non-water block immediately adjacent to the
     * specified block
     */
    public boolean canBlockFreeze(int p_72834_1_, int p_72834_2_, int p_72834_3_, boolean p_72834_4_) {
        ...
        if (var6 > 0.15F) {
            ...
            if (p_72834_2_ >= 0 && p_72834_2_ < 256
                    && this.getSavedLightValue(EnumSkyBlock.Block, p_72834_1_, p_72834_2_, p_72834_3_) < 10) {
                Block var7 = this.getBlock(p_72834_1_, p_72834_2_, p_72834_3_);

                if ((var7 == Blocks.water || var7 == Blocks.flowing_water)
                        && this.getBlockMetadata(p_72834_1_, p_72834_2_, p_72834_3_) == 0) {
                    if (!p_72834_4_) {
                        return true;
                    }
    ...
    public boolean func_147478_e(int p_147478_1_, int p_147478_2_, int p_147478_3_, boolean p_147478_4_) {
        ...
        if (var6 > 0.15F) {
            ...
            if (p_147478_2_ >= 0 && p_147478_2_ < 256
                    && this.getSavedLightValue(EnumSkyBlock.Block, p_147478_1_, p_147478_2_, p_147478_3_) < 10) {
                            ...
                            if (var15 + var16 + var17 < 17) {
                                for (int var18 = 0; var18 < 6; ++var18) {
                                    ...
                                    if (var14 == var13 - var22 && var6 < this.lightUpdateBlockList.length) {
                                        this.lightUpdateBlockList[var6++] = var19 - p_147463_2_ + 32
                                                | var20 - p_147463_3_ + 32 << 6 | var21 - p_147463_4_ + 32 << 12
                                                | var13 - var22 << 18;
                                    }
                                }
                            }
                    ...
                    if (var14 > var13) {
                        ...
                        if (var15 + var16 + var17 < 17 && var23) {
                            if (this.getSavedLightValue(p_147463_1_, var10 - 1, var11, var12) < var14) {
                                this.lightUpdateBlockList[var6++] = var10 - 1 - p_147463_2_ + 32
                                        + (var11 - p_147463_3_ + 32 << 6) + (var12 - p_147463_4_ + 32 << 12);
                            }
                            ...
                            if (this.getSavedLightValue(p_147463_1_, var10, var11 - 1, var12) < var14) {
                                this.lightUpdateBlockList[var6++] = var10 - p_147463_2_ + 32
                                        + (var11 - 1 - p_147463_3_ + 32 << 6) + (var12 - p_147463_4_ + 32 << 12);
                            }
                            ...
                            if (this.getSavedLightValue(p_147463_1_, var10, var11, var12 - 1) < var14) {
                                this.lightUpdateBlockList[var6++] = var10 - p_147463_2_ + 32
                                        + (var11 - p_147463_3_ + 32 << 6) + (var12 - 1 - p_147463_4_ + 32 << 12);
                            }
    ...
    public List selectEntitiesWithinAABB(Class p_82733_1_, AxisAlignedBB p_82733_2_, IEntitySelector p_82733_3_) {
        ...
        for (int var9 = var4; var9 <= var5; ++var9) {
            for (int var10 = var6; var10 <= var7; ++var10) {
                if (this.chunkExists(var9, var10)) {
                    this.getChunkFromChunkCoords(var9, var10).getEntitiesOfTypeWithinAAAB(p_82733_1_, p_82733_2_, var8,
                            p_82733_3_);
                }
            }
        }
    ...
    public int countEntities(Class p_72907_1_) {
        ...
        for (int var3 = 0; var3 < this.loadedEntityList.size(); ++var3) {
            ...
            if ((!(var4 instanceof EntityLiving) || !((EntityLiving) var4).isNoDespawnRequired())
                    && p_72907_1_.isAssignableFrom(var4.getClass())) {
                ++var2;
            }
        }
    ...
    public PathEntity getPathEntityToEntity(Entity p_72865_1_, Entity p_72865_2_, float p_72865_3_, boolean p_72865_4_,
        ...
        PathEntity var19 = (new PathFinder(var18, p_72865_4_, p_72865_5_, p_72865_6_, p_72865_7_))
    ...
    public PathEntity getEntityPathToXYZ(Entity p_72844_1_, int p_72844_2_, int p_72844_3_, int p_72844_4_,
        ...
        PathEntity var21 = (new PathFinder(var20, p_72844_6_, p_72844_7_, p_72844_8_, p_72844_9_))
    ...
    public int isBlockProvidingPowerTo(int p_72879_1_, int p_72879_2_, int p_72879_3_, int p_72879_4_) {
        return this.getBlock(p_72879_1_, p_72879_2_, p_72879_3_).isProvidingStrongPower(this, p_72879_1_, p_72879_2_,
                ...
                if (var5 >= 15) {
                    ...
                    if (var5 >= 15) {
                        ...
                        if (var5 >= 15) {
                            ...
                            var5 = Math.max(var5,
                                    this.isBlockProvidingPowerTo(p_94577_1_ + 1, p_94577_2_, p_94577_3_, 5));
     ...
     * from a neighboring block. Used by
    ...
    public int getStrongestIndirectPower(int p_94572_1_, int p_94572_2_, int p_94572_3_) {
        ...
        for (int var5 = 0; var5 < 6; ++var5) {
            int var6 = this.getIndirectPowerLevelTo(p_94572_1_ + Facing.offsetsXForSide[var5],
                    p_94572_2_ + Facing.offsetsYForSide[var5], p_94572_3_ + Facing.offsetsZForSide[var5], var5);
     ...
     * distance is less than 0 then ignored).
     * Args: entity, dist
     */
     ...
     * can be set to less than 0 to not
    ...
    public float getWeightedThunderStrength(float p_72819_1_) {
        return (this.prevThunderingStrength + (this.thunderingStrength - this.prevThunderingStrength) * p_72819_1_)
                * this.getRainStrength(p_72819_1_);
    }
     ...
     * removing any existing ones of the same
     * id.
     */
     ...
     * using the MapStorage, instantiating
    ...
    public void playBroadcastSound(int p_82739_1_, int p_82739_2_, int p_82739_3_, int p_82739_4_, int p_82739_5_) {
        for (int var6 = 0; var6 < this.worldAccesses.size(); ++var6) {
            ((IWorldAccess) this.worldAccesses.get(var6)).broadcastSound(p_82739_1_, p_82739_2_, p_82739_3_, p_82739_4_,
                    p_82739_5_);
        }
    }
    ...
    public Random setRandomSeed(int p_72843_1_, int p_72843_2_, int p_72843_3_) {
        long var4 = (long) p_72843_1_ * 341873128712L + (long) p_72843_2_ * 132897987541L
                + this.getWorldInfo().getSeed() + (long) p_72843_3_;
    ...
    public float func_147462_b(double p_147462_1_, double p_147462_3_, double p_147462_5_) {
        return this.func_147473_B(MathHelper.floor_double(p_147462_1_), MathHelper.floor_double(p_147462_3_),
    ...
    public float func_147473_B(int p_147473_1_, int p_147473_2_, int p_147473_3_) {
        ...
        if (this.blockExists(p_147473_1_, p_147473_2_, p_147473_3_)) {
            ...
            var4 += MathHelper.clamp_float(
                    (float) this.getChunkFromBlockCoords(p_147473_1_, p_147473_3_).inhabitedTime / 3600000.0F, 0.0F,
                    1.0F) * (var5 ? 1.0F : 0.75F);
            var4 += var6 * 0.25F;
        }
