            ...
            if (p_77648_1_.getItemDamage() == 15) {
                ...
                if (var11 == Blocks.log && BlockLog.func_150165_c(var12) == 3) {
                    ...
                    if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_, p_77648_6_)) {
                        int var13 = Blocks.cocoa.onBlockPlaced(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_,
    ...
    public static void func_150918_a(World p_150918_0_, int p_150918_1_, int p_150918_2_, int p_150918_3_,
        ...
        if (var5.getMaterial() != Material.air) {
            ...
            for (int var6 = 0; var6 < p_150918_4_; ++var6) {
                ...
                p_150918_0_.spawnParticle("happyVillager", (double) ((float) p_150918_1_ + itemRand.nextFloat()),
                        (double) p_150918_2_ + (double) itemRand.nextFloat() * var5.getBlockBoundsMaxY(),
                        (double) ((float) p_150918_3_ + itemRand.nextFloat()), var7, var9, var11);
            }
        }
    }
