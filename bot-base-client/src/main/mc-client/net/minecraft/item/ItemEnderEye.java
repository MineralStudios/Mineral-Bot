...
public class ItemEnderEye extends Item {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        if (p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_)
                && var11 == Blocks.end_portal_frame && !BlockEndPortalFrame.func_150020_b(var12)) {
            if (p_77648_3_.isClient) {
                ...
                if (var17 && var15 == var26 + 2) {
                    for (var19 = var26; var19 <= var15; ++var19) {
                        ...
                        if (p_77648_3_.getBlock(var29, p_77648_5_, var21) != Blocks.end_portal_frame
                                || !BlockEndPortalFrame
                                        .func_150020_b(p_77648_3_.getBlockMetadata(var29, p_77648_5_, var21))) {
                            var17 = false;
                            break;
                        }
                    }
                    ...
                    for (var19 = var26 - 1; var19 <= var15 + 1; var19 += 4) {
                        for (var29 = 1; var29 <= 3; ++var29) {
                            ...
                            if (p_77648_3_.getBlock(var21, p_77648_5_, var30) != Blocks.end_portal_frame
                                    || !BlockEndPortalFrame
                                            .func_150020_b(p_77648_3_.getBlockMetadata(var21, p_77648_5_, var30))) {
                                var17 = false;
                                break;
                            }
                        }
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        ...
        if (var4 != null && var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
                && p_77659_2_.getBlock(var4.blockX, var4.blockY, var4.blockZ) == Blocks.end_portal_frame) {
            return p_77659_1_;
        } else {
            if (!p_77659_2_.isClient) {
                ChunkPosition var5 = p_77659_2_.findClosestStructure("Stronghold", (int) p_77659_3_.posX,
                        (int) p_77659_3_.posY, (int) p_77659_3_.posZ);
