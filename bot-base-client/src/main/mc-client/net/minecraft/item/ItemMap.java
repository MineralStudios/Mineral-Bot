...
public class ItemMap extends ItemMapBase {
                    ...
                    for (int var16 = var8 - var9 - 1; var16 < var8 + var9; ++var16) {
                        if (var11 >= 0 && var16 >= -1 && var11 < 128 && var16 < 128) {
                            ...
                            if (!var23.isEmpty()) {
                                    ...
                                    for (var29 = 0; var29 < var4; ++var29) {
                                        for (int var30 = 0; var30 < var4; ++var30) {
                                            ...
                                            if (var31 > 1) {
                                                do {
                                                    --var31;
                                                    var32 = var23.getBlockAt(var29 + var24, var31, var30 + var25);
                                                    var33 = var23.getBlockMetadata(var29 + var24, var31, var30 + var25);
                                                } while (var32.getMapColor(var33) == MapColor.field_151660_b
                                                        && var31 > 0);
                                                ...
                                                if (var31 > 0 && var32.getMaterial().isLiquid()) {
                                                    ...
                                                    do {
                                                        var35 = var23.getBlockAt(var29 + var24, var34--, var30 + var25);
                                                        ++var26;
                                ...
                                var26 /= var4 * var4;
                                double var36 = (var27 - var14) * 4.0D / (double) (var4 + 4)
                                ...
                                MapColor var38 = (MapColor) Iterables.getFirst(Multisets.copyHighestCountFirst(var22),
                                ...
                                if (var16 >= 0 && var17 * var17 + var18 * var18 < var9 * var9
    ...
    public Packet func_150911_c(ItemStack p_150911_1_, World p_150911_2_, EntityPlayer p_150911_3_) {
        byte[] var4 = this.getMapData(p_150911_1_, p_150911_2_).getUpdatePacketData(p_150911_1_, p_150911_2_,
                p_150911_3_);
