    ...
    public void addRecipes(CraftingManager p_77586_1_) {
        for (int var2 = 0; var2 < this.recipeItems[0].length; ++var2) {
            ...
            for (int var4 = 0; var4 < this.recipeItems.length - 1; ++var4) {
                ...
                assert var3 != null;
                assert this.recipePatterns[var4] != null;
                assert var5 != null;
                assert Items.stick != null;
                Object[] array = new Object[] { this.recipePatterns[var4], '#', Items.stick, 'X', var3 };
                p_77586_1_.addRecipe(new ItemStack(var5), array);
            }
        }
