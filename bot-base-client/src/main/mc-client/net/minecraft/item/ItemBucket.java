        ...
        if (var5 == null) {
            ...
            if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (var4) {
                    ...
                    if (this.tryPlaceContainedLiquid(p_77659_2_, var6, var7, var8)
                            && !p_77659_3_.capabilities.isCreativeMode) {
                        return new ItemStack(Items.bucket);
                    }
                }
            }
        ...
        if (this.isFull == Blocks.air) {
            ...
            if (!p_77875_1_.isAirBlock(p_77875_2_, p_77875_3_, p_77875_4_) && !var6) {
                ...
                if (p_77875_1_.provider.isHellWorld && this.isFull == Blocks.flowing_water) {
                    p_77875_1_.playSoundEffect((double) ((float) p_77875_2_ + 0.5F),
                            (double) ((float) p_77875_3_ + 0.5F), (double) ((float) p_77875_4_ + 0.5F), "random.fizz",
                            0.5F, 2.6F + (p_77875_1_.rand.nextFloat() - p_77875_1_.rand.nextFloat()) * 0.8F);

                    for (int var7 = 0; var7 < 8; ++var7) {
                        p_77875_1_.spawnParticle("largesmoke", (double) p_77875_2_ + Math.random(),
                                (double) p_77875_3_ + Math.random(), (double) p_77875_4_ + Math.random(), 0.0D, 0.0D,
                                0.0D);
                    }
                } else {
