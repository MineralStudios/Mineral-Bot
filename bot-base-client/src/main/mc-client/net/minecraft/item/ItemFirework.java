...
public class ItemFirework extends Item {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        if (!p_77648_3_.isClient) {
            EntityFireworkRocket var11 = new EntityFireworkRocket(p_77648_3_,
                    (double) ((float) p_77648_4_ + p_77648_8_), (double) ((float) p_77648_5_ + p_77648_9_),
                    (double) ((float) p_77648_6_ + p_77648_10_), p_77648_1_);
        ...
        if (p_77624_1_.hasTagCompound()) {
            ...
            if (var5 != null) {
                if (var5.func_150297_b("Flight", 99)) {
                    p_77624_3_.add(
                            StatCollector.translateToLocal("item.fireworks.flight") + " " + var5.getByte("Flight"));
                }
