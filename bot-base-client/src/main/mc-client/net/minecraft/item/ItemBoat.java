...
public class ItemBoat extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        ...
        double var9 = p_77659_3_.prevPosY + (p_77659_3_.posY - p_77659_3_.prevPosY) * (double) var4 + 1.62D
        ...
        if (var24 == null) {
            ...
            boolean var26 = false;
            float var27 = 1.0F;
            List var28 = p_77659_2_.getEntitiesWithinAABBExcludingEntity(p_77659_3_,
                    p_77659_3_.boundingBox.addCoord(var25.xCoord * var21, var25.yCoord * var21, var25.zCoord * var21)
            ...
            if (var26) {
                ...
                if (var24.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                    ...
                    EntityBoat var35 = new EntityBoat(p_77659_2_, (double) ((float) var29 + 0.5F),
                            (double) ((float) var33 + 1.0F), (double) ((float) var34 + 0.5F));
                    var35.rotationYaw = (float) (((MathHelper
                            .floor_double((double) (p_77659_3_.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);

                    if (!p_77659_2_.getCollidingBoundingBoxes(var35, var35.boundingBox.expand(-0.1D, -0.1D, -0.1D))
                            .isEmpty()) {
                        return p_77659_1_;
                    }
