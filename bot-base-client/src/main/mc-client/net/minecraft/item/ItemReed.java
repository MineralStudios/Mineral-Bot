...
public class ItemReed extends Item {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_)) {
            ...
            if (p_77648_3_.canPlaceEntityOnSide(this.field_150935_a, p_77648_4_, p_77648_5_, p_77648_6_, false,
                    p_77648_7_, (Entity) null, p_77648_1_)) {
                int var12 = this.field_150935_a.onBlockPlaced(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_,
                ...
                if (p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, this.field_150935_a, var12, 3)) {
                    if (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == this.field_150935_a) {
                        this.field_150935_a.onBlockPlacedBy(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_2_,
                                p_77648_1_);
                    ...
                    p_77648_3_.playSoundEffect((double) ((float) p_77648_4_ + 0.5F),
                            ...
                            this.field_150935_a.stepSound.func_150496_b(),
                            (this.field_150935_a.stepSound.func_150497_c() + 1.0F) / 2.0F,
                            this.field_150935_a.stepSound.func_150494_d() * 0.8F);
