...
public class ItemSlab extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        if (this.field_150948_b) {
            ...
            if ((p_77648_7_ == 1 && !var14 || p_77648_7_ == 0 && var14) && var11 == this.field_150949_c
                ...
                if (p_77648_3_
                        ...
                        && p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, this.field_150947_d, var13, 3)) {
                    p_77648_3_.playSoundEffect((double) ((float) p_77648_4_ + 0.5F),
                            ...
                            (this.field_150947_d.stepSound.func_150497_c() + 1.0F) / 2.0F,
                            this.field_150947_d.stepSound.func_150494_d() * 0.8F);
    ...
    public boolean func_150936_a(World p_150936_1_, int p_150936_2_, int p_150936_3_, int p_150936_4_, int p_150936_5_,
        ...
        if ((p_150936_5_ == 1 && !var14 || p_150936_5_ == 0 && var14) && var11 == this.field_150949_c
            ...
            var13 = var16 & 7;
            return var15 == this.field_150949_c && var13 == p_150936_7_.getItemDamage() ? true
                    : super.func_150936_a(p_150936_1_, var8, var9, var10, p_150936_5_, p_150936_6_, p_150936_7_);
        }
    }
    ...
    private boolean func_150946_a(ItemStack p_150946_1_, EntityPlayer p_150946_2_, World p_150946_3_, int p_150946_4_,
        ...
        if (var8 == this.field_150949_c && var10 == p_150946_1_.getItemDamage()) {
            if (p_150946_3_
                    ...
                    && p_150946_3_.setBlock(p_150946_4_, p_150946_5_, p_150946_6_, this.field_150947_d, var10, 3)) {
