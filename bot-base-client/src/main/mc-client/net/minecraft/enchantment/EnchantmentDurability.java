...
public class EnchantmentDurability extends Enchantment {
     ...
     * should be negated using the
     * enchantment level (par1). If the ItemStack is Armor then there is a flat 60%
     * chance for damage to be negated no
     * matter the enchantment level, otherwise there is a 1-(par/1) chance for
     * damage to be negated.
     */
