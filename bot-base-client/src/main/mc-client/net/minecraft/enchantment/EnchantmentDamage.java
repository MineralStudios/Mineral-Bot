...
public class EnchantmentDamage extends Enchantment {
     ...
     * values to be able to use thing
     * enchant.
     */
    ...
    public EnchantmentDamage(int p_i1923_1_, int p_i1923_2_, int damageType) {
    ...
    public float func_152376_a(int p_152376_1_, EnumCreatureAttribute p_152376_2_) {
        return this.damageType == 0 ? (float) p_152376_1_ * 1.25F
                : (this.damageType == 1 && p_152376_2_ == EnumCreatureAttribute.UNDEAD ? (float) p_152376_1_ * 2.5F
                        : (this.damageType == 2 && p_152376_2_ == EnumCreatureAttribute.ARTHROPOD
                                ? (float) p_152376_1_ * 2.5F
                                : 0.0F));
    }
