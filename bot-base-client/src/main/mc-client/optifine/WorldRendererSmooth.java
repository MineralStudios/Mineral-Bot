...
public class WorldRendererSmooth extends WorldRenderer {
    ...
    public WorldRendererSmooth(Minecraft mc, World par1World, List par2List, int par3, int par4, int par5, int par6) {
        ...
        if (this.worldObj == null) {
            ...
            if (!this.isUpdating) {
                if (this.needsBoxUpdate) {
                    ...
                    RenderItem.renderAABB(this.mc,
                            AxisAlignedBB.getBoundingBox((double) this.posXClip, (double) this.posYClip,
                                    (double) this.posZClip, (double) (this.posXClip + 16),
                                    (double) (this.posYClip + 16),
                                    (double) (this.posZClip + 16)));
                    GL11.glEndList();
            ...
            if (!this.isUpdating) {
                ...
                EntityLivingBase renderPass = mc.renderViewEntity;
                ...
                chunkcache = new ChunkCache(this.worldObj, var27 - renderNextPass, yMin - renderNextPass,
                        zMin - renderNextPass, xMax + renderNextPass, yMax + renderNextPass, zMax + renderNextPass,
                        renderNextPass);
                renderblocks = new RenderBlocks(this.mc, chunkcache);
                Reflector.callVoid(Reflector.ForgeHooksClient_setWorldRendererRB, new Object[]{renderblocks});
                setOldEntityRenders = new HashSet(this.tileEntityRenderers);
            ...
            if (this.isUpdating || chunkcache != null && !chunkcache.extendedLevelsInChunkCache()) {
                ...
                for (int var31 = 0; var31 < 2; ++var31) {
                    ...
                    for (int y = yMin; y < yMax; ++y) {
                        ...
                        } else if (hasGlList && finishTime != 0L && System.nanoTime() - finishTime > 0L
                                && this.activeListIndex[var31] < 15) {
                                ...
                                if (block != null && block.getMaterial() != Material.air) {
                                    ...
                                    if (Reflector.ForgeBlock_canRenderInPass.exists()) {
                                        canRender = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInPass,
                                                new Object[]{Integer.valueOf(var31)});
                                    }
            ...
            if (setOldEntityRenders != null)
                this.tileEntityRenderers.forEach(setOldEntityRenders::remove);
