...
public class Mipmaps {
        ...
        if (texWidth == width && texHeight == height) {
            ...
            while (true) {
                ...
                if (mipWidth <= 0 && mipHeight <= 0) {
                    Dimension[] mipmapDimensions1 = (Dimension[]) ((Dimension[]) listDims
            ...
            Config.warn("Mipmaps not possible (power of 2 dimensions needed), texture: " + iconName + ", dim: " + width
                    + "x" + height);
    ...
    public static void allocateMipmapTextures(int width, int height, String name) {
        ...
        for (int i = 0; i < dims.length; ++i) {
            ...
            int mipHeight = dim.height;
            int level = i + 1;
            GL11.glTexImage2D(GL11.GL_TEXTURE_2D, level, GL11.GL_RGBA, mipWidth, mipHeight, 0, GL12.GL_BGRA,
