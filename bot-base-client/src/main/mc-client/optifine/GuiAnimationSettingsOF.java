...
public class GuiAnimationSettingsOF extends GuiScreen {
    ...
    private static GameSettings.Options[] enumOptions = new GameSettings.Options[] {
            ...
            GameSettings.Options.ANIMATED_ITEMS, GameSettings.Options.ANIMATED_TEXTURES,
            GameSettings.Options.PARTICLES };

    public GuiAnimationSettingsOF(Minecraft mc, GuiScreen guiscreen, GameSettings gamesettings) {
        super(mc);
    ...
    public void initGui() {
        ...
        this.buttonList
                .add(new GuiButton(this.mc, 210, this.width / 2 - 155, this.height / 6 + 168 + 11, 70, 20, "All ON"));
        this.buttonList
                .add(new GuiButton(this.mc, 211, this.width / 2 - 155 + 80, this.height / 6 + 168 + 11, 70, 20,
                        "All OFF"));
        this.buttonList.add(new GuiOptionButton(this.mc, 200, this.width / 2 + 5, this.height / 6 + 168 + 11,
