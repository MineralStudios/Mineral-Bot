...
public class HttpUtils {
    ...
    public static byte[] get(Minecraft mc, String urlStr) throws IOException {
        HttpURLConnection conn = null;

        try {
            URL url = new URL(urlStr);
            conn = (HttpURLConnection) url.openConnection(mc.getProxy());
    ...
    public static String post(Minecraft mc, String urlStr, Map headers, byte[] content) throws IOException {
        HttpURLConnection conn = null;
