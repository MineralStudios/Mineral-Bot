...
public class TextureAnimations {
    ...
    public static TextureAnimation[] getTextureAnimations(Minecraft mc, IResourcePack[] rps) {
        ArrayList list = new ArrayList();

        for (int anims = 0; anims < rps.length; ++anims) {
            IResourcePack rp = rps[anims];
            TextureAnimation[] tas = getTextureAnimations(mc, rp);
        ...
        TextureAnimation[] var5 = (TextureAnimation[]) ((TextureAnimation[]) list
                .toArray(new TextureAnimation[list.size()]));
        return var5;
    }

    public static TextureAnimation[] getTextureAnimations(Minecraft mc, IResourcePack rp) {
        ...
        if (animPropNames.length <= 0) {
            ...
            for (int anims = 0; anims < animPropNames.length; ++anims) {
                ...
                try {
                    ...
                    props.load(in);
                    TextureAnimation anim = makeTextureAnimation(mc, props, e);
            ...
            TextureAnimation[] var12 = (TextureAnimation[]) ((TextureAnimation[]) list
                    .toArray(new TextureAnimation[list.size()]));
            return var12;
        }
    }

    public static TextureAnimation makeTextureAnimation(Minecraft mc, Properties props, ResourceLocation propLoc) {
            ...
            if (x >= 0 && y >= 0 && width >= 0 && height >= 0) {
                ...
                if (imageBytes == null) {
                    ...
                    if (!mc.getConfig().hasResource(locTexTo)) {
                        ...
                        ITextureObject destTex = TextureUtils.getTexture(mc, locTexTo);
                        ...
                        if (destTex == null) {
                            ...
                            TextureAnimation anim = new TextureAnimation(texFrom, imageBytes, texTo, destTexId, x, y,
                                    width, height, props, 1);
                            return anim;
                        }
                    }
                }
