...
public class PlayerItemParser {
    ...
    public static PlayerItemModel parseItemModel(Minecraft mc, JsonObject obj) {
        ...
        if (!Config.equals(type, "PlayerItem")) {
            ...
            for (int modelRenderers = 0; modelRenderers < models.size(); ++modelRenderers) {
                ...
                PlayerItemRenderer var18 = parseItemRenderer(mc, elem, textureDim);
            ...
            PlayerItemRenderer[] var16 = (PlayerItemRenderer[]) ((PlayerItemRenderer[]) listModels
                    .toArray(new PlayerItemRenderer[listModels.size()]));
    ...
    private static PlayerItemRenderer parseItemRenderer(Minecraft mc, JsonObject elem, Dimension textureDim) {
        ...
        if (!Config.equals(type, "ModelBox")) {
            ...
            ModelRenderer mr = parseModelRenderer(mc, elem, modelBase);
            PlayerItemRenderer pir = new PlayerItemRenderer(attachTo, scale, mr);
            return pir;
        }
    }

    private static ModelRenderer parseModelRenderer(Minecraft mc, JsonObject elem, ModelBase modelBase) {
        ModelRenderer mr = new ModelRenderer(mc, modelBase);
        ...
        if (submodel != null) {
            ModelRenderer var23 = parseModelRenderer(mc, submodel, modelBase);
            mr.addChild(var23);
        }
        ...
        if (var24 != null) {
            for (int var26 = 0; var26 < var24.size(); ++var26) {
                ...
                ModelRenderer var29 = parseModelRenderer(mc, var28, modelBase);
                mr.addChild(var29);
            }
        }
