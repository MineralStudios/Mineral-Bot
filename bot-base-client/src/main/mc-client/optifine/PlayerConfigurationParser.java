...
public class PlayerConfigurationParser {
    ...
    public PlayerConfigurationParser(Minecraft mc, String player) {
        this.player = player;
        this.mc = mc;
    }
    ...
    private BufferedImage downloadTextureImage(String texturePath) {
        ...
        try {
            byte[] e = HttpPipeline.get(textureUrl, this.mc.getProxy());
