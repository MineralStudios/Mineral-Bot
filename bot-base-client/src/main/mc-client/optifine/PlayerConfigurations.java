...
public class PlayerConfigurations {
    ...
    public static void renderPlayerItems(ModelBiped modelBiped, AbstractClientPlayer player, float scale,
            float partialTicks) {
    ...
    public static synchronized PlayerConfiguration getPlayerConfiguration(AbstractClientPlayer player) {
        ...
        if (name == null) {
            ...
            if (pc == null) {
                ...
                PlayerConfigurationReceiver pcl = new PlayerConfigurationReceiver(player.getMc(), name);
                String url = "http://s.optifine.net/users/" + name + ".cfg";
                FileDownloadThread fdt = new FileDownloadThread(url, pcl, player.getMc());
                fdt.start();
            }
