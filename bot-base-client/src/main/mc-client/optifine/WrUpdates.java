...
public class WrUpdates {
    ...
    public static WorldRenderer makeWorldRenderer(Minecraft mc, World worldObj, List tileEntities, int x, int y, int z,
            int glRenderListBase) {
        return wrUpdater == null ? new WorldRenderer(mc, worldObj, tileEntities, x, y, z, glRenderListBase)
                : wrUpdater.makeWorldRenderer(worldObj, tileEntities, x, y, z, glRenderListBase);
    }
